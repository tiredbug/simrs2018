...
$vw_spp_ls_gaji_list_add = NULL; // Initialize page object first

class cvw_spp_ls_gaji_list_add extends cvw_spp_ls_gaji_list {
	...
	// Page object name
	var $PageObjName = 'vw_spp_ls_gaji_list_add';
	...
	function Page_Init() {
		...
		if (@$_POST["ajax"] == "autofill") {
			...
			// Process auto fill for detail table 'vw_spp_ls_gaji_list_detail_belanja'
			if (@$_POST["grid"] == "fvw_spp_ls_gaji_list_detail_belanjagrid") {
				if (!isset($GLOBALS["vw_spp_ls_gaji_list_detail_belanja_grid"])) $GLOBALS["vw_spp_ls_gaji_list_detail_belanja_grid"] = new cvw_spp_ls_gaji_list_detail_belanja_grid;
				$GLOBALS["vw_spp_ls_gaji_list_detail_belanja_grid"]->Page_Init();
				$this->Page_Terminate();
				exit();
			}

			// Process auto fill for detail table 'vw_spp_ls_gaji_list_detail_pajak'
			if (@$_POST["grid"] == "fvw_spp_ls_gaji_list_detail_pajakgrid") {
				if (!isset($GLOBALS["vw_spp_ls_gaji_list_detail_pajak_grid"])) $GLOBALS["vw_spp_ls_gaji_list_detail_pajak_grid"] = new cvw_spp_ls_gaji_list_detail_pajak_grid;
				$GLOBALS["vw_spp_ls_gaji_list_detail_pajak_grid"]->Page_Init();
				$this->Page_Terminate();
				exit();
			}
		...
		switch ($this->CurrentAction) {
			...
			case "C": // Copy an existing record
				if (!$this->LoadRow()) { // Load record based on key
					...
					$this->Page_Terminate("vw_spp_ls_gaji_listlist.php"); // No matching record, return to list
				}
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					if (ew_GetPageName($sReturnUrl) == "vw_spp_ls_gaji_listlist.php")
						$sReturnUrl = $this->AddMasterUrl($sReturnUrl); // List page, return to list page with correct master key if necessary
					elseif (ew_GetPageName($sReturnUrl) == "vw_spp_ls_gaji_listview.php")
	...
	function LoadDefaultValues() {
		...
		$this->detail_jenis_spp->CurrentValue = 5;
		...
		$this->kode_program->CurrentValue = "1.02.037";
	...
	function ValidateForm() {
		...
		if (in_array("vw_spp_ls_gaji_list_detail_belanja", $DetailTblVar) && $GLOBALS["vw_spp_ls_gaji_list_detail_belanja"]->DetailAdd) {
			if (!isset($GLOBALS["vw_spp_ls_gaji_list_detail_belanja_grid"])) $GLOBALS["vw_spp_ls_gaji_list_detail_belanja_grid"] = new cvw_spp_ls_gaji_list_detail_belanja_grid(); // get detail page object
			$GLOBALS["vw_spp_ls_gaji_list_detail_belanja_grid"]->ValidateGridForm();
		}
		if (in_array("vw_spp_ls_gaji_list_detail_pajak", $DetailTblVar) && $GLOBALS["vw_spp_ls_gaji_list_detail_pajak"]->DetailAdd) {
			if (!isset($GLOBALS["vw_spp_ls_gaji_list_detail_pajak_grid"])) $GLOBALS["vw_spp_ls_gaji_list_detail_pajak_grid"] = new cvw_spp_ls_gaji_list_detail_pajak_grid(); // get detail page object
			$GLOBALS["vw_spp_ls_gaji_list_detail_pajak_grid"]->ValidateGridForm();
		}
	...
	function AddRow($rsold = NULL) {
		...
		if ($AddRow) {
			$DetailTblVar = explode(",", $this->getCurrentDetailTable());
			if (in_array("vw_spp_ls_gaji_list_detail_belanja", $DetailTblVar) && $GLOBALS["vw_spp_ls_gaji_list_detail_belanja"]->DetailAdd) {
				$GLOBALS["vw_spp_ls_gaji_list_detail_belanja"]->id_spp->setSessionValue($this->id->CurrentValue); // Set master key
				$GLOBALS["vw_spp_ls_gaji_list_detail_belanja"]->id_jenis_spp->setSessionValue($this->id_jenis_spp->CurrentValue); // Set master key
				$GLOBALS["vw_spp_ls_gaji_list_detail_belanja"]->detail_jenis_spp->setSessionValue($this->detail_jenis_spp->CurrentValue); // Set master key
				$GLOBALS["vw_spp_ls_gaji_list_detail_belanja"]->no_spp->setSessionValue($this->no_spp->CurrentValue); // Set master key
				$GLOBALS["vw_spp_ls_gaji_list_detail_belanja"]->program->setSessionValue($this->kode_program->CurrentValue); // Set master key
				$GLOBALS["vw_spp_ls_gaji_list_detail_belanja"]->kegiatan->setSessionValue($this->kode_kegiatan->CurrentValue); // Set master key
				$GLOBALS["vw_spp_ls_gaji_list_detail_belanja"]->sub_kegiatan->setSessionValue($this->kode_sub_kegiatan->CurrentValue); // Set master key
				$GLOBALS["vw_spp_ls_gaji_list_detail_belanja"]->tahun_anggaran->setSessionValue($this->tahun_anggaran->CurrentValue); // Set master key
				if (!isset($GLOBALS["vw_spp_ls_gaji_list_detail_belanja_grid"])) $GLOBALS["vw_spp_ls_gaji_list_detail_belanja_grid"] = new cvw_spp_ls_gaji_list_detail_belanja_grid(); // Get detail page object
				$Security->LoadCurrentUserLevel($this->ProjectID . "vw_spp_ls_gaji_list_detail_belanja"); // Load user level of detail table
				$AddRow = $GLOBALS["vw_spp_ls_gaji_list_detail_belanja_grid"]->GridInsert();
				$Security->LoadCurrentUserLevel($this->ProjectID . $this->TableName); // Restore user level of master table
				if (!$AddRow)
					$GLOBALS["vw_spp_ls_gaji_list_detail_belanja"]->tahun_anggaran->setSessionValue(""); // Clear master key if insert failed
			}
			if (in_array("vw_spp_ls_gaji_list_detail_pajak", $DetailTblVar) && $GLOBALS["vw_spp_ls_gaji_list_detail_pajak"]->DetailAdd) {
				$GLOBALS["vw_spp_ls_gaji_list_detail_pajak"]->id_spp->setSessionValue($this->id->CurrentValue); // Set master key
				$GLOBALS["vw_spp_ls_gaji_list_detail_pajak"]->id_jenis_spp->setSessionValue($this->id_jenis_spp->CurrentValue); // Set master key
				$GLOBALS["vw_spp_ls_gaji_list_detail_pajak"]->detail_jenis_spp->setSessionValue($this->detail_jenis_spp->CurrentValue); // Set master key
				$GLOBALS["vw_spp_ls_gaji_list_detail_pajak"]->no_spp->setSessionValue($this->no_spp->CurrentValue); // Set master key
				$GLOBALS["vw_spp_ls_gaji_list_detail_pajak"]->program->setSessionValue($this->kode_program->CurrentValue); // Set master key
				$GLOBALS["vw_spp_ls_gaji_list_detail_pajak"]->kegiatan->setSessionValue($this->kode_kegiatan->CurrentValue); // Set master key
				$GLOBALS["vw_spp_ls_gaji_list_detail_pajak"]->sub_kegiatan->setSessionValue($this->kode_sub_kegiatan->CurrentValue); // Set master key
				$GLOBALS["vw_spp_ls_gaji_list_detail_pajak"]->tahun_anggaran->setSessionValue($this->tahun_anggaran->CurrentValue); // Set master key
				if (!isset($GLOBALS["vw_spp_ls_gaji_list_detail_pajak_grid"])) $GLOBALS["vw_spp_ls_gaji_list_detail_pajak_grid"] = new cvw_spp_ls_gaji_list_detail_pajak_grid(); // Get detail page object
				$Security->LoadCurrentUserLevel($this->ProjectID . "vw_spp_ls_gaji_list_detail_pajak"); // Load user level of detail table
				$AddRow = $GLOBALS["vw_spp_ls_gaji_list_detail_pajak_grid"]->GridInsert();
				$Security->LoadCurrentUserLevel($this->ProjectID . $this->TableName); // Restore user level of master table
				if (!$AddRow)
					$GLOBALS["vw_spp_ls_gaji_list_detail_pajak"]->tahun_anggaran->setSessionValue(""); // Clear master key if insert failed
			}
		}
	...
	function SetUpDetailParms() {
		...
		if ($sDetailTblVar <> "") {
			...
			if (in_array("vw_spp_ls_gaji_list_detail_belanja", $DetailTblVar)) {
				...
				if ($GLOBALS["vw_spp_ls_gaji_list_detail_belanja_grid"]->DetailAdd) {
					if ($this->CopyRecord)
						$GLOBALS["vw_spp_ls_gaji_list_detail_belanja_grid"]->CurrentMode = "copy";
					else
						$GLOBALS["vw_spp_ls_gaji_list_detail_belanja_grid"]->CurrentMode = "add";
					$GLOBALS["vw_spp_ls_gaji_list_detail_belanja_grid"]->CurrentAction = "gridadd";
			...
			if (in_array("vw_spp_ls_gaji_list_detail_pajak", $DetailTblVar)) {
				...
				if ($GLOBALS["vw_spp_ls_gaji_list_detail_pajak_grid"]->DetailAdd) {
					if ($this->CopyRecord)
						$GLOBALS["vw_spp_ls_gaji_list_detail_pajak_grid"]->CurrentMode = "copy";
					else
						$GLOBALS["vw_spp_ls_gaji_list_detail_pajak_grid"]->CurrentMode = "add";
					$GLOBALS["vw_spp_ls_gaji_list_detail_pajak_grid"]->CurrentAction = "gridadd";
...
// Create page object
if (!isset($vw_spp_ls_gaji_list_add)) $vw_spp_ls_gaji_list_add = new cvw_spp_ls_gaji_list_add();

// Page init
$vw_spp_ls_gaji_list_add->Page_Init();

// Page main
$vw_spp_ls_gaji_list_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$vw_spp_ls_gaji_list_add->Page_Render();
?>
...
var CurrentForm = fvw_spp_ls_gaji_listadd = new ew_Form("fvw_spp_ls_gaji_listadd", "add");

// Validate form
fvw_spp_ls_gaji_listadd.Validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		$fobj.data("rowindex", infix);
			...
			if (elm && !ew_CheckInteger(elm.value))
				return this.OnError(elm, "<?php echo ew_JsEncode2($vw_spp_ls_gaji_list->tahun_anggaran->FldErrMsg()) ?>");
...
fvw_spp_ls_gaji_listadd.Form_CustomValidate = 
...
fvw_spp_ls_gaji_listadd.ValidateRequired = true;
<?php } else { ?>
fvw_spp_ls_gaji_listadd.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fvw_spp_ls_gaji_listadd.Lists["x_id_jenis_spp"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_jenis_spp","","",""],"ParentFields":[],"ChildFields":["x_detail_jenis_spp"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"l_jenis_spp"};
fvw_spp_ls_gaji_listadd.Lists["x_detail_jenis_spp"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_detail_jenis_spp","","",""],"ParentFields":["x_id_jenis_spp"],"ChildFields":[],"FilterFields":["x_id_jenis"],"Options":[],"Template":"","LinkTable":"l_jenis_detail_spp"};
fvw_spp_ls_gaji_listadd.Lists["x_status_spp"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fvw_spp_ls_gaji_listadd.Lists["x_status_spp"].Options = <?php echo json_encode($vw_spp_ls_gaji_list->status_spp->Options()) ?>;
fvw_spp_ls_gaji_listadd.Lists["x_kode_program"] = {"LinkField":"x_kode_program","Ajax":true,"AutoFill":false,"DisplayFields":["x_nama_program","","",""],"ParentFields":[],"ChildFields":["x_kode_kegiatan"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"m_program"};
fvw_spp_ls_gaji_listadd.Lists["x_kode_kegiatan"] = {"LinkField":"x_kode_kegiatan","Ajax":true,"AutoFill":false,"DisplayFields":["x_nama_kegiatan","","",""],"ParentFields":["x_kode_program"],"ChildFields":["x_kode_sub_kegiatan"],"FilterFields":["x_kode_program"],"Options":[],"Template":"","LinkTable":"m_kegiatan"};
fvw_spp_ls_gaji_listadd.Lists["x_kode_sub_kegiatan"] = {"LinkField":"x_kode_sub_kegiatan","Ajax":true,"AutoFill":false,"DisplayFields":["x_nama_sub_kegiatan","","",""],"ParentFields":["x_kode_kegiatan"],"ChildFields":[],"FilterFields":["x_kode_kegiatan"],"Options":[],"Template":"","LinkTable":"m_sub_kegiatan"};
fvw_spp_ls_gaji_listadd.Lists["x_nama_bendahara"] = {"LinkField":"x_nama","Ajax":true,"AutoFill":true,"DisplayFields":["x_nama","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"m_pejabat_keuangan"};
fvw_spp_ls_gaji_listadd.Lists["x_nama_pptk"] = {"LinkField":"x_nama","Ajax":true,"AutoFill":true,"DisplayFields":["x_nama","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"m_pejabat_keuangan"};
...
<?php if (!$vw_spp_ls_gaji_list_add->IsModal) { ?>
<?php } ?>
<?php $vw_spp_ls_gaji_list_add->ShowPageHeader(); ?>
<?php
$vw_spp_ls_gaji_list_add->ShowMessage();
?>
<form name="fvw_spp_ls_gaji_listadd" id="fvw_spp_ls_gaji_listadd" class="<?php echo $vw_spp_ls_gaji_list_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($vw_spp_ls_gaji_list_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $vw_spp_ls_gaji_list_add->Token ?>">
<?php } ?>
...
<?php } ?>
<div id="tpd_vw_spp_ls_gaji_listadd" class="ewCustomTemplate"></div>
<script id="tpm_vw_spp_ls_gaji_listadd" type="text/html">
<div id="ct_vw_spp_ls_gaji_list_add"><div id="ct_sample_add">
<div class="ewRow">
<div class="panel panel-default">
 ...
 <!-- Start   KOLOM 1 -->
  <div class="col-lg-6 col-md-6 col-sm-6">
	...
	<?php echo $vw_spp_ls_gaji_list->id_jenis_spp->FldCaption() ?></label>
	<div class="col-sm-8">{{include tmpl="#tpx_vw_spp_ls_gaji_list_id_jenis_spp"/}}</div>
	</div>
	...
	<?php echo $vw_spp_ls_gaji_list->detail_jenis_spp->FldCaption() ?></label>
	<div class="col-sm-8">{{include tmpl="#tpx_vw_spp_ls_gaji_list_detail_jenis_spp"/}}</div>
	</div>
	<div id="r_status_spp" class="form-group">
	<label id="elh_status_spp" for="x_status_spp" class="col-sm-3 control-label ewLabel">
	<?php echo $vw_spp_ls_gaji_list->status_spp->FldCaption() ?></label>
	<div class="col-sm-8">{{include tmpl="#tpx_vw_spp_ls_gaji_list_status_spp"/}}</div>
	</div>
	<div id="r_no_spp" class="form-group">
	<label id="elh_no_spp" for="x_no_spp" class="col-sm-3 control-label ewLabel">
	<?php echo $vw_spp_ls_gaji_list->no_spp->FldCaption() ?></label>
	<div class="col-sm-8">{{include tmpl="#tpx_vw_spp_ls_gaji_list_no_spp"/}}</div>
	</div>
	<div id="r_tgl_spp" class="form-group">
	<label id="elh_tgl_spp" for="x_tgl_spp" class="col-sm-3 control-label ewLabel">
	<?php echo $vw_spp_ls_gaji_list->tgl_spp->FldCaption() ?></label>
	<div class="col-sm-8">{{include tmpl="#tpx_vw_spp_ls_gaji_list_tgl_spp"/}}</div>
	</div>
	...
	<?php echo $vw_spp_ls_gaji_list->nama_bendahara->FldCaption() ?></label>
	<div class="col-sm-8">{{include tmpl="#tpx_vw_spp_ls_gaji_list_nama_bendahara"/}}</div>
	</div>
	<div id="r_nama_pptk" class="form-group">
	<label id="elh_nama_pptk" for="x_nama_pptk" class="col-sm-3 control-label ewLabel">
	<?php echo $vw_spp_ls_gaji_list->nama_pptk->FldCaption() ?></label>
	<div class="col-sm-8">{{include tmpl="#tpx_vw_spp_ls_gaji_list_nama_pptk"/}}</div>
	</div>
	<div id="r_kode_program" class="form-group">
	<label id="elh_kode_program" for="x_kode_program" class="col-sm-3 control-label ewLabel">
	<?php echo $vw_spp_ls_gaji_list->kode_program->FldCaption() ?></label>
	<div class="col-sm-8">{{include tmpl="#tpx_vw_spp_ls_gaji_list_kode_program"/}}</div>
	</div>
	...
	<?php echo $vw_spp_ls_gaji_list->kode_kegiatan->FldCaption() ?></label>
	<div class="col-sm-8">{{include tmpl="#tpx_vw_spp_ls_gaji_list_kode_kegiatan"/}}</div>
	</div>
	...
	<?php echo $vw_spp_ls_gaji_list->kode_sub_kegiatan->FldCaption() ?></label>
	<div class="col-sm-8">{{include tmpl="#tpx_vw_spp_ls_gaji_list_kode_sub_kegiatan"/}}</div>
	</div>
  </div>
 <!-- end   KOLOM 1 -->
 <!-- Start   KOLOM 2 -->
  <div class="col-lg-6 col-md-6 col-sm-6">
	...
	<?php echo $vw_spp_ls_gaji_list->keterangan->FldCaption() ?></label>
	<div class="col-sm-8">{{include tmpl="#tpx_vw_spp_ls_gaji_list_keterangan"/}}</div>
	</div>
	...
	<?php echo $vw_spp_ls_gaji_list->nip_bendahara->FldCaption() ?></label>
	<div class="col-sm-8">{{include tmpl="#tpx_vw_spp_ls_gaji_list_nip_bendahara"/}}</div>
	</div>
	<div id="r_nip_pptk" class="form-group">
	<label id="elh_nip_pptk" for="x_nip_pptk" class="col-sm-3 control-label ewLabel">
	<?php echo $vw_spp_ls_gaji_list->nip_pptk->FldCaption() ?></label>
	<div class="col-sm-8">{{include tmpl="#tpx_vw_spp_ls_gaji_list_nip_pptk"/}}</div>
	</div>
  </div>
   <!-- End   KOLOM 2 -->
</div>
...
<?php if ($vw_spp_ls_gaji_list->id_jenis_spp->Visible) { // id_jenis_spp ?>
	<div id="r_id_jenis_spp" class="form-group">
		<label id="elh_vw_spp_ls_gaji_list_id_jenis_spp" for="x_id_jenis_spp" class="col-sm-2 control-label ewLabel"><script id="tpc_vw_spp_ls_gaji_list_id_jenis_spp" class="vw_spp_ls_gaji_listadd" type="text/html"><span><?php echo $vw_spp_ls_gaji_list->id_jenis_spp->FldCaption() ?></span></script></label>
		<div class="col-sm-10"><div<?php echo $vw_spp_ls_gaji_list->id_jenis_spp->CellAttributes() ?>>
<script id="tpx_vw_spp_ls_gaji_list_id_jenis_spp" class="vw_spp_ls_gaji_listadd" type="text/html">
...
<?php echo $vw_spp_ls_gaji_list->id_jenis_spp->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($vw_spp_ls_gaji_list->detail_jenis_spp->Visible) { // detail_jenis_spp ?>
	<div id="r_detail_jenis_spp" class="form-group">
		<label id="elh_vw_spp_ls_gaji_list_detail_jenis_spp" for="x_detail_jenis_spp" class="col-sm-2 control-label ewLabel"><script id="tpc_vw_spp_ls_gaji_list_detail_jenis_spp" class="vw_spp_ls_gaji_listadd" type="text/html"><span><?php echo $vw_spp_ls_gaji_list->detail_jenis_spp->FldCaption() ?></span></script></label>
		<div class="col-sm-10"><div<?php echo $vw_spp_ls_gaji_list->detail_jenis_spp->CellAttributes() ?>>
<script id="tpx_vw_spp_ls_gaji_list_detail_jenis_spp" class="vw_spp_ls_gaji_listadd" type="text/html">
...
<?php echo $vw_spp_ls_gaji_list->detail_jenis_spp->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($vw_spp_ls_gaji_list->status_spp->Visible) { // status_spp ?>
	<div id="r_status_spp" class="form-group">
		<label id="elh_vw_spp_ls_gaji_list_status_spp" for="x_status_spp" class="col-sm-2 control-label ewLabel"><script id="tpc_vw_spp_ls_gaji_list_status_spp" class="vw_spp_ls_gaji_listadd" type="text/html"><span><?php echo $vw_spp_ls_gaji_list->status_spp->FldCaption() ?></span></script></label>
		<div class="col-sm-10"><div<?php echo $vw_spp_ls_gaji_list->status_spp->CellAttributes() ?>>
<script id="tpx_vw_spp_ls_gaji_list_status_spp" class="vw_spp_ls_gaji_listadd" type="text/html">
...
<?php echo $vw_spp_ls_gaji_list->status_spp->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($vw_spp_ls_gaji_list->no_spp->Visible) { // no_spp ?>
	<div id="r_no_spp" class="form-group">
		<label id="elh_vw_spp_ls_gaji_list_no_spp" for="x_no_spp" class="col-sm-2 control-label ewLabel"><script id="tpc_vw_spp_ls_gaji_list_no_spp" class="vw_spp_ls_gaji_listadd" type="text/html"><span><?php echo $vw_spp_ls_gaji_list->no_spp->FldCaption() ?></span></script></label>
		<div class="col-sm-10"><div<?php echo $vw_spp_ls_gaji_list->no_spp->CellAttributes() ?>>
<script id="tpx_vw_spp_ls_gaji_list_no_spp" class="vw_spp_ls_gaji_listadd" type="text/html">
...
<?php echo $vw_spp_ls_gaji_list->no_spp->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($vw_spp_ls_gaji_list->tgl_spp->Visible) { // tgl_spp ?>
	<div id="r_tgl_spp" class="form-group">
		<label id="elh_vw_spp_ls_gaji_list_tgl_spp" for="x_tgl_spp" class="col-sm-2 control-label ewLabel"><script id="tpc_vw_spp_ls_gaji_list_tgl_spp" class="vw_spp_ls_gaji_listadd" type="text/html"><span><?php echo $vw_spp_ls_gaji_list->tgl_spp->FldCaption() ?></span></script></label>
		<div class="col-sm-10"><div<?php echo $vw_spp_ls_gaji_list->tgl_spp->CellAttributes() ?>>
<script id="tpx_vw_spp_ls_gaji_list_tgl_spp" class="vw_spp_ls_gaji_listadd" type="text/html">
...
<script type="text/html" class="vw_spp_ls_gaji_listadd_js">
ew_CreateCalendar("fvw_spp_ls_gaji_listadd", "x_tgl_spp", 7);
</script>
<?php echo $vw_spp_ls_gaji_list->tgl_spp->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($vw_spp_ls_gaji_list->keterangan->Visible) { // keterangan ?>
	<div id="r_keterangan" class="form-group">
		<label id="elh_vw_spp_ls_gaji_list_keterangan" for="x_keterangan" class="col-sm-2 control-label ewLabel"><script id="tpc_vw_spp_ls_gaji_list_keterangan" class="vw_spp_ls_gaji_listadd" type="text/html"><span><?php echo $vw_spp_ls_gaji_list->keterangan->FldCaption() ?></span></script></label>
		<div class="col-sm-10"><div<?php echo $vw_spp_ls_gaji_list->keterangan->CellAttributes() ?>>
<script id="tpx_vw_spp_ls_gaji_list_keterangan" class="vw_spp_ls_gaji_listadd" type="text/html">
<span id="el_vw_spp_ls_gaji_list_keterangan">
<input type="text" data-table="vw_spp_ls_gaji_list" data-field="x_keterangan" name="x_keterangan" id="x_keterangan" size="30" maxlength="45" placeholder="<?php echo ew_HtmlEncode($vw_spp_ls_gaji_list->keterangan->getPlaceHolder()) ?>" value="<?php echo $vw_spp_ls_gaji_list->keterangan->EditValue ?>"<?php echo $vw_spp_ls_gaji_list->keterangan->EditAttributes() ?>>
</span>
</script>
<?php echo $vw_spp_ls_gaji_list->keterangan->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($vw_spp_ls_gaji_list->kode_program->Visible) { // kode_program ?>
	<div id="r_kode_program" class="form-group">
		<label id="elh_vw_spp_ls_gaji_list_kode_program" for="x_kode_program" class="col-sm-2 control-label ewLabel"><script id="tpc_vw_spp_ls_gaji_list_kode_program" class="vw_spp_ls_gaji_listadd" type="text/html"><span><?php echo $vw_spp_ls_gaji_list->kode_program->FldCaption() ?></span></script></label>
		<div class="col-sm-10"><div<?php echo $vw_spp_ls_gaji_list->kode_program->CellAttributes() ?>>
<script id="tpx_vw_spp_ls_gaji_list_kode_program" class="vw_spp_ls_gaji_listadd" type="text/html">
<span id="el_vw_spp_ls_gaji_list_kode_program">
<?php $vw_spp_ls_gaji_list->kode_program->EditAttrs["onchange"] = "ew_UpdateOpt.call(this); " . @$vw_spp_ls_gaji_list->kode_program->EditAttrs["onchange"]; ?>
<select data-table="vw_spp_ls_gaji_list" data-field="x_kode_program" data-value-separator="<?php echo $vw_spp_ls_gaji_list->kode_program->DisplayValueSeparatorAttribute() ?>" id="x_kode_program" name="x_kode_program"<?php echo $vw_spp_ls_gaji_list->kode_program->EditAttributes() ?>>
<?php echo $vw_spp_ls_gaji_list->kode_program->SelectOptionListHtml("x_kode_program") ?>
</select>
<input type="hidden" name="s_x_kode_program" id="s_x_kode_program" value="<?php echo $vw_spp_ls_gaji_list->kode_program->LookupFilterQuery() ?>">
</span>
</script>
<?php echo $vw_spp_ls_gaji_list->kode_program->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($vw_spp_ls_gaji_list->kode_kegiatan->Visible) { // kode_kegiatan ?>
	<div id="r_kode_kegiatan" class="form-group">
		<label id="elh_vw_spp_ls_gaji_list_kode_kegiatan" for="x_kode_kegiatan" class="col-sm-2 control-label ewLabel"><script id="tpc_vw_spp_ls_gaji_list_kode_kegiatan" class="vw_spp_ls_gaji_listadd" type="text/html"><span><?php echo $vw_spp_ls_gaji_list->kode_kegiatan->FldCaption() ?></span></script></label>
		<div class="col-sm-10"><div<?php echo $vw_spp_ls_gaji_list->kode_kegiatan->CellAttributes() ?>>
<script id="tpx_vw_spp_ls_gaji_list_kode_kegiatan" class="vw_spp_ls_gaji_listadd" type="text/html">
<span id="el_vw_spp_ls_gaji_list_kode_kegiatan">
<?php $vw_spp_ls_gaji_list->kode_kegiatan->EditAttrs["onchange"] = "ew_UpdateOpt.call(this); " . @$vw_spp_ls_gaji_list->kode_kegiatan->EditAttrs["onchange"]; ?>
<select data-table="vw_spp_ls_gaji_list" data-field="x_kode_kegiatan" data-value-separator="<?php echo $vw_spp_ls_gaji_list->kode_kegiatan->DisplayValueSeparatorAttribute() ?>" id="x_kode_kegiatan" name="x_kode_kegiatan"<?php echo $vw_spp_ls_gaji_list->kode_kegiatan->EditAttributes() ?>>
<?php echo $vw_spp_ls_gaji_list->kode_kegiatan->SelectOptionListHtml("x_kode_kegiatan") ?>
</select>
<input type="hidden" name="s_x_kode_kegiatan" id="s_x_kode_kegiatan" value="<?php echo $vw_spp_ls_gaji_list->kode_kegiatan->LookupFilterQuery() ?>">
</span>
</script>
<?php echo $vw_spp_ls_gaji_list->kode_kegiatan->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($vw_spp_ls_gaji_list->kode_sub_kegiatan->Visible) { // kode_sub_kegiatan ?>
	<div id="r_kode_sub_kegiatan" class="form-group">
		<label id="elh_vw_spp_ls_gaji_list_kode_sub_kegiatan" for="x_kode_sub_kegiatan" class="col-sm-2 control-label ewLabel"><script id="tpc_vw_spp_ls_gaji_list_kode_sub_kegiatan" class="vw_spp_ls_gaji_listadd" type="text/html"><span><?php echo $vw_spp_ls_gaji_list->kode_sub_kegiatan->FldCaption() ?></span></script></label>
		<div class="col-sm-10"><div<?php echo $vw_spp_ls_gaji_list->kode_sub_kegiatan->CellAttributes() ?>>
<script id="tpx_vw_spp_ls_gaji_list_kode_sub_kegiatan" class="vw_spp_ls_gaji_listadd" type="text/html">
<span id="el_vw_spp_ls_gaji_list_kode_sub_kegiatan">
<select data-table="vw_spp_ls_gaji_list" data-field="x_kode_sub_kegiatan" data-value-separator="<?php echo $vw_spp_ls_gaji_list->kode_sub_kegiatan->DisplayValueSeparatorAttribute() ?>" id="x_kode_sub_kegiatan" name="x_kode_sub_kegiatan"<?php echo $vw_spp_ls_gaji_list->kode_sub_kegiatan->EditAttributes() ?>>
<?php echo $vw_spp_ls_gaji_list->kode_sub_kegiatan->SelectOptionListHtml("x_kode_sub_kegiatan") ?>
</select>
<input type="hidden" name="s_x_kode_sub_kegiatan" id="s_x_kode_sub_kegiatan" value="<?php echo $vw_spp_ls_gaji_list->kode_sub_kegiatan->LookupFilterQuery() ?>">
</span>
</script>
<?php echo $vw_spp_ls_gaji_list->kode_sub_kegiatan->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($vw_spp_ls_gaji_list->nama_bendahara->Visible) { // nama_bendahara ?>
	<div id="r_nama_bendahara" class="form-group">
		<label id="elh_vw_spp_ls_gaji_list_nama_bendahara" for="x_nama_bendahara" class="col-sm-2 control-label ewLabel"><script id="tpc_vw_spp_ls_gaji_list_nama_bendahara" class="vw_spp_ls_gaji_listadd" type="text/html"><span><?php echo $vw_spp_ls_gaji_list->nama_bendahara->FldCaption() ?></span></script></label>
		<div class="col-sm-10"><div<?php echo $vw_spp_ls_gaji_list->nama_bendahara->CellAttributes() ?>>
<script id="tpx_vw_spp_ls_gaji_list_nama_bendahara" class="vw_spp_ls_gaji_listadd" type="text/html">
<span id="el_vw_spp_ls_gaji_list_nama_bendahara">
<?php $vw_spp_ls_gaji_list->nama_bendahara->EditAttrs["onchange"] = "ew_AutoFill(this); " . @$vw_spp_ls_gaji_list->nama_bendahara->EditAttrs["onchange"]; ?>
<select data-table="vw_spp_ls_gaji_list" data-field="x_nama_bendahara" data-value-separator="<?php echo $vw_spp_ls_gaji_list->nama_bendahara->DisplayValueSeparatorAttribute() ?>" id="x_nama_bendahara" name="x_nama_bendahara"<?php echo $vw_spp_ls_gaji_list->nama_bendahara->EditAttributes() ?>>
<?php echo $vw_spp_ls_gaji_list->nama_bendahara->SelectOptionListHtml("x_nama_bendahara") ?>
</select>
<input type="hidden" name="s_x_nama_bendahara" id="s_x_nama_bendahara" value="<?php echo $vw_spp_ls_gaji_list->nama_bendahara->LookupFilterQuery() ?>">
<input type="hidden" name="ln_x_nama_bendahara" id="ln_x_nama_bendahara" value="x_nip_bendahara">
</span>
</script>
<?php echo $vw_spp_ls_gaji_list->nama_bendahara->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($vw_spp_ls_gaji_list->nip_bendahara->Visible) { // nip_bendahara ?>
	<div id="r_nip_bendahara" class="form-group">
		<label id="elh_vw_spp_ls_gaji_list_nip_bendahara" for="x_nip_bendahara" class="col-sm-2 control-label ewLabel"><script id="tpc_vw_spp_ls_gaji_list_nip_bendahara" class="vw_spp_ls_gaji_listadd" type="text/html"><span><?php echo $vw_spp_ls_gaji_list->nip_bendahara->FldCaption() ?></span></script></label>
		<div class="col-sm-10"><div<?php echo $vw_spp_ls_gaji_list->nip_bendahara->CellAttributes() ?>>
<script id="tpx_vw_spp_ls_gaji_list_nip_bendahara" class="vw_spp_ls_gaji_listadd" type="text/html">
<span id="el_vw_spp_ls_gaji_list_nip_bendahara">
<input type="text" data-table="vw_spp_ls_gaji_list" data-field="x_nip_bendahara" name="x_nip_bendahara" id="x_nip_bendahara" size="30" maxlength="45" placeholder="<?php echo ew_HtmlEncode($vw_spp_ls_gaji_list->nip_bendahara->getPlaceHolder()) ?>" value="<?php echo $vw_spp_ls_gaji_list->nip_bendahara->EditValue ?>"<?php echo $vw_spp_ls_gaji_list->nip_bendahara->EditAttributes() ?>>
</span>
</script>
<?php echo $vw_spp_ls_gaji_list->nip_bendahara->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($vw_spp_ls_gaji_list->nama_pptk->Visible) { // nama_pptk ?>
	<div id="r_nama_pptk" class="form-group">
		<label id="elh_vw_spp_ls_gaji_list_nama_pptk" for="x_nama_pptk" class="col-sm-2 control-label ewLabel"><script id="tpc_vw_spp_ls_gaji_list_nama_pptk" class="vw_spp_ls_gaji_listadd" type="text/html"><span><?php echo $vw_spp_ls_gaji_list->nama_pptk->FldCaption() ?></span></script></label>
		<div class="col-sm-10"><div<?php echo $vw_spp_ls_gaji_list->nama_pptk->CellAttributes() ?>>
<script id="tpx_vw_spp_ls_gaji_list_nama_pptk" class="vw_spp_ls_gaji_listadd" type="text/html">
<span id="el_vw_spp_ls_gaji_list_nama_pptk">
<?php $vw_spp_ls_gaji_list->nama_pptk->EditAttrs["onchange"] = "ew_AutoFill(this); " . @$vw_spp_ls_gaji_list->nama_pptk->EditAttrs["onchange"]; ?>
<select data-table="vw_spp_ls_gaji_list" data-field="x_nama_pptk" data-value-separator="<?php echo $vw_spp_ls_gaji_list->nama_pptk->DisplayValueSeparatorAttribute() ?>" id="x_nama_pptk" name="x_nama_pptk"<?php echo $vw_spp_ls_gaji_list->nama_pptk->EditAttributes() ?>>
<?php echo $vw_spp_ls_gaji_list->nama_pptk->SelectOptionListHtml("x_nama_pptk") ?>
</select>
<input type="hidden" name="s_x_nama_pptk" id="s_x_nama_pptk" value="<?php echo $vw_spp_ls_gaji_list->nama_pptk->LookupFilterQuery() ?>">
<input type="hidden" name="ln_x_nama_pptk" id="ln_x_nama_pptk" value="x_nip_pptk">
</span>
</script>
<?php echo $vw_spp_ls_gaji_list->nama_pptk->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($vw_spp_ls_gaji_list->nip_pptk->Visible) { // nip_pptk ?>
	<div id="r_nip_pptk" class="form-group">
		<label id="elh_vw_spp_ls_gaji_list_nip_pptk" for="x_nip_pptk" class="col-sm-2 control-label ewLabel"><script id="tpc_vw_spp_ls_gaji_list_nip_pptk" class="vw_spp_ls_gaji_listadd" type="text/html"><span><?php echo $vw_spp_ls_gaji_list->nip_pptk->FldCaption() ?></span></script></label>
		<div class="col-sm-10"><div<?php echo $vw_spp_ls_gaji_list->nip_pptk->CellAttributes() ?>>
<script id="tpx_vw_spp_ls_gaji_list_nip_pptk" class="vw_spp_ls_gaji_listadd" type="text/html">
<span id="el_vw_spp_ls_gaji_list_nip_pptk">
<input type="text" data-table="vw_spp_ls_gaji_list" data-field="x_nip_pptk" name="x_nip_pptk" id="x_nip_pptk" size="30" maxlength="45" placeholder="<?php echo ew_HtmlEncode($vw_spp_ls_gaji_list->nip_pptk->getPlaceHolder()) ?>" value="<?php echo $vw_spp_ls_gaji_list->nip_pptk->EditValue ?>"<?php echo $vw_spp_ls_gaji_list->nip_pptk->EditAttributes() ?>>
</span>
</script>
<?php echo $vw_spp_ls_gaji_list->nip_pptk->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($vw_spp_ls_gaji_list->tahun_anggaran->Visible) { // tahun_anggaran ?>
	<div id="r_tahun_anggaran" class="form-group">
		<label id="elh_vw_spp_ls_gaji_list_tahun_anggaran" for="x_tahun_anggaran" class="col-sm-2 control-label ewLabel"><script id="tpc_vw_spp_ls_gaji_list_tahun_anggaran" class="vw_spp_ls_gaji_listadd" type="text/html"><span><?php echo $vw_spp_ls_gaji_list->tahun_anggaran->FldCaption() ?></span></script></label>
		<div class="col-sm-10"><div<?php echo $vw_spp_ls_gaji_list->tahun_anggaran->CellAttributes() ?>>
<script id="tpx_vw_spp_ls_gaji_list_tahun_anggaran" class="vw_spp_ls_gaji_listadd" type="text/html">
<span id="el_vw_spp_ls_gaji_list_tahun_anggaran">
<input type="text" data-table="vw_spp_ls_gaji_list" data-field="x_tahun_anggaran" name="x_tahun_anggaran" id="x_tahun_anggaran" size="30" placeholder="<?php echo ew_HtmlEncode($vw_spp_ls_gaji_list->tahun_anggaran->getPlaceHolder()) ?>" value="<?php echo $vw_spp_ls_gaji_list->tahun_anggaran->EditValue ?>"<?php echo $vw_spp_ls_gaji_list->tahun_anggaran->EditAttributes() ?>>
</span>
</script>
<?php echo $vw_spp_ls_gaji_list->tahun_anggaran->CustomMsg ?></div></div>
	</div>
<?php } ?>
</div>
<?php
	if (in_array("vw_spp_ls_gaji_list_detail_belanja", explode(",", $vw_spp_ls_gaji_list->getCurrentDetailTable())) && $vw_spp_ls_gaji_list_detail_belanja->DetailAdd) {
?>
...
<?php } ?>
<?php
	if (in_array("vw_spp_ls_gaji_list_detail_pajak", explode(",", $vw_spp_ls_gaji_list->getCurrentDetailTable())) && $vw_spp_ls_gaji_list_detail_pajak->DetailAdd) {
?>
<?php if ($vw_spp_ls_gaji_list->getCurrentDetailTable() <> "") { ?>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $vw_spp_ls_gaji_list_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
ew_ApplyTemplate("tpd_vw_spp_ls_gaji_listadd", "tpm_vw_spp_ls_gaji_listadd", "vw_spp_ls_gaji_listadd", "<?php echo $vw_spp_ls_gaji_list->CustomExport ?>");
jQuery("script.vw_spp_ls_gaji_listadd_js").each(function(){ew_AddScript(this.text);});
</script>
<script type="text/javascript">
fvw_spp_ls_gaji_listadd.Init();
</script>
<?php
$vw_spp_ls_gaji_list_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$vw_spp_ls_gaji_list_add->Page_Terminate();
?>
