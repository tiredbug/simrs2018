...
$vw_spp_tu_list_view = NULL; // Initialize page object first

class cvw_spp_tu_list_view extends cvw_spp_tu_list {
	...
	// Page object name
	var $PageObjName = 'vw_spp_tu_list_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["id"] <> "") {
				...
				$sReturnUrl = "vw_spp_tu_listlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "vw_spp_tu_listlist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "vw_spp_tu_listlist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($vw_spp_tu_list_view)) $vw_spp_tu_list_view = new cvw_spp_tu_list_view();

// Page init
$vw_spp_tu_list_view->Page_Init();

// Page main
$vw_spp_tu_list_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$vw_spp_tu_list_view->Page_Render();
?>
...
var CurrentForm = fvw_spp_tu_listview = new ew_Form("fvw_spp_tu_listview", "view");

// Form_CustomValidate event
fvw_spp_tu_listview.Form_CustomValidate = 
...
fvw_spp_tu_listview.ValidateRequired = true;
<?php } else { ?>
fvw_spp_tu_listview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fvw_spp_tu_listview.Lists["x_id_jenis_spp"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_jenis_spp","","",""],"ParentFields":[],"ChildFields":["x_detail_jenis_spp"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"l_jenis_spp"};
fvw_spp_tu_listview.Lists["x_detail_jenis_spp"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_detail_jenis_spp","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"l_jenis_detail_spp"};
fvw_spp_tu_listview.Lists["x_status_spp"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fvw_spp_tu_listview.Lists["x_status_spp"].Options = <?php echo json_encode($vw_spp_tu_list->status_spp->Options()) ?>;
...
<?php if (!$vw_spp_tu_list_view->IsModal) { ?>
<?php } ?>
<?php $vw_spp_tu_list_view->ExportOptions->Render("body") ?>
<?php
	foreach ($vw_spp_tu_list_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$vw_spp_tu_list_view->IsModal) { ?>
...
<?php $vw_spp_tu_list_view->ShowPageHeader(); ?>
<?php
$vw_spp_tu_list_view->ShowMessage();
?>
<form name="fvw_spp_tu_listview" id="fvw_spp_tu_listview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($vw_spp_tu_list_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $vw_spp_tu_list_view->Token ?>">
<?php } ?>
...
<?php if ($vw_spp_tu_list->id->Visible) { // id ?>
	<tr id="r_id">
		<td><span id="elh_vw_spp_tu_list_id"><?php echo $vw_spp_tu_list->id->FldCaption() ?></span></td>
...
<?php echo $vw_spp_tu_list->id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($vw_spp_tu_list->id_jenis_spp->Visible) { // id_jenis_spp ?>
	<tr id="r_id_jenis_spp">
		<td><span id="elh_vw_spp_tu_list_id_jenis_spp"><?php echo $vw_spp_tu_list->id_jenis_spp->FldCaption() ?></span></td>
...
<?php echo $vw_spp_tu_list->id_jenis_spp->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($vw_spp_tu_list->detail_jenis_spp->Visible) { // detail_jenis_spp ?>
	<tr id="r_detail_jenis_spp">
		<td><span id="elh_vw_spp_tu_list_detail_jenis_spp"><?php echo $vw_spp_tu_list->detail_jenis_spp->FldCaption() ?></span></td>
...
<?php echo $vw_spp_tu_list->detail_jenis_spp->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($vw_spp_tu_list->status_spp->Visible) { // status_spp ?>
	<tr id="r_status_spp">
		<td><span id="elh_vw_spp_tu_list_status_spp"><?php echo $vw_spp_tu_list->status_spp->FldCaption() ?></span></td>
...
<?php echo $vw_spp_tu_list->status_spp->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($vw_spp_tu_list->no_spp->Visible) { // no_spp ?>
	<tr id="r_no_spp">
		<td><span id="elh_vw_spp_tu_list_no_spp"><?php echo $vw_spp_tu_list->no_spp->FldCaption() ?></span></td>
...
<?php echo $vw_spp_tu_list->no_spp->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($vw_spp_tu_list->tgl_spp->Visible) { // tgl_spp ?>
	<tr id="r_tgl_spp">
		<td><span id="elh_vw_spp_tu_list_tgl_spp"><?php echo $vw_spp_tu_list->tgl_spp->FldCaption() ?></span></td>
...
<?php echo $vw_spp_tu_list->tgl_spp->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($vw_spp_tu_list->kode_program->Visible) { // kode_program ?>
	<tr id="r_kode_program">
		<td><span id="elh_vw_spp_tu_list_kode_program"><?php echo $vw_spp_tu_list->kode_program->FldCaption() ?></span></td>
...
<?php echo $vw_spp_tu_list->kode_program->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($vw_spp_tu_list->kode_kegiatan->Visible) { // kode_kegiatan ?>
	<tr id="r_kode_kegiatan">
		<td><span id="elh_vw_spp_tu_list_kode_kegiatan"><?php echo $vw_spp_tu_list->kode_kegiatan->FldCaption() ?></span></td>
...
<?php echo $vw_spp_tu_list->kode_kegiatan->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($vw_spp_tu_list->keterangan->Visible) { // keterangan ?>
	<tr id="r_keterangan">
		<td><span id="elh_vw_spp_tu_list_keterangan"><?php echo $vw_spp_tu_list->keterangan->FldCaption() ?></span></td>
...
<?php echo $vw_spp_tu_list->keterangan->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
fvw_spp_tu_listview.Init();
</script>
<?php
$vw_spp_tu_list_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$vw_spp_tu_list_view->Page_Terminate();
?>
