...
class cuserlevelpermissions_list extends cuserlevelpermissions {
	...
	function RenderListOptions() {
		...
		$oListOpt->Body = "<label><input class=\"magic-checkbox ewPointer\" type=\"checkbox\" name=\"key_m[]\" value=\"" . ew_HtmlEncode($this->userlevelid->CurrentValue . $GLOBALS["EW_COMPOSITE_KEY_SEPARATOR"] . $this->_tablename->CurrentValue) . "\" onclick='ew_ClickMultiCheckbox(event);'><span></span></label>";
		...
		$options = &$this->OtherOptions;
			...
			foreach ($this->ListActions->Items as $listaction) {
				if ($listaction->Select == EW_ACTION_MULTIPLE) {
					...
					$item->Body = "<a class=\"btn btn-xs btn-default line-2540\" title=\"" . ew_HtmlEncode($caption) . "\" data-caption=\"" . ew_HtmlEncode($caption) . "\" href=\"\" onclick=\"ew_SubmitAction(event,jQuery.extend({f:document.fuserlevelpermissionslist}," . $listaction->ToJson(TRUE) . "));return false;\">" . $icon . "</a>";
...
<form name="fuserlevelpermissionslistsrch" id="fuserlevelpermissionslistsrch" class="form-horizontal ewForm" action="<?php echo ew_CurrentPage() ?>">
<?php $SearchPanelClass = ($userlevelpermissions_list->SearchWhere <> "") ? " in" : " in"; ?>
<div id="fuserlevelpermissionslistsrch_SearchPanel" class="box box-default collapse<?php echo $SearchPanelClass ?>">
...
<div class="panel panel-default ewGrid userlevelpermissions">
...
<?php } ?>
<input type="hidden" name="t" value="userlevelpermissions">
<div id="gmp_userlevelpermissions" class="<?php if (ew_IsResponsiveLayout()) { echo "table-responsive "; } ?>box box-primary">
<?php if ($userlevelpermissions_list->TotalRecs > 0 || $userlevelpermissions->CurrentAction == "gridedit") { ?>
<table id="tbl_userlevelpermissionslist" class="table ewTable table-bordered table-striped table-condensed table-hover">
...
<?php if ($userlevelpermissions->userlevelid->Visible) { // userlevelid ?>
	...
	<?php } else { ?>
		<th data-name="userlevelid"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $userlevelpermissions->SortUrl($userlevelpermissions->userlevelid) ?>',2);"><div id="elh_userlevelpermissions_userlevelid" class="userlevelpermissions_userlevelid">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $userlevelpermissions->userlevelid->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($userlevelpermissions->userlevelid->getSort() == "ASC") { ?> <i class="fa fa-sort-amount-asc text-muted"></i><?php } elseif ($userlevelpermissions->userlevelid->getSort() == "DESC") { ?> <i class="fa fa-sort-amount-desc text-muted"></i><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($userlevelpermissions->_tablename->Visible) { // tablename ?>
	...
	<?php } else { ?>
		<th data-name="_tablename"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $userlevelpermissions->SortUrl($userlevelpermissions->_tablename) ?>',2);"><div id="elh_userlevelpermissions__tablename" class="userlevelpermissions__tablename">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $userlevelpermissions->_tablename->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($userlevelpermissions->_tablename->getSort() == "ASC") { ?> <i class="fa fa-sort-amount-asc text-muted"></i><?php } elseif ($userlevelpermissions->_tablename->getSort() == "DESC") { ?> <i class="fa fa-sort-amount-desc text-muted"></i><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($userlevelpermissions->permission->Visible) { // permission ?>
	...
	<?php } else { ?>
		<th data-name="permission"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $userlevelpermissions->SortUrl($userlevelpermissions->permission) ?>',2);"><div id="elh_userlevelpermissions_permission" class="userlevelpermissions_permission">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $userlevelpermissions->permission->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($userlevelpermissions->permission->getSort() == "ASC") { ?> <i class="fa fa-sort-amount-asc text-muted"></i><?php } elseif ($userlevelpermissions->permission->getSort() == "DESC") { ?> <i class="fa fa-sort-amount-desc text-muted"></i><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php
...
<!--first page button-->
	...
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $userlevelpermissions_list->PageUrl() ?>start=<?php echo $userlevelpermissions_list->Pager->FirstButton->Start ?>"><span class="fa fa-fast-backward"></span></a>
	<?php } else { ?>
...
<!--previous page button-->
	...
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $userlevelpermissions_list->PageUrl() ?>start=<?php echo $userlevelpermissions_list->Pager->PrevButton->Start ?>"><span class="fa fa-step-backward"></span></a>
	<?php } else { ?>
...
<!--next page button-->
	...
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $userlevelpermissions_list->PageUrl() ?>start=<?php echo $userlevelpermissions_list->Pager->NextButton->Start ?>"><span class="fa fa-step-forward"></span></a>
	<?php } else { ?>
...
<!--last page button-->
	...
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $userlevelpermissions_list->PageUrl() ?>start=<?php echo $userlevelpermissions_list->Pager->LastButton->Start ?>"><span class="fa fa-fast-forward"></span></a>
	<?php } else { ?>
...
<?php } ?>
<?php if ($userlevelpermissions_list->TotalRecs > 0 && (!EW_AUTO_HIDE_PAGE_SIZE_SELECTOR || $userlevelpermissions_list->Pager->Visible)) { ?>
<div class="text-center">
<input type="hidden" name="t" value="userlevelpermissions">
<select name="<?php echo EW_TABLE_REC_PER_PAGE ?>" class="form-control input-sm ewTooltip" title="<?php echo $Language->Phrase("RecordsPerPage") ?>" onchange="this.form.submit();">
<option value="5"<?php if ($userlevelpermissions_list->DisplayRecs == 5) { ?> selected<?php } ?>>5</option>
