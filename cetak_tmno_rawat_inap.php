...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr align="left" valign="top" style="font-size: small">
    ...
    <td width="56%"><span class="style15">
      <?php  print $r[3];?>
    </span></td>
    ...
    <td width="15%"><span class="style21">
      <?php  print $r[1];?>
    </span></td>
    </tr>
  <tr align="left" valign="top" style="font-size: small">
  ...
  <tr align="left" valign="top" style="font-size: xx-small">
    ...
    <td><span class="style11" >:</span></td>
    <td style="font-size: small"><span class="style17">
      <?php  print $r[8].', '.getInfoKecamatan($r[10]).' '.getInfoKota($r[11]);?>
    </span></td>
    <td><span class="style11"></span></td>
    <td><span class="style11"></span></td>
    <td class="style11">&nbsp;</td>
  ...
  <tr align="left" valign="top" style="font-size: small">
    ...
    <td><span class="style18">
      <?php $a = getNamaJaminan($adms[4]); print $a[1]; ?>
    </span></td>
    <td><span class="style11"></span></td>
    <td><span class="style11"></span></td>
    <td class="style11">&nbsp;</td>
  ...
  <tr align="left" valign="top" style="font-size: small">
    ...
    <td><span class="style19">
      <?php $a = getNamaRuangInap($adms[9]); print $a[1]; ?>
    </span>      <span class="style20">
    <?php  //$b = getNamaRuangInap($adms[10]); 
	print ' / '.$adms[10]; ?>
    </span></td>
    <td><span class="style11"></span></td>
    <td><span class="style11"></span></td>
