...
$vw_spp_ls_barang_jasa_detail_add = NULL; // Initialize page object first

class cvw_spp_ls_barang_jasa_detail_add extends cvw_spp_ls_barang_jasa_detail {
	...
	// Page object name
	var $PageObjName = 'vw_spp_ls_barang_jasa_detail_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "vw_spp_ls_barang_jasa_detailview.php")
...
// Create page object
if (!isset($vw_spp_ls_barang_jasa_detail_add)) $vw_spp_ls_barang_jasa_detail_add = new cvw_spp_ls_barang_jasa_detail_add();

// Page init
$vw_spp_ls_barang_jasa_detail_add->Page_Init();

// Page main
$vw_spp_ls_barang_jasa_detail_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$vw_spp_ls_barang_jasa_detail_add->Page_Render();
?>
...
var CurrentForm = fvw_spp_ls_barang_jasa_detailadd = new ew_Form("fvw_spp_ls_barang_jasa_detailadd", "add");

// Validate form
fvw_spp_ls_barang_jasa_detailadd.Validate = function() {
...
fvw_spp_ls_barang_jasa_detailadd.Form_CustomValidate = 
...
fvw_spp_ls_barang_jasa_detailadd.ValidateRequired = true;
<?php } else { ?>
fvw_spp_ls_barang_jasa_detailadd.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fvw_spp_ls_barang_jasa_detailadd.Lists["x_akun1"] = {"LinkField":"x_kel1","Ajax":true,"AutoFill":false,"DisplayFields":["x_nmkel1","","",""],"ParentFields":[],"ChildFields":["x_akun2","x_akun3","x_akun4","x_akun5"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"keu_akun1"};
fvw_spp_ls_barang_jasa_detailadd.Lists["x_akun2"] = {"LinkField":"x_kel2","Ajax":true,"AutoFill":false,"DisplayFields":["x_nmkel2","","",""],"ParentFields":["x_akun1"],"ChildFields":["x_akun3","x_akun4","x_akun5"],"FilterFields":["x_kel1"],"Options":[],"Template":"","LinkTable":"keu_akun2"};
fvw_spp_ls_barang_jasa_detailadd.Lists["x_akun3"] = {"LinkField":"x_kel3","Ajax":true,"AutoFill":false,"DisplayFields":["x_nmkel3","","",""],"ParentFields":["x_akun2","x_akun1"],"ChildFields":["x_akun4","x_akun5"],"FilterFields":["x_kel2","x_kel1"],"Options":[],"Template":"","LinkTable":"keu_akun3"};
fvw_spp_ls_barang_jasa_detailadd.Lists["x_akun4"] = {"LinkField":"x_kel4","Ajax":true,"AutoFill":false,"DisplayFields":["x_nmkel4","","",""],"ParentFields":["x_akun3","x_akun2","x_akun1"],"ChildFields":["x_akun5"],"FilterFields":["x_kel3","x_kel2","x_kel1"],"Options":[],"Template":"","LinkTable":"keu_akun4"};
fvw_spp_ls_barang_jasa_detailadd.Lists["x_akun5"] = {"LinkField":"x_akun5","Ajax":true,"AutoFill":false,"DisplayFields":["x_nama_akun","","",""],"ParentFields":["x_akun4","x_akun3","x_akun2","x_akun1"],"ChildFields":[],"FilterFields":["x_akun4","x_akun3","x_akun2","x_akun1"],"Options":[],"Template":"","LinkTable":"keu_akun5"};
...
<?php if (!$vw_spp_ls_barang_jasa_detail_add->IsModal) { ?>
<?php } ?>
<?php $vw_spp_ls_barang_jasa_detail_add->ShowPageHeader(); ?>
<?php
$vw_spp_ls_barang_jasa_detail_add->ShowMessage();
?>
<form name="fvw_spp_ls_barang_jasa_detailadd" id="fvw_spp_ls_barang_jasa_detailadd" class="<?php echo $vw_spp_ls_barang_jasa_detail_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($vw_spp_ls_barang_jasa_detail_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $vw_spp_ls_barang_jasa_detail_add->Token ?>">
<?php } ?>
...
<?php if (strval($vw_spp_ls_barang_jasa_detail->id_spp->getSessionValue()) <> "") { ?>
<input type="hidden" name="x_id_spp" id="x_id_spp" value="<?php echo ew_HtmlEncode(strval($vw_spp_ls_barang_jasa_detail->id_spp->getSessionValue())) ?>">
<?php } ?>
<?php if (strval($vw_spp_ls_barang_jasa_detail->id_jenis_spp->getSessionValue()) <> "") { ?>
<input type="hidden" name="x_id_jenis_spp" id="x_id_jenis_spp" value="<?php echo ew_HtmlEncode(strval($vw_spp_ls_barang_jasa_detail->id_jenis_spp->getSessionValue())) ?>">
<?php } ?>
<?php if (strval($vw_spp_ls_barang_jasa_detail->detail_jenis_spp->getSessionValue()) <> "") { ?>
<input type="hidden" name="x_detail_jenis_spp" id="x_detail_jenis_spp" value="<?php echo ew_HtmlEncode(strval($vw_spp_ls_barang_jasa_detail->detail_jenis_spp->getSessionValue())) ?>">
<?php } ?>
<?php if (strval($vw_spp_ls_barang_jasa_detail->no_spp->getSessionValue()) <> "") { ?>
<input type="hidden" name="x_no_spp" id="x_no_spp" value="<?php echo ew_HtmlEncode(strval($vw_spp_ls_barang_jasa_detail->no_spp->getSessionValue())) ?>">
<?php } ?>
<?php if (strval($vw_spp_ls_barang_jasa_detail->program->getSessionValue()) <> "") { ?>
<input type="hidden" name="x_program" id="x_program" value="<?php echo ew_HtmlEncode(strval($vw_spp_ls_barang_jasa_detail->program->getSessionValue())) ?>">
<?php } ?>
<?php if (strval($vw_spp_ls_barang_jasa_detail->kegiatan->getSessionValue()) <> "") { ?>
<input type="hidden" name="x_kegiatan" id="x_kegiatan" value="<?php echo ew_HtmlEncode(strval($vw_spp_ls_barang_jasa_detail->kegiatan->getSessionValue())) ?>">
<?php } ?>
<?php if (strval($vw_spp_ls_barang_jasa_detail->sub_kegiatan->getSessionValue()) <> "") { ?>
<input type="hidden" name="x_sub_kegiatan" id="x_sub_kegiatan" value="<?php echo ew_HtmlEncode(strval($vw_spp_ls_barang_jasa_detail->sub_kegiatan->getSessionValue())) ?>">
<?php } ?>
<?php if (strval($vw_spp_ls_barang_jasa_detail->tahun_anggaran->getSessionValue()) <> "") { ?>
<input type="hidden" name="x_tahun_anggaran" id="x_tahun_anggaran" value="<?php echo ew_HtmlEncode(strval($vw_spp_ls_barang_jasa_detail->tahun_anggaran->getSessionValue())) ?>">
<?php } ?>
<?php if (!$vw_spp_ls_barang_jasa_detail_add->IsModal) { ?>
<div class="form-group">
	<div class="col-sm-offset-2 col-sm-10">
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $vw_spp_ls_barang_jasa_detail_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
fvw_spp_ls_barang_jasa_detailadd.Init();
</script>
<?php
$vw_spp_ls_barang_jasa_detail_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$vw_spp_ls_barang_jasa_detail_add->Page_Terminate();
?>
