...
$pendaftaran_sukses_php = NULL; // Initialize page object first

class cpendaftaran_sukses_php {
	...
	// Table name
	var $TableName = 'pendaftaran_sukses.php';

	// Page object name
	var $PageObjName = 'pendaftaran_sukses_php';
	...
	function __construct() {
		...
		if (!defined("EW_TABLE_NAME"))
			define("EW_TABLE_NAME", 'pendaftaran_sukses.php', TRUE);
	...
	function SetupBreadcrumb() {
		...
		$Breadcrumb->Add("custom", "pendaftaran_sukses_php", $url, "", "pendaftaran_sukses_php", TRUE);
	}
}
?>
<?php ew_Header(FALSE) ?>
...
// Create page object
if (!isset($pendaftaran_sukses_php)) $pendaftaran_sukses_php = new cpendaftaran_sukses_php();

// Page init
$pendaftaran_sukses_php->Page_Init();

// Page main
$pendaftaran_sukses_php->Page_Main();
...
<div class="ewToolbar">
<?php
$pendaftaran_sukses_php->ShowMessage();
?>
</div>
<?php } ?>
<?php
		//$url = "cetak_formulir_pendaftaran_pasien.php
		//?IDXDAFTAR=".$this->IDXDAFTAR->CurrentValue."
		//&KDPOLY=".$this->KDPOLY->CurrentValue."&TGLREG=".$this->TGLREG->CurrentValue;
		...
		if (!isset($_GET["KDPOLY"]) || !isset($_GET["IDXDAFTAR"])) {
...
<?php
$pendaftaran_sukses_php->Page_Terminate();
?>
