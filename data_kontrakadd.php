...
$data_kontrak_add = NULL; // Initialize page object first

class cdata_kontrak_add extends cdata_kontrak {
	...
	// Page object name
	var $PageObjName = 'data_kontrak_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "data_kontrakview.php")
...
// Create page object
if (!isset($data_kontrak_add)) $data_kontrak_add = new cdata_kontrak_add();

// Page init
$data_kontrak_add->Page_Init();

// Page main
$data_kontrak_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$data_kontrak_add->Page_Render();
?>
...
var CurrentForm = fdata_kontrakadd = new ew_Form("fdata_kontrakadd", "add");

// Validate form
fdata_kontrakadd.Validate = function() {
...
fdata_kontrakadd.Form_CustomValidate = 
...
fdata_kontrakadd.ValidateRequired = true;
<?php } else { ?>
fdata_kontrakadd.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fdata_kontrakadd.Lists["x_program"] = {"LinkField":"x_kode_program","Ajax":true,"AutoFill":false,"DisplayFields":["x_nama_program","","",""],"ParentFields":[],"ChildFields":["x_kegiatan"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"m_program"};
fdata_kontrakadd.Lists["x_kegiatan"] = {"LinkField":"x_kode_kegiatan","Ajax":true,"AutoFill":false,"DisplayFields":["x_nama_kegiatan","","",""],"ParentFields":["x_program"],"ChildFields":["x_sub_kegiatan"],"FilterFields":["x_kode_program"],"Options":[],"Template":"","LinkTable":"m_kegiatan"};
fdata_kontrakadd.Lists["x_sub_kegiatan"] = {"LinkField":"x_kode_sub_kegiatan","Ajax":true,"AutoFill":true,"DisplayFields":["x_nama_sub_kegiatan","","",""],"ParentFields":["x_kegiatan"],"ChildFields":[],"FilterFields":["x_kode_kegiatan"],"Options":[],"Template":"","LinkTable":"m_sub_kegiatan"};
fdata_kontrakadd.Lists["x_bentuk_perusahaan"] = {"LinkField":"x_bentuk_perusahaan","Ajax":true,"AutoFill":false,"DisplayFields":["x_bentuk_perusahaan","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"bentuk_perusahaan"};
fdata_kontrakadd.Lists["x_lanjutkan"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fdata_kontrakadd.Lists["x_lanjutkan"].Options = <?php echo json_encode($data_kontrak->lanjutkan->Options()) ?>;
fdata_kontrakadd.Lists["x_nama_ppkom"] = {"LinkField":"x_nama","Ajax":true,"AutoFill":true,"DisplayFields":["x_nama","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"m_pejabat_keuangan"};
...
<?php if (!$data_kontrak_add->IsModal) { ?>
<?php } ?>
<?php $data_kontrak_add->ShowPageHeader(); ?>
<?php
$data_kontrak_add->ShowMessage();
?>
<form name="fdata_kontrakadd" id="fdata_kontrakadd" class="<?php echo $data_kontrak_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($data_kontrak_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $data_kontrak_add->Token ?>">
<?php } ?>
...
<script type="text/javascript">
ew_CreateCalendar("fdata_kontrakadd", "x_tgl_kontrak", 0);
</script>
<?php } ?>
</span>
...
<script type="text/javascript">
ew_CreateCalendar("fdata_kontrakadd", "x_tgl_mulai", 7);
</script>
<?php } ?>
</span>
...
<script type="text/javascript">
ew_CreateCalendar("fdata_kontrakadd", "x_tgl_selesai", 7);
</script>
<?php } ?>
</span>
...
<?php if (AllowAdd(CurrentProjectID() . "m_pejabat_keuangan")) { ?>
<button type="button" title="<?php echo ew_HtmlTitle($Language->Phrase("AddLink")) . "&nbsp;" . $data_kontrak->nama_ppkom->FldCaption() ?>" onclick="ew_AddOptDialogShow({lnk:this,el:'x_nama_ppkom',url:'m_pejabat_keuanganaddopt.php'});" class="ewAddOptBtn btn btn-default btn-sm" id="aol_x_nama_ppkom"><span class="glyphicon glyphicon-plus ewIcon"></span><span class="hide"><?php echo $Language->Phrase("AddLink") ?>&nbsp;<?php echo $data_kontrak->nama_ppkom->FldCaption() ?></span></button>
<?php } ?>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $data_kontrak_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
fdata_kontrakadd.Init();
</script>
<?php
$data_kontrak_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$data_kontrak_add->Page_Terminate();
?>
