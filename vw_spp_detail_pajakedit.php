...
$vw_spp_detail_pajak_edit = NULL; // Initialize page object first

class cvw_spp_detail_pajak_edit extends cvw_spp_detail_pajak {
	...
	// Page object name
	var $PageObjName = 'vw_spp_detail_pajak_edit';
	...
	function Page_Main() {
		...
		if ($this->id->CurrentValue == "") {
			$this->Page_Terminate("vw_spp_detail_pajaklist.php"); // Invalid key, return to list
		}
...
// Create page object
if (!isset($vw_spp_detail_pajak_edit)) $vw_spp_detail_pajak_edit = new cvw_spp_detail_pajak_edit();

// Page init
$vw_spp_detail_pajak_edit->Page_Init();

// Page main
$vw_spp_detail_pajak_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$vw_spp_detail_pajak_edit->Page_Render();
?>
...
var CurrentForm = fvw_spp_detail_pajakedit = new ew_Form("fvw_spp_detail_pajakedit", "edit");

// Validate form
fvw_spp_detail_pajakedit.Validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		$fobj.data("rowindex", infix);
			...
			if (elm && !ew_CheckInteger(elm.value))
				return this.OnError(elm, "<?php echo ew_JsEncode2($vw_spp_detail_pajak->id_spp->FldErrMsg()) ?>");
			elm = this.GetElements("x" + infix + "_id_jenis_spp");
			if (elm && !ew_CheckInteger(elm.value))
				return this.OnError(elm, "<?php echo ew_JsEncode2($vw_spp_detail_pajak->id_jenis_spp->FldErrMsg()) ?>");
			elm = this.GetElements("x" + infix + "_detail_jenis_spp");
			if (elm && !ew_CheckInteger(elm.value))
				return this.OnError(elm, "<?php echo ew_JsEncode2($vw_spp_detail_pajak->detail_jenis_spp->FldErrMsg()) ?>");
			...
			if (elm && !ew_IsHidden(elm) && !ew_HasValue(elm))
				return this.OnError(elm, "<?php echo ew_JsEncode2(str_replace("%s", $vw_spp_detail_pajak->tahun_anggaran->FldCaption(), $vw_spp_detail_pajak->tahun_anggaran->ReqErrMsg)) ?>");
			elm = this.GetElements("x" + infix + "_tahun_anggaran");
			if (elm && !ew_CheckInteger(elm.value))
				return this.OnError(elm, "<?php echo ew_JsEncode2($vw_spp_detail_pajak->tahun_anggaran->FldErrMsg()) ?>");
			elm = this.GetElements("x" + infix + "_akun1");
			if (elm && !ew_IsHidden(elm) && !ew_HasValue(elm))
				return this.OnError(elm, "<?php echo ew_JsEncode2(str_replace("%s", $vw_spp_detail_pajak->akun1->FldCaption(), $vw_spp_detail_pajak->akun1->ReqErrMsg)) ?>");
			elm = this.GetElements("x" + infix + "_akun2");
			if (elm && !ew_IsHidden(elm) && !ew_HasValue(elm))
				return this.OnError(elm, "<?php echo ew_JsEncode2(str_replace("%s", $vw_spp_detail_pajak->akun2->FldCaption(), $vw_spp_detail_pajak->akun2->ReqErrMsg)) ?>");
			elm = this.GetElements("x" + infix + "_akun3");
			if (elm && !ew_IsHidden(elm) && !ew_HasValue(elm))
				return this.OnError(elm, "<?php echo ew_JsEncode2(str_replace("%s", $vw_spp_detail_pajak->akun3->FldCaption(), $vw_spp_detail_pajak->akun3->ReqErrMsg)) ?>");
			elm = this.GetElements("x" + infix + "_akun4");
			if (elm && !ew_IsHidden(elm) && !ew_HasValue(elm))
				return this.OnError(elm, "<?php echo ew_JsEncode2(str_replace("%s", $vw_spp_detail_pajak->akun4->FldCaption(), $vw_spp_detail_pajak->akun4->ReqErrMsg)) ?>");
			elm = this.GetElements("x" + infix + "_akun5");
			if (elm && !ew_IsHidden(elm) && !ew_HasValue(elm))
				return this.OnError(elm, "<?php echo ew_JsEncode2(str_replace("%s", $vw_spp_detail_pajak->akun5->FldCaption(), $vw_spp_detail_pajak->akun5->ReqErrMsg)) ?>");
...
fvw_spp_detail_pajakedit.Form_CustomValidate = 
...
fvw_spp_detail_pajakedit.ValidateRequired = true;
<?php } else { ?>
fvw_spp_detail_pajakedit.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fvw_spp_detail_pajakedit.Lists["x_kd_rekening_belanja"] = {"LinkField":"x_kd_akun","Ajax":true,"AutoFill":false,"DisplayFields":["x_kd_akun","x_nama_akun","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"keu_akun5"};
...
<?php if (!$vw_spp_detail_pajak_edit->IsModal) { ?>
<?php } ?>
<?php $vw_spp_detail_pajak_edit->ShowPageHeader(); ?>
<?php
$vw_spp_detail_pajak_edit->ShowMessage();
?>
<form name="fvw_spp_detail_pajakedit" id="fvw_spp_detail_pajakedit" class="<?php echo $vw_spp_detail_pajak_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($vw_spp_detail_pajak_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $vw_spp_detail_pajak_edit->Token ?>">
<?php } ?>
...
<?php } ?>
<div>
<?php if ($vw_spp_detail_pajak->id->Visible) { // id ?>
	<div id="r_id" class="form-group">
		<label id="elh_vw_spp_detail_pajak_id" class="col-sm-2 control-label ewLabel"><?php echo $vw_spp_detail_pajak->id->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $vw_spp_detail_pajak->id->CellAttributes() ?>>
<span id="el_vw_spp_detail_pajak_id">
<span<?php echo $vw_spp_detail_pajak->id->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $vw_spp_detail_pajak->id->EditValue ?></p></span>
</span>
<input type="hidden" data-table="vw_spp_detail_pajak" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($vw_spp_detail_pajak->id->CurrentValue) ?>">
<?php echo $vw_spp_detail_pajak->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($vw_spp_detail_pajak->id_spp->Visible) { // id_spp ?>
	<div id="r_id_spp" class="form-group">
		<label id="elh_vw_spp_detail_pajak_id_spp" for="x_id_spp" class="col-sm-2 control-label ewLabel"><?php echo $vw_spp_detail_pajak->id_spp->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $vw_spp_detail_pajak->id_spp->CellAttributes() ?>>
<?php if ($vw_spp_detail_pajak->id_spp->getSessionValue() <> "") { ?>
<span id="el_vw_spp_detail_pajak_id_spp">
<span<?php echo $vw_spp_detail_pajak->id_spp->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $vw_spp_detail_pajak->id_spp->ViewValue ?></p></span>
</span>
<input type="hidden" id="x_id_spp" name="x_id_spp" value="<?php echo ew_HtmlEncode($vw_spp_detail_pajak->id_spp->CurrentValue) ?>">
<?php } else { ?>
<span id="el_vw_spp_detail_pajak_id_spp">
<input type="text" data-table="vw_spp_detail_pajak" data-field="x_id_spp" name="x_id_spp" id="x_id_spp" size="30" placeholder="<?php echo ew_HtmlEncode($vw_spp_detail_pajak->id_spp->getPlaceHolder()) ?>" value="<?php echo $vw_spp_detail_pajak->id_spp->EditValue ?>"<?php echo $vw_spp_detail_pajak->id_spp->EditAttributes() ?>>
</span>
<?php } ?>
<?php echo $vw_spp_detail_pajak->id_spp->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($vw_spp_detail_pajak->id_jenis_spp->Visible) { // id_jenis_spp ?>
	<div id="r_id_jenis_spp" class="form-group">
		<label id="elh_vw_spp_detail_pajak_id_jenis_spp" for="x_id_jenis_spp" class="col-sm-2 control-label ewLabel"><?php echo $vw_spp_detail_pajak->id_jenis_spp->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $vw_spp_detail_pajak->id_jenis_spp->CellAttributes() ?>>
<?php if ($vw_spp_detail_pajak->id_jenis_spp->getSessionValue() <> "") { ?>
<span id="el_vw_spp_detail_pajak_id_jenis_spp">
<span<?php echo $vw_spp_detail_pajak->id_jenis_spp->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $vw_spp_detail_pajak->id_jenis_spp->ViewValue ?></p></span>
</span>
<input type="hidden" id="x_id_jenis_spp" name="x_id_jenis_spp" value="<?php echo ew_HtmlEncode($vw_spp_detail_pajak->id_jenis_spp->CurrentValue) ?>">
<?php } else { ?>
<span id="el_vw_spp_detail_pajak_id_jenis_spp">
<input type="text" data-table="vw_spp_detail_pajak" data-field="x_id_jenis_spp" name="x_id_jenis_spp" id="x_id_jenis_spp" size="30" placeholder="<?php echo ew_HtmlEncode($vw_spp_detail_pajak->id_jenis_spp->getPlaceHolder()) ?>" value="<?php echo $vw_spp_detail_pajak->id_jenis_spp->EditValue ?>"<?php echo $vw_spp_detail_pajak->id_jenis_spp->EditAttributes() ?>>
</span>
<?php } ?>
<?php echo $vw_spp_detail_pajak->id_jenis_spp->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($vw_spp_detail_pajak->detail_jenis_spp->Visible) { // detail_jenis_spp ?>
	<div id="r_detail_jenis_spp" class="form-group">
		<label id="elh_vw_spp_detail_pajak_detail_jenis_spp" for="x_detail_jenis_spp" class="col-sm-2 control-label ewLabel"><?php echo $vw_spp_detail_pajak->detail_jenis_spp->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $vw_spp_detail_pajak->detail_jenis_spp->CellAttributes() ?>>
<?php if ($vw_spp_detail_pajak->detail_jenis_spp->getSessionValue() <> "") { ?>
<span id="el_vw_spp_detail_pajak_detail_jenis_spp">
<span<?php echo $vw_spp_detail_pajak->detail_jenis_spp->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $vw_spp_detail_pajak->detail_jenis_spp->ViewValue ?></p></span>
</span>
<input type="hidden" id="x_detail_jenis_spp" name="x_detail_jenis_spp" value="<?php echo ew_HtmlEncode($vw_spp_detail_pajak->detail_jenis_spp->CurrentValue) ?>">
<?php } else { ?>
<span id="el_vw_spp_detail_pajak_detail_jenis_spp">
<input type="text" data-table="vw_spp_detail_pajak" data-field="x_detail_jenis_spp" name="x_detail_jenis_spp" id="x_detail_jenis_spp" size="30" placeholder="<?php echo ew_HtmlEncode($vw_spp_detail_pajak->detail_jenis_spp->getPlaceHolder()) ?>" value="<?php echo $vw_spp_detail_pajak->detail_jenis_spp->EditValue ?>"<?php echo $vw_spp_detail_pajak->detail_jenis_spp->EditAttributes() ?>>
</span>
<?php } ?>
<?php echo $vw_spp_detail_pajak->detail_jenis_spp->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($vw_spp_detail_pajak->no_spp->Visible) { // no_spp ?>
	<div id="r_no_spp" class="form-group">
		<label id="elh_vw_spp_detail_pajak_no_spp" for="x_no_spp" class="col-sm-2 control-label ewLabel"><?php echo $vw_spp_detail_pajak->no_spp->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $vw_spp_detail_pajak->no_spp->CellAttributes() ?>>
<?php if ($vw_spp_detail_pajak->no_spp->getSessionValue() <> "") { ?>
<span id="el_vw_spp_detail_pajak_no_spp">
<span<?php echo $vw_spp_detail_pajak->no_spp->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $vw_spp_detail_pajak->no_spp->ViewValue ?></p></span>
</span>
<input type="hidden" id="x_no_spp" name="x_no_spp" value="<?php echo ew_HtmlEncode($vw_spp_detail_pajak->no_spp->CurrentValue) ?>">
<?php } else { ?>
<span id="el_vw_spp_detail_pajak_no_spp">
<input type="text" data-table="vw_spp_detail_pajak" data-field="x_no_spp" name="x_no_spp" id="x_no_spp" size="30" maxlength="45" placeholder="<?php echo ew_HtmlEncode($vw_spp_detail_pajak->no_spp->getPlaceHolder()) ?>" value="<?php echo $vw_spp_detail_pajak->no_spp->EditValue ?>"<?php echo $vw_spp_detail_pajak->no_spp->EditAttributes() ?>>
</span>
<?php } ?>
<?php echo $vw_spp_detail_pajak->no_spp->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($vw_spp_detail_pajak->program->Visible) { // program ?>
	<div id="r_program" class="form-group">
		<label id="elh_vw_spp_detail_pajak_program" for="x_program" class="col-sm-2 control-label ewLabel"><?php echo $vw_spp_detail_pajak->program->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $vw_spp_detail_pajak->program->CellAttributes() ?>>
<?php if ($vw_spp_detail_pajak->program->getSessionValue() <> "") { ?>
<span id="el_vw_spp_detail_pajak_program">
<span<?php echo $vw_spp_detail_pajak->program->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $vw_spp_detail_pajak->program->ViewValue ?></p></span>
</span>
<input type="hidden" id="x_program" name="x_program" value="<?php echo ew_HtmlEncode($vw_spp_detail_pajak->program->CurrentValue) ?>">
<?php } else { ?>
<span id="el_vw_spp_detail_pajak_program">
<input type="text" data-table="vw_spp_detail_pajak" data-field="x_program" name="x_program" id="x_program" size="30" maxlength="45" placeholder="<?php echo ew_HtmlEncode($vw_spp_detail_pajak->program->getPlaceHolder()) ?>" value="<?php echo $vw_spp_detail_pajak->program->EditValue ?>"<?php echo $vw_spp_detail_pajak->program->EditAttributes() ?>>
</span>
<?php } ?>
<?php echo $vw_spp_detail_pajak->program->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($vw_spp_detail_pajak->kegiatan->Visible) { // kegiatan ?>
	<div id="r_kegiatan" class="form-group">
		<label id="elh_vw_spp_detail_pajak_kegiatan" for="x_kegiatan" class="col-sm-2 control-label ewLabel"><?php echo $vw_spp_detail_pajak->kegiatan->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $vw_spp_detail_pajak->kegiatan->CellAttributes() ?>>
<?php if ($vw_spp_detail_pajak->kegiatan->getSessionValue() <> "") { ?>
<span id="el_vw_spp_detail_pajak_kegiatan">
<span<?php echo $vw_spp_detail_pajak->kegiatan->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $vw_spp_detail_pajak->kegiatan->ViewValue ?></p></span>
</span>
<input type="hidden" id="x_kegiatan" name="x_kegiatan" value="<?php echo ew_HtmlEncode($vw_spp_detail_pajak->kegiatan->CurrentValue) ?>">
<?php } else { ?>
<span id="el_vw_spp_detail_pajak_kegiatan">
<input type="text" data-table="vw_spp_detail_pajak" data-field="x_kegiatan" name="x_kegiatan" id="x_kegiatan" size="30" maxlength="45" placeholder="<?php echo ew_HtmlEncode($vw_spp_detail_pajak->kegiatan->getPlaceHolder()) ?>" value="<?php echo $vw_spp_detail_pajak->kegiatan->EditValue ?>"<?php echo $vw_spp_detail_pajak->kegiatan->EditAttributes() ?>>
</span>
<?php } ?>
<?php echo $vw_spp_detail_pajak->kegiatan->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($vw_spp_detail_pajak->sub_kegiatan->Visible) { // sub_kegiatan ?>
	<div id="r_sub_kegiatan" class="form-group">
		<label id="elh_vw_spp_detail_pajak_sub_kegiatan" for="x_sub_kegiatan" class="col-sm-2 control-label ewLabel"><?php echo $vw_spp_detail_pajak->sub_kegiatan->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $vw_spp_detail_pajak->sub_kegiatan->CellAttributes() ?>>
<?php if ($vw_spp_detail_pajak->sub_kegiatan->getSessionValue() <> "") { ?>
<span id="el_vw_spp_detail_pajak_sub_kegiatan">
<span<?php echo $vw_spp_detail_pajak->sub_kegiatan->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $vw_spp_detail_pajak->sub_kegiatan->ViewValue ?></p></span>
</span>
<input type="hidden" id="x_sub_kegiatan" name="x_sub_kegiatan" value="<?php echo ew_HtmlEncode($vw_spp_detail_pajak->sub_kegiatan->CurrentValue) ?>">
<?php } else { ?>
<span id="el_vw_spp_detail_pajak_sub_kegiatan">
<input type="text" data-table="vw_spp_detail_pajak" data-field="x_sub_kegiatan" name="x_sub_kegiatan" id="x_sub_kegiatan" size="30" maxlength="45" placeholder="<?php echo ew_HtmlEncode($vw_spp_detail_pajak->sub_kegiatan->getPlaceHolder()) ?>" value="<?php echo $vw_spp_detail_pajak->sub_kegiatan->EditValue ?>"<?php echo $vw_spp_detail_pajak->sub_kegiatan->EditAttributes() ?>>
</span>
<?php } ?>
<?php echo $vw_spp_detail_pajak->sub_kegiatan->CustomMsg ?></div></div>
	</div>
<?php } ?>
...
<?php } ?>
<?php if ($vw_spp_detail_pajak->tahun_anggaran->Visible) { // tahun_anggaran ?>
	<div id="r_tahun_anggaran" class="form-group">
		<label id="elh_vw_spp_detail_pajak_tahun_anggaran" for="x_tahun_anggaran" class="col-sm-2 control-label ewLabel"><?php echo $vw_spp_detail_pajak->tahun_anggaran->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="col-sm-10"><div<?php echo $vw_spp_detail_pajak->tahun_anggaran->CellAttributes() ?>>
<?php if ($vw_spp_detail_pajak->tahun_anggaran->getSessionValue() <> "") { ?>
<span id="el_vw_spp_detail_pajak_tahun_anggaran">
<span<?php echo $vw_spp_detail_pajak->tahun_anggaran->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $vw_spp_detail_pajak->tahun_anggaran->ViewValue ?></p></span>
</span>
<input type="hidden" id="x_tahun_anggaran" name="x_tahun_anggaran" value="<?php echo ew_HtmlEncode($vw_spp_detail_pajak->tahun_anggaran->CurrentValue) ?>">
<?php } else { ?>
<span id="el_vw_spp_detail_pajak_tahun_anggaran">
<input type="text" data-table="vw_spp_detail_pajak" data-field="x_tahun_anggaran" name="x_tahun_anggaran" id="x_tahun_anggaran" size="30" placeholder="<?php echo ew_HtmlEncode($vw_spp_detail_pajak->tahun_anggaran->getPlaceHolder()) ?>" value="<?php echo $vw_spp_detail_pajak->tahun_anggaran->EditValue ?>"<?php echo $vw_spp_detail_pajak->tahun_anggaran->EditAttributes() ?>>
</span>
<?php } ?>
<?php echo $vw_spp_detail_pajak->tahun_anggaran->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($vw_spp_detail_pajak->akun1->Visible) { // akun1 ?>
	<div id="r_akun1" class="form-group">
		<label id="elh_vw_spp_detail_pajak_akun1" for="x_akun1" class="col-sm-2 control-label ewLabel"><?php echo $vw_spp_detail_pajak->akun1->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="col-sm-10"><div<?php echo $vw_spp_detail_pajak->akun1->CellAttributes() ?>>
<span id="el_vw_spp_detail_pajak_akun1">
<input type="text" data-table="vw_spp_detail_pajak" data-field="x_akun1" name="x_akun1" id="x_akun1" size="30" maxlength="45" placeholder="<?php echo ew_HtmlEncode($vw_spp_detail_pajak->akun1->getPlaceHolder()) ?>" value="<?php echo $vw_spp_detail_pajak->akun1->EditValue ?>"<?php echo $vw_spp_detail_pajak->akun1->EditAttributes() ?>>
</span>
<?php echo $vw_spp_detail_pajak->akun1->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($vw_spp_detail_pajak->akun2->Visible) { // akun2 ?>
	<div id="r_akun2" class="form-group">
		<label id="elh_vw_spp_detail_pajak_akun2" for="x_akun2" class="col-sm-2 control-label ewLabel"><?php echo $vw_spp_detail_pajak->akun2->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="col-sm-10"><div<?php echo $vw_spp_detail_pajak->akun2->CellAttributes() ?>>
<span id="el_vw_spp_detail_pajak_akun2">
<input type="text" data-table="vw_spp_detail_pajak" data-field="x_akun2" name="x_akun2" id="x_akun2" size="30" maxlength="45" placeholder="<?php echo ew_HtmlEncode($vw_spp_detail_pajak->akun2->getPlaceHolder()) ?>" value="<?php echo $vw_spp_detail_pajak->akun2->EditValue ?>"<?php echo $vw_spp_detail_pajak->akun2->EditAttributes() ?>>
</span>
<?php echo $vw_spp_detail_pajak->akun2->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($vw_spp_detail_pajak->akun3->Visible) { // akun3 ?>
	<div id="r_akun3" class="form-group">
		<label id="elh_vw_spp_detail_pajak_akun3" for="x_akun3" class="col-sm-2 control-label ewLabel"><?php echo $vw_spp_detail_pajak->akun3->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="col-sm-10"><div<?php echo $vw_spp_detail_pajak->akun3->CellAttributes() ?>>
<span id="el_vw_spp_detail_pajak_akun3">
<input type="text" data-table="vw_spp_detail_pajak" data-field="x_akun3" name="x_akun3" id="x_akun3" size="30" maxlength="45" placeholder="<?php echo ew_HtmlEncode($vw_spp_detail_pajak->akun3->getPlaceHolder()) ?>" value="<?php echo $vw_spp_detail_pajak->akun3->EditValue ?>"<?php echo $vw_spp_detail_pajak->akun3->EditAttributes() ?>>
</span>
<?php echo $vw_spp_detail_pajak->akun3->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($vw_spp_detail_pajak->akun4->Visible) { // akun4 ?>
	<div id="r_akun4" class="form-group">
		<label id="elh_vw_spp_detail_pajak_akun4" for="x_akun4" class="col-sm-2 control-label ewLabel"><?php echo $vw_spp_detail_pajak->akun4->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="col-sm-10"><div<?php echo $vw_spp_detail_pajak->akun4->CellAttributes() ?>>
<span id="el_vw_spp_detail_pajak_akun4">
<input type="text" data-table="vw_spp_detail_pajak" data-field="x_akun4" name="x_akun4" id="x_akun4" size="30" maxlength="45" placeholder="<?php echo ew_HtmlEncode($vw_spp_detail_pajak->akun4->getPlaceHolder()) ?>" value="<?php echo $vw_spp_detail_pajak->akun4->EditValue ?>"<?php echo $vw_spp_detail_pajak->akun4->EditAttributes() ?>>
</span>
<?php echo $vw_spp_detail_pajak->akun4->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($vw_spp_detail_pajak->akun5->Visible) { // akun5 ?>
	<div id="r_akun5" class="form-group">
		<label id="elh_vw_spp_detail_pajak_akun5" for="x_akun5" class="col-sm-2 control-label ewLabel"><?php echo $vw_spp_detail_pajak->akun5->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="col-sm-10"><div<?php echo $vw_spp_detail_pajak->akun5->CellAttributes() ?>>
<span id="el_vw_spp_detail_pajak_akun5">
<input type="text" data-table="vw_spp_detail_pajak" data-field="x_akun5" name="x_akun5" id="x_akun5" size="30" maxlength="45" placeholder="<?php echo ew_HtmlEncode($vw_spp_detail_pajak->akun5->getPlaceHolder()) ?>" value="<?php echo $vw_spp_detail_pajak->akun5->EditValue ?>"<?php echo $vw_spp_detail_pajak->akun5->EditAttributes() ?>>
</span>
<?php echo $vw_spp_detail_pajak->akun5->CustomMsg ?></div></div>
	</div>
<?php } ?>
</div>
<?php if (!$vw_spp_detail_pajak_edit->IsModal) { ?>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $vw_spp_detail_pajak_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
fvw_spp_detail_pajakedit.Init();
</script>
<?php
$vw_spp_detail_pajak_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$vw_spp_detail_pajak_edit->Page_Terminate();
?>
