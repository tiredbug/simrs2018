...
class csimrs2012_db extends cDbHelper {

	// Database connection info
	var $Host = '192.168.1.27';
	var $Port = 3306;
	var $Username = 'root';
	var $Password = 'takonbudi';
	var $DbName = 'simrs2012';
...
class cdbantrianSis_db extends cDbHelper {

	// Database connection info
	var $Host = '192.168.1.250';
	var $Port = 3306;
	var $Username = 'root';
	var $Password = '';
	var $DbName = 'dbantrianSis';
