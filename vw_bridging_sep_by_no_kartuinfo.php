...
$vw_bridging_sep_by_no_kartu = NULL;

//
// Table class for vw_bridging_sep_by_no_kartu
//
class cvw_bridging_sep_by_no_kartu extends cTable {
	...
	function __construct() {
		...
		$this->TableVar = 'vw_bridging_sep_by_no_kartu';
		$this->TableName = 'vw_bridging_sep_by_no_kartu';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`vw_bridging_sep_by_no_kartu`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// IDXDAFTAR
		$this->IDXDAFTAR = new cField('vw_bridging_sep_by_no_kartu', 'vw_bridging_sep_by_no_kartu', 'x_IDXDAFTAR', 'IDXDAFTAR', '`IDXDAFTAR`', '`IDXDAFTAR`', 3, -1, FALSE, '`IDXDAFTAR`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// NOMR
		$this->NOMR = new cField('vw_bridging_sep_by_no_kartu', 'vw_bridging_sep_by_no_kartu', 'x_NOMR', 'NOMR', '`NOMR`', '`NOMR`', 200, -1, FALSE, '`NOMR`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->NOMR->Sortable = TRUE; // Allow sort
		$this->fields['NOMR'] = &$this->NOMR;

		// KDPOLY
		$this->KDPOLY = new cField('vw_bridging_sep_by_no_kartu', 'vw_bridging_sep_by_no_kartu', 'x_KDPOLY', 'KDPOLY', '`KDPOLY`', '`KDPOLY`', 3, -1, FALSE, '`KDPOLY`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// KDCARABAYAR
		$this->KDCARABAYAR = new cField('vw_bridging_sep_by_no_kartu', 'vw_bridging_sep_by_no_kartu', 'x_KDCARABAYAR', 'KDCARABAYAR', '`KDCARABAYAR`', '`KDCARABAYAR`', 3, -1, FALSE, '`KDCARABAYAR`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// NIP
		$this->NIP = new cField('vw_bridging_sep_by_no_kartu', 'vw_bridging_sep_by_no_kartu', 'x_NIP', 'NIP', '`NIP`', '`NIP`', 200, -1, FALSE, '`NIP`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->NIP->Sortable = TRUE; // Allow sort
		$this->fields['NIP'] = &$this->NIP;

		// TGLREG
		$this->TGLREG = new cField('vw_bridging_sep_by_no_kartu', 'vw_bridging_sep_by_no_kartu', 'x_TGLREG', 'TGLREG', '`TGLREG`', ew_CastDateFieldForLike('`TGLREG`', 0, "DB"), 133, 0, FALSE, '`TGLREG`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// JAMREG
		$this->JAMREG = new cField('vw_bridging_sep_by_no_kartu', 'vw_bridging_sep_by_no_kartu', 'x_JAMREG', 'JAMREG', '`JAMREG`', ew_CastDateFieldForLike('`JAMREG`', 0, "DB"), 135, 0, FALSE, '`JAMREG`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// NO_SJP
		$this->NO_SJP = new cField('vw_bridging_sep_by_no_kartu', 'vw_bridging_sep_by_no_kartu', 'x_NO_SJP', 'NO_SJP', '`NO_SJP`', '`NO_SJP`', 200, -1, FALSE, '`NO_SJP`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->NO_SJP->Sortable = TRUE; // Allow sort
		$this->fields['NO_SJP'] = &$this->NO_SJP;

		// NOKARTU
		$this->NOKARTU = new cField('vw_bridging_sep_by_no_kartu', 'vw_bridging_sep_by_no_kartu', 'x_NOKARTU', 'NOKARTU', '`NOKARTU`', '`NOKARTU`', 200, -1, FALSE, '`NOKARTU`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->NOKARTU->Sortable = TRUE; // Allow sort
		$this->fields['NOKARTU'] = &$this->NOKARTU;

		// TANGGAL_SEP
		$this->TANGGAL_SEP = new cField('vw_bridging_sep_by_no_kartu', 'vw_bridging_sep_by_no_kartu', 'x_TANGGAL_SEP', 'TANGGAL_SEP', '`TANGGAL_SEP`', ew_CastDateFieldForLike('`TANGGAL_SEP`', 5, "DB"), 135, 5, FALSE, '`TANGGAL_SEP`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// TANGGALRUJUK_SEP
		$this->TANGGALRUJUK_SEP = new cField('vw_bridging_sep_by_no_kartu', 'vw_bridging_sep_by_no_kartu', 'x_TANGGALRUJUK_SEP', 'TANGGALRUJUK_SEP', '`TANGGALRUJUK_SEP`', ew_CastDateFieldForLike('`TANGGALRUJUK_SEP`', 5, "DB"), 135, 5, FALSE, '`TANGGALRUJUK_SEP`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// KELASRAWAT_SEP
		$this->KELASRAWAT_SEP = new cField('vw_bridging_sep_by_no_kartu', 'vw_bridging_sep_by_no_kartu', 'x_KELASRAWAT_SEP', 'KELASRAWAT_SEP', '`KELASRAWAT_SEP`', '`KELASRAWAT_SEP`', 3, -1, FALSE, '`KELASRAWAT_SEP`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// NORUJUKAN_SEP
		$this->NORUJUKAN_SEP = new cField('vw_bridging_sep_by_no_kartu', 'vw_bridging_sep_by_no_kartu', 'x_NORUJUKAN_SEP', 'NORUJUKAN_SEP', '`NORUJUKAN_SEP`', '`NORUJUKAN_SEP`', 200, -1, FALSE, '`NORUJUKAN_SEP`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->NORUJUKAN_SEP->Sortable = TRUE; // Allow sort
		$this->fields['NORUJUKAN_SEP'] = &$this->NORUJUKAN_SEP;

		// PPKPELAYANAN_SEP
		$this->PPKPELAYANAN_SEP = new cField('vw_bridging_sep_by_no_kartu', 'vw_bridging_sep_by_no_kartu', 'x_PPKPELAYANAN_SEP', 'PPKPELAYANAN_SEP', '`PPKPELAYANAN_SEP`', '`PPKPELAYANAN_SEP`', 200, -1, FALSE, '`PPKPELAYANAN_SEP`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PPKPELAYANAN_SEP->Sortable = TRUE; // Allow sort
		$this->fields['PPKPELAYANAN_SEP'] = &$this->PPKPELAYANAN_SEP;

		// JENISPERAWATAN_SEP
		$this->JENISPERAWATAN_SEP = new cField('vw_bridging_sep_by_no_kartu', 'vw_bridging_sep_by_no_kartu', 'x_JENISPERAWATAN_SEP', 'JENISPERAWATAN_SEP', '`JENISPERAWATAN_SEP`', '`JENISPERAWATAN_SEP`', 3, -1, FALSE, '`JENISPERAWATAN_SEP`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		...
		// CATATAN_SEP
		$this->CATATAN_SEP = new cField('vw_bridging_sep_by_no_kartu', 'vw_bridging_sep_by_no_kartu', 'x_CATATAN_SEP', 'CATATAN_SEP', '`CATATAN_SEP`', '`CATATAN_SEP`', 200, -1, FALSE, '`CATATAN_SEP`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->CATATAN_SEP->Sortable = TRUE; // Allow sort
		$this->fields['CATATAN_SEP'] = &$this->CATATAN_SEP;

		// DIAGNOSAAWAL_SEP
		$this->DIAGNOSAAWAL_SEP = new cField('vw_bridging_sep_by_no_kartu', 'vw_bridging_sep_by_no_kartu', 'x_DIAGNOSAAWAL_SEP', 'DIAGNOSAAWAL_SEP', '`DIAGNOSAAWAL_SEP`', '`DIAGNOSAAWAL_SEP`', 200, -1, FALSE, '`DIAGNOSAAWAL_SEP`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DIAGNOSAAWAL_SEP->Sortable = TRUE; // Allow sort
		$this->fields['DIAGNOSAAWAL_SEP'] = &$this->DIAGNOSAAWAL_SEP;

		// NAMADIAGNOSA_SEP
		$this->NAMADIAGNOSA_SEP = new cField('vw_bridging_sep_by_no_kartu', 'vw_bridging_sep_by_no_kartu', 'x_NAMADIAGNOSA_SEP', 'NAMADIAGNOSA_SEP', '`NAMADIAGNOSA_SEP`', '`NAMADIAGNOSA_SEP`', 200, -1, FALSE, '`NAMADIAGNOSA_SEP`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->NAMADIAGNOSA_SEP->Sortable = TRUE; // Allow sort
		$this->fields['NAMADIAGNOSA_SEP'] = &$this->NAMADIAGNOSA_SEP;

		// LAKALANTAS_SEP
		$this->LAKALANTAS_SEP = new cField('vw_bridging_sep_by_no_kartu', 'vw_bridging_sep_by_no_kartu', 'x_LAKALANTAS_SEP', 'LAKALANTAS_SEP', '`LAKALANTAS_SEP`', '`LAKALANTAS_SEP`', 3, -1, FALSE, '`LAKALANTAS_SEP`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		...
		// LOKASILAKALANTAS
		$this->LOKASILAKALANTAS = new cField('vw_bridging_sep_by_no_kartu', 'vw_bridging_sep_by_no_kartu', 'x_LOKASILAKALANTAS', 'LOKASILAKALANTAS', '`LOKASILAKALANTAS`', '`LOKASILAKALANTAS`', 200, -1, FALSE, '`LOKASILAKALANTAS`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->LOKASILAKALANTAS->Sortable = TRUE; // Allow sort
		$this->fields['LOKASILAKALANTAS'] = &$this->LOKASILAKALANTAS;

		// USER
		$this->USER = new cField('vw_bridging_sep_by_no_kartu', 'vw_bridging_sep_by_no_kartu', 'x_USER', 'USER', '`USER`', '`USER`', 200, -1, FALSE, '`USER`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->USER->Sortable = TRUE; // Allow sort
		$this->fields['USER'] = &$this->USER;

		// generate_sep
		$this->generate_sep = new cField('vw_bridging_sep_by_no_kartu', 'vw_bridging_sep_by_no_kartu', 'x_generate_sep', 'generate_sep', '`generate_sep`', '`generate_sep`', 3, -1, FALSE, '`generate_sep`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
		...
		// PESERTANIK_SEP
		$this->PESERTANIK_SEP = new cField('vw_bridging_sep_by_no_kartu', 'vw_bridging_sep_by_no_kartu', 'x_PESERTANIK_SEP', 'PESERTANIK_SEP', '`PESERTANIK_SEP`', '`PESERTANIK_SEP`', 200, -1, FALSE, '`PESERTANIK_SEP`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PESERTANIK_SEP->Sortable = TRUE; // Allow sort
		$this->fields['PESERTANIK_SEP'] = &$this->PESERTANIK_SEP;

		// PESERTANAMA_SEP
		$this->PESERTANAMA_SEP = new cField('vw_bridging_sep_by_no_kartu', 'vw_bridging_sep_by_no_kartu', 'x_PESERTANAMA_SEP', 'PESERTANAMA_SEP', '`PESERTANAMA_SEP`', '`PESERTANAMA_SEP`', 200, -1, FALSE, '`PESERTANAMA_SEP`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PESERTANAMA_SEP->Sortable = TRUE; // Allow sort
		$this->fields['PESERTANAMA_SEP'] = &$this->PESERTANAMA_SEP;

		// PESERTAJENISKELAMIN_SEP
		$this->PESERTAJENISKELAMIN_SEP = new cField('vw_bridging_sep_by_no_kartu', 'vw_bridging_sep_by_no_kartu', 'x_PESERTAJENISKELAMIN_SEP', 'PESERTAJENISKELAMIN_SEP', '`PESERTAJENISKELAMIN_SEP`', '`PESERTAJENISKELAMIN_SEP`', 200, -1, FALSE, '`PESERTAJENISKELAMIN_SEP`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PESERTAJENISKELAMIN_SEP->Sortable = TRUE; // Allow sort
		$this->fields['PESERTAJENISKELAMIN_SEP'] = &$this->PESERTAJENISKELAMIN_SEP;

		// PESERTANAMAKELAS_SEP
		$this->PESERTANAMAKELAS_SEP = new cField('vw_bridging_sep_by_no_kartu', 'vw_bridging_sep_by_no_kartu', 'x_PESERTANAMAKELAS_SEP', 'PESERTANAMAKELAS_SEP', '`PESERTANAMAKELAS_SEP`', '`PESERTANAMAKELAS_SEP`', 200, -1, FALSE, '`PESERTANAMAKELAS_SEP`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PESERTANAMAKELAS_SEP->Sortable = TRUE; // Allow sort
		$this->fields['PESERTANAMAKELAS_SEP'] = &$this->PESERTANAMAKELAS_SEP;

		// PESERTAPISAT
		$this->PESERTAPISAT = new cField('vw_bridging_sep_by_no_kartu', 'vw_bridging_sep_by_no_kartu', 'x_PESERTAPISAT', 'PESERTAPISAT', '`PESERTAPISAT`', '`PESERTAPISAT`', 200, -1, FALSE, '`PESERTAPISAT`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PESERTAPISAT->Sortable = TRUE; // Allow sort
		$this->fields['PESERTAPISAT'] = &$this->PESERTAPISAT;

		// PESERTATGLLAHIR
		$this->PESERTATGLLAHIR = new cField('vw_bridging_sep_by_no_kartu', 'vw_bridging_sep_by_no_kartu', 'x_PESERTATGLLAHIR', 'PESERTATGLLAHIR', '`PESERTATGLLAHIR`', '`PESERTATGLLAHIR`', 200, -1, FALSE, '`PESERTATGLLAHIR`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PESERTATGLLAHIR->Sortable = TRUE; // Allow sort
		$this->fields['PESERTATGLLAHIR'] = &$this->PESERTATGLLAHIR;

		// PESERTAJENISPESERTA_SEP
		$this->PESERTAJENISPESERTA_SEP = new cField('vw_bridging_sep_by_no_kartu', 'vw_bridging_sep_by_no_kartu', 'x_PESERTAJENISPESERTA_SEP', 'PESERTAJENISPESERTA_SEP', '`PESERTAJENISPESERTA_SEP`', '`PESERTAJENISPESERTA_SEP`', 200, -1, FALSE, '`PESERTAJENISPESERTA_SEP`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PESERTAJENISPESERTA_SEP->Sortable = TRUE; // Allow sort
		$this->fields['PESERTAJENISPESERTA_SEP'] = &$this->PESERTAJENISPESERTA_SEP;

		// PESERTANAMAJENISPESERTA_SEP
		$this->PESERTANAMAJENISPESERTA_SEP = new cField('vw_bridging_sep_by_no_kartu', 'vw_bridging_sep_by_no_kartu', 'x_PESERTANAMAJENISPESERTA_SEP', 'PESERTANAMAJENISPESERTA_SEP', '`PESERTANAMAJENISPESERTA_SEP`', '`PESERTANAMAJENISPESERTA_SEP`', 200, -1, FALSE, '`PESERTANAMAJENISPESERTA_SEP`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->PESERTANAMAJENISPESERTA_SEP->Sortable = TRUE; // Allow sort
		$this->fields['PESERTANAMAJENISPESERTA_SEP'] = &$this->PESERTANAMAJENISPESERTA_SEP;

		// POLITUJUAN_SEP
		$this->POLITUJUAN_SEP = new cField('vw_bridging_sep_by_no_kartu', 'vw_bridging_sep_by_no_kartu', 'x_POLITUJUAN_SEP', 'POLITUJUAN_SEP', '`POLITUJUAN_SEP`', '`POLITUJUAN_SEP`', 200, -1, FALSE, '`POLITUJUAN_SEP`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->POLITUJUAN_SEP->Sortable = TRUE; // Allow sort
		$this->POLITUJUAN_SEP->UsePleaseSelect = TRUE; // Use PleaseSelect by default
		$this->POLITUJUAN_SEP->PleaseSelectText = $Language->Phrase("PleaseSelect"); // PleaseSelect text
		$this->fields['POLITUJUAN_SEP'] = &$this->POLITUJUAN_SEP;

		// NAMAPOLITUJUAN_SEP
		$this->NAMAPOLITUJUAN_SEP = new cField('vw_bridging_sep_by_no_kartu', 'vw_bridging_sep_by_no_kartu', 'x_NAMAPOLITUJUAN_SEP', 'NAMAPOLITUJUAN_SEP', '`NAMAPOLITUJUAN_SEP`', '`NAMAPOLITUJUAN_SEP`', 200, -1, FALSE, '`NAMAPOLITUJUAN_SEP`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->NAMAPOLITUJUAN_SEP->Sortable = TRUE; // Allow sort
		$this->fields['NAMAPOLITUJUAN_SEP'] = &$this->NAMAPOLITUJUAN_SEP;

		// KDPPKRUJUKAN_SEP
		$this->KDPPKRUJUKAN_SEP = new cField('vw_bridging_sep_by_no_kartu', 'vw_bridging_sep_by_no_kartu', 'x_KDPPKRUJUKAN_SEP', 'KDPPKRUJUKAN_SEP', '`KDPPKRUJUKAN_SEP`', '`KDPPKRUJUKAN_SEP`', 200, -1, FALSE, '`KDPPKRUJUKAN_SEP`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->KDPPKRUJUKAN_SEP->Sortable = TRUE; // Allow sort
		$this->fields['KDPPKRUJUKAN_SEP'] = &$this->KDPPKRUJUKAN_SEP;

		// NMPPKRUJUKAN_SEP
		$this->NMPPKRUJUKAN_SEP = new cField('vw_bridging_sep_by_no_kartu', 'vw_bridging_sep_by_no_kartu', 'x_NMPPKRUJUKAN_SEP', 'NMPPKRUJUKAN_SEP', '`NMPPKRUJUKAN_SEP`', '`NMPPKRUJUKAN_SEP`', 200, -1, FALSE, '`NMPPKRUJUKAN_SEP`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->NMPPKRUJUKAN_SEP->Sortable = TRUE; // Allow sort
		$this->fields['NMPPKRUJUKAN_SEP'] = &$this->NMPPKRUJUKAN_SEP;

		// mapingtransaksi
		$this->mapingtransaksi = new cField('vw_bridging_sep_by_no_kartu', 'vw_bridging_sep_by_no_kartu', 'x_mapingtransaksi', 'mapingtransaksi', '`mapingtransaksi`', '`mapingtransaksi`', 3, -1, FALSE, '`mapingtransaksi`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
		...
		$this->bridging_kepesertaan_by_no_ka = new cField('vw_bridging_sep_by_no_kartu', 'vw_bridging_sep_by_no_kartu', 'x_bridging_kepesertaan_by_no_ka', 'bridging_kepesertaan_by_no_ka', '`bridging_kepesertaan_by_no_ka`', '`bridging_kepesertaan_by_no_ka`', 3, -1, FALSE, '`bridging_kepesertaan_by_no_ka`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'CHECKBOX');
		$this->bridging_kepesertaan_by_no_ka->Sortable = FALSE; // Allow sort
		$this->bridging_kepesertaan_by_no_ka->OptionCount = 1;
		...
		// pasien_NOTELP
		$this->pasien_NOTELP = new cField('vw_bridging_sep_by_no_kartu', 'vw_bridging_sep_by_no_kartu', 'x_pasien_NOTELP', 'pasien_NOTELP', '`pasien_NOTELP`', '`pasien_NOTELP`', 200, -1, FALSE, '`pasien_NOTELP`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->pasien_NOTELP->Sortable = TRUE; // Allow sort
		$this->fields['pasien_NOTELP'] = &$this->pasien_NOTELP;

		// penjamin_kkl_id
		$this->penjamin_kkl_id = new cField('vw_bridging_sep_by_no_kartu', 'vw_bridging_sep_by_no_kartu', 'x_penjamin_kkl_id', 'penjamin_kkl_id', '`penjamin_kkl_id`', '`penjamin_kkl_id`', 3, -1, FALSE, '`penjamin_kkl_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->asalfaskesrujukan_id = new cField('vw_bridging_sep_by_no_kartu', 'vw_bridging_sep_by_no_kartu', 'x_asalfaskesrujukan_id', 'asalfaskesrujukan_id', '`asalfaskesrujukan_id`', '`asalfaskesrujukan_id`', 3, -1, FALSE, '`asalfaskesrujukan_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// peserta_cob
		$this->peserta_cob = new cField('vw_bridging_sep_by_no_kartu', 'vw_bridging_sep_by_no_kartu', 'x_peserta_cob', 'peserta_cob', '`peserta_cob`', '`peserta_cob`', 3, -1, FALSE, '`peserta_cob`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// poli_eksekutif
		$this->poli_eksekutif = new cField('vw_bridging_sep_by_no_kartu', 'vw_bridging_sep_by_no_kartu', 'x_poli_eksekutif', 'poli_eksekutif', '`poli_eksekutif`', '`poli_eksekutif`', 3, -1, FALSE, '`poli_eksekutif`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->status_kepesertaan_BPJS = new cField('vw_bridging_sep_by_no_kartu', 'vw_bridging_sep_by_no_kartu', 'x_status_kepesertaan_BPJS', 'status_kepesertaan_BPJS', '`status_kepesertaan_BPJS`', '`status_kepesertaan_BPJS`', 200, -1, FALSE, '`status_kepesertaan_BPJS`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`vw_bridging_sep_by_no_kartu`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "vw_bridging_sep_by_no_kartulist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("vw_bridging_sep_by_no_kartuview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("vw_bridging_sep_by_no_kartuview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "vw_bridging_sep_by_no_kartuadd.php?" . $this->UrlParm($parm);
		else
			$url = "vw_bridging_sep_by_no_kartuadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("vw_bridging_sep_by_no_kartuedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("vw_bridging_sep_by_no_kartuadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("vw_bridging_sep_by_no_kartudelete.php", $this->UrlParm());
	}
   ...
   // Common render codes
		...
		// bridging_kepesertaan_by_no_ka
		if (strval($this->bridging_kepesertaan_by_no_ka->CurrentValue) <> "") {
			$this->bridging_kepesertaan_by_no_ka->ViewValue = "";
			$arwrk = explode(",", strval($this->bridging_kepesertaan_by_no_ka->CurrentValue));
			$cnt = count($arwrk);
			for ($ari = 0; $ari < $cnt; $ari++) {
				$this->bridging_kepesertaan_by_no_ka->ViewValue .= $this->bridging_kepesertaan_by_no_ka->OptionCaption(trim($arwrk[$ari]));
				if ($ari < $cnt-1) $this->bridging_kepesertaan_by_no_ka->ViewValue .= ew_ViewOptionSeparator($ari);
			}
		} else {
			$this->bridging_kepesertaan_by_no_ka->ViewValue = NULL;
		}
		...
		if ($this->Export == "") {
			...
			$this->PESERTANIK_SEP->LinkAttrs["data-tooltip-id"] = "tt_vw_bridging_sep_by_no_kartu_x" . (($this->RowType <> EW_ROWTYPE_MASTER) ? @$this->RowCnt : "") . "_PESERTANIK_SEP";
	...
	function RenderEditRow() {
		...
		$this->bridging_kepesertaan_by_no_ka->EditValue = $this->bridging_kepesertaan_by_no_ka->Options(FALSE);
		...
		if (!$Doc->ExportCustom) {
			...
			if ($Doc->Horizontal) { // Horizontal format, write header
				...
				if ($ExportPageType == "view") {
					...
					if ($this->PESERTANIK_SEP->Exportable) $Doc->ExportCaption($this->PESERTANIK_SEP);
					if ($this->PESERTANAMA_SEP->Exportable) $Doc->ExportCaption($this->PESERTANAMA_SEP);
					if ($this->PESERTAJENISKELAMIN_SEP->Exportable) $Doc->ExportCaption($this->PESERTAJENISKELAMIN_SEP);
					if ($this->PESERTANAMAKELAS_SEP->Exportable) $Doc->ExportCaption($this->PESERTANAMAKELAS_SEP);
					if ($this->PESERTAPISAT->Exportable) $Doc->ExportCaption($this->PESERTAPISAT);
					if ($this->PESERTATGLLAHIR->Exportable) $Doc->ExportCaption($this->PESERTATGLLAHIR);
					if ($this->PESERTAJENISPESERTA_SEP->Exportable) $Doc->ExportCaption($this->PESERTAJENISPESERTA_SEP);
					if ($this->PESERTANAMAJENISPESERTA_SEP->Exportable) $Doc->ExportCaption($this->PESERTANAMAJENISPESERTA_SEP);
					if ($this->POLITUJUAN_SEP->Exportable) $Doc->ExportCaption($this->POLITUJUAN_SEP);
					if ($this->NAMAPOLITUJUAN_SEP->Exportable) $Doc->ExportCaption($this->NAMAPOLITUJUAN_SEP);
					if ($this->KDPPKRUJUKAN_SEP->Exportable) $Doc->ExportCaption($this->KDPPKRUJUKAN_SEP);
					if ($this->NMPPKRUJUKAN_SEP->Exportable) $Doc->ExportCaption($this->NMPPKRUJUKAN_SEP);
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if (!$Doc->ExportCustom) {
					...
					if ($ExportPageType == "view") {
						...
						if ($this->PESERTANIK_SEP->Exportable) $Doc->ExportField($this->PESERTANIK_SEP);
						if ($this->PESERTANAMA_SEP->Exportable) $Doc->ExportField($this->PESERTANAMA_SEP);
						if ($this->PESERTAJENISKELAMIN_SEP->Exportable) $Doc->ExportField($this->PESERTAJENISKELAMIN_SEP);
						if ($this->PESERTANAMAKELAS_SEP->Exportable) $Doc->ExportField($this->PESERTANAMAKELAS_SEP);
						if ($this->PESERTAPISAT->Exportable) $Doc->ExportField($this->PESERTAPISAT);
						if ($this->PESERTATGLLAHIR->Exportable) $Doc->ExportField($this->PESERTATGLLAHIR);
						if ($this->PESERTAJENISPESERTA_SEP->Exportable) $Doc->ExportField($this->PESERTAJENISPESERTA_SEP);
						if ($this->PESERTANAMAJENISPESERTA_SEP->Exportable) $Doc->ExportField($this->PESERTANAMAJENISPESERTA_SEP);
						if ($this->POLITUJUAN_SEP->Exportable) $Doc->ExportField($this->POLITUJUAN_SEP);
						if ($this->NAMAPOLITUJUAN_SEP->Exportable) $Doc->ExportField($this->NAMAPOLITUJUAN_SEP);
						if ($this->KDPPKRUJUKAN_SEP->Exportable) $Doc->ExportField($this->KDPPKRUJUKAN_SEP);
						if ($this->NMPPKRUJUKAN_SEP->Exportable) $Doc->ExportField($this->NMPPKRUJUKAN_SEP);
	...
	function GetAutoFill($id, $val) {
		$rsarr = array();
		$rowcnt = 0;
		if (preg_match('/^x(\d)*_DIAGNOSAAWAL_SEP$/', $id)) {
			$conn = &$this->Connection();
			$sSqlWrk = "SELECT `Description` AS FIELD0 FROM `refdiagnosis`";
			...
			if ($rs = ew_LoadRecordset($sSqlWrk, $conn)) {
				while ($rs && !$rs->EOF) {
					$ar = array();
					$this->NAMADIAGNOSA_SEP->setDbValue($rs->fields[0]);
					$this->RowType == EW_ROWTYPE_EDIT;
					$this->RenderEditRow();
					$ar[] = ($this->NAMADIAGNOSA_SEP->AutoFillOriginalValue) ? $this->NAMADIAGNOSA_SEP->CurrentValue : $this->NAMADIAGNOSA_SEP->EditValue;
					$rowcnt += 1;
					$rsarr[] = $ar;
					$rs->MoveNext();
				}
		...
		if (preg_match('/^x(\d)*_POLITUJUAN_SEP$/', $id)) {
			$conn = &$this->Connection();
			$sSqlWrk = "SELECT `NMPOLI` AS FIELD0 FROM `refpoli`";
			$sWhereWrk = "(`KDPOLI` = " . ew_QuotedValue($val, EW_DATATYPE_STRING, $this->DBID) . ")";
			$this->POLITUJUAN_SEP->LookupFilters = array();
			$this->Lookup_Selecting($this->POLITUJUAN_SEP, $sWhereWrk); // Call Lookup selecting
			if ($sWhereWrk <> "") $sSqlWrk .= " WHERE " . $sWhereWrk;
			if ($rs = ew_LoadRecordset($sSqlWrk, $conn)) {
				while ($rs && !$rs->EOF) {
					$ar = array();
					$this->NAMAPOLITUJUAN_SEP->setDbValue($rs->fields[0]);
					$this->RowType == EW_ROWTYPE_EDIT;
					$this->RenderEditRow();
					$ar[] = ($this->NAMAPOLITUJUAN_SEP->AutoFillOriginalValue) ? $this->NAMAPOLITUJUAN_SEP->CurrentValue : $this->NAMAPOLITUJUAN_SEP->EditValue;
					$rowcnt += 1;
					$rsarr[] = $ar;
					$rs->MoveNext();
				}
	...
	function WriteAuditTrailDummy($typ) {
		$table = 'vw_bridging_sep_by_no_kartu';
		$usr = CurrentUserID();
	...
	function Recordset_Selecting(&$filter) {
		...
		ew_AddFilter($filter, "TGLREG <= CURDATE() AND TGLREG  >= (CURDATE() - interval 2 day) AND KDCARABAYAR != 1 AND KDCARABAYAR != 9 AND KDCARABAYAR != 7  "); 
	}
	...
	function Row_Rendered() {
		...
		$this->status_kepesertaan_BPJS->ReadOnly = TRUE;  
