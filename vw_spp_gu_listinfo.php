...
//
// Table class for vw_spp_gu_list
//
class cvw_spp_gu_list extends cTable {
	var $id;
	var $id_jenis_spp;
	...
	function __construct() {
		...
		$this->TableVar = 'vw_spp_gu_list';
		$this->TableName = 'vw_spp_gu_list';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`vw_spp_gu_list`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('vw_spp_gu_list', 'vw_spp_gu_list', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// id_jenis_spp
		$this->id_jenis_spp = new cField('vw_spp_gu_list', 'vw_spp_gu_list', 'x_id_jenis_spp', 'id_jenis_spp', '`id_jenis_spp`', '`id_jenis_spp`', 3, -1, FALSE, '`id_jenis_spp`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// detail_jenis_spp
		$this->detail_jenis_spp = new cField('vw_spp_gu_list', 'vw_spp_gu_list', 'x_detail_jenis_spp', 'detail_jenis_spp', '`detail_jenis_spp`', '`detail_jenis_spp`', 3, -1, FALSE, '`detail_jenis_spp`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// status_spp
		$this->status_spp = new cField('vw_spp_gu_list', 'vw_spp_gu_list', 'x_status_spp', 'status_spp', '`status_spp`', '`status_spp`', 3, -1, FALSE, '`status_spp`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// no_spp
		$this->no_spp = new cField('vw_spp_gu_list', 'vw_spp_gu_list', 'x_no_spp', 'no_spp', '`no_spp`', '`no_spp`', 200, -1, FALSE, '`no_spp`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->no_spp->Sortable = TRUE; // Allow sort
		$this->fields['no_spp'] = &$this->no_spp;

		// tgl_spp
		$this->tgl_spp = new cField('vw_spp_gu_list', 'vw_spp_gu_list', 'x_tgl_spp', 'tgl_spp', '`tgl_spp`', ew_CastDateFieldForLike('`tgl_spp`', 7, "DB"), 135, 7, FALSE, '`tgl_spp`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// keterangan
		$this->keterangan = new cField('vw_spp_gu_list', 'vw_spp_gu_list', 'x_keterangan', 'keterangan', '`keterangan`', '`keterangan`', 201, -1, FALSE, '`keterangan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->keterangan->Sortable = TRUE; // Allow sort
		$this->fields['keterangan'] = &$this->keterangan;

		// nama_bendahara
		$this->nama_bendahara = new cField('vw_spp_gu_list', 'vw_spp_gu_list', 'x_nama_bendahara', 'nama_bendahara', '`nama_bendahara`', '`nama_bendahara`', 200, -1, FALSE, '`nama_bendahara`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// nip_bendahara
		$this->nip_bendahara = new cField('vw_spp_gu_list', 'vw_spp_gu_list', 'x_nip_bendahara', 'nip_bendahara', '`nip_bendahara`', '`nip_bendahara`', 200, -1, FALSE, '`nip_bendahara`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->nip_bendahara->Sortable = TRUE; // Allow sort
		$this->fields['nip_bendahara'] = &$this->nip_bendahara;

		// nama_pptk
		$this->nama_pptk = new cField('vw_spp_gu_list', 'vw_spp_gu_list', 'x_nama_pptk', 'nama_pptk', '`nama_pptk`', '`nama_pptk`', 200, -1, FALSE, '`nama_pptk`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// nip_pptk
		$this->nip_pptk = new cField('vw_spp_gu_list', 'vw_spp_gu_list', 'x_nip_pptk', 'nip_pptk', '`nip_pptk`', '`nip_pptk`', 200, -1, FALSE, '`nip_pptk`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->nip_pptk->Sortable = TRUE; // Allow sort
		$this->fields['nip_pptk'] = &$this->nip_pptk;

		// kode_program
		$this->kode_program = new cField('vw_spp_gu_list', 'vw_spp_gu_list', 'x_kode_program', 'kode_program', '`kode_program`', '`kode_program`', 200, -1, FALSE, '`kode_program`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// kode_kegiatan
		$this->kode_kegiatan = new cField('vw_spp_gu_list', 'vw_spp_gu_list', 'x_kode_kegiatan', 'kode_kegiatan', '`kode_kegiatan`', '`kode_kegiatan`', 200, -1, FALSE, '`kode_kegiatan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// kode_sub_kegiatan
		$this->kode_sub_kegiatan = new cField('vw_spp_gu_list', 'vw_spp_gu_list', 'x_kode_sub_kegiatan', 'kode_sub_kegiatan', '`kode_sub_kegiatan`', '`kode_sub_kegiatan`', 200, -1, FALSE, '`kode_sub_kegiatan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// tahun_anggaran
		$this->tahun_anggaran = new cField('vw_spp_gu_list', 'vw_spp_gu_list', 'x_tahun_anggaran', 'tahun_anggaran', '`tahun_anggaran`', '`tahun_anggaran`', 3, -1, FALSE, '`tahun_anggaran`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// id_spj
		$this->id_spj = new cField('vw_spp_gu_list', 'vw_spp_gu_list', 'x_id_spj', 'id_spj', '`id_spj`', '`id_spj`', 3, -1, FALSE, '`id_spj`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// id_spd
		$this->id_spd = new cField('vw_spp_gu_list', 'vw_spp_gu_list', 'x_id_spd', 'id_spd', '`id_spd`', '`id_spd`', 3, -1, FALSE, '`id_spd`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// jumlah_spd
		$this->jumlah_spd = new cField('vw_spp_gu_list', 'vw_spp_gu_list', 'x_jumlah_spd', 'jumlah_spd', '`jumlah_spd`', '`jumlah_spd`', 5, -1, FALSE, '`jumlah_spd`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// nomer_dasar_spd
		$this->nomer_dasar_spd = new cField('vw_spp_gu_list', 'vw_spp_gu_list', 'x_nomer_dasar_spd', 'nomer_dasar_spd', '`nomer_dasar_spd`', '`nomer_dasar_spd`', 200, -1, FALSE, '`nomer_dasar_spd`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->nomer_dasar_spd->Sortable = FALSE; // Allow sort
		$this->fields['nomer_dasar_spd'] = &$this->nomer_dasar_spd;

		// tanggal_spd
		$this->tanggal_spd = new cField('vw_spp_gu_list', 'vw_spp_gu_list', 'x_tanggal_spd', 'tanggal_spd', '`tanggal_spd`', ew_CastDateFieldForLike('`tanggal_spd`', 0, "DB"), 135, 0, FALSE, '`tanggal_spd`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`vw_spp_gu_list`";
	}
	...
	function getSqlWhere() { // Where
		...
		$this->TableFilter = "`detail_jenis_spp`=1";
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("vw_spp_gu_listview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("vw_spp_gu_listview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "vw_spp_gu_listadd.php?" . $this->UrlParm($parm);
		else
			$url = "vw_spp_gu_listadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("vw_spp_gu_listedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("vw_spp_gu_listadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("vw_spp_gu_listdelete.php", $this->UrlParm());
	}
   ...
   // Common render codes
	...
	function Row_Inserting($rsold, &$rsnew) {
		...
		$rsnew["no_spp"] = GetNextNomerSPP_GU(); 
		return TRUE;
	}
	...
	function Row_Rendered() {
		...
		if (CurrentPageID() == "add" && $this->CurrentAction != "F") {
			$this->no_spp->CurrentValue = GetNextNomerSPP_GU(); // trik
			$this->no_spp->EditValue = $this->no_spp->CurrentValue; // tampilkan

			 // supaya tidak bisa diubah
		}
