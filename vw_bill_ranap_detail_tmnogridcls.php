...
$vw_bill_ranap_detail_tmno_grid = NULL; // Initialize page object first

class cvw_bill_ranap_detail_tmno_grid extends cvw_bill_ranap_detail_tmno {
	...
	// Page object name
	var $PageObjName = 'vw_bill_ranap_detail_tmno_grid';

	// Grid form hidden field names
	var $FormName = 'fvw_bill_ranap_detail_tmnogrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["vw_bill_ranap_detail_tmno"];
