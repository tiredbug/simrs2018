...
$fake_sales_view = NULL; // Initialize page object first

class cfake_sales_view extends cfake_sales {
	...
	// Page object name
	var $PageObjName = 'fake_sales_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["sales_id"] <> "") {
				...
				$sReturnUrl = "fake_saleslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "fake_saleslist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "fake_saleslist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($fake_sales_view)) $fake_sales_view = new cfake_sales_view();

// Page init
$fake_sales_view->Page_Init();

// Page main
$fake_sales_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$fake_sales_view->Page_Render();
?>
...
var CurrentForm = ffake_salesview = new ew_Form("ffake_salesview", "view");

// Form_CustomValidate event
ffake_salesview.Form_CustomValidate = 
...
ffake_salesview.ValidateRequired = true;
<?php } else { ?>
ffake_salesview.ValidateRequired = false; 
<?php } ?>
...
<?php if (!$fake_sales_view->IsModal) { ?>
<?php } ?>
<?php $fake_sales_view->ExportOptions->Render("body") ?>
<?php
	foreach ($fake_sales_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$fake_sales_view->IsModal) { ?>
...
<?php $fake_sales_view->ShowPageHeader(); ?>
<?php
$fake_sales_view->ShowMessage();
?>
<form name="ffake_salesview" id="ffake_salesview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($fake_sales_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $fake_sales_view->Token ?>">
<?php } ?>
...
<?php if ($fake_sales->sales_id->Visible) { // sales_id ?>
	<tr id="r_sales_id">
		<td><span id="elh_fake_sales_sales_id"><?php echo $fake_sales->sales_id->FldCaption() ?></span></td>
...
<?php echo $fake_sales->sales_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($fake_sales->sales_month->Visible) { // sales_month ?>
	<tr id="r_sales_month">
		<td><span id="elh_fake_sales_sales_month"><?php echo $fake_sales->sales_month->FldCaption() ?></span></td>
...
<?php echo $fake_sales->sales_month->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($fake_sales->sales_total->Visible) { // sales_total ?>
	<tr id="r_sales_total">
		<td><span id="elh_fake_sales_sales_total"><?php echo $fake_sales->sales_total->FldCaption() ?></span></td>
...
<?php echo $fake_sales->sales_total->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($fake_sales->sales_category->Visible) { // sales_category ?>
	<tr id="r_sales_category">
		<td><span id="elh_fake_sales_sales_category"><?php echo $fake_sales->sales_category->FldCaption() ?></span></td>
...
<?php echo $fake_sales->sales_category->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
ffake_salesview.Init();
</script>
<?php
$fake_sales_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$fake_sales_view->Page_Terminate();
?>
