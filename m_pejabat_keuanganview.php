...
$m_pejabat_keuangan_view = NULL; // Initialize page object first

class cm_pejabat_keuangan_view extends cm_pejabat_keuangan {
	...
	// Page object name
	var $PageObjName = 'm_pejabat_keuangan_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["id"] <> "") {
				...
				$sReturnUrl = "m_pejabat_keuanganlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "m_pejabat_keuanganlist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "m_pejabat_keuanganlist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($m_pejabat_keuangan_view)) $m_pejabat_keuangan_view = new cm_pejabat_keuangan_view();

// Page init
$m_pejabat_keuangan_view->Page_Init();

// Page main
$m_pejabat_keuangan_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$m_pejabat_keuangan_view->Page_Render();
?>
...
var CurrentForm = fm_pejabat_keuanganview = new ew_Form("fm_pejabat_keuanganview", "view");

// Form_CustomValidate event
fm_pejabat_keuanganview.Form_CustomValidate = 
...
fm_pejabat_keuanganview.ValidateRequired = true;
<?php } else { ?>
fm_pejabat_keuanganview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fm_pejabat_keuanganview.Lists["x_jabatan"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fm_pejabat_keuanganview.Lists["x_jabatan"].Options = <?php echo json_encode($m_pejabat_keuangan->jabatan->Options()) ?>;
...
<?php if (!$m_pejabat_keuangan_view->IsModal) { ?>
<?php } ?>
<?php $m_pejabat_keuangan_view->ExportOptions->Render("body") ?>
<?php
	foreach ($m_pejabat_keuangan_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$m_pejabat_keuangan_view->IsModal) { ?>
...
<?php $m_pejabat_keuangan_view->ShowPageHeader(); ?>
<?php
$m_pejabat_keuangan_view->ShowMessage();
?>
<form name="fm_pejabat_keuanganview" id="fm_pejabat_keuanganview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($m_pejabat_keuangan_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $m_pejabat_keuangan_view->Token ?>">
<?php } ?>
...
<?php if ($m_pejabat_keuangan->id->Visible) { // id ?>
	<tr id="r_id">
		<td><span id="elh_m_pejabat_keuangan_id"><?php echo $m_pejabat_keuangan->id->FldCaption() ?></span></td>
...
<?php echo $m_pejabat_keuangan->id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($m_pejabat_keuangan->jabatan->Visible) { // jabatan ?>
	<tr id="r_jabatan">
		<td><span id="elh_m_pejabat_keuangan_jabatan"><?php echo $m_pejabat_keuangan->jabatan->FldCaption() ?></span></td>
...
<?php echo $m_pejabat_keuangan->jabatan->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($m_pejabat_keuangan->nama->Visible) { // nama ?>
	<tr id="r_nama">
		<td><span id="elh_m_pejabat_keuangan_nama"><?php echo $m_pejabat_keuangan->nama->FldCaption() ?></span></td>
...
<?php echo $m_pejabat_keuangan->nama->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($m_pejabat_keuangan->nip->Visible) { // nip ?>
	<tr id="r_nip">
		<td><span id="elh_m_pejabat_keuangan_nip"><?php echo $m_pejabat_keuangan->nip->FldCaption() ?></span></td>
...
<?php echo $m_pejabat_keuangan->nip->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($m_pejabat_keuangan->npwp->Visible) { // npwp ?>
	<tr id="r_npwp">
		<td><span id="elh_m_pejabat_keuangan_npwp"><?php echo $m_pejabat_keuangan->npwp->FldCaption() ?></span></td>
...
<?php echo $m_pejabat_keuangan->npwp->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($m_pejabat_keuangan->nama_rekening->Visible) { // nama_rekening ?>
	<tr id="r_nama_rekening">
		<td><span id="elh_m_pejabat_keuangan_nama_rekening"><?php echo $m_pejabat_keuangan->nama_rekening->FldCaption() ?></span></td>
...
<?php echo $m_pejabat_keuangan->nama_rekening->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($m_pejabat_keuangan->nomer_rekening->Visible) { // nomer_rekening ?>
	<tr id="r_nomer_rekening">
		<td><span id="elh_m_pejabat_keuangan_nomer_rekening"><?php echo $m_pejabat_keuangan->nomer_rekening->FldCaption() ?></span></td>
...
<?php echo $m_pejabat_keuangan->nomer_rekening->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
fm_pejabat_keuanganview.Init();
</script>
<?php
$m_pejabat_keuangan_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$m_pejabat_keuangan_view->Page_Terminate();
?>
