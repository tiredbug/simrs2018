...
class clogin extends cm_login {
	...
	function __construct() {
		...
		if (!isset($GLOBALS["m_login"])) $GLOBALS["m_login"] = &$this;
...
<div class="login-logo">
	<img src="<?php echo $EW_RELATIVE_PATH ?>phpimages/Untitled-23.png" alt="">
    <br />
	<?php echo $Language->ProjectPhrase("BodyTitle") ?>
</div>
<div class="login-box-body">
<form name="flogin" id="flogin" action="<?php echo ew_CurrentPage() ?>" method="post">
...
<div class="form-group has-feedback">
	<input type="text" name="username" id="username" class="form-control ewControl" value="<?php echo ew_HtmlEncode($login->Username) ?>" placeholder="<?php echo ew_HtmlEncode($Language->Phrase("Username")) ?>">
	<span class="glyphicon glyphicon-envelope form-control-feedback"></span>
</div>
</section>
<section>
<div class="form-group has-feedback">
    <input type="password" name="password" id="password" class="form-control ewControl" placeholder="<?php echo ew_HtmlEncode($Language->Phrase("Password")) ?>">
...
<div class="row">
<div class="col-xs-8">
<a id="ewLoginOptions" class="ewPointer collapsed" data-toggle="collapse" data-target="#flogin_options"><span> <?php echo $Language->Phrase("LoginOptions") ?>  </span><i class="fa fa-angle-down"></i></a>
    <div id="flogin_options" class="collapse">
    <div class="">
    <label for="type1">
    <input type="radio" name="type" id="type1" value="a"<?php if ($login->LoginType == "a") { ?> checked<?php } ?>> <?php echo $Language->Phrase("AutoLogin") ?>
    </label>
    </div>
    <div class="">
    <label for="type2">
    <input type="radio" name="type" id="type2" value="u"<?php if ($login->LoginType == "u") { ?>  checked<?php } ?>> <?php echo $Language->Phrase("SaveUserName") ?>
    </label>
    </div>
    <div class="">
    <label for="type3">
    <input type="radio" name="type" id="type3" value=""<?php if ($login->LoginType == "") { ?> checked<?php } ?>> <?php echo $Language->Phrase("AlwaysAsk") ?>
    </label>
    </div>
	</div>
	</div>
    <div class="col-xs-4">
    <button class="btn btn-primary ewButton btn-block" name="btnsubmit" id="btnsubmit" type="submit"><?php echo $Language->Phrase("Login") ?></button>
    </div>
</div>
</section>
</fieldset>
