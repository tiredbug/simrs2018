...
define("EW_PROJECT_NAME", "billingrawatinap_new2", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME, TRUE); // Config file name
define("EW_PROJECT_ID", "{9EA43BBE-9546-4DFA-A9E1-2DE91AC35CAA}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'nSdvnmu9wyaql0Kq', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/billingrawatinap_new2.css", TRUE); // Project stylesheet file name
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "simrs2012", "qs" => "`", "qe" => "`");
$EW_CONN[0] = &$EW_CONN["DB"];
$EW_CONN["dbantrianSis"] = array("conn" => NULL, "id" => "dbantrianSis", "type" => "MYSQL", "host" => "192.168.1.250", "port" => 3306, "user" => "root", "pass" => "", "db" => "dbantrianSis", "qs" => "`", "qe" => "`", "new" => TRUE);
$EW_CONN[1] = &$EW_CONN["dbantrianSis"];
...
$EW_LANGUAGE_FILE[] = array("en", "", "english-epi.xml");
...
// Security
define("EW_ADMIN_USER_NAME", "abc", TRUE); // Administrator user name
define("EW_ADMIN_PASSWORD", "abc", TRUE); // Administrator password
...
define("EW_USER_TABLE", "`m_login`", TRUE);
define("EW_USER_NAME_FILTER", "(`NIP` = '%u')", TRUE);
...
define("EW_USER_PROFILE_SESSION_TIMEOUT", 10, TRUE);
...
define("EW_MENU_CLASSNAME", "sidebar-menu", TRUE);
define("EW_SUBMENU_CLASSNAME", "treeview-menu", TRUE);
define("EW_SUBMENU_DROPDOWN_IMAGE", "", TRUE);
define("EW_SUBMENU_DROPDOWN_ICON_CLASSNAME", "pull-right-container", TRUE);
define("EW_MENU_DIVIDER_CLASSNAME", "divider", TRUE);
define("EW_MENU_ITEM_CLASSNAME", "", TRUE);
define("EW_SUBMENU_ITEM_CLASSNAME", "", TRUE);
