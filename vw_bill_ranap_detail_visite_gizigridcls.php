...
$vw_bill_ranap_detail_visite_gizi_grid = NULL; // Initialize page object first

class cvw_bill_ranap_detail_visite_gizi_grid extends cvw_bill_ranap_detail_visite_gizi {
	...
	// Page object name
	var $PageObjName = 'vw_bill_ranap_detail_visite_gizi_grid';

	// Grid form hidden field names
	var $FormName = 'fvw_bill_ranap_detail_visite_gizigrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["vw_bill_ranap_detail_visite_gizi"];
