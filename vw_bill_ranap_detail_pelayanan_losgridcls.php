...
$vw_bill_ranap_detail_pelayanan_los_grid = NULL; // Initialize page object first

class cvw_bill_ranap_detail_pelayanan_los_grid extends cvw_bill_ranap_detail_pelayanan_los {
	...
	// Page object name
	var $PageObjName = 'vw_bill_ranap_detail_pelayanan_los_grid';

	// Grid form hidden field names
	var $FormName = 'fvw_bill_ranap_detail_pelayanan_losgrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["vw_bill_ranap_detail_pelayanan_los"];
