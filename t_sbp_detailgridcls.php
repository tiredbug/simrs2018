...
$t_sbp_detail_grid = NULL; // Initialize page object first

class ct_sbp_detail_grid extends ct_sbp_detail {
	...
	// Page object name
	var $PageObjName = 't_sbp_detail_grid';

	// Grid form hidden field names
	var $FormName = 'ft_sbp_detailgrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["t_sbp_detail"];
