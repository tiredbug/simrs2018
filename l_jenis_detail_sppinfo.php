...
$l_jenis_detail_spp = NULL;

//
// Table class for l_jenis_detail_spp
//
class cl_jenis_detail_spp extends cTable {
	var $id;
	var $id_jenis;
	...
	function __construct() {
		...
		$this->TableVar = 'l_jenis_detail_spp';
		$this->TableName = 'l_jenis_detail_spp';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`l_jenis_detail_spp`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('l_jenis_detail_spp', 'l_jenis_detail_spp', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// id_jenis
		$this->id_jenis = new cField('l_jenis_detail_spp', 'l_jenis_detail_spp', 'x_id_jenis', 'id_jenis', '`id_jenis`', '`id_jenis`', 3, -1, FALSE, '`id_jenis`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// detail_jenis_spp
		$this->detail_jenis_spp = new cField('l_jenis_detail_spp', 'l_jenis_detail_spp', 'x_detail_jenis_spp', 'detail_jenis_spp', '`detail_jenis_spp`', '`detail_jenis_spp`', 200, -1, FALSE, '`detail_jenis_spp`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`l_jenis_detail_spp`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "l_jenis_detail_spplist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("l_jenis_detail_sppview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("l_jenis_detail_sppview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "l_jenis_detail_sppadd.php?" . $this->UrlParm($parm);
		else
			$url = "l_jenis_detail_sppadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("l_jenis_detail_sppedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("l_jenis_detail_sppadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("l_jenis_detail_sppdelete.php", $this->UrlParm());
	}
