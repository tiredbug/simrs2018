...
if($r==4){			include 'menu/pendaftaran.php';
}else if($r==6){ 	include 'menu/administrasi_klaim_bpjs.php';
}else if($r==5){	include 'menu/billing_rawat_inap.php';
}else if($r==7){	include 'menu/bendahara_keuangan.php';
