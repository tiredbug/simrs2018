...
$t_sbp_detail_add = NULL; // Initialize page object first

class ct_sbp_detail_add extends ct_sbp_detail {
	...
	// Page object name
	var $PageObjName = 't_sbp_detail_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "t_sbp_detailview.php")
	...
	function LoadDefaultValues() {
		...
		$this->uraian_tambahan->CurrentValue = NULL;
		$this->uraian_tambahan->OldValue = $this->uraian_tambahan->CurrentValue;
	}
	...
	function AddRow($rsold = NULL) {
		...
		// uraian_tambahan
		$this->uraian_tambahan->SetDbValueDef($rsnew, $this->uraian_tambahan->CurrentValue, NULL, FALSE);
...
// Create page object
if (!isset($t_sbp_detail_add)) $t_sbp_detail_add = new ct_sbp_detail_add();

// Page init
$t_sbp_detail_add->Page_Init();

// Page main
$t_sbp_detail_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t_sbp_detail_add->Page_Render();
?>
...
var CurrentForm = ft_sbp_detailadd = new ew_Form("ft_sbp_detailadd", "add");

// Validate form
ft_sbp_detailadd.Validate = function() {
...
ft_sbp_detailadd.Form_CustomValidate = 
...
ft_sbp_detailadd.ValidateRequired = true;
<?php } else { ?>
ft_sbp_detailadd.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ft_sbp_detailadd.Lists["x_akun1"] = {"LinkField":"x_kel1","Ajax":true,"AutoFill":false,"DisplayFields":["x_nmkel1","","",""],"ParentFields":[],"ChildFields":["x_akun2","x_akun3","x_akun4","x_akun5"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"keu_akun1"};
ft_sbp_detailadd.Lists["x_akun2"] = {"LinkField":"x_kel2","Ajax":true,"AutoFill":false,"DisplayFields":["x_nmkel2","","",""],"ParentFields":["x_akun1"],"ChildFields":["x_akun3","x_akun4","x_akun5"],"FilterFields":["x_kel1"],"Options":[],"Template":"","LinkTable":"keu_akun2"};
ft_sbp_detailadd.Lists["x_akun3"] = {"LinkField":"x_kel3","Ajax":true,"AutoFill":false,"DisplayFields":["x_nmkel3","","",""],"ParentFields":["x_akun2","x_akun1"],"ChildFields":["x_akun4","x_akun5"],"FilterFields":["x_kel2","x_kel1"],"Options":[],"Template":"","LinkTable":"keu_akun3"};
ft_sbp_detailadd.Lists["x_akun4"] = {"LinkField":"x_kel4","Ajax":true,"AutoFill":false,"DisplayFields":["x_nmkel4","","",""],"ParentFields":["x_akun3","x_akun2","x_akun1"],"ChildFields":["x_akun5"],"FilterFields":["x_kel3","x_kel2","x_kel1"],"Options":[],"Template":"","LinkTable":"keu_akun4"};
ft_sbp_detailadd.Lists["x_akun5"] = {"LinkField":"x_akun5","Ajax":true,"AutoFill":false,"DisplayFields":["x_nama_akun","","",""],"ParentFields":["x_akun4","x_akun3","x_akun2","x_akun1"],"ChildFields":[],"FilterFields":["x_akun4","x_akun3","x_akun2","x_akun1"],"Options":[],"Template":"","LinkTable":"keu_akun5"};
...
<?php if (!$t_sbp_detail_add->IsModal) { ?>
<?php } ?>
<?php $t_sbp_detail_add->ShowPageHeader(); ?>
<?php
$t_sbp_detail_add->ShowMessage();
?>
<form name="ft_sbp_detailadd" id="ft_sbp_detailadd" class="<?php echo $t_sbp_detail_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t_sbp_detail_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t_sbp_detail_add->Token ?>">
<?php } ?>
...
<?php if (strval($t_sbp_detail->id_sbp->getSessionValue()) <> "") { ?>
<input type="hidden" name="x_id_sbp" id="x_id_sbp" value="<?php echo ew_HtmlEncode(strval($t_sbp_detail->id_sbp->getSessionValue())) ?>">
<?php } ?>
<?php if (strval($t_sbp_detail->tipe_sbp->getSessionValue()) <> "") { ?>
<input type="hidden" name="x_tipe_sbp" id="x_tipe_sbp" value="<?php echo ew_HtmlEncode(strval($t_sbp_detail->tipe_sbp->getSessionValue())) ?>">
<?php } ?>
<?php if (strval($t_sbp_detail->no_sbp->getSessionValue()) <> "") { ?>
<input type="hidden" name="x_no_sbp" id="x_no_sbp" value="<?php echo ew_HtmlEncode(strval($t_sbp_detail->no_sbp->getSessionValue())) ?>">
<?php } ?>
<?php if (strval($t_sbp_detail->program->getSessionValue()) <> "") { ?>
<input type="hidden" name="x_program" id="x_program" value="<?php echo ew_HtmlEncode(strval($t_sbp_detail->program->getSessionValue())) ?>">
<?php } ?>
<?php if (strval($t_sbp_detail->kegiatan->getSessionValue()) <> "") { ?>
<input type="hidden" name="x_kegiatan" id="x_kegiatan" value="<?php echo ew_HtmlEncode(strval($t_sbp_detail->kegiatan->getSessionValue())) ?>">
<?php } ?>
<?php if (strval($t_sbp_detail->sub_kegiatan->getSessionValue()) <> "") { ?>
<input type="hidden" name="x_sub_kegiatan" id="x_sub_kegiatan" value="<?php echo ew_HtmlEncode(strval($t_sbp_detail->sub_kegiatan->getSessionValue())) ?>">
<?php } ?>
<?php if (strval($t_sbp_detail->tahun_anggaran->getSessionValue()) <> "") { ?>
<input type="hidden" name="x_tahun_anggaran" id="x_tahun_anggaran" value="<?php echo ew_HtmlEncode(strval($t_sbp_detail->tahun_anggaran->getSessionValue())) ?>">
<?php } ?>
<?php if (!$t_sbp_detail_add->IsModal) { ?>
<div class="form-group">
	<div class="col-sm-offset-2 col-sm-10">
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t_sbp_detail_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
ft_sbp_detailadd.Init();
</script>
<?php
$t_sbp_detail_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$t_sbp_detail_add->Page_Terminate();
?>
