...
$vw_bill_ranap_detail_pelayanan_los = NULL;

//
// Table class for vw_bill_ranap_detail_pelayanan_los
//
class cvw_bill_ranap_detail_pelayanan_los extends cTable {
	...
	function __construct() {
		...
		$this->TableVar = 'vw_bill_ranap_detail_pelayanan_los';
		$this->TableName = 'vw_bill_ranap_detail_pelayanan_los';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`vw_bill_ranap_detail_pelayanan_los`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('vw_bill_ranap_detail_pelayanan_los', 'vw_bill_ranap_detail_pelayanan_los', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// id_admission
		$this->id_admission = new cField('vw_bill_ranap_detail_pelayanan_los', 'vw_bill_ranap_detail_pelayanan_los', 'x_id_admission', 'id_admission', '`id_admission`', '`id_admission`', 3, -1, FALSE, '`id_admission`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// nomr
		$this->nomr = new cField('vw_bill_ranap_detail_pelayanan_los', 'vw_bill_ranap_detail_pelayanan_los', 'x_nomr', 'nomr', '`nomr`', '`nomr`', 200, -1, FALSE, '`nomr`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->nomr->Sortable = TRUE; // Allow sort
		$this->fields['nomr'] = &$this->nomr;

		// statusbayar
		$this->statusbayar = new cField('vw_bill_ranap_detail_pelayanan_los', 'vw_bill_ranap_detail_pelayanan_los', 'x_statusbayar', 'statusbayar', '`statusbayar`', '`statusbayar`', 3, -1, FALSE, '`statusbayar`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// kelas
		$this->kelas = new cField('vw_bill_ranap_detail_pelayanan_los', 'vw_bill_ranap_detail_pelayanan_los', 'x_kelas', 'kelas', '`kelas`', '`kelas`', 3, -1, FALSE, '`kelas`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// tanggal
		$this->tanggal = new cField('vw_bill_ranap_detail_pelayanan_los', 'vw_bill_ranap_detail_pelayanan_los', 'x_tanggal', 'tanggal', '`tanggal`', ew_CastDateFieldForLike('`tanggal`', 0, "DB"), 135, 0, FALSE, '`tanggal`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->tanggal->Sortable = TRUE; // Allow sort
		$this->tanggal->FldDefaultErrMsg = str_replace("%s", $GLOBALS["EW_DATE_FORMAT"], $Language->Phrase("IncorrectDate"));
		$this->fields['tanggal'] = &$this->tanggal;

		// kode_tindakan
		$this->kode_tindakan = new cField('vw_bill_ranap_detail_pelayanan_los', 'vw_bill_ranap_detail_pelayanan_los', 'x_kode_tindakan', 'kode_tindakan', '`kode_tindakan`', '`kode_tindakan`', 3, -1, FALSE, '`kode_tindakan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// nama_tindakan
		$this->nama_tindakan = new cField('vw_bill_ranap_detail_pelayanan_los', 'vw_bill_ranap_detail_pelayanan_los', 'x_nama_tindakan', 'nama_tindakan', '`nama_tindakan`', '`nama_tindakan`', 200, -1, FALSE, '`nama_tindakan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->nama_tindakan->Sortable = TRUE; // Allow sort
		$this->fields['nama_tindakan'] = &$this->nama_tindakan;

		// kelompok1
		$this->kelompok1 = new cField('vw_bill_ranap_detail_pelayanan_los', 'vw_bill_ranap_detail_pelayanan_los', 'x_kelompok1', 'kelompok1', '`kelompok1`', '`kelompok1`', 3, -1, FALSE, '`kelompok1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// kelompok2
		$this->kelompok2 = new cField('vw_bill_ranap_detail_pelayanan_los', 'vw_bill_ranap_detail_pelayanan_los', 'x_kelompok2', 'kelompok2', '`kelompok2`', '`kelompok2`', 3, -1, FALSE, '`kelompok2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// tarif
		$this->tarif = new cField('vw_bill_ranap_detail_pelayanan_los', 'vw_bill_ranap_detail_pelayanan_los', 'x_tarif', 'tarif', '`tarif`', '`tarif`', 5, -1, FALSE, '`tarif`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// bhp
		$this->bhp = new cField('vw_bill_ranap_detail_pelayanan_los', 'vw_bill_ranap_detail_pelayanan_los', 'x_bhp', 'bhp', '`bhp`', '`bhp`', 5, -1, FALSE, '`bhp`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->bhp->Sortable = TRUE; // Allow sort
		$this->bhp->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['bhp'] = &$this->bhp;

		// qty
		$this->qty = new cField('vw_bill_ranap_detail_pelayanan_los', 'vw_bill_ranap_detail_pelayanan_los', 'x_qty', 'qty', '`qty`', '`qty`', 3, -1, FALSE, '`qty`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->qty->Sortable = TRUE; // Allow sort
		$this->qty->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['qty'] = &$this->qty;

		// user
		$this->user = new cField('vw_bill_ranap_detail_pelayanan_los', 'vw_bill_ranap_detail_pelayanan_los', 'x_user', 'user', '`user`', '`user`', 200, -1, FALSE, '`user`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->user->Sortable = TRUE; // Allow sort
		$this->fields['user'] = &$this->user;

		// kelompok_tindakan
		$this->kelompok_tindakan = new cField('vw_bill_ranap_detail_pelayanan_los', 'vw_bill_ranap_detail_pelayanan_los', 'x_kelompok_tindakan', 'kelompok_tindakan', '`kelompok_tindakan`', '`kelompok_tindakan`', 3, -1, FALSE, '`kelompok_tindakan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// kode_dokter
		$this->kode_dokter = new cField('vw_bill_ranap_detail_pelayanan_los', 'vw_bill_ranap_detail_pelayanan_los', 'x_kode_dokter', 'kode_dokter', '`kode_dokter`', '`kode_dokter`', 3, -1, FALSE, '`kode_dokter`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// no_ruang
		$this->no_ruang = new cField('vw_bill_ranap_detail_pelayanan_los', 'vw_bill_ranap_detail_pelayanan_los', 'x_no_ruang', 'no_ruang', '`no_ruang`', '`no_ruang`', 3, -1, FALSE, '`no_ruang`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function SqlMasterFilter_vw_bill_ranap() {
		return "`id_admission`=@id_admission@ AND `nomr`='@nomr@' AND `statusbayar`=@statusbayar@ AND `KELASPERAWATAN_ID`=@KELASPERAWATAN_ID@";
	}

	// Detail filter
	function SqlDetailFilter_vw_bill_ranap() {
		return "`id_admission`=@id_admission@ AND `nomr`='@nomr@' AND `statusbayar`=@statusbayar@ AND `kelas`=@kelas@";
	}
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`vw_bill_ranap_detail_pelayanan_los`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "vw_bill_ranap_detail_pelayanan_loslist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("vw_bill_ranap_detail_pelayanan_losview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("vw_bill_ranap_detail_pelayanan_losview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "vw_bill_ranap_detail_pelayanan_losadd.php?" . $this->UrlParm($parm);
		else
			$url = "vw_bill_ranap_detail_pelayanan_losadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("vw_bill_ranap_detail_pelayanan_losedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("vw_bill_ranap_detail_pelayanan_losadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("vw_bill_ranap_detail_pelayanan_losdelete.php", $this->UrlParm());
	}
   ...
   // Common render codes
	...
	function RenderEditRow() {
		...
		$this->kode_tindakan->EditValue = $this->kode_tindakan->CurrentValue;
	...
	function GetAutoFill($id, $val) {
		...
		if (preg_match('/^x(\d)*_kode_tindakan$/', $id)) {
			$conn = &$this->Connection();
			$sSqlWrk = "SELECT `nama_tindakan` AS FIELD0, `sub_kelompok1` AS FIELD1, `sub_kelompok1` AS FIELD2, `sub_kelompok2` AS FIELD3, `tarif` AS FIELD4, `bhp` AS FIELD5 FROM `vw_bill_ranap_data_tarif_tindakan`";
			...
			if ($rs = ew_LoadRecordset($sSqlWrk, $conn)) {
				while ($rs && !$rs->EOF) {
					$ar = array();
					$this->nama_tindakan->setDbValue($rs->fields[0]);
					$this->kelompok_tindakan->setDbValue($rs->fields[1]);
					$this->kelompok1->setDbValue($rs->fields[2]);
					$this->kelompok2->setDbValue($rs->fields[3]);
					$this->tarif->setDbValue($rs->fields[4]);
					$this->bhp->setDbValue($rs->fields[5]);
					$this->RowType == EW_ROWTYPE_EDIT;
					$this->RenderEditRow();
					$ar[] = ($this->nama_tindakan->AutoFillOriginalValue) ? $this->nama_tindakan->CurrentValue : $this->nama_tindakan->EditValue;
					$ar[] = ($this->kelompok_tindakan->AutoFillOriginalValue) ? $this->kelompok_tindakan->CurrentValue : $this->kelompok_tindakan->EditValue;
					$ar[] = ($this->kelompok1->AutoFillOriginalValue) ? $this->kelompok1->CurrentValue : $this->kelompok1->EditValue;
					$ar[] = ($this->kelompok2->AutoFillOriginalValue) ? $this->kelompok2->CurrentValue : $this->kelompok2->EditValue;
					$ar[] = ($this->tarif->AutoFillOriginalValue) ? $this->tarif->CurrentValue : $this->tarif->EditValue;
					$ar[] = ($this->bhp->AutoFillOriginalValue) ? $this->bhp->CurrentValue : $this->bhp->EditValue;
					$rowcnt += 1;
					$rsarr[] = $ar;
					$rs->MoveNext();
				}
	...
	function WriteAuditTrailDummy($typ) {
		$table = 'vw_bill_ranap_detail_pelayanan_los';
		$usr = CurrentUserID();
	...
	function Row_Rendered() {
		...
		$this->kode_tindakan->ReadOnly = TRUE;
