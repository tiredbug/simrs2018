...
$m_kegiatan_grid = NULL; // Initialize page object first

class cm_kegiatan_grid extends cm_kegiatan {
	...
	// Page object name
	var $PageObjName = 'm_kegiatan_grid';

	// Grid form hidden field names
	var $FormName = 'fm_kegiatangrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["m_kegiatan"];

		}
		$this->AddUrl = "m_kegiatanadd.php";
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function EmptyRow() {
		...
		if ($objForm->HasValue("x_kode_kegiatan") && $objForm->HasValue("o_kode_kegiatan") && $this->kode_kegiatan->CurrentValue <> $this->kode_kegiatan->OldValue)
			return FALSE;
		if ($objForm->HasValue("x_nama_kegiatan") && $objForm->HasValue("o_nama_kegiatan") && $this->nama_kegiatan->CurrentValue <> $this->nama_kegiatan->OldValue)
			return FALSE;
		return TRUE;
	}
	...
	function LoadFormValues() {
		...
		$this->nama_kegiatan->setOldValue($objForm->GetValue("o_nama_kegiatan"));
	}
	...
	function SetUpMasterParms() {
		...
		if ($sMasterTblVar == "m_program") {
			...
			if ($GLOBALS["m_program"]->EventCancelled) $this->EventCancelled = TRUE;
		}
