...
$keu_akun5_add = NULL; // Initialize page object first

class ckeu_akun5_add extends ckeu_akun5 {
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "keu_akun5view.php")
	...
	function LoadDefaultValues() {
		...
		$this->kd_akun4->CurrentValue = NULL;
		$this->kd_akun4->OldValue = $this->kd_akun4->CurrentValue;
	}
	...
	function AddRow($rsold = NULL) {
		...
		// kd_akun4
		$this->kd_akun4->SetDbValueDef($rsnew, $this->kd_akun4->CurrentValue, NULL, FALSE);
...
// Create page object
if (!isset($keu_akun5_add)) $keu_akun5_add = new ckeu_akun5_add();

// Page init
$keu_akun5_add->Page_Init();

// Page main
$keu_akun5_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$keu_akun5_add->Page_Render();
?>
...
var CurrentForm = fkeu_akun5add = new ew_Form("fkeu_akun5add", "add");

// Validate form
fkeu_akun5add.Validate = function() {
...
fkeu_akun5add.Form_CustomValidate = 
...
fkeu_akun5add.ValidateRequired = true;
<?php } else { ?>
fkeu_akun5add.ValidateRequired = false; 
<?php } ?>
...
<?php if (!$keu_akun5_add->IsModal) { ?>
<?php } ?>
<?php $keu_akun5_add->ShowPageHeader(); ?>
<?php
$keu_akun5_add->ShowMessage();
?>
<form name="fkeu_akun5add" id="fkeu_akun5add" class="<?php echo $keu_akun5_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($keu_akun5_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $keu_akun5_add->Token ?>">
<?php } ?>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $keu_akun5_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
