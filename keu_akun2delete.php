...
$keu_akun2_delete = NULL; // Initialize page object first

class ckeu_akun2_delete extends ckeu_akun2 {
	...
	// Page object name
	var $PageObjName = 'keu_akun2_delete';
	...
	function Page_Main() {
		...
		if ($sFilter == "")
			$this->Page_Terminate("keu_akun2list.php"); // Prevent SQL injection, return to list

		// Set up filter (SQL WHHERE clause) and get return SQL
		// SQL constructor in keu_akun2 class, keu_akun2info.php
		...
		if ($this->CurrentAction == "I") { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->Page_Terminate("keu_akun2list.php"); // Return to list
			}
		}
	}
...
// Create page object
if (!isset($keu_akun2_delete)) $keu_akun2_delete = new ckeu_akun2_delete();

// Page init
$keu_akun2_delete->Page_Init();

// Page main
$keu_akun2_delete->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$keu_akun2_delete->Page_Render();
?>
...
var CurrentForm = fkeu_akun2delete = new ew_Form("fkeu_akun2delete", "delete");

// Form_CustomValidate event
fkeu_akun2delete.Form_CustomValidate = 
...
fkeu_akun2delete.ValidateRequired = true;
<?php } else { ?>
fkeu_akun2delete.ValidateRequired = false; 
<?php } ?>
...
<?php $keu_akun2_delete->ShowPageHeader(); ?>
<?php
$keu_akun2_delete->ShowMessage();
?>
<form name="fkeu_akun2delete" id="fkeu_akun2delete" class="form-inline ewForm ewDeleteForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($keu_akun2_delete->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $keu_akun2_delete->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="keu_akun2">
<input type="hidden" name="a_delete" id="a_delete" value="D">
<?php foreach ($keu_akun2_delete->RecKeys as $key) { ?>
...
<?php if ($keu_akun2->kd_akun->Visible) { // kd_akun ?>
		<th><span id="elh_keu_akun2_kd_akun" class="keu_akun2_kd_akun"><?php echo $keu_akun2->kd_akun->FldCaption() ?></span></th>
<?php } ?>
<?php if ($keu_akun2->kel2->Visible) { // kel2 ?>
		<th><span id="elh_keu_akun2_kel2" class="keu_akun2_kel2"><?php echo $keu_akun2->kel2->FldCaption() ?></span></th>
<?php } ?>
<?php if ($keu_akun2->nmkel2->Visible) { // nmkel2 ?>
		<th><span id="elh_keu_akun2_nmkel2" class="keu_akun2_nmkel2"><?php echo $keu_akun2->nmkel2->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
<?php
$keu_akun2_delete->RecCnt = 0;
$i = 0;
while (!$keu_akun2_delete->Recordset->EOF) {
	$keu_akun2_delete->RecCnt++;
	$keu_akun2_delete->RowCnt++;

	// Set row properties
	$keu_akun2->ResetAttrs();
	$keu_akun2->RowType = EW_ROWTYPE_VIEW; // View

	// Get the field contents
	$keu_akun2_delete->LoadRowValues($keu_akun2_delete->Recordset);

	// Render row
	$keu_akun2_delete->RenderRow();
?>
	<tr<?php echo $keu_akun2->RowAttributes() ?>>
<?php if ($keu_akun2->kd_akun->Visible) { // kd_akun ?>
		<td<?php echo $keu_akun2->kd_akun->CellAttributes() ?>>
<span id="el<?php echo $keu_akun2_delete->RowCnt ?>_keu_akun2_kd_akun" class="keu_akun2_kd_akun">
...
<span id="el<?php echo $keu_akun2_delete->RowCnt ?>_keu_akun2_kel2" class="keu_akun2_kel2">
...
<span id="el<?php echo $keu_akun2_delete->RowCnt ?>_keu_akun2_nmkel2" class="keu_akun2_nmkel2">
...
<?php
	$keu_akun2_delete->Recordset->MoveNext();
}
$keu_akun2_delete->Recordset->Close();
?>
</tbody>
</table>
</div>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $keu_akun2_delete->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
</div>
</form>
<script type="text/javascript">
fkeu_akun2delete.Init();
</script>
<?php
$keu_akun2_delete->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$keu_akun2_delete->Page_Terminate();
?>
