...
$vw_spp_ls_barang_jasa_detail_grid = NULL; // Initialize page object first

class cvw_spp_ls_barang_jasa_detail_grid extends cvw_spp_ls_barang_jasa_detail {
	...
	// Page object name
	var $PageObjName = 'vw_spp_ls_barang_jasa_detail_grid';

	// Grid form hidden field names
	var $FormName = 'fvw_spp_ls_barang_jasa_detailgrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["vw_spp_ls_barang_jasa_detail"];
