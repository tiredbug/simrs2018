...
$vw_bill_ranap_detail_tindakan_perawat_delete = NULL; // Initialize page object first

class cvw_bill_ranap_detail_tindakan_perawat_delete extends cvw_bill_ranap_detail_tindakan_perawat {
	...
	// Page object name
	var $PageObjName = 'vw_bill_ranap_detail_tindakan_perawat_delete';
	...
	function Page_Main() {
		...
		if ($sFilter == "")
			$this->Page_Terminate("vw_bill_ranap_detail_tindakan_perawatlist.php"); // Prevent SQL injection, return to list

		// Set up filter (SQL WHHERE clause) and get return SQL
		// SQL constructor in vw_bill_ranap_detail_tindakan_perawat class, vw_bill_ranap_detail_tindakan_perawatinfo.php
		...
		if ($this->CurrentAction == "I") { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->Page_Terminate("vw_bill_ranap_detail_tindakan_perawatlist.php"); // Return to list
			}
		}
	}
...
// Create page object
if (!isset($vw_bill_ranap_detail_tindakan_perawat_delete)) $vw_bill_ranap_detail_tindakan_perawat_delete = new cvw_bill_ranap_detail_tindakan_perawat_delete();

// Page init
$vw_bill_ranap_detail_tindakan_perawat_delete->Page_Init();

// Page main
$vw_bill_ranap_detail_tindakan_perawat_delete->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$vw_bill_ranap_detail_tindakan_perawat_delete->Page_Render();
?>
...
var CurrentForm = fvw_bill_ranap_detail_tindakan_perawatdelete = new ew_Form("fvw_bill_ranap_detail_tindakan_perawatdelete", "delete");

// Form_CustomValidate event
fvw_bill_ranap_detail_tindakan_perawatdelete.Form_CustomValidate = 
...
fvw_bill_ranap_detail_tindakan_perawatdelete.ValidateRequired = true;
<?php } else { ?>
fvw_bill_ranap_detail_tindakan_perawatdelete.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fvw_bill_ranap_detail_tindakan_perawatdelete.Lists["x_kode_tindakan"] = {"LinkField":"x_kode","Ajax":true,"AutoFill":false,"DisplayFields":["x_nama_tindakan","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"vw_bill_ranap_data_tarif_tindakan"};
...
<?php $vw_bill_ranap_detail_tindakan_perawat_delete->ShowPageHeader(); ?>
<?php
$vw_bill_ranap_detail_tindakan_perawat_delete->ShowMessage();
?>
<form name="fvw_bill_ranap_detail_tindakan_perawatdelete" id="fvw_bill_ranap_detail_tindakan_perawatdelete" class="form-inline ewForm ewDeleteForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($vw_bill_ranap_detail_tindakan_perawat_delete->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $vw_bill_ranap_detail_tindakan_perawat_delete->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="vw_bill_ranap_detail_tindakan_perawat">
<input type="hidden" name="a_delete" id="a_delete" value="D">
<?php foreach ($vw_bill_ranap_detail_tindakan_perawat_delete->RecKeys as $key) { ?>
...
<?php if ($vw_bill_ranap_detail_tindakan_perawat->statusbayar->Visible) { // statusbayar ?>
		<th><span id="elh_vw_bill_ranap_detail_tindakan_perawat_statusbayar" class="vw_bill_ranap_detail_tindakan_perawat_statusbayar"><?php echo $vw_bill_ranap_detail_tindakan_perawat->statusbayar->FldCaption() ?></span></th>
<?php } ?>
<?php if ($vw_bill_ranap_detail_tindakan_perawat->tanggal->Visible) { // tanggal ?>
		<th><span id="elh_vw_bill_ranap_detail_tindakan_perawat_tanggal" class="vw_bill_ranap_detail_tindakan_perawat_tanggal"><?php echo $vw_bill_ranap_detail_tindakan_perawat->tanggal->FldCaption() ?></span></th>
<?php } ?>
<?php if ($vw_bill_ranap_detail_tindakan_perawat->kode_tindakan->Visible) { // kode_tindakan ?>
		<th><span id="elh_vw_bill_ranap_detail_tindakan_perawat_kode_tindakan" class="vw_bill_ranap_detail_tindakan_perawat_kode_tindakan"><?php echo $vw_bill_ranap_detail_tindakan_perawat->kode_tindakan->FldCaption() ?></span></th>
<?php } ?>
<?php if ($vw_bill_ranap_detail_tindakan_perawat->qty->Visible) { // qty ?>
		<th><span id="elh_vw_bill_ranap_detail_tindakan_perawat_qty" class="vw_bill_ranap_detail_tindakan_perawat_qty"><?php echo $vw_bill_ranap_detail_tindakan_perawat->qty->FldCaption() ?></span></th>
<?php } ?>
<?php if ($vw_bill_ranap_detail_tindakan_perawat->tarif->Visible) { // tarif ?>
		<th><span id="elh_vw_bill_ranap_detail_tindakan_perawat_tarif" class="vw_bill_ranap_detail_tindakan_perawat_tarif"><?php echo $vw_bill_ranap_detail_tindakan_perawat->tarif->FldCaption() ?></span></th>
<?php } ?>
<?php if ($vw_bill_ranap_detail_tindakan_perawat->bhp->Visible) { // bhp ?>
		<th><span id="elh_vw_bill_ranap_detail_tindakan_perawat_bhp" class="vw_bill_ranap_detail_tindakan_perawat_bhp"><?php echo $vw_bill_ranap_detail_tindakan_perawat->bhp->FldCaption() ?></span></th>
<?php } ?>
<?php if ($vw_bill_ranap_detail_tindakan_perawat->user->Visible) { // user ?>
		<th><span id="elh_vw_bill_ranap_detail_tindakan_perawat_user" class="vw_bill_ranap_detail_tindakan_perawat_user"><?php echo $vw_bill_ranap_detail_tindakan_perawat->user->FldCaption() ?></span></th>
<?php } ?>
<?php if ($vw_bill_ranap_detail_tindakan_perawat->no_ruang->Visible) { // no_ruang ?>
		<th><span id="elh_vw_bill_ranap_detail_tindakan_perawat_no_ruang" class="vw_bill_ranap_detail_tindakan_perawat_no_ruang"><?php echo $vw_bill_ranap_detail_tindakan_perawat->no_ruang->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
<?php
$vw_bill_ranap_detail_tindakan_perawat_delete->RecCnt = 0;
$i = 0;
while (!$vw_bill_ranap_detail_tindakan_perawat_delete->Recordset->EOF) {
	$vw_bill_ranap_detail_tindakan_perawat_delete->RecCnt++;
	$vw_bill_ranap_detail_tindakan_perawat_delete->RowCnt++;

	// Set row properties
	$vw_bill_ranap_detail_tindakan_perawat->ResetAttrs();
	$vw_bill_ranap_detail_tindakan_perawat->RowType = EW_ROWTYPE_VIEW; // View

	// Get the field contents
	$vw_bill_ranap_detail_tindakan_perawat_delete->LoadRowValues($vw_bill_ranap_detail_tindakan_perawat_delete->Recordset);

	// Render row
	$vw_bill_ranap_detail_tindakan_perawat_delete->RenderRow();
?>
	<tr<?php echo $vw_bill_ranap_detail_tindakan_perawat->RowAttributes() ?>>
<?php if ($vw_bill_ranap_detail_tindakan_perawat->statusbayar->Visible) { // statusbayar ?>
		<td<?php echo $vw_bill_ranap_detail_tindakan_perawat->statusbayar->CellAttributes() ?>>
<span id="el<?php echo $vw_bill_ranap_detail_tindakan_perawat_delete->RowCnt ?>_vw_bill_ranap_detail_tindakan_perawat_statusbayar" class="vw_bill_ranap_detail_tindakan_perawat_statusbayar">
...
<?php } ?>
<?php if ($vw_bill_ranap_detail_tindakan_perawat->tanggal->Visible) { // tanggal ?>
		<td<?php echo $vw_bill_ranap_detail_tindakan_perawat->tanggal->CellAttributes() ?>>
<span id="el<?php echo $vw_bill_ranap_detail_tindakan_perawat_delete->RowCnt ?>_vw_bill_ranap_detail_tindakan_perawat_tanggal" class="vw_bill_ranap_detail_tindakan_perawat_tanggal">
...
<?php } ?>
<?php if ($vw_bill_ranap_detail_tindakan_perawat->kode_tindakan->Visible) { // kode_tindakan ?>
		<td<?php echo $vw_bill_ranap_detail_tindakan_perawat->kode_tindakan->CellAttributes() ?>>
<span id="el<?php echo $vw_bill_ranap_detail_tindakan_perawat_delete->RowCnt ?>_vw_bill_ranap_detail_tindakan_perawat_kode_tindakan" class="vw_bill_ranap_detail_tindakan_perawat_kode_tindakan">
...
<?php } ?>
<?php if ($vw_bill_ranap_detail_tindakan_perawat->qty->Visible) { // qty ?>
		<td<?php echo $vw_bill_ranap_detail_tindakan_perawat->qty->CellAttributes() ?>>
<span id="el<?php echo $vw_bill_ranap_detail_tindakan_perawat_delete->RowCnt ?>_vw_bill_ranap_detail_tindakan_perawat_qty" class="vw_bill_ranap_detail_tindakan_perawat_qty">
...
<?php } ?>
<?php if ($vw_bill_ranap_detail_tindakan_perawat->tarif->Visible) { // tarif ?>
		<td<?php echo $vw_bill_ranap_detail_tindakan_perawat->tarif->CellAttributes() ?>>
<span id="el<?php echo $vw_bill_ranap_detail_tindakan_perawat_delete->RowCnt ?>_vw_bill_ranap_detail_tindakan_perawat_tarif" class="vw_bill_ranap_detail_tindakan_perawat_tarif">
...
<?php } ?>
<?php if ($vw_bill_ranap_detail_tindakan_perawat->bhp->Visible) { // bhp ?>
		<td<?php echo $vw_bill_ranap_detail_tindakan_perawat->bhp->CellAttributes() ?>>
<span id="el<?php echo $vw_bill_ranap_detail_tindakan_perawat_delete->RowCnt ?>_vw_bill_ranap_detail_tindakan_perawat_bhp" class="vw_bill_ranap_detail_tindakan_perawat_bhp">
...
<?php } ?>
<?php if ($vw_bill_ranap_detail_tindakan_perawat->user->Visible) { // user ?>
		<td<?php echo $vw_bill_ranap_detail_tindakan_perawat->user->CellAttributes() ?>>
<span id="el<?php echo $vw_bill_ranap_detail_tindakan_perawat_delete->RowCnt ?>_vw_bill_ranap_detail_tindakan_perawat_user" class="vw_bill_ranap_detail_tindakan_perawat_user">
...
<?php } ?>
<?php if ($vw_bill_ranap_detail_tindakan_perawat->no_ruang->Visible) { // no_ruang ?>
		<td<?php echo $vw_bill_ranap_detail_tindakan_perawat->no_ruang->CellAttributes() ?>>
<span id="el<?php echo $vw_bill_ranap_detail_tindakan_perawat_delete->RowCnt ?>_vw_bill_ranap_detail_tindakan_perawat_no_ruang" class="vw_bill_ranap_detail_tindakan_perawat_no_ruang">
...
<?php
	$vw_bill_ranap_detail_tindakan_perawat_delete->Recordset->MoveNext();
}
$vw_bill_ranap_detail_tindakan_perawat_delete->Recordset->Close();
?>
</tbody>
</table>
</div>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $vw_bill_ranap_detail_tindakan_perawat_delete->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
</div>
</form>
<script type="text/javascript">
fvw_bill_ranap_detail_tindakan_perawatdelete.Init();
</script>
<?php
$vw_bill_ranap_detail_tindakan_perawat_delete->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$vw_bill_ranap_detail_tindakan_perawat_delete->Page_Terminate();
?>
