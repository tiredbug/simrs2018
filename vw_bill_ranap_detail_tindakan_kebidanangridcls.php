...
$vw_bill_ranap_detail_tindakan_kebidanan_grid = NULL; // Initialize page object first

class cvw_bill_ranap_detail_tindakan_kebidanan_grid extends cvw_bill_ranap_detail_tindakan_kebidanan {
	...
	// Page object name
	var $PageObjName = 'vw_bill_ranap_detail_tindakan_kebidanan_grid';

	// Grid form hidden field names
	var $FormName = 'fvw_bill_ranap_detail_tindakan_kebidanangrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["vw_bill_ranap_detail_tindakan_kebidanan"];
