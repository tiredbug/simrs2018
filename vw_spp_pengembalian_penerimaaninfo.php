...
$vw_spp_pengembalian_penerimaan = NULL;

//
// Table class for vw_spp_pengembalian_penerimaan
//
class cvw_spp_pengembalian_penerimaan extends cTable {
	var $id;
	var $id_jenis_spp;
	...
	function __construct() {
		...
		$this->TableVar = 'vw_spp_pengembalian_penerimaan';
		$this->TableName = 'vw_spp_pengembalian_penerimaan';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`vw_spp_pengembalian_penerimaan`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('vw_spp_pengembalian_penerimaan', 'vw_spp_pengembalian_penerimaan', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// id_jenis_spp
		$this->id_jenis_spp = new cField('vw_spp_pengembalian_penerimaan', 'vw_spp_pengembalian_penerimaan', 'x_id_jenis_spp', 'id_jenis_spp', '`id_jenis_spp`', '`id_jenis_spp`', 3, -1, FALSE, '`id_jenis_spp`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// detail_jenis_spp
		$this->detail_jenis_spp = new cField('vw_spp_pengembalian_penerimaan', 'vw_spp_pengembalian_penerimaan', 'x_detail_jenis_spp', 'detail_jenis_spp', '`detail_jenis_spp`', '`detail_jenis_spp`', 3, -1, FALSE, '`detail_jenis_spp`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// status_spp
		$this->status_spp = new cField('vw_spp_pengembalian_penerimaan', 'vw_spp_pengembalian_penerimaan', 'x_status_spp', 'status_spp', '`status_spp`', '`status_spp`', 3, -1, FALSE, '`status_spp`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// kode_program
		$this->kode_program = new cField('vw_spp_pengembalian_penerimaan', 'vw_spp_pengembalian_penerimaan', 'x_kode_program', 'kode_program', '`kode_program`', '`kode_program`', 200, -1, FALSE, '`kode_program`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// kode_kegiatan
		$this->kode_kegiatan = new cField('vw_spp_pengembalian_penerimaan', 'vw_spp_pengembalian_penerimaan', 'x_kode_kegiatan', 'kode_kegiatan', '`kode_kegiatan`', '`kode_kegiatan`', 200, -1, FALSE, '`kode_kegiatan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// kode_sub_kegiatan
		$this->kode_sub_kegiatan = new cField('vw_spp_pengembalian_penerimaan', 'vw_spp_pengembalian_penerimaan', 'x_kode_sub_kegiatan', 'kode_sub_kegiatan', '`kode_sub_kegiatan`', '`kode_sub_kegiatan`', 200, -1, FALSE, '`kode_sub_kegiatan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// no_spp
		$this->no_spp = new cField('vw_spp_pengembalian_penerimaan', 'vw_spp_pengembalian_penerimaan', 'x_no_spp', 'no_spp', '`no_spp`', '`no_spp`', 200, -1, FALSE, '`no_spp`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->no_spp->Sortable = TRUE; // Allow sort
		$this->fields['no_spp'] = &$this->no_spp;

		// nama_bendahara
		$this->nama_bendahara = new cField('vw_spp_pengembalian_penerimaan', 'vw_spp_pengembalian_penerimaan', 'x_nama_bendahara', 'nama_bendahara', '`nama_bendahara`', '`nama_bendahara`', 200, -1, FALSE, '`nama_bendahara`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// nip_bendahara
		$this->nip_bendahara = new cField('vw_spp_pengembalian_penerimaan', 'vw_spp_pengembalian_penerimaan', 'x_nip_bendahara', 'nip_bendahara', '`nip_bendahara`', '`nip_bendahara`', 200, -1, FALSE, '`nip_bendahara`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->nip_bendahara->Sortable = TRUE; // Allow sort
		$this->fields['nip_bendahara'] = &$this->nip_bendahara;

		// tgl_spp
		$this->tgl_spp = new cField('vw_spp_pengembalian_penerimaan', 'vw_spp_pengembalian_penerimaan', 'x_tgl_spp', 'tgl_spp', '`tgl_spp`', ew_CastDateFieldForLike('`tgl_spp`', 7, "DB"), 135, 7, FALSE, '`tgl_spp`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// kode_rekening
		$this->kode_rekening = new cField('vw_spp_pengembalian_penerimaan', 'vw_spp_pengembalian_penerimaan', 'x_kode_rekening', 'kode_rekening', '`kode_rekening`', '`kode_rekening`', 200, -1, FALSE, '`kode_rekening`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->kode_rekening->Sortable = TRUE; // Allow sort
		$this->fields['kode_rekening'] = &$this->kode_rekening;

		// keterangan
		$this->keterangan = new cField('vw_spp_pengembalian_penerimaan', 'vw_spp_pengembalian_penerimaan', 'x_keterangan', 'keterangan', '`keterangan`', '`keterangan`', 201, -1, FALSE, '`keterangan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->keterangan->Sortable = TRUE; // Allow sort
		$this->fields['keterangan'] = &$this->keterangan;

		// tahun_anggaran
		$this->tahun_anggaran = new cField('vw_spp_pengembalian_penerimaan', 'vw_spp_pengembalian_penerimaan', 'x_tahun_anggaran', 'tahun_anggaran', '`tahun_anggaran`', '`tahun_anggaran`', 3, -1, FALSE, '`tahun_anggaran`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// id_spd
		$this->id_spd = new cField('vw_spp_pengembalian_penerimaan', 'vw_spp_pengembalian_penerimaan', 'x_id_spd', 'id_spd', '`id_spd`', '`id_spd`', 3, -1, FALSE, '`id_spd`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// tanggal_spd
		$this->tanggal_spd = new cField('vw_spp_pengembalian_penerimaan', 'vw_spp_pengembalian_penerimaan', 'x_tanggal_spd', 'tanggal_spd', '`tanggal_spd`', ew_CastDateFieldForLike('`tanggal_spd`', 0, "DB"), 135, 0, FALSE, '`tanggal_spd`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// nomer_dasar_spd
		$this->nomer_dasar_spd = new cField('vw_spp_pengembalian_penerimaan', 'vw_spp_pengembalian_penerimaan', 'x_nomer_dasar_spd', 'nomer_dasar_spd', '`nomer_dasar_spd`', '`nomer_dasar_spd`', 200, -1, FALSE, '`nomer_dasar_spd`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->nomer_dasar_spd->Sortable = TRUE; // Allow sort
		$this->fields['nomer_dasar_spd'] = &$this->nomer_dasar_spd;

		// jumlah_spd
		$this->jumlah_spd = new cField('vw_spp_pengembalian_penerimaan', 'vw_spp_pengembalian_penerimaan', 'x_jumlah_spd', 'jumlah_spd', '`jumlah_spd`', '`jumlah_spd`', 5, -1, FALSE, '`jumlah_spd`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function GetDetailUrl() {
		...
		// Detail url
		$sDetailUrl = "";
		if ($this->getCurrentDetailTable() == "vw_spp_pengembalian_penerimaan_detail_belanja") {
			$sDetailUrl = $GLOBALS["vw_spp_pengembalian_penerimaan_detail_belanja"]->GetListUrl() . "?" . EW_TABLE_SHOW_MASTER . "=" . $this->TableVar;
			...
			$sDetailUrl .= "&fk_kode_sub_kegiatan=" . urlencode($this->kode_sub_kegiatan->CurrentValue);
			$sDetailUrl .= "&fk_tahun_anggaran=" . urlencode($this->tahun_anggaran->CurrentValue);
		}
		if ($sDetailUrl == "") {
			$sDetailUrl = "vw_spp_pengembalian_penerimaanlist.php";
		}
		return $sDetailUrl;
	}
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`vw_spp_pengembalian_penerimaan`";
	}
	...
	function getSqlWhere() { // Where
		...
		$this->TableFilter = "`detail_jenis_spp`=10";
	...
	function Update(&$rs, $where = "", $rsold = NULL, $curfilter = TRUE) {
		...
		// Cascade Update detail table 'vw_spp_pengembalian_penerimaan_detail_belanja'
		...
		if (!is_null($rsold) && (isset($rs['kode_sub_kegiatan']) && $rsold['kode_sub_kegiatan'] <> $rs['kode_sub_kegiatan'])) { // Update detail field 'sub_kegiatan'
			$bCascadeUpdate = TRUE;
			$rscascade['sub_kegiatan'] = $rs['kode_sub_kegiatan']; 
		}
		...
		if ($bCascadeUpdate) {
			if (!isset($GLOBALS["vw_spp_pengembalian_penerimaan_detail_belanja"])) $GLOBALS["vw_spp_pengembalian_penerimaan_detail_belanja"] = new cvw_spp_pengembalian_penerimaan_detail_belanja();
			$rswrk = $GLOBALS["vw_spp_pengembalian_penerimaan_detail_belanja"]->LoadRs("`id_spp` = " . ew_QuotedValue($rsold['id'], EW_DATATYPE_NUMBER, 'DB') . " AND " . "`id_jenis_spp` = " . ew_QuotedValue($rsold['id_jenis_spp'], EW_DATATYPE_NUMBER, 'DB') . " AND " . "`detail_jenis_spp` = " . ew_QuotedValue($rsold['detail_jenis_spp'], EW_DATATYPE_NUMBER, 'DB') . " AND " . "`no_spp` = " . ew_QuotedValue($rsold['no_spp'], EW_DATATYPE_STRING, 'DB') . " AND " . "`program` = " . ew_QuotedValue($rsold['kode_program'], EW_DATATYPE_STRING, 'DB') . " AND " . "`kegiatan` = " . ew_QuotedValue($rsold['kode_kegiatan'], EW_DATATYPE_STRING, 'DB') . " AND " . "`sub_kegiatan` = " . ew_QuotedValue($rsold['kode_sub_kegiatan'], EW_DATATYPE_STRING, 'DB') . " AND " . "`tahun_anggaran` = " . ew_QuotedValue($rsold['tahun_anggaran'], EW_DATATYPE_NUMBER, 'DB')); 
			while ($rswrk && !$rswrk->EOF) {
				$rskey = array();
				$fldname = 'id';
				$rskey[$fldname] = $rswrk->fields[$fldname];
				$bUpdate = $GLOBALS["vw_spp_pengembalian_penerimaan_detail_belanja"]->Update($rscascade, $rskey, $rswrk->fields);
	...
	function Delete(&$rs, $where = "", $curfilter = TRUE) {
		...
		// Cascade delete detail table 'vw_spp_pengembalian_penerimaan_detail_belanja'
		if (!isset($GLOBALS["vw_spp_pengembalian_penerimaan_detail_belanja"])) $GLOBALS["vw_spp_pengembalian_penerimaan_detail_belanja"] = new cvw_spp_pengembalian_penerimaan_detail_belanja();
		$rscascade = $GLOBALS["vw_spp_pengembalian_penerimaan_detail_belanja"]->LoadRs("`id_spp` = " . ew_QuotedValue($rs['id'], EW_DATATYPE_NUMBER, "DB") . " AND " . "`id_jenis_spp` = " . ew_QuotedValue($rs['id_jenis_spp'], EW_DATATYPE_NUMBER, "DB") . " AND " . "`detail_jenis_spp` = " . ew_QuotedValue($rs['detail_jenis_spp'], EW_DATATYPE_NUMBER, "DB") . " AND " . "`no_spp` = " . ew_QuotedValue($rs['no_spp'], EW_DATATYPE_STRING, "DB") . " AND " . "`program` = " . ew_QuotedValue($rs['kode_program'], EW_DATATYPE_STRING, "DB") . " AND " . "`kegiatan` = " . ew_QuotedValue($rs['kode_kegiatan'], EW_DATATYPE_STRING, "DB") . " AND " . "`sub_kegiatan` = " . ew_QuotedValue($rs['kode_sub_kegiatan'], EW_DATATYPE_STRING, "DB") . " AND " . "`tahun_anggaran` = " . ew_QuotedValue($rs['tahun_anggaran'], EW_DATATYPE_NUMBER, "DB")); 
		while ($rscascade && !$rscascade->EOF) {
			$GLOBALS["vw_spp_pengembalian_penerimaan_detail_belanja"]->Delete($rscascade->fields);
			$rscascade->MoveNext();
		}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "vw_spp_pengembalian_penerimaanlist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("vw_spp_pengembalian_penerimaanview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("vw_spp_pengembalian_penerimaanview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "vw_spp_pengembalian_penerimaanadd.php?" . $this->UrlParm($parm);
		else
			$url = "vw_spp_pengembalian_penerimaanadd.php";
		return $this->AddMasterUrl($url);
	}
	...
	function GetEditUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("vw_spp_pengembalian_penerimaanedit.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("vw_spp_pengembalian_penerimaanedit.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("vw_spp_pengembalian_penerimaanadd.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("vw_spp_pengembalian_penerimaanadd.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("vw_spp_pengembalian_penerimaandelete.php", $this->UrlParm());
	}
   ...
   // Common render codes
	...
	function Row_Inserting($rsold, &$rsnew) {
		...
		$rsnew["no_spp"] = GetNextNomerSPP_PP();
		$rsnew["id_spd"] = ew_ExecuteScalar("SELECT id FROM t_spd  order by id DESC LIMIT 1");
		$rsnew["tanggal_spd"] = ew_ExecuteScalar("SELECT tanggal FROM t_spd  order by id DESC LIMIT 1");
		$rsnew["nomer_dasar_spd"] = ew_ExecuteScalar("SELECT no_spd FROM t_spd  order by id DESC LIMIT 1");
		$rsnew["jumlah_spd"] = ew_ExecuteScalar("SELECT jumlah_spd FROM t_spd  order by id DESC LIMIT 1");
		return TRUE;
	}
	...
	function Row_Rendered() {
		...
		//var_dump($this-><FieldName>);
			...
			$this->no_spp->CurrentValue = GetNextNomerSPP_PP(); // trik
