...
$vw_bill_ranap_detail_visite_farmasi_delete = NULL; // Initialize page object first

class cvw_bill_ranap_detail_visite_farmasi_delete extends cvw_bill_ranap_detail_visite_farmasi {
	...
	// Page object name
	var $PageObjName = 'vw_bill_ranap_detail_visite_farmasi_delete';
	...
	function Page_Main() {
		...
		if ($sFilter == "")
			$this->Page_Terminate("vw_bill_ranap_detail_visite_farmasilist.php"); // Prevent SQL injection, return to list

		// Set up filter (SQL WHHERE clause) and get return SQL
		// SQL constructor in vw_bill_ranap_detail_visite_farmasi class, vw_bill_ranap_detail_visite_farmasiinfo.php
		...
		if ($this->CurrentAction == "I") { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->Page_Terminate("vw_bill_ranap_detail_visite_farmasilist.php"); // Return to list
			}
		}
	}
...
// Create page object
if (!isset($vw_bill_ranap_detail_visite_farmasi_delete)) $vw_bill_ranap_detail_visite_farmasi_delete = new cvw_bill_ranap_detail_visite_farmasi_delete();

// Page init
$vw_bill_ranap_detail_visite_farmasi_delete->Page_Init();

// Page main
$vw_bill_ranap_detail_visite_farmasi_delete->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$vw_bill_ranap_detail_visite_farmasi_delete->Page_Render();
?>
...
var CurrentForm = fvw_bill_ranap_detail_visite_farmasidelete = new ew_Form("fvw_bill_ranap_detail_visite_farmasidelete", "delete");

// Form_CustomValidate event
fvw_bill_ranap_detail_visite_farmasidelete.Form_CustomValidate = 
...
fvw_bill_ranap_detail_visite_farmasidelete.ValidateRequired = true;
<?php } else { ?>
fvw_bill_ranap_detail_visite_farmasidelete.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fvw_bill_ranap_detail_visite_farmasidelete.Lists["x_kode_tindakan"] = {"LinkField":"x_kode","Ajax":true,"AutoFill":false,"DisplayFields":["x_nama_tindakan","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"vw_bill_ranap_data_tarif_tindakan"};
fvw_bill_ranap_detail_visite_farmasidelete.Lists["x_kode_farmasi"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_nama","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"m_farmasi"};
...
<?php $vw_bill_ranap_detail_visite_farmasi_delete->ShowPageHeader(); ?>
<?php
$vw_bill_ranap_detail_visite_farmasi_delete->ShowMessage();
?>
<form name="fvw_bill_ranap_detail_visite_farmasidelete" id="fvw_bill_ranap_detail_visite_farmasidelete" class="form-inline ewForm ewDeleteForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($vw_bill_ranap_detail_visite_farmasi_delete->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $vw_bill_ranap_detail_visite_farmasi_delete->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="vw_bill_ranap_detail_visite_farmasi">
<input type="hidden" name="a_delete" id="a_delete" value="D">
<?php foreach ($vw_bill_ranap_detail_visite_farmasi_delete->RecKeys as $key) { ?>
...
<?php if ($vw_bill_ranap_detail_visite_farmasi->tanggal->Visible) { // tanggal ?>
		<th><span id="elh_vw_bill_ranap_detail_visite_farmasi_tanggal" class="vw_bill_ranap_detail_visite_farmasi_tanggal"><?php echo $vw_bill_ranap_detail_visite_farmasi->tanggal->FldCaption() ?></span></th>
<?php } ?>
<?php if ($vw_bill_ranap_detail_visite_farmasi->kode_tindakan->Visible) { // kode_tindakan ?>
		<th><span id="elh_vw_bill_ranap_detail_visite_farmasi_kode_tindakan" class="vw_bill_ranap_detail_visite_farmasi_kode_tindakan"><?php echo $vw_bill_ranap_detail_visite_farmasi->kode_tindakan->FldCaption() ?></span></th>
<?php } ?>
<?php if ($vw_bill_ranap_detail_visite_farmasi->kode_farmasi->Visible) { // kode_farmasi ?>
		<th><span id="elh_vw_bill_ranap_detail_visite_farmasi_kode_farmasi" class="vw_bill_ranap_detail_visite_farmasi_kode_farmasi"><?php echo $vw_bill_ranap_detail_visite_farmasi->kode_farmasi->FldCaption() ?></span></th>
<?php } ?>
<?php if ($vw_bill_ranap_detail_visite_farmasi->qty->Visible) { // qty ?>
		<th><span id="elh_vw_bill_ranap_detail_visite_farmasi_qty" class="vw_bill_ranap_detail_visite_farmasi_qty"><?php echo $vw_bill_ranap_detail_visite_farmasi->qty->FldCaption() ?></span></th>
<?php } ?>
<?php if ($vw_bill_ranap_detail_visite_farmasi->tarif->Visible) { // tarif ?>
		<th><span id="elh_vw_bill_ranap_detail_visite_farmasi_tarif" class="vw_bill_ranap_detail_visite_farmasi_tarif"><?php echo $vw_bill_ranap_detail_visite_farmasi->tarif->FldCaption() ?></span></th>
<?php } ?>
<?php if ($vw_bill_ranap_detail_visite_farmasi->bhp->Visible) { // bhp ?>
		<th><span id="elh_vw_bill_ranap_detail_visite_farmasi_bhp" class="vw_bill_ranap_detail_visite_farmasi_bhp"><?php echo $vw_bill_ranap_detail_visite_farmasi->bhp->FldCaption() ?></span></th>
<?php } ?>
<?php if ($vw_bill_ranap_detail_visite_farmasi->nama_tindakan->Visible) { // nama_tindakan ?>
		<th><span id="elh_vw_bill_ranap_detail_visite_farmasi_nama_tindakan" class="vw_bill_ranap_detail_visite_farmasi_nama_tindakan"><?php echo $vw_bill_ranap_detail_visite_farmasi->nama_tindakan->FldCaption() ?></span></th>
<?php } ?>
<?php if ($vw_bill_ranap_detail_visite_farmasi->user->Visible) { // user ?>
		<th><span id="elh_vw_bill_ranap_detail_visite_farmasi_user" class="vw_bill_ranap_detail_visite_farmasi_user"><?php echo $vw_bill_ranap_detail_visite_farmasi->user->FldCaption() ?></span></th>
<?php } ?>
<?php if ($vw_bill_ranap_detail_visite_farmasi->no_ruang->Visible) { // no_ruang ?>
		<th><span id="elh_vw_bill_ranap_detail_visite_farmasi_no_ruang" class="vw_bill_ranap_detail_visite_farmasi_no_ruang"><?php echo $vw_bill_ranap_detail_visite_farmasi->no_ruang->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
<?php
$vw_bill_ranap_detail_visite_farmasi_delete->RecCnt = 0;
$i = 0;
while (!$vw_bill_ranap_detail_visite_farmasi_delete->Recordset->EOF) {
	$vw_bill_ranap_detail_visite_farmasi_delete->RecCnt++;
	$vw_bill_ranap_detail_visite_farmasi_delete->RowCnt++;

	// Set row properties
	$vw_bill_ranap_detail_visite_farmasi->ResetAttrs();
	$vw_bill_ranap_detail_visite_farmasi->RowType = EW_ROWTYPE_VIEW; // View

	// Get the field contents
	$vw_bill_ranap_detail_visite_farmasi_delete->LoadRowValues($vw_bill_ranap_detail_visite_farmasi_delete->Recordset);

	// Render row
	$vw_bill_ranap_detail_visite_farmasi_delete->RenderRow();
?>
	<tr<?php echo $vw_bill_ranap_detail_visite_farmasi->RowAttributes() ?>>
<?php if ($vw_bill_ranap_detail_visite_farmasi->tanggal->Visible) { // tanggal ?>
		<td<?php echo $vw_bill_ranap_detail_visite_farmasi->tanggal->CellAttributes() ?>>
<span id="el<?php echo $vw_bill_ranap_detail_visite_farmasi_delete->RowCnt ?>_vw_bill_ranap_detail_visite_farmasi_tanggal" class="vw_bill_ranap_detail_visite_farmasi_tanggal">
...
<?php } ?>
<?php if ($vw_bill_ranap_detail_visite_farmasi->kode_tindakan->Visible) { // kode_tindakan ?>
		<td<?php echo $vw_bill_ranap_detail_visite_farmasi->kode_tindakan->CellAttributes() ?>>
<span id="el<?php echo $vw_bill_ranap_detail_visite_farmasi_delete->RowCnt ?>_vw_bill_ranap_detail_visite_farmasi_kode_tindakan" class="vw_bill_ranap_detail_visite_farmasi_kode_tindakan">
...
<?php } ?>
<?php if ($vw_bill_ranap_detail_visite_farmasi->kode_farmasi->Visible) { // kode_farmasi ?>
		<td<?php echo $vw_bill_ranap_detail_visite_farmasi->kode_farmasi->CellAttributes() ?>>
<span id="el<?php echo $vw_bill_ranap_detail_visite_farmasi_delete->RowCnt ?>_vw_bill_ranap_detail_visite_farmasi_kode_farmasi" class="vw_bill_ranap_detail_visite_farmasi_kode_farmasi">
...
<?php } ?>
<?php if ($vw_bill_ranap_detail_visite_farmasi->qty->Visible) { // qty ?>
		<td<?php echo $vw_bill_ranap_detail_visite_farmasi->qty->CellAttributes() ?>>
<span id="el<?php echo $vw_bill_ranap_detail_visite_farmasi_delete->RowCnt ?>_vw_bill_ranap_detail_visite_farmasi_qty" class="vw_bill_ranap_detail_visite_farmasi_qty">
...
<?php } ?>
<?php if ($vw_bill_ranap_detail_visite_farmasi->tarif->Visible) { // tarif ?>
		<td<?php echo $vw_bill_ranap_detail_visite_farmasi->tarif->CellAttributes() ?>>
<span id="el<?php echo $vw_bill_ranap_detail_visite_farmasi_delete->RowCnt ?>_vw_bill_ranap_detail_visite_farmasi_tarif" class="vw_bill_ranap_detail_visite_farmasi_tarif">
...
<?php } ?>
<?php if ($vw_bill_ranap_detail_visite_farmasi->bhp->Visible) { // bhp ?>
		<td<?php echo $vw_bill_ranap_detail_visite_farmasi->bhp->CellAttributes() ?>>
<span id="el<?php echo $vw_bill_ranap_detail_visite_farmasi_delete->RowCnt ?>_vw_bill_ranap_detail_visite_farmasi_bhp" class="vw_bill_ranap_detail_visite_farmasi_bhp">
...
<?php } ?>
<?php if ($vw_bill_ranap_detail_visite_farmasi->nama_tindakan->Visible) { // nama_tindakan ?>
		<td<?php echo $vw_bill_ranap_detail_visite_farmasi->nama_tindakan->CellAttributes() ?>>
<span id="el<?php echo $vw_bill_ranap_detail_visite_farmasi_delete->RowCnt ?>_vw_bill_ranap_detail_visite_farmasi_nama_tindakan" class="vw_bill_ranap_detail_visite_farmasi_nama_tindakan">
...
<?php } ?>
<?php if ($vw_bill_ranap_detail_visite_farmasi->user->Visible) { // user ?>
		<td<?php echo $vw_bill_ranap_detail_visite_farmasi->user->CellAttributes() ?>>
<span id="el<?php echo $vw_bill_ranap_detail_visite_farmasi_delete->RowCnt ?>_vw_bill_ranap_detail_visite_farmasi_user" class="vw_bill_ranap_detail_visite_farmasi_user">
...
<?php } ?>
<?php if ($vw_bill_ranap_detail_visite_farmasi->no_ruang->Visible) { // no_ruang ?>
		<td<?php echo $vw_bill_ranap_detail_visite_farmasi->no_ruang->CellAttributes() ?>>
<span id="el<?php echo $vw_bill_ranap_detail_visite_farmasi_delete->RowCnt ?>_vw_bill_ranap_detail_visite_farmasi_no_ruang" class="vw_bill_ranap_detail_visite_farmasi_no_ruang">
...
<?php
	$vw_bill_ranap_detail_visite_farmasi_delete->Recordset->MoveNext();
}
$vw_bill_ranap_detail_visite_farmasi_delete->Recordset->Close();
?>
</tbody>
</table>
</div>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $vw_bill_ranap_detail_visite_farmasi_delete->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
</div>
</form>
<script type="text/javascript">
fvw_bill_ranap_detail_visite_farmasidelete.Init();
</script>
<?php
$vw_bill_ranap_detail_visite_farmasi_delete->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$vw_bill_ranap_detail_visite_farmasi_delete->Page_Terminate();
?>
