...
$vw_bill_ranap_detail_tmno_delete = NULL; // Initialize page object first

class cvw_bill_ranap_detail_tmno_delete extends cvw_bill_ranap_detail_tmno {
	...
	// Page object name
	var $PageObjName = 'vw_bill_ranap_detail_tmno_delete';
	...
	function Page_Main() {
		...
		if ($sFilter == "")
			$this->Page_Terminate("vw_bill_ranap_detail_tmnolist.php"); // Prevent SQL injection, return to list

		// Set up filter (SQL WHHERE clause) and get return SQL
		// SQL constructor in vw_bill_ranap_detail_tmno class, vw_bill_ranap_detail_tmnoinfo.php
		...
		if ($this->CurrentAction == "I") { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->Page_Terminate("vw_bill_ranap_detail_tmnolist.php"); // Return to list
			}
		}
	}
...
// Create page object
if (!isset($vw_bill_ranap_detail_tmno_delete)) $vw_bill_ranap_detail_tmno_delete = new cvw_bill_ranap_detail_tmno_delete();

// Page init
$vw_bill_ranap_detail_tmno_delete->Page_Init();

// Page main
$vw_bill_ranap_detail_tmno_delete->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$vw_bill_ranap_detail_tmno_delete->Page_Render();
?>
...
var CurrentForm = fvw_bill_ranap_detail_tmnodelete = new ew_Form("fvw_bill_ranap_detail_tmnodelete", "delete");

// Form_CustomValidate event
fvw_bill_ranap_detail_tmnodelete.Form_CustomValidate = 
...
fvw_bill_ranap_detail_tmnodelete.ValidateRequired = true;
<?php } else { ?>
fvw_bill_ranap_detail_tmnodelete.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fvw_bill_ranap_detail_tmnodelete.Lists["x_kode_tindakan"] = {"LinkField":"x_kode","Ajax":true,"AutoFill":false,"DisplayFields":["x_nama_tindakan","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"vw_bill_ranap_data_tarif_tindakan"};
fvw_bill_ranap_detail_tmnodelete.Lists["x_kode_dokter"] = {"LinkField":"x_kd_dokter","Ajax":true,"AutoFill":false,"DisplayFields":["x_NAMADOKTER","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"vw_dokter_jaga_ranap"};
...
<?php $vw_bill_ranap_detail_tmno_delete->ShowPageHeader(); ?>
<?php
$vw_bill_ranap_detail_tmno_delete->ShowMessage();
?>
<form name="fvw_bill_ranap_detail_tmnodelete" id="fvw_bill_ranap_detail_tmnodelete" class="form-inline ewForm ewDeleteForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($vw_bill_ranap_detail_tmno_delete->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $vw_bill_ranap_detail_tmno_delete->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="vw_bill_ranap_detail_tmno">
<input type="hidden" name="a_delete" id="a_delete" value="D">
<?php foreach ($vw_bill_ranap_detail_tmno_delete->RecKeys as $key) { ?>
...
<?php if ($vw_bill_ranap_detail_tmno->tanggal->Visible) { // tanggal ?>
		<th><span id="elh_vw_bill_ranap_detail_tmno_tanggal" class="vw_bill_ranap_detail_tmno_tanggal"><?php echo $vw_bill_ranap_detail_tmno->tanggal->FldCaption() ?></span></th>
<?php } ?>
<?php if ($vw_bill_ranap_detail_tmno->kode_tindakan->Visible) { // kode_tindakan ?>
		<th><span id="elh_vw_bill_ranap_detail_tmno_kode_tindakan" class="vw_bill_ranap_detail_tmno_kode_tindakan"><?php echo $vw_bill_ranap_detail_tmno->kode_tindakan->FldCaption() ?></span></th>
<?php } ?>
<?php if ($vw_bill_ranap_detail_tmno->kode_dokter->Visible) { // kode_dokter ?>
		<th><span id="elh_vw_bill_ranap_detail_tmno_kode_dokter" class="vw_bill_ranap_detail_tmno_kode_dokter"><?php echo $vw_bill_ranap_detail_tmno->kode_dokter->FldCaption() ?></span></th>
<?php } ?>
<?php if ($vw_bill_ranap_detail_tmno->qty->Visible) { // qty ?>
		<th><span id="elh_vw_bill_ranap_detail_tmno_qty" class="vw_bill_ranap_detail_tmno_qty"><?php echo $vw_bill_ranap_detail_tmno->qty->FldCaption() ?></span></th>
<?php } ?>
<?php if ($vw_bill_ranap_detail_tmno->tarif->Visible) { // tarif ?>
		<th><span id="elh_vw_bill_ranap_detail_tmno_tarif" class="vw_bill_ranap_detail_tmno_tarif"><?php echo $vw_bill_ranap_detail_tmno->tarif->FldCaption() ?></span></th>
<?php } ?>
<?php if ($vw_bill_ranap_detail_tmno->bhp->Visible) { // bhp ?>
		<th><span id="elh_vw_bill_ranap_detail_tmno_bhp" class="vw_bill_ranap_detail_tmno_bhp"><?php echo $vw_bill_ranap_detail_tmno->bhp->FldCaption() ?></span></th>
<?php } ?>
<?php if ($vw_bill_ranap_detail_tmno->user->Visible) { // user ?>
		<th><span id="elh_vw_bill_ranap_detail_tmno_user" class="vw_bill_ranap_detail_tmno_user"><?php echo $vw_bill_ranap_detail_tmno->user->FldCaption() ?></span></th>
<?php } ?>
<?php if ($vw_bill_ranap_detail_tmno->no_ruang->Visible) { // no_ruang ?>
		<th><span id="elh_vw_bill_ranap_detail_tmno_no_ruang" class="vw_bill_ranap_detail_tmno_no_ruang"><?php echo $vw_bill_ranap_detail_tmno->no_ruang->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
<?php
$vw_bill_ranap_detail_tmno_delete->RecCnt = 0;
$i = 0;
while (!$vw_bill_ranap_detail_tmno_delete->Recordset->EOF) {
	$vw_bill_ranap_detail_tmno_delete->RecCnt++;
	$vw_bill_ranap_detail_tmno_delete->RowCnt++;

	// Set row properties
	$vw_bill_ranap_detail_tmno->ResetAttrs();
	$vw_bill_ranap_detail_tmno->RowType = EW_ROWTYPE_VIEW; // View

	// Get the field contents
	$vw_bill_ranap_detail_tmno_delete->LoadRowValues($vw_bill_ranap_detail_tmno_delete->Recordset);

	// Render row
	$vw_bill_ranap_detail_tmno_delete->RenderRow();
?>
	<tr<?php echo $vw_bill_ranap_detail_tmno->RowAttributes() ?>>
<?php if ($vw_bill_ranap_detail_tmno->tanggal->Visible) { // tanggal ?>
		<td<?php echo $vw_bill_ranap_detail_tmno->tanggal->CellAttributes() ?>>
<span id="el<?php echo $vw_bill_ranap_detail_tmno_delete->RowCnt ?>_vw_bill_ranap_detail_tmno_tanggal" class="vw_bill_ranap_detail_tmno_tanggal">
...
<?php } ?>
<?php if ($vw_bill_ranap_detail_tmno->kode_tindakan->Visible) { // kode_tindakan ?>
		<td<?php echo $vw_bill_ranap_detail_tmno->kode_tindakan->CellAttributes() ?>>
<span id="el<?php echo $vw_bill_ranap_detail_tmno_delete->RowCnt ?>_vw_bill_ranap_detail_tmno_kode_tindakan" class="vw_bill_ranap_detail_tmno_kode_tindakan">
...
<?php } ?>
<?php if ($vw_bill_ranap_detail_tmno->kode_dokter->Visible) { // kode_dokter ?>
		<td<?php echo $vw_bill_ranap_detail_tmno->kode_dokter->CellAttributes() ?>>
<span id="el<?php echo $vw_bill_ranap_detail_tmno_delete->RowCnt ?>_vw_bill_ranap_detail_tmno_kode_dokter" class="vw_bill_ranap_detail_tmno_kode_dokter">
...
<?php } ?>
<?php if ($vw_bill_ranap_detail_tmno->qty->Visible) { // qty ?>
		<td<?php echo $vw_bill_ranap_detail_tmno->qty->CellAttributes() ?>>
<span id="el<?php echo $vw_bill_ranap_detail_tmno_delete->RowCnt ?>_vw_bill_ranap_detail_tmno_qty" class="vw_bill_ranap_detail_tmno_qty">
...
<?php } ?>
<?php if ($vw_bill_ranap_detail_tmno->tarif->Visible) { // tarif ?>
		<td<?php echo $vw_bill_ranap_detail_tmno->tarif->CellAttributes() ?>>
<span id="el<?php echo $vw_bill_ranap_detail_tmno_delete->RowCnt ?>_vw_bill_ranap_detail_tmno_tarif" class="vw_bill_ranap_detail_tmno_tarif">
...
<?php } ?>
<?php if ($vw_bill_ranap_detail_tmno->bhp->Visible) { // bhp ?>
		<td<?php echo $vw_bill_ranap_detail_tmno->bhp->CellAttributes() ?>>
<span id="el<?php echo $vw_bill_ranap_detail_tmno_delete->RowCnt ?>_vw_bill_ranap_detail_tmno_bhp" class="vw_bill_ranap_detail_tmno_bhp">
...
<?php } ?>
<?php if ($vw_bill_ranap_detail_tmno->user->Visible) { // user ?>
		<td<?php echo $vw_bill_ranap_detail_tmno->user->CellAttributes() ?>>
<span id="el<?php echo $vw_bill_ranap_detail_tmno_delete->RowCnt ?>_vw_bill_ranap_detail_tmno_user" class="vw_bill_ranap_detail_tmno_user">
...
<?php } ?>
<?php if ($vw_bill_ranap_detail_tmno->no_ruang->Visible) { // no_ruang ?>
		<td<?php echo $vw_bill_ranap_detail_tmno->no_ruang->CellAttributes() ?>>
<span id="el<?php echo $vw_bill_ranap_detail_tmno_delete->RowCnt ?>_vw_bill_ranap_detail_tmno_no_ruang" class="vw_bill_ranap_detail_tmno_no_ruang">
...
<?php
	$vw_bill_ranap_detail_tmno_delete->Recordset->MoveNext();
}
$vw_bill_ranap_detail_tmno_delete->Recordset->Close();
?>
</tbody>
</table>
</div>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $vw_bill_ranap_detail_tmno_delete->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
</div>
</form>
<script type="text/javascript">
fvw_bill_ranap_detail_tmnodelete.Init();
</script>
<?php
$vw_bill_ranap_detail_tmno_delete->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$vw_bill_ranap_detail_tmno_delete->Page_Terminate();
?>
