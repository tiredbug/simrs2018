...
$vw_bill_ranap_detail_konsul_dokter_add = NULL; // Initialize page object first

class cvw_bill_ranap_detail_konsul_dokter_add extends cvw_bill_ranap_detail_konsul_dokter {
	...
	// Page object name
	var $PageObjName = 'vw_bill_ranap_detail_konsul_dokter_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "vw_bill_ranap_detail_konsul_dokterview.php")
...
// Create page object
if (!isset($vw_bill_ranap_detail_konsul_dokter_add)) $vw_bill_ranap_detail_konsul_dokter_add = new cvw_bill_ranap_detail_konsul_dokter_add();

// Page init
$vw_bill_ranap_detail_konsul_dokter_add->Page_Init();

// Page main
$vw_bill_ranap_detail_konsul_dokter_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$vw_bill_ranap_detail_konsul_dokter_add->Page_Render();
?>
...
var CurrentForm = fvw_bill_ranap_detail_konsul_dokteradd = new ew_Form("fvw_bill_ranap_detail_konsul_dokteradd", "add");

// Validate form
fvw_bill_ranap_detail_konsul_dokteradd.Validate = function() {
...
fvw_bill_ranap_detail_konsul_dokteradd.Form_CustomValidate = 
...
fvw_bill_ranap_detail_konsul_dokteradd.ValidateRequired = true;
<?php } else { ?>
fvw_bill_ranap_detail_konsul_dokteradd.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fvw_bill_ranap_detail_konsul_dokteradd.Lists["x_kode_tindakan"] = {"LinkField":"x_kode","Ajax":true,"AutoFill":true,"DisplayFields":["x_nama_tindakan","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"vw_bill_ranap_data_tarif_tindakan"};
fvw_bill_ranap_detail_konsul_dokteradd.Lists["x_kode_dokter"] = {"LinkField":"x_kd_dokter","Ajax":true,"AutoFill":false,"DisplayFields":["x_NAMADOKTER","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"vw_dokter_jaga_ranap"};
...
<?php if (!$vw_bill_ranap_detail_konsul_dokter_add->IsModal) { ?>
<?php } ?>
<?php $vw_bill_ranap_detail_konsul_dokter_add->ShowPageHeader(); ?>
<?php
$vw_bill_ranap_detail_konsul_dokter_add->ShowMessage();
?>
<form name="fvw_bill_ranap_detail_konsul_dokteradd" id="fvw_bill_ranap_detail_konsul_dokteradd" class="<?php echo $vw_bill_ranap_detail_konsul_dokter_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($vw_bill_ranap_detail_konsul_dokter_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $vw_bill_ranap_detail_konsul_dokter_add->Token ?>">
<?php } ?>
...
<script type="text/javascript">
ew_CreateCalendar("fvw_bill_ranap_detail_konsul_dokteradd", "x_tanggal", 7);
</script>
<?php } ?>
</span>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $vw_bill_ranap_detail_konsul_dokter_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
fvw_bill_ranap_detail_konsul_dokteradd.Init();
</script>
<?php
$vw_bill_ranap_detail_konsul_dokter_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$vw_bill_ranap_detail_konsul_dokter_add->Page_Terminate();
?>
