...
$vw_bridging_sep_by_no_rujukan_list = NULL; // Initialize page object first

class cvw_bridging_sep_by_no_rujukan_list extends cvw_bridging_sep_by_no_rujukan {
	...
	// Page object name
	var $PageObjName = 'vw_bridging_sep_by_no_rujukan_list';

	// Grid form hidden field names
	var $FormName = 'fvw_bridging_sep_by_no_rujukanlist';
	...
	function __construct() {
		...
		$this->AddUrl = "vw_bridging_sep_by_no_rujukanadd.php";
		$this->InlineAddUrl = $this->PageUrl() . "a=add";
		$this->GridAddUrl = $this->PageUrl() . "a=gridadd";
		$this->GridEditUrl = $this->PageUrl() . "a=gridedit";
		$this->MultiDeleteUrl = "vw_bridging_sep_by_no_rujukandelete.php";
		$this->MultiUpdateUrl = "vw_bridging_sep_by_no_rujukanupdate.php";
		...
		$this->FilterOptions->TagClassName = "ewFilterOption fvw_bridging_sep_by_no_rujukanlistsrch";
	...
	function GetFilterList() {
		...
		if (EW_SEARCH_FILTER_OPTION == "Server") {
			$sSavedFilterList = isset($UserProfile) ? $UserProfile->GetSearchFilters(CurrentUserName(), "fvw_bridging_sep_by_no_rujukanlistsrch") : "";
		} else {
			$sSavedFilterList = "";
		}
		...
		$sFilterList = ew_Concat($sFilterList, $this->generate_sep->AdvancedSearch->ToJSON(), ","); // Field generate_sep
		...
		$sFilterList = ew_Concat($sFilterList, $this->mapingtransaksi->AdvancedSearch->ToJSON(), ","); // Field mapingtransaksi
		$sFilterList = ew_Concat($sFilterList, $this->bridging_by_no_rujukan->AdvancedSearch->ToJSON(), ","); // Field bridging_by_no_rujukan
		$sFilterList = ew_Concat($sFilterList, $this->bridging_rujukan_faskes_2->AdvancedSearch->ToJSON(), ","); // Field bridging_rujukan_faskes_2
	...
	function ProcessFilterList() {
		...
		if (@$_POST["ajax"] == "savefilters") { // Save filter request (Ajax)
			...
			$UserProfile->SetSearchFilters(CurrentUserName(), "fvw_bridging_sep_by_no_rujukanlistsrch", $filters);
	...
	function RestoreFilterList() {
		...
		// Field generate_sep
		$this->generate_sep->AdvancedSearch->SearchValue = @$filter["x_generate_sep"];
		$this->generate_sep->AdvancedSearch->SearchOperator = @$filter["z_generate_sep"];
		$this->generate_sep->AdvancedSearch->SearchCondition = @$filter["v_generate_sep"];
		$this->generate_sep->AdvancedSearch->SearchValue2 = @$filter["y_generate_sep"];
		$this->generate_sep->AdvancedSearch->SearchOperator2 = @$filter["w_generate_sep"];
		$this->generate_sep->AdvancedSearch->Save();
		...
		// Field mapingtransaksi
		$this->mapingtransaksi->AdvancedSearch->SearchValue = @$filter["x_mapingtransaksi"];
		$this->mapingtransaksi->AdvancedSearch->SearchOperator = @$filter["z_mapingtransaksi"];
		$this->mapingtransaksi->AdvancedSearch->SearchCondition = @$filter["v_mapingtransaksi"];
		$this->mapingtransaksi->AdvancedSearch->SearchValue2 = @$filter["y_mapingtransaksi"];
		$this->mapingtransaksi->AdvancedSearch->SearchOperator2 = @$filter["w_mapingtransaksi"];
		$this->mapingtransaksi->AdvancedSearch->Save();

		// Field bridging_by_no_rujukan
		$this->bridging_by_no_rujukan->AdvancedSearch->SearchValue = @$filter["x_bridging_by_no_rujukan"];
		$this->bridging_by_no_rujukan->AdvancedSearch->SearchOperator = @$filter["z_bridging_by_no_rujukan"];
		$this->bridging_by_no_rujukan->AdvancedSearch->SearchCondition = @$filter["v_bridging_by_no_rujukan"];
		$this->bridging_by_no_rujukan->AdvancedSearch->SearchValue2 = @$filter["y_bridging_by_no_rujukan"];
		$this->bridging_by_no_rujukan->AdvancedSearch->SearchOperator2 = @$filter["w_bridging_by_no_rujukan"];
		$this->bridging_by_no_rujukan->AdvancedSearch->Save();

		// Field bridging_rujukan_faskes_2
		$this->bridging_rujukan_faskes_2->AdvancedSearch->SearchValue = @$filter["x_bridging_rujukan_faskes_2"];
		$this->bridging_rujukan_faskes_2->AdvancedSearch->SearchOperator = @$filter["z_bridging_rujukan_faskes_2"];
		$this->bridging_rujukan_faskes_2->AdvancedSearch->SearchCondition = @$filter["v_bridging_rujukan_faskes_2"];
		$this->bridging_rujukan_faskes_2->AdvancedSearch->SearchValue2 = @$filter["y_bridging_rujukan_faskes_2"];
		$this->bridging_rujukan_faskes_2->AdvancedSearch->SearchOperator2 = @$filter["w_bridging_rujukan_faskes_2"];
		$this->bridging_rujukan_faskes_2->AdvancedSearch->Save();
	...
	function SetUpSortOrder() {
		...
		if (@$_GET["order"] <> "") {
			...
			$this->UpdateSort($this->NORUJUKAN_SEP, $bCtrl); // NORUJUKAN_SEP
	...
	function SetupOtherOptions() {
		...
		$item->Body = "<a class=\"ewSaveFilter\" data-form=\"fvw_bridging_sep_by_no_rujukanlistsrch\" href=\"#\">" . $Language->Phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->Add("deletefilter");
		$item->Body = "<a class=\"ewDeleteFilter\" data-form=\"fvw_bridging_sep_by_no_rujukanlistsrch\" href=\"#\">" . $Language->Phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
		...
		$options = &$this->OtherOptions;
			...
			foreach ($this->ListActions->Items as $listaction) {
				if ($listaction->Select == EW_ACTION_MULTIPLE) {
					...
					$item->Body = "<a class=\"btn btn-xs btn-default line-2540\" title=\"" . ew_HtmlEncode($caption) . "\" data-caption=\"" . ew_HtmlEncode($caption) . "\" href=\"\" onclick=\"ew_SubmitAction(event,jQuery.extend({f:document.fvw_bridging_sep_by_no_rujukanlist}," . $listaction->ToJson(TRUE) . "));return false;\">" . $icon . "</a>";
	...
	function SetupSearchOptions() {
		...
		$item->Body = "<button type=\"button\" class=\"btn btn-default ewSearchToggle" . $SearchToggleClass . "\" title=\"" . $Language->Phrase("SearchPanel") . "\" data-caption=\"" . $Language->Phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"fvw_bridging_sep_by_no_rujukanlistsrch\">" . $Language->Phrase("SearchBtn") . "</button>";
		$item->Visible = TRUE;
...
// Create page object
if (!isset($vw_bridging_sep_by_no_rujukan_list)) $vw_bridging_sep_by_no_rujukan_list = new cvw_bridging_sep_by_no_rujukan_list();

// Page init
$vw_bridging_sep_by_no_rujukan_list->Page_Init();

// Page main
$vw_bridging_sep_by_no_rujukan_list->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$vw_bridging_sep_by_no_rujukan_list->Page_Render();
?>
...
var CurrentForm = fvw_bridging_sep_by_no_rujukanlist = new ew_Form("fvw_bridging_sep_by_no_rujukanlist", "list");
fvw_bridging_sep_by_no_rujukanlist.FormKeyCountName = '<?php echo $vw_bridging_sep_by_no_rujukan_list->FormKeyCountName ?>';

// Form_CustomValidate event
fvw_bridging_sep_by_no_rujukanlist.Form_CustomValidate = 
...
fvw_bridging_sep_by_no_rujukanlist.ValidateRequired = true;
<?php } else { ?>
fvw_bridging_sep_by_no_rujukanlist.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fvw_bridging_sep_by_no_rujukanlist.Lists["x_NOMR"] = {"LinkField":"x_NOMR","Ajax":true,"AutoFill":false,"DisplayFields":["x_NOMR","x_NAMA","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"m_pasien"};
fvw_bridging_sep_by_no_rujukanlist.Lists["x_KDCARABAYAR"] = {"LinkField":"x_KODE","Ajax":true,"AutoFill":false,"DisplayFields":["x_NAMA","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"m_carabayar"};

// Form object for search
var CurrentSearchForm = fvw_bridging_sep_by_no_rujukanlistsrch = new ew_Form("fvw_bridging_sep_by_no_rujukanlistsrch");
</script>
<script type="text/javascript">

// Write your client script here, no need to add script tags.
</script>
<?php if ($vw_bridging_sep_by_no_rujukan_list->TotalRecs > 0 && $vw_bridging_sep_by_no_rujukan_list->ExportOptions->Visible()) { ?>
<?php $vw_bridging_sep_by_no_rujukan_list->ExportOptions->Render("body") ?>
<?php } ?>
<?php if ($vw_bridging_sep_by_no_rujukan_list->SearchOptions->Visible()) { ?>
<?php $vw_bridging_sep_by_no_rujukan_list->SearchOptions->Render("body") ?>
<?php } ?>
<?php if ($vw_bridging_sep_by_no_rujukan_list->FilterOptions->Visible()) { ?>
<?php $vw_bridging_sep_by_no_rujukan_list->FilterOptions->Render("body") ?>
<?php } ?>
<div class="clearfix"></div>
<?php
	$bSelectLimit = $vw_bridging_sep_by_no_rujukan_list->UseSelectLimit;
	if ($bSelectLimit) {
		if ($vw_bridging_sep_by_no_rujukan_list->TotalRecs <= 0)
			$vw_bridging_sep_by_no_rujukan_list->TotalRecs = $vw_bridging_sep_by_no_rujukan->SelectRecordCount();
	} else {
		if (!$vw_bridging_sep_by_no_rujukan_list->Recordset && ($vw_bridging_sep_by_no_rujukan_list->Recordset = $vw_bridging_sep_by_no_rujukan_list->LoadRecordset()))
			$vw_bridging_sep_by_no_rujukan_list->TotalRecs = $vw_bridging_sep_by_no_rujukan_list->Recordset->RecordCount();
	}
	$vw_bridging_sep_by_no_rujukan_list->StartRec = 1;
	if ($vw_bridging_sep_by_no_rujukan_list->DisplayRecs <= 0 || ($vw_bridging_sep_by_no_rujukan->Export <> "" && $vw_bridging_sep_by_no_rujukan->ExportAll)) // Display all records
		$vw_bridging_sep_by_no_rujukan_list->DisplayRecs = $vw_bridging_sep_by_no_rujukan_list->TotalRecs;
	if (!($vw_bridging_sep_by_no_rujukan->Export <> "" && $vw_bridging_sep_by_no_rujukan->ExportAll))
		$vw_bridging_sep_by_no_rujukan_list->SetUpStartRec(); // Set up start record position
	if ($bSelectLimit)
		$vw_bridging_sep_by_no_rujukan_list->Recordset = $vw_bridging_sep_by_no_rujukan_list->LoadRecordset($vw_bridging_sep_by_no_rujukan_list->StartRec-1, $vw_bridging_sep_by_no_rujukan_list->DisplayRecs);

	// Set no record found message
	if ($vw_bridging_sep_by_no_rujukan->CurrentAction == "" && $vw_bridging_sep_by_no_rujukan_list->TotalRecs == 0) {
		if (!$Security->CanList())
			$vw_bridging_sep_by_no_rujukan_list->setWarningMessage(ew_DeniedMsg());
		if ($vw_bridging_sep_by_no_rujukan_list->SearchWhere == "0=101")
			$vw_bridging_sep_by_no_rujukan_list->setWarningMessage($Language->Phrase("EnterSearchCriteria"));
		else
			$vw_bridging_sep_by_no_rujukan_list->setWarningMessage($Language->Phrase("NoRecord"));
	}

	// Audit trail on search
	if ($vw_bridging_sep_by_no_rujukan_list->AuditTrailOnSearch && $vw_bridging_sep_by_no_rujukan_list->Command == "search" && !$vw_bridging_sep_by_no_rujukan_list->RestoreSearch) {
		$searchparm = ew_ServerVar("QUERY_STRING");
		$searchsql = $vw_bridging_sep_by_no_rujukan_list->getSessionWhere();
		$vw_bridging_sep_by_no_rujukan_list->WriteAuditTrailOnSearch($searchparm, $searchsql);
	}
$vw_bridging_sep_by_no_rujukan_list->RenderOtherOptions();
?>
<?php if ($Security->CanSearch()) { ?>
<?php if ($vw_bridging_sep_by_no_rujukan->Export == "" && $vw_bridging_sep_by_no_rujukan->CurrentAction == "") { ?>
<form name="fvw_bridging_sep_by_no_rujukanlistsrch" id="fvw_bridging_sep_by_no_rujukanlistsrch" class="form-horizontal ewForm" action="<?php echo ew_CurrentPage() ?>">
<?php $SearchPanelClass = ($vw_bridging_sep_by_no_rujukan_list->SearchWhere <> "") ? " in" : " in"; ?>
<div id="fvw_bridging_sep_by_no_rujukanlistsrch_SearchPanel" class="box box-default collapse<?php echo $SearchPanelClass ?>">
<input type="hidden" name="cmd" value="search">
<input type="hidden" name="t" value="vw_bridging_sep_by_no_rujukan">
<div class="box-body">
<div id="xsr_1">
	<div class="ewQuickSearch input-group">
	<input type="text" name="<?php echo EW_TABLE_BASIC_SEARCH ?>" id="<?php echo EW_TABLE_BASIC_SEARCH ?>" class="form-control" value="<?php echo ew_HtmlEncode($vw_bridging_sep_by_no_rujukan_list->BasicSearch->getKeyword()) ?>" placeholder="<?php echo ew_HtmlEncode($Language->Phrase("Search")) ?>">
	<input type="hidden" name="<?php echo EW_TABLE_BASIC_SEARCH_TYPE ?>" id="<?php echo EW_TABLE_BASIC_SEARCH_TYPE ?>" value="<?php echo ew_HtmlEncode($vw_bridging_sep_by_no_rujukan_list->BasicSearch->getType()) ?>">
	<div class="input-group-btn">
		<button type="button" data-toggle="dropdown" class="btn btn-default"><span id="searchtype"><?php echo $vw_bridging_sep_by_no_rujukan_list->BasicSearch->getTypeNameShort() ?></span><span class="caret"></span></button>
		<ul class="dropdown-menu pull-right" role="menu">
			<li<?php if ($vw_bridging_sep_by_no_rujukan_list->BasicSearch->getType() == "") echo " class=\"active\""; ?>><a href="javascript:void(0);" onclick="ew_SetSearchType(this)"><?php echo $Language->Phrase("QuickSearchAuto") ?></a></li>
			<li<?php if ($vw_bridging_sep_by_no_rujukan_list->BasicSearch->getType() == "=") echo " class=\"active\""; ?>><a href="javascript:void(0);" onclick="ew_SetSearchType(this,'=')"><?php echo $Language->Phrase("QuickSearchExact") ?></a></li>
			<li<?php if ($vw_bridging_sep_by_no_rujukan_list->BasicSearch->getType() == "AND") echo " class=\"active\""; ?>><a href="javascript:void(0);" onclick="ew_SetSearchType(this,'AND')"><?php echo $Language->Phrase("QuickSearchAll") ?></a></li>
			<li<?php if ($vw_bridging_sep_by_no_rujukan_list->BasicSearch->getType() == "OR") echo " class=\"active\""; ?>><a href="javascript:void(0);" onclick="ew_SetSearchType(this,'OR')"><?php echo $Language->Phrase("QuickSearchAny") ?></a></li>
		</ul>
...
<?php } ?>
<?php } ?>
<?php $vw_bridging_sep_by_no_rujukan_list->ShowPageHeader(); ?>
<?php
$vw_bridging_sep_by_no_rujukan_list->ShowMessage();
?>
<?php if ($vw_bridging_sep_by_no_rujukan_list->TotalRecs > 0 || $vw_bridging_sep_by_no_rujukan->CurrentAction <> "") { ?>
<div class="panel panel-default ewGrid vw_bridging_sep_by_no_rujukan">
<form name="fvw_bridging_sep_by_no_rujukanlist" id="fvw_bridging_sep_by_no_rujukanlist" class="form-inline ewForm ewListForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($vw_bridging_sep_by_no_rujukan_list->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $vw_bridging_sep_by_no_rujukan_list->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="vw_bridging_sep_by_no_rujukan">
<div id="gmp_vw_bridging_sep_by_no_rujukan" class="<?php if (ew_IsResponsiveLayout()) { echo "table-responsive "; } ?>box box-primary">
<?php if ($vw_bridging_sep_by_no_rujukan_list->TotalRecs > 0 || $vw_bridging_sep_by_no_rujukan->CurrentAction == "gridedit") { ?>
<table id="tbl_vw_bridging_sep_by_no_rujukanlist" class="table ewTable table-bordered table-striped table-condensed table-hover">
<?php echo $vw_bridging_sep_by_no_rujukan->TableCustomInnerHtml ?>
<thead><!-- Table header -->
	<tr class="ewTableHeader">
<?php

// Header row
$vw_bridging_sep_by_no_rujukan_list->RowType = EW_ROWTYPE_HEADER;

// Render list options
$vw_bridging_sep_by_no_rujukan_list->RenderListOptions();

// Render list options (header, left)
$vw_bridging_sep_by_no_rujukan_list->ListOptions->Render("header", "left");
?>
<?php if ($vw_bridging_sep_by_no_rujukan->IDXDAFTAR->Visible) { // IDXDAFTAR ?>
	<?php if ($vw_bridging_sep_by_no_rujukan->SortUrl($vw_bridging_sep_by_no_rujukan->IDXDAFTAR) == "") { ?>
		<th data-name="IDXDAFTAR"><div id="elh_vw_bridging_sep_by_no_rujukan_IDXDAFTAR" class="vw_bridging_sep_by_no_rujukan_IDXDAFTAR"><div class="ewTableHeaderCaption"><?php echo $vw_bridging_sep_by_no_rujukan->IDXDAFTAR->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="IDXDAFTAR"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $vw_bridging_sep_by_no_rujukan->SortUrl($vw_bridging_sep_by_no_rujukan->IDXDAFTAR) ?>',2);"><div id="elh_vw_bridging_sep_by_no_rujukan_IDXDAFTAR" class="vw_bridging_sep_by_no_rujukan_IDXDAFTAR">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $vw_bridging_sep_by_no_rujukan->IDXDAFTAR->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($vw_bridging_sep_by_no_rujukan->IDXDAFTAR->getSort() == "ASC") { ?> <i class="fa fa-sort-amount-asc text-muted"></i><?php } elseif ($vw_bridging_sep_by_no_rujukan->IDXDAFTAR->getSort() == "DESC") { ?> <i class="fa fa-sort-amount-desc text-muted"></i><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($vw_bridging_sep_by_no_rujukan->NOMR->Visible) { // NOMR ?>
	<?php if ($vw_bridging_sep_by_no_rujukan->SortUrl($vw_bridging_sep_by_no_rujukan->NOMR) == "") { ?>
		<th data-name="NOMR"><div id="elh_vw_bridging_sep_by_no_rujukan_NOMR" class="vw_bridging_sep_by_no_rujukan_NOMR"><div class="ewTableHeaderCaption"><?php echo $vw_bridging_sep_by_no_rujukan->NOMR->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="NOMR"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $vw_bridging_sep_by_no_rujukan->SortUrl($vw_bridging_sep_by_no_rujukan->NOMR) ?>',2);"><div id="elh_vw_bridging_sep_by_no_rujukan_NOMR" class="vw_bridging_sep_by_no_rujukan_NOMR">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $vw_bridging_sep_by_no_rujukan->NOMR->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($vw_bridging_sep_by_no_rujukan->NOMR->getSort() == "ASC") { ?> <i class="fa fa-sort-amount-asc text-muted"></i><?php } elseif ($vw_bridging_sep_by_no_rujukan->NOMR->getSort() == "DESC") { ?> <i class="fa fa-sort-amount-desc text-muted"></i><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($vw_bridging_sep_by_no_rujukan->KDCARABAYAR->Visible) { // KDCARABAYAR ?>
	<?php if ($vw_bridging_sep_by_no_rujukan->SortUrl($vw_bridging_sep_by_no_rujukan->KDCARABAYAR) == "") { ?>
		<th data-name="KDCARABAYAR"><div id="elh_vw_bridging_sep_by_no_rujukan_KDCARABAYAR" class="vw_bridging_sep_by_no_rujukan_KDCARABAYAR"><div class="ewTableHeaderCaption"><?php echo $vw_bridging_sep_by_no_rujukan->KDCARABAYAR->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="KDCARABAYAR"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $vw_bridging_sep_by_no_rujukan->SortUrl($vw_bridging_sep_by_no_rujukan->KDCARABAYAR) ?>',2);"><div id="elh_vw_bridging_sep_by_no_rujukan_KDCARABAYAR" class="vw_bridging_sep_by_no_rujukan_KDCARABAYAR">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $vw_bridging_sep_by_no_rujukan->KDCARABAYAR->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($vw_bridging_sep_by_no_rujukan->KDCARABAYAR->getSort() == "ASC") { ?> <i class="fa fa-sort-amount-asc text-muted"></i><?php } elseif ($vw_bridging_sep_by_no_rujukan->KDCARABAYAR->getSort() == "DESC") { ?> <i class="fa fa-sort-amount-desc text-muted"></i><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($vw_bridging_sep_by_no_rujukan->NIP->Visible) { // NIP ?>
	<?php if ($vw_bridging_sep_by_no_rujukan->SortUrl($vw_bridging_sep_by_no_rujukan->NIP) == "") { ?>
		<th data-name="NIP"><div id="elh_vw_bridging_sep_by_no_rujukan_NIP" class="vw_bridging_sep_by_no_rujukan_NIP"><div class="ewTableHeaderCaption"><?php echo $vw_bridging_sep_by_no_rujukan->NIP->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="NIP"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $vw_bridging_sep_by_no_rujukan->SortUrl($vw_bridging_sep_by_no_rujukan->NIP) ?>',2);"><div id="elh_vw_bridging_sep_by_no_rujukan_NIP" class="vw_bridging_sep_by_no_rujukan_NIP">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $vw_bridging_sep_by_no_rujukan->NIP->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($vw_bridging_sep_by_no_rujukan->NIP->getSort() == "ASC") { ?> <i class="fa fa-sort-amount-asc text-muted"></i><?php } elseif ($vw_bridging_sep_by_no_rujukan->NIP->getSort() == "DESC") { ?> <i class="fa fa-sort-amount-desc text-muted"></i><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($vw_bridging_sep_by_no_rujukan->JAMREG->Visible) { // JAMREG ?>
	<?php if ($vw_bridging_sep_by_no_rujukan->SortUrl($vw_bridging_sep_by_no_rujukan->JAMREG) == "") { ?>
		<th data-name="JAMREG"><div id="elh_vw_bridging_sep_by_no_rujukan_JAMREG" class="vw_bridging_sep_by_no_rujukan_JAMREG"><div class="ewTableHeaderCaption"><?php echo $vw_bridging_sep_by_no_rujukan->JAMREG->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="JAMREG"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $vw_bridging_sep_by_no_rujukan->SortUrl($vw_bridging_sep_by_no_rujukan->JAMREG) ?>',2);"><div id="elh_vw_bridging_sep_by_no_rujukan_JAMREG" class="vw_bridging_sep_by_no_rujukan_JAMREG">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $vw_bridging_sep_by_no_rujukan->JAMREG->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($vw_bridging_sep_by_no_rujukan->JAMREG->getSort() == "ASC") { ?> <i class="fa fa-sort-amount-asc text-muted"></i><?php } elseif ($vw_bridging_sep_by_no_rujukan->JAMREG->getSort() == "DESC") { ?> <i class="fa fa-sort-amount-desc text-muted"></i><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($vw_bridging_sep_by_no_rujukan->NO_SJP->Visible) { // NO_SJP ?>
	<?php if ($vw_bridging_sep_by_no_rujukan->SortUrl($vw_bridging_sep_by_no_rujukan->NO_SJP) == "") { ?>
		<th data-name="NO_SJP"><div id="elh_vw_bridging_sep_by_no_rujukan_NO_SJP" class="vw_bridging_sep_by_no_rujukan_NO_SJP"><div class="ewTableHeaderCaption"><?php echo $vw_bridging_sep_by_no_rujukan->NO_SJP->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="NO_SJP"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $vw_bridging_sep_by_no_rujukan->SortUrl($vw_bridging_sep_by_no_rujukan->NO_SJP) ?>',2);"><div id="elh_vw_bridging_sep_by_no_rujukan_NO_SJP" class="vw_bridging_sep_by_no_rujukan_NO_SJP">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $vw_bridging_sep_by_no_rujukan->NO_SJP->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($vw_bridging_sep_by_no_rujukan->NO_SJP->getSort() == "ASC") { ?> <i class="fa fa-sort-amount-asc text-muted"></i><?php } elseif ($vw_bridging_sep_by_no_rujukan->NO_SJP->getSort() == "DESC") { ?> <i class="fa fa-sort-amount-desc text-muted"></i><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($vw_bridging_sep_by_no_rujukan->NORUJUKAN_SEP->Visible) { // NORUJUKAN_SEP ?>
	<?php if ($vw_bridging_sep_by_no_rujukan->SortUrl($vw_bridging_sep_by_no_rujukan->NORUJUKAN_SEP) == "") { ?>
		<th data-name="NORUJUKAN_SEP"><div id="elh_vw_bridging_sep_by_no_rujukan_NORUJUKAN_SEP" class="vw_bridging_sep_by_no_rujukan_NORUJUKAN_SEP"><div class="ewTableHeaderCaption"><?php echo $vw_bridging_sep_by_no_rujukan->NORUJUKAN_SEP->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="NORUJUKAN_SEP"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $vw_bridging_sep_by_no_rujukan->SortUrl($vw_bridging_sep_by_no_rujukan->NORUJUKAN_SEP) ?>',2);"><div id="elh_vw_bridging_sep_by_no_rujukan_NORUJUKAN_SEP" class="vw_bridging_sep_by_no_rujukan_NORUJUKAN_SEP">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $vw_bridging_sep_by_no_rujukan->NORUJUKAN_SEP->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($vw_bridging_sep_by_no_rujukan->NORUJUKAN_SEP->getSort() == "ASC") { ?> <i class="fa fa-sort-amount-asc text-muted"></i><?php } elseif ($vw_bridging_sep_by_no_rujukan->NORUJUKAN_SEP->getSort() == "DESC") { ?> <i class="fa fa-sort-amount-desc text-muted"></i><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($vw_bridging_sep_by_no_rujukan->USER->Visible) { // USER ?>
	<?php if ($vw_bridging_sep_by_no_rujukan->SortUrl($vw_bridging_sep_by_no_rujukan->USER) == "") { ?>
		<th data-name="USER"><div id="elh_vw_bridging_sep_by_no_rujukan_USER" class="vw_bridging_sep_by_no_rujukan_USER"><div class="ewTableHeaderCaption"><?php echo $vw_bridging_sep_by_no_rujukan->USER->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="USER"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $vw_bridging_sep_by_no_rujukan->SortUrl($vw_bridging_sep_by_no_rujukan->USER) ?>',2);"><div id="elh_vw_bridging_sep_by_no_rujukan_USER" class="vw_bridging_sep_by_no_rujukan_USER">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $vw_bridging_sep_by_no_rujukan->USER->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($vw_bridging_sep_by_no_rujukan->USER->getSort() == "ASC") { ?> <i class="fa fa-sort-amount-asc text-muted"></i><?php } elseif ($vw_bridging_sep_by_no_rujukan->USER->getSort() == "DESC") { ?> <i class="fa fa-sort-amount-desc text-muted"></i><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php
...
$vw_bridging_sep_by_no_rujukan_list->ListOptions->Render("header", "right");
?>
	</tr>
</thead>
<tbody>
<?php
if ($vw_bridging_sep_by_no_rujukan->ExportAll && $vw_bridging_sep_by_no_rujukan->Export <> "") {
	$vw_bridging_sep_by_no_rujukan_list->StopRec = $vw_bridging_sep_by_no_rujukan_list->TotalRecs;
} else {

	// Set the last record to display
	if ($vw_bridging_sep_by_no_rujukan_list->TotalRecs > $vw_bridging_sep_by_no_rujukan_list->StartRec + $vw_bridging_sep_by_no_rujukan_list->DisplayRecs - 1)
		$vw_bridging_sep_by_no_rujukan_list->StopRec = $vw_bridging_sep_by_no_rujukan_list->StartRec + $vw_bridging_sep_by_no_rujukan_list->DisplayRecs - 1;
	else
		$vw_bridging_sep_by_no_rujukan_list->StopRec = $vw_bridging_sep_by_no_rujukan_list->TotalRecs;
}
$vw_bridging_sep_by_no_rujukan_list->RecCnt = $vw_bridging_sep_by_no_rujukan_list->StartRec - 1;
if ($vw_bridging_sep_by_no_rujukan_list->Recordset && !$vw_bridging_sep_by_no_rujukan_list->Recordset->EOF) {
	$vw_bridging_sep_by_no_rujukan_list->Recordset->MoveFirst();
	$bSelectLimit = $vw_bridging_sep_by_no_rujukan_list->UseSelectLimit;
	if (!$bSelectLimit && $vw_bridging_sep_by_no_rujukan_list->StartRec > 1)
		$vw_bridging_sep_by_no_rujukan_list->Recordset->Move($vw_bridging_sep_by_no_rujukan_list->StartRec - 1);
} elseif (!$vw_bridging_sep_by_no_rujukan->AllowAddDeleteRow && $vw_bridging_sep_by_no_rujukan_list->StopRec == 0) {
	$vw_bridging_sep_by_no_rujukan_list->StopRec = $vw_bridging_sep_by_no_rujukan->GridAddRowCount;
}

// Initialize aggregate
$vw_bridging_sep_by_no_rujukan->RowType = EW_ROWTYPE_AGGREGATEINIT;
$vw_bridging_sep_by_no_rujukan->ResetAttrs();
$vw_bridging_sep_by_no_rujukan_list->RenderRow();
while ($vw_bridging_sep_by_no_rujukan_list->RecCnt < $vw_bridging_sep_by_no_rujukan_list->StopRec) {
	$vw_bridging_sep_by_no_rujukan_list->RecCnt++;
	if (intval($vw_bridging_sep_by_no_rujukan_list->RecCnt) >= intval($vw_bridging_sep_by_no_rujukan_list->StartRec)) {
		$vw_bridging_sep_by_no_rujukan_list->RowCnt++;

		// Set up key count
		$vw_bridging_sep_by_no_rujukan_list->KeyCount = $vw_bridging_sep_by_no_rujukan_list->RowIndex;

		// Init row class and style
		$vw_bridging_sep_by_no_rujukan->ResetAttrs();
		$vw_bridging_sep_by_no_rujukan->CssClass = "";
		if ($vw_bridging_sep_by_no_rujukan->CurrentAction == "gridadd") {
		} else {
			$vw_bridging_sep_by_no_rujukan_list->LoadRowValues($vw_bridging_sep_by_no_rujukan_list->Recordset); // Load row values
		}
		$vw_bridging_sep_by_no_rujukan->RowType = EW_ROWTYPE_VIEW; // Render view

		// Set up row id / data-rowindex
		$vw_bridging_sep_by_no_rujukan->RowAttrs = array_merge($vw_bridging_sep_by_no_rujukan->RowAttrs, array('data-rowindex'=>$vw_bridging_sep_by_no_rujukan_list->RowCnt, 'id'=>'r' . $vw_bridging_sep_by_no_rujukan_list->RowCnt . '_vw_bridging_sep_by_no_rujukan', 'data-rowtype'=>$vw_bridging_sep_by_no_rujukan->RowType));
		...
		$vw_bridging_sep_by_no_rujukan_list->RenderListOptions();
?>
	<tr<?php echo $vw_bridging_sep_by_no_rujukan->RowAttributes() ?>>
<?php

// Render list options (body, left)
$vw_bridging_sep_by_no_rujukan_list->ListOptions->Render("body", "left", $vw_bridging_sep_by_no_rujukan_list->RowCnt);
?>
	<?php if ($vw_bridging_sep_by_no_rujukan->IDXDAFTAR->Visible) { // IDXDAFTAR ?>
		<td data-name="IDXDAFTAR"<?php echo $vw_bridging_sep_by_no_rujukan->IDXDAFTAR->CellAttributes() ?>>
<div id="orig<?php echo $vw_bridging_sep_by_no_rujukan_list->RowCnt ?>_vw_bridging_sep_by_no_rujukan_IDXDAFTAR" class="hide">
<span id="el<?php echo $vw_bridging_sep_by_no_rujukan_list->RowCnt ?>_vw_bridging_sep_by_no_rujukan_IDXDAFTAR" class="vw_bridging_sep_by_no_rujukan_IDXDAFTAR">
<span<?php echo $vw_bridging_sep_by_no_rujukan->IDXDAFTAR->ViewAttributes() ?>>
<?php echo $vw_bridging_sep_by_no_rujukan->IDXDAFTAR->ListViewValue() ?></span>
</span>
</div>
<div class="btn-group">
	<button type="button" class="btn btn-success btn-xs"><span class="glyphicon glyphicon-print" aria-hidden="true"></span>   Menu</button>
		...
		<ul style="background:#605CA8" class="dropdown-menu" role="menu" >
			<li class="divider"></li>
			<li><a style="color:#ffffff" target="_self" href="vw_bridging_sep_by_no_rujukanedit.php?IDXDAFTAR=<?php echo urlencode(CurrentPage()->IDXDAFTAR->CurrentValue) ?>"><b>-  </b><b> Pembuatan Nomer SEP </b></a></li>
...
<a id="<?php echo $vw_bridging_sep_by_no_rujukan_list->PageObjName . "_row_" . $vw_bridging_sep_by_no_rujukan_list->RowCnt ?>"></a></td>
	<?php } ?>
	<?php if ($vw_bridging_sep_by_no_rujukan->NOMR->Visible) { // NOMR ?>
		<td data-name="NOMR"<?php echo $vw_bridging_sep_by_no_rujukan->NOMR->CellAttributes() ?>>
<span id="el<?php echo $vw_bridging_sep_by_no_rujukan_list->RowCnt ?>_vw_bridging_sep_by_no_rujukan_NOMR" class="vw_bridging_sep_by_no_rujukan_NOMR">
<span<?php echo $vw_bridging_sep_by_no_rujukan->NOMR->ViewAttributes() ?>>
<?php echo $vw_bridging_sep_by_no_rujukan->NOMR->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($vw_bridging_sep_by_no_rujukan->KDCARABAYAR->Visible) { // KDCARABAYAR ?>
		<td data-name="KDCARABAYAR"<?php echo $vw_bridging_sep_by_no_rujukan->KDCARABAYAR->CellAttributes() ?>>
<span id="el<?php echo $vw_bridging_sep_by_no_rujukan_list->RowCnt ?>_vw_bridging_sep_by_no_rujukan_KDCARABAYAR" class="vw_bridging_sep_by_no_rujukan_KDCARABAYAR">
<span<?php echo $vw_bridging_sep_by_no_rujukan->KDCARABAYAR->ViewAttributes() ?>>
<?php echo $vw_bridging_sep_by_no_rujukan->KDCARABAYAR->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($vw_bridging_sep_by_no_rujukan->NIP->Visible) { // NIP ?>
		<td data-name="NIP"<?php echo $vw_bridging_sep_by_no_rujukan->NIP->CellAttributes() ?>>
<span id="el<?php echo $vw_bridging_sep_by_no_rujukan_list->RowCnt ?>_vw_bridging_sep_by_no_rujukan_NIP" class="vw_bridging_sep_by_no_rujukan_NIP">
<span<?php echo $vw_bridging_sep_by_no_rujukan->NIP->ViewAttributes() ?>>
<?php echo $vw_bridging_sep_by_no_rujukan->NIP->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($vw_bridging_sep_by_no_rujukan->JAMREG->Visible) { // JAMREG ?>
		<td data-name="JAMREG"<?php echo $vw_bridging_sep_by_no_rujukan->JAMREG->CellAttributes() ?>>
<span id="el<?php echo $vw_bridging_sep_by_no_rujukan_list->RowCnt ?>_vw_bridging_sep_by_no_rujukan_JAMREG" class="vw_bridging_sep_by_no_rujukan_JAMREG">
<span<?php echo $vw_bridging_sep_by_no_rujukan->JAMREG->ViewAttributes() ?>>
<?php echo $vw_bridging_sep_by_no_rujukan->JAMREG->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($vw_bridging_sep_by_no_rujukan->NO_SJP->Visible) { // NO_SJP ?>
		<td data-name="NO_SJP"<?php echo $vw_bridging_sep_by_no_rujukan->NO_SJP->CellAttributes() ?>>
<span id="el<?php echo $vw_bridging_sep_by_no_rujukan_list->RowCnt ?>_vw_bridging_sep_by_no_rujukan_NO_SJP" class="vw_bridging_sep_by_no_rujukan_NO_SJP">
<span<?php echo $vw_bridging_sep_by_no_rujukan->NO_SJP->ViewAttributes() ?>>
<?php echo $vw_bridging_sep_by_no_rujukan->NO_SJP->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($vw_bridging_sep_by_no_rujukan->NORUJUKAN_SEP->Visible) { // NORUJUKAN_SEP ?>
		<td data-name="NORUJUKAN_SEP"<?php echo $vw_bridging_sep_by_no_rujukan->NORUJUKAN_SEP->CellAttributes() ?>>
<span id="el<?php echo $vw_bridging_sep_by_no_rujukan_list->RowCnt ?>_vw_bridging_sep_by_no_rujukan_NORUJUKAN_SEP" class="vw_bridging_sep_by_no_rujukan_NORUJUKAN_SEP">
<span<?php echo $vw_bridging_sep_by_no_rujukan->NORUJUKAN_SEP->ViewAttributes() ?>>
<?php echo $vw_bridging_sep_by_no_rujukan->NORUJUKAN_SEP->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($vw_bridging_sep_by_no_rujukan->USER->Visible) { // USER ?>
		<td data-name="USER"<?php echo $vw_bridging_sep_by_no_rujukan->USER->CellAttributes() ?>>
<span id="el<?php echo $vw_bridging_sep_by_no_rujukan_list->RowCnt ?>_vw_bridging_sep_by_no_rujukan_USER" class="vw_bridging_sep_by_no_rujukan_USER">
<span<?php echo $vw_bridging_sep_by_no_rujukan->USER->ViewAttributes() ?>>
<?php echo $vw_bridging_sep_by_no_rujukan->USER->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
<?php
...
$vw_bridging_sep_by_no_rujukan_list->ListOptions->Render("body", "right", $vw_bridging_sep_by_no_rujukan_list->RowCnt);
?>
	</tr>
<?php
	}
	if ($vw_bridging_sep_by_no_rujukan->CurrentAction <> "gridadd")
		$vw_bridging_sep_by_no_rujukan_list->Recordset->MoveNext();
}
?>
</tbody>
</table>
<?php } ?>
<?php if ($vw_bridging_sep_by_no_rujukan->CurrentAction == "") { ?>
...
// Close recordset
if ($vw_bridging_sep_by_no_rujukan_list->Recordset)
	$vw_bridging_sep_by_no_rujukan_list->Recordset->Close();
?>
<div class="panel-footer ewGridLowerPanel">
<?php if ($vw_bridging_sep_by_no_rujukan->CurrentAction <> "gridadd" && $vw_bridging_sep_by_no_rujukan->CurrentAction <> "gridedit") { ?>
<form name="ewPagerForm" class="ewForm form-inline ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
<?php if (!isset($vw_bridging_sep_by_no_rujukan_list->Pager)) $vw_bridging_sep_by_no_rujukan_list->Pager = new cPrevNextPager($vw_bridging_sep_by_no_rujukan_list->StartRec, $vw_bridging_sep_by_no_rujukan_list->DisplayRecs, $vw_bridging_sep_by_no_rujukan_list->TotalRecs) ?>
<?php if ($vw_bridging_sep_by_no_rujukan_list->Pager->RecordCount > 0 && $vw_bridging_sep_by_no_rujukan_list->Pager->Visible) { ?>
<div class="text-center">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($vw_bridging_sep_by_no_rujukan_list->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $vw_bridging_sep_by_no_rujukan_list->PageUrl() ?>start=<?php echo $vw_bridging_sep_by_no_rujukan_list->Pager->FirstButton->Start ?>"><span class="fa fa-fast-backward"></span></a>
	<?php } else { ?>
...
<!--previous page button-->
	<?php if ($vw_bridging_sep_by_no_rujukan_list->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $vw_bridging_sep_by_no_rujukan_list->PageUrl() ?>start=<?php echo $vw_bridging_sep_by_no_rujukan_list->Pager->PrevButton->Start ?>"><span class="fa fa-step-backward"></span></a>
	<?php } else { ?>
...
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $vw_bridging_sep_by_no_rujukan_list->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($vw_bridging_sep_by_no_rujukan_list->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $vw_bridging_sep_by_no_rujukan_list->PageUrl() ?>start=<?php echo $vw_bridging_sep_by_no_rujukan_list->Pager->NextButton->Start ?>"><span class="fa fa-step-forward"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="fa fa-step-forward"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($vw_bridging_sep_by_no_rujukan_list->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $vw_bridging_sep_by_no_rujukan_list->PageUrl() ?>start=<?php echo $vw_bridging_sep_by_no_rujukan_list->Pager->LastButton->Start ?>"><span class="fa fa-fast-forward"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $vw_bridging_sep_by_no_rujukan_list->Pager->PageCount ?></span>
</div>
<div class="text-center">
	<span><?php echo $Language->Phrase("Record") ?>&nbsp;<?php echo $vw_bridging_sep_by_no_rujukan_list->Pager->FromIndex ?>&nbsp;<?php echo $Language->Phrase("To") ?>&nbsp;<?php echo $vw_bridging_sep_by_no_rujukan_list->Pager->ToIndex ?>&nbsp;<?php echo $Language->Phrase("Of") ?>&nbsp;<?php echo $vw_bridging_sep_by_no_rujukan_list->Pager->RecordCount ?></span>
</div>
<?php } ?>
<?php if ($vw_bridging_sep_by_no_rujukan_list->TotalRecs > 0 && (!EW_AUTO_HIDE_PAGE_SIZE_SELECTOR || $vw_bridging_sep_by_no_rujukan_list->Pager->Visible)) { ?>
<div class="text-center">
<input type="hidden" name="t" value="vw_bridging_sep_by_no_rujukan">
<select name="<?php echo EW_TABLE_REC_PER_PAGE ?>" class="form-control input-sm ewTooltip" title="<?php echo $Language->Phrase("RecordsPerPage") ?>" onchange="this.form.submit();">
<option value="5"<?php if ($vw_bridging_sep_by_no_rujukan_list->DisplayRecs == 5) { ?> selected<?php } ?>>5</option>
<option value="10"<?php if ($vw_bridging_sep_by_no_rujukan_list->DisplayRecs == 10) { ?> selected<?php } ?>>10</option>
<option value="20"<?php if ($vw_bridging_sep_by_no_rujukan_list->DisplayRecs == 20) { ?> selected<?php } ?>>20</option>
<option value="50"<?php if ($vw_bridging_sep_by_no_rujukan_list->DisplayRecs == 50) { ?> selected<?php } ?>>50</option>
<option value="100"<?php if ($vw_bridging_sep_by_no_rujukan_list->DisplayRecs == 100) { ?> selected<?php } ?>>100</option>
</select>
</div>
<?php } ?>
</form>
...
<?php
	foreach ($vw_bridging_sep_by_no_rujukan_list->OtherOptions as &$option)
...
<?php } ?>
<?php if ($vw_bridging_sep_by_no_rujukan_list->TotalRecs == 0 && $vw_bridging_sep_by_no_rujukan->CurrentAction == "") { // Show other options ?>
<div class="ewListOtherOptions">
<?php
	foreach ($vw_bridging_sep_by_no_rujukan_list->OtherOptions as &$option) {
		$option->ButtonClass = "";
...
<?php } ?>
<script type="text/javascript">
fvw_bridging_sep_by_no_rujukanlistsrch.FilterList = <?php echo $vw_bridging_sep_by_no_rujukan_list->GetFilterList() ?>;
fvw_bridging_sep_by_no_rujukanlistsrch.Init();
fvw_bridging_sep_by_no_rujukanlist.Init();
</script>
<?php
$vw_bridging_sep_by_no_rujukan_list->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$vw_bridging_sep_by_no_rujukan_list->Page_Terminate();
?>
