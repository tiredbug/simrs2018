...
$vw_spp_pengembalian_penerimaan_delete = NULL; // Initialize page object first

class cvw_spp_pengembalian_penerimaan_delete extends cvw_spp_pengembalian_penerimaan {
	...
	// Page object name
	var $PageObjName = 'vw_spp_pengembalian_penerimaan_delete';
	...
	function Page_Main() {
		...
		if ($sFilter == "")
			$this->Page_Terminate("vw_spp_pengembalian_penerimaanlist.php"); // Prevent SQL injection, return to list

		// Set up filter (SQL WHHERE clause) and get return SQL
		// SQL constructor in vw_spp_pengembalian_penerimaan class, vw_spp_pengembalian_penerimaaninfo.php
		...
		if ($this->CurrentAction == "I") { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->Page_Terminate("vw_spp_pengembalian_penerimaanlist.php"); // Return to list
			}
		}
	}
...
// Create page object
if (!isset($vw_spp_pengembalian_penerimaan_delete)) $vw_spp_pengembalian_penerimaan_delete = new cvw_spp_pengembalian_penerimaan_delete();

// Page init
$vw_spp_pengembalian_penerimaan_delete->Page_Init();

// Page main
$vw_spp_pengembalian_penerimaan_delete->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$vw_spp_pengembalian_penerimaan_delete->Page_Render();
?>
...
var CurrentForm = fvw_spp_pengembalian_penerimaandelete = new ew_Form("fvw_spp_pengembalian_penerimaandelete", "delete");

// Form_CustomValidate event
fvw_spp_pengembalian_penerimaandelete.Form_CustomValidate = 
...
fvw_spp_pengembalian_penerimaandelete.ValidateRequired = true;
<?php } else { ?>
fvw_spp_pengembalian_penerimaandelete.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fvw_spp_pengembalian_penerimaandelete.Lists["x_status_spp"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fvw_spp_pengembalian_penerimaandelete.Lists["x_status_spp"].Options = <?php echo json_encode($vw_spp_pengembalian_penerimaan->status_spp->Options()) ?>;
...
<?php $vw_spp_pengembalian_penerimaan_delete->ShowPageHeader(); ?>
<?php
$vw_spp_pengembalian_penerimaan_delete->ShowMessage();
?>
<form name="fvw_spp_pengembalian_penerimaandelete" id="fvw_spp_pengembalian_penerimaandelete" class="form-inline ewForm ewDeleteForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($vw_spp_pengembalian_penerimaan_delete->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $vw_spp_pengembalian_penerimaan_delete->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="vw_spp_pengembalian_penerimaan">
<input type="hidden" name="a_delete" id="a_delete" value="D">
<?php foreach ($vw_spp_pengembalian_penerimaan_delete->RecKeys as $key) { ?>
...
<?php if ($vw_spp_pengembalian_penerimaan->id->Visible) { // id ?>
		<th><span id="elh_vw_spp_pengembalian_penerimaan_id" class="vw_spp_pengembalian_penerimaan_id"><?php echo $vw_spp_pengembalian_penerimaan->id->FldCaption() ?></span></th>
<?php } ?>
<?php if ($vw_spp_pengembalian_penerimaan->status_spp->Visible) { // status_spp ?>
		<th><span id="elh_vw_spp_pengembalian_penerimaan_status_spp" class="vw_spp_pengembalian_penerimaan_status_spp"><?php echo $vw_spp_pengembalian_penerimaan->status_spp->FldCaption() ?></span></th>
<?php } ?>
<?php if ($vw_spp_pengembalian_penerimaan->no_spp->Visible) { // no_spp ?>
		<th><span id="elh_vw_spp_pengembalian_penerimaan_no_spp" class="vw_spp_pengembalian_penerimaan_no_spp"><?php echo $vw_spp_pengembalian_penerimaan->no_spp->FldCaption() ?></span></th>
<?php } ?>
<?php if ($vw_spp_pengembalian_penerimaan->tgl_spp->Visible) { // tgl_spp ?>
		<th><span id="elh_vw_spp_pengembalian_penerimaan_tgl_spp" class="vw_spp_pengembalian_penerimaan_tgl_spp"><?php echo $vw_spp_pengembalian_penerimaan->tgl_spp->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
<?php
$vw_spp_pengembalian_penerimaan_delete->RecCnt = 0;
$i = 0;
while (!$vw_spp_pengembalian_penerimaan_delete->Recordset->EOF) {
	$vw_spp_pengembalian_penerimaan_delete->RecCnt++;
	$vw_spp_pengembalian_penerimaan_delete->RowCnt++;

	// Set row properties
	$vw_spp_pengembalian_penerimaan->ResetAttrs();
	$vw_spp_pengembalian_penerimaan->RowType = EW_ROWTYPE_VIEW; // View

	// Get the field contents
	$vw_spp_pengembalian_penerimaan_delete->LoadRowValues($vw_spp_pengembalian_penerimaan_delete->Recordset);

	// Render row
	$vw_spp_pengembalian_penerimaan_delete->RenderRow();
?>
	<tr<?php echo $vw_spp_pengembalian_penerimaan->RowAttributes() ?>>
<?php if ($vw_spp_pengembalian_penerimaan->id->Visible) { // id ?>
		<td<?php echo $vw_spp_pengembalian_penerimaan->id->CellAttributes() ?>>
<div id="orig<?php echo $vw_spp_pengembalian_penerimaan_delete->RowCnt ?>_vw_spp_pengembalian_penerimaan_id" class="hide">
<span id="el<?php echo $vw_spp_pengembalian_penerimaan_delete->RowCnt ?>_vw_spp_pengembalian_penerimaan_id" class="vw_spp_pengembalian_penerimaan_id">
...
<span id="el<?php echo $vw_spp_pengembalian_penerimaan_delete->RowCnt ?>_vw_spp_pengembalian_penerimaan_status_spp" class="vw_spp_pengembalian_penerimaan_status_spp">
...
<span id="el<?php echo $vw_spp_pengembalian_penerimaan_delete->RowCnt ?>_vw_spp_pengembalian_penerimaan_no_spp" class="vw_spp_pengembalian_penerimaan_no_spp">
...
<span id="el<?php echo $vw_spp_pengembalian_penerimaan_delete->RowCnt ?>_vw_spp_pengembalian_penerimaan_tgl_spp" class="vw_spp_pengembalian_penerimaan_tgl_spp">
...
<?php
	$vw_spp_pengembalian_penerimaan_delete->Recordset->MoveNext();
}
$vw_spp_pengembalian_penerimaan_delete->Recordset->Close();
?>
</tbody>
</table>
</div>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $vw_spp_pengembalian_penerimaan_delete->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
</div>
</form>
<script type="text/javascript">
fvw_spp_pengembalian_penerimaandelete.Init();
</script>
<?php
$vw_spp_pengembalian_penerimaan_delete->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$vw_spp_pengembalian_penerimaan_delete->Page_Terminate();
?>
