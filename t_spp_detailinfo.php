...
//
// Table class for t_spp_detail
//
class ct_spp_detail extends cTable {
	var $id;
	var $id_spp;
	var $id_jenis_spp;
	...
	function __construct() {
		...
		$this->TableVar = 't_spp_detail';
		$this->TableName = 't_spp_detail';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`t_spp_detail`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('t_spp_detail', 't_spp_detail', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// id_spp
		$this->id_spp = new cField('t_spp_detail', 't_spp_detail', 'x_id_spp', 'id_spp', '`id_spp`', '`id_spp`', 3, -1, FALSE, '`id_spp`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// id_jenis_spp
		$this->id_jenis_spp = new cField('t_spp_detail', 't_spp_detail', 'x_id_jenis_spp', 'id_jenis_spp', '`id_jenis_spp`', '`id_jenis_spp`', 3, -1, FALSE, '`id_jenis_spp`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// detail_jenis_spp
		$this->detail_jenis_spp = new cField('t_spp_detail', 't_spp_detail', 'x_detail_jenis_spp', 'detail_jenis_spp', '`detail_jenis_spp`', '`detail_jenis_spp`', 3, -1, FALSE, '`detail_jenis_spp`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// no_spp
		$this->no_spp = new cField('t_spp_detail', 't_spp_detail', 'x_no_spp', 'no_spp', '`no_spp`', '`no_spp`', 200, -1, FALSE, '`no_spp`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->no_spp->Sortable = TRUE; // Allow sort
		$this->fields['no_spp'] = &$this->no_spp;

		// program
		$this->program = new cField('t_spp_detail', 't_spp_detail', 'x_program', 'program', '`program`', '`program`', 200, -1, FALSE, '`program`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->program->Sortable = TRUE; // Allow sort
		$this->fields['program'] = &$this->program;

		// kegiatan
		$this->kegiatan = new cField('t_spp_detail', 't_spp_detail', 'x_kegiatan', 'kegiatan', '`kegiatan`', '`kegiatan`', 200, -1, FALSE, '`kegiatan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->kegiatan->Sortable = TRUE; // Allow sort
		$this->fields['kegiatan'] = &$this->kegiatan;

		// sub_kegiatan
		$this->sub_kegiatan = new cField('t_spp_detail', 't_spp_detail', 'x_sub_kegiatan', 'sub_kegiatan', '`sub_kegiatan`', '`sub_kegiatan`', 200, -1, FALSE, '`sub_kegiatan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->sub_kegiatan->Sortable = TRUE; // Allow sort
		$this->fields['sub_kegiatan'] = &$this->sub_kegiatan;

		// kd_rekening_belanja
		$this->kd_rekening_belanja = new cField('t_spp_detail', 't_spp_detail', 'x_kd_rekening_belanja', 'kd_rekening_belanja', '`kd_rekening_belanja`', '`kd_rekening_belanja`', 200, -1, FALSE, '`kd_rekening_belanja`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->kd_rekening_belanja->Sortable = TRUE; // Allow sort
		$this->kd_rekening_belanja->UsePleaseSelect = TRUE; // Use PleaseSelect by default
		$this->kd_rekening_belanja->PleaseSelectText = $Language->Phrase("PleaseSelect"); // PleaseSelect text
		$this->fields['kd_rekening_belanja'] = &$this->kd_rekening_belanja;

		// tahun_anggaran
		$this->tahun_anggaran = new cField('t_spp_detail', 't_spp_detail', 'x_tahun_anggaran', 'tahun_anggaran', '`tahun_anggaran`', '`tahun_anggaran`', 3, -1, FALSE, '`tahun_anggaran`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// akun1
		$this->akun1 = new cField('t_spp_detail', 't_spp_detail', 'x_akun1', 'akun1', '`akun1`', '`akun1`', 200, -1, FALSE, '`akun1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->akun1->Sortable = TRUE; // Allow sort
		$this->fields['akun1'] = &$this->akun1;

		// akun2
		$this->akun2 = new cField('t_spp_detail', 't_spp_detail', 'x_akun2', 'akun2', '`akun2`', '`akun2`', 200, -1, FALSE, '`akun2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->akun2->Sortable = TRUE; // Allow sort
		$this->fields['akun2'] = &$this->akun2;

		// akun3
		$this->akun3 = new cField('t_spp_detail', 't_spp_detail', 'x_akun3', 'akun3', '`akun3`', '`akun3`', 200, -1, FALSE, '`akun3`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->akun3->Sortable = TRUE; // Allow sort
		$this->fields['akun3'] = &$this->akun3;

		// akun4
		$this->akun4 = new cField('t_spp_detail', 't_spp_detail', 'x_akun4', 'akun4', '`akun4`', '`akun4`', 200, -1, FALSE, '`akun4`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->akun4->Sortable = TRUE; // Allow sort
		$this->fields['akun4'] = &$this->akun4;

		// akun5
		$this->akun5 = new cField('t_spp_detail', 't_spp_detail', 'x_akun5', 'akun5', '`akun5`', '`akun5`', 200, -1, FALSE, '`akun5`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->akun5->Sortable = TRUE; // Allow sort
		$this->fields['akun5'] = &$this->akun5;

		// jumlah_belanja
		$this->jumlah_belanja = new cField('t_spp_detail', 't_spp_detail', 'x_jumlah_belanja', 'jumlah_belanja', '`jumlah_belanja`', '`jumlah_belanja`', 5, -1, FALSE, '`jumlah_belanja`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function GetMasterFilter() {
		...
		// Master filter
		$sMasterFilter = "";
		if ($this->getCurrentMasterTable() == "vw_spp_up_list") {
	...
	// Master filter
	function SqlMasterFilter_vw_spp_up_list() {
		return "`id`=@id@ AND `id_jenis_spp`=@id_jenis_spp@ AND `detail_jenis_spp`=@detail_jenis_spp@ AND `no_spp`='@no_spp@' AND `kode_program`='@kode_program@' AND `kode_kegiatan`='@kode_kegiatan@' AND `tahun_anggaran`=@tahun_anggaran@";
	}

	// Detail filter
	function SqlDetailFilter_vw_spp_up_list() {
		return "`id_spp`=@id_spp@ AND `id_jenis_spp`=@id_jenis_spp@ AND `detail_jenis_spp`=@detail_jenis_spp@ AND `no_spp`='@no_spp@' AND `program`='@program@' AND `kegiatan`='@kegiatan@' AND `tahun_anggaran`=@tahun_anggaran@";
	}
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`t_spp_detail`";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("t_spp_detailview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("t_spp_detailview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "t_spp_detailadd.php?" . $this->UrlParm($parm);
		else
			$url = "t_spp_detailadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("t_spp_detailedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("t_spp_detailadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("t_spp_detaildelete.php", $this->UrlParm());
	}

	// Add master url
	function AddMasterUrl($url) {
		if ($this->getCurrentMasterTable() == "vw_spp_up_list" && strpos($url, EW_TABLE_SHOW_MASTER . "=") === FALSE) {
   ...
   // Common render codes
	...
	function Row_Inserting($rsold, &$rsnew) {
		...
		$rsnew["akun1"] = ew_ExecuteScalar("SELECT akun1 FROM simrs2012.keu_akun5 where kd_akun = '".$rsnew["kd_rekening_belanja"]."' LIMIT 1");
		$rsnew["akun2"] = ew_ExecuteScalar("SELECT akun2 FROM simrs2012.keu_akun5 where kd_akun = '".$rsnew["kd_rekening_belanja"]."' LIMIT 1");
		$rsnew["akun3"] = ew_ExecuteScalar("SELECT akun2 FROM simrs2012.keu_akun5 where kd_akun = '".$rsnew["kd_rekening_belanja"]."' LIMIT 1");
		$rsnew["akun4"] = ew_ExecuteScalar("SELECT akun4 FROM simrs2012.keu_akun5 where kd_akun = '".$rsnew["kd_rekening_belanja"]."' LIMIT 1");
		$rsnew["akun5"] = ew_ExecuteScalar("SELECT akun5 FROM simrs2012.keu_akun5 where kd_akun = '".$rsnew["kd_rekening_belanja"]."' LIMIT 1");
		return TRUE;
	}
