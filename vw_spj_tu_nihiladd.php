...
$vw_spj_tu_nihil_add = NULL; // Initialize page object first

class cvw_spj_tu_nihil_add extends cvw_spj_tu_nihil {
	...
	// Page object name
	var $PageObjName = 'vw_spj_tu_nihil_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "vw_spj_tu_nihilview.php")
	...
	function LoadDefaultValues() {
		...
		$this->nama_kuasa->CurrentValue = NULL;
		$this->nama_kuasa->OldValue = $this->nama_kuasa->CurrentValue;
		$this->nip_kuasa->CurrentValue = NULL;
		$this->nip_kuasa->OldValue = $this->nip_kuasa->CurrentValue;
	}
	...
	function AddRow($rsold = NULL) {
		...
		// nama_kuasa
		$this->nama_kuasa->SetDbValueDef($rsnew, $this->nama_kuasa->CurrentValue, NULL, FALSE);

		// nip_kuasa
		$this->nip_kuasa->SetDbValueDef($rsnew, $this->nip_kuasa->CurrentValue, NULL, FALSE);
...
// Create page object
if (!isset($vw_spj_tu_nihil_add)) $vw_spj_tu_nihil_add = new cvw_spj_tu_nihil_add();

// Page init
$vw_spj_tu_nihil_add->Page_Init();

// Page main
$vw_spj_tu_nihil_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$vw_spj_tu_nihil_add->Page_Render();
?>
...
var CurrentForm = fvw_spj_tu_nihiladd = new ew_Form("fvw_spj_tu_nihiladd", "add");

// Validate form
fvw_spj_tu_nihiladd.Validate = function() {
...
fvw_spj_tu_nihiladd.Form_CustomValidate = 
...
fvw_spj_tu_nihiladd.ValidateRequired = true;
<?php } else { ?>
fvw_spj_tu_nihiladd.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fvw_spj_tu_nihiladd.Lists["x_jenis_spj"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fvw_spj_tu_nihiladd.Lists["x_jenis_spj"].Options = <?php echo json_encode($vw_spj_tu_nihil->jenis_spj->Options()) ?>;
...
<?php if (!$vw_spj_tu_nihil_add->IsModal) { ?>
<?php } ?>
<?php $vw_spj_tu_nihil_add->ShowPageHeader(); ?>
<?php
$vw_spj_tu_nihil_add->ShowMessage();
?>
<form name="fvw_spj_tu_nihiladd" id="fvw_spj_tu_nihiladd" class="<?php echo $vw_spj_tu_nihil_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($vw_spj_tu_nihil_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $vw_spj_tu_nihil_add->Token ?>">
<?php } ?>
...
<script type="text/javascript">
ew_CreateCalendar("fvw_spj_tu_nihiladd", "x_tgl_spj", 7);
</script>
<?php } ?>
</span>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $vw_spj_tu_nihil_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
fvw_spj_tu_nihiladd.Init();
</script>
<?php
$vw_spj_tu_nihil_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$vw_spj_tu_nihil_add->Page_Terminate();
?>
