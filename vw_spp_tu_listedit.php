...
$vw_spp_tu_list_edit = NULL; // Initialize page object first

class cvw_spp_tu_list_edit extends cvw_spp_tu_list {
	...
	// Page object name
	var $PageObjName = 'vw_spp_tu_list_edit';
	...
	function Page_Main() {
		...
		if ($this->id->CurrentValue == "") {
			$this->Page_Terminate("vw_spp_tu_listlist.php"); // Invalid key, return to list
		}
		...
		switch ($this->CurrentAction) {
			case "I": // Get a record to display
				if (!$this->LoadRow()) { // Load record based on key
					...
					$this->Page_Terminate("vw_spp_tu_listlist.php"); // No matching record, return to list
				}
				break;
			Case "U": // Update
				$sReturnUrl = $this->getReturnUrl();
				if (ew_GetPageName($sReturnUrl) == "vw_spp_tu_listlist.php")
...
// Create page object
if (!isset($vw_spp_tu_list_edit)) $vw_spp_tu_list_edit = new cvw_spp_tu_list_edit();

// Page init
$vw_spp_tu_list_edit->Page_Init();

// Page main
$vw_spp_tu_list_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$vw_spp_tu_list_edit->Page_Render();
?>
...
var CurrentForm = fvw_spp_tu_listedit = new ew_Form("fvw_spp_tu_listedit", "edit");

// Validate form
fvw_spp_tu_listedit.Validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		$fobj.data("rowindex", infix);
			...
			if (elm && !ew_CheckEuroDate(elm.value))
				return this.OnError(elm, "<?php echo ew_JsEncode2($vw_spp_tu_list->tgl_spp->FldErrMsg()) ?>");
...
fvw_spp_tu_listedit.Form_CustomValidate = 
...
fvw_spp_tu_listedit.ValidateRequired = true;
<?php } else { ?>
fvw_spp_tu_listedit.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fvw_spp_tu_listedit.Lists["x_id_jenis_spp"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_jenis_spp","","",""],"ParentFields":[],"ChildFields":["x_detail_jenis_spp"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"l_jenis_spp"};
fvw_spp_tu_listedit.Lists["x_detail_jenis_spp"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_detail_jenis_spp","","",""],"ParentFields":["x_id_jenis_spp"],"ChildFields":[],"FilterFields":["x_id_jenis"],"Options":[],"Template":"","LinkTable":"l_jenis_detail_spp"};
fvw_spp_tu_listedit.Lists["x_status_spp"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fvw_spp_tu_listedit.Lists["x_status_spp"].Options = <?php echo json_encode($vw_spp_tu_list->status_spp->Options()) ?>;
...
<?php if (!$vw_spp_tu_list_edit->IsModal) { ?>
<?php } ?>
<?php $vw_spp_tu_list_edit->ShowPageHeader(); ?>
<?php
$vw_spp_tu_list_edit->ShowMessage();
?>
<form name="fvw_spp_tu_listedit" id="fvw_spp_tu_listedit" class="<?php echo $vw_spp_tu_list_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($vw_spp_tu_list_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $vw_spp_tu_list_edit->Token ?>">
<?php } ?>
...
<?php if ($vw_spp_tu_list->id->Visible) { // id ?>
	<div id="r_id" class="form-group">
		<label id="elh_vw_spp_tu_list_id" class="col-sm-2 control-label ewLabel"><?php echo $vw_spp_tu_list->id->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $vw_spp_tu_list->id->CellAttributes() ?>>
<span id="el_vw_spp_tu_list_id">
<span<?php echo $vw_spp_tu_list->id->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $vw_spp_tu_list->id->EditValue ?></p></span>
</span>
<input type="hidden" data-table="vw_spp_tu_list" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($vw_spp_tu_list->id->CurrentValue) ?>">
<?php echo $vw_spp_tu_list->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($vw_spp_tu_list->id_jenis_spp->Visible) { // id_jenis_spp ?>
	<div id="r_id_jenis_spp" class="form-group">
		<label id="elh_vw_spp_tu_list_id_jenis_spp" for="x_id_jenis_spp" class="col-sm-2 control-label ewLabel"><?php echo $vw_spp_tu_list->id_jenis_spp->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $vw_spp_tu_list->id_jenis_spp->CellAttributes() ?>>
<span id="el_vw_spp_tu_list_id_jenis_spp">
<?php $vw_spp_tu_list->id_jenis_spp->EditAttrs["onchange"] = "ew_UpdateOpt.call(this); " . @$vw_spp_tu_list->id_jenis_spp->EditAttrs["onchange"]; ?>
<select data-table="vw_spp_tu_list" data-field="x_id_jenis_spp" data-value-separator="<?php echo $vw_spp_tu_list->id_jenis_spp->DisplayValueSeparatorAttribute() ?>" id="x_id_jenis_spp" name="x_id_jenis_spp"<?php echo $vw_spp_tu_list->id_jenis_spp->EditAttributes() ?>>
<?php echo $vw_spp_tu_list->id_jenis_spp->SelectOptionListHtml("x_id_jenis_spp") ?>
</select>
<input type="hidden" name="s_x_id_jenis_spp" id="s_x_id_jenis_spp" value="<?php echo $vw_spp_tu_list->id_jenis_spp->LookupFilterQuery() ?>">
</span>
<?php echo $vw_spp_tu_list->id_jenis_spp->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($vw_spp_tu_list->detail_jenis_spp->Visible) { // detail_jenis_spp ?>
	<div id="r_detail_jenis_spp" class="form-group">
		<label id="elh_vw_spp_tu_list_detail_jenis_spp" for="x_detail_jenis_spp" class="col-sm-2 control-label ewLabel"><?php echo $vw_spp_tu_list->detail_jenis_spp->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $vw_spp_tu_list->detail_jenis_spp->CellAttributes() ?>>
<span id="el_vw_spp_tu_list_detail_jenis_spp">
<select data-table="vw_spp_tu_list" data-field="x_detail_jenis_spp" data-value-separator="<?php echo $vw_spp_tu_list->detail_jenis_spp->DisplayValueSeparatorAttribute() ?>" id="x_detail_jenis_spp" name="x_detail_jenis_spp"<?php echo $vw_spp_tu_list->detail_jenis_spp->EditAttributes() ?>>
<?php echo $vw_spp_tu_list->detail_jenis_spp->SelectOptionListHtml("x_detail_jenis_spp") ?>
</select>
<input type="hidden" name="s_x_detail_jenis_spp" id="s_x_detail_jenis_spp" value="<?php echo $vw_spp_tu_list->detail_jenis_spp->LookupFilterQuery() ?>">
</span>
<?php echo $vw_spp_tu_list->detail_jenis_spp->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($vw_spp_tu_list->status_spp->Visible) { // status_spp ?>
	<div id="r_status_spp" class="form-group">
		<label id="elh_vw_spp_tu_list_status_spp" for="x_status_spp" class="col-sm-2 control-label ewLabel"><?php echo $vw_spp_tu_list->status_spp->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $vw_spp_tu_list->status_spp->CellAttributes() ?>>
<span id="el_vw_spp_tu_list_status_spp">
<select data-table="vw_spp_tu_list" data-field="x_status_spp" data-value-separator="<?php echo $vw_spp_tu_list->status_spp->DisplayValueSeparatorAttribute() ?>" id="x_status_spp" name="x_status_spp"<?php echo $vw_spp_tu_list->status_spp->EditAttributes() ?>>
<?php echo $vw_spp_tu_list->status_spp->SelectOptionListHtml("x_status_spp") ?>
</select>
</span>
<?php echo $vw_spp_tu_list->status_spp->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($vw_spp_tu_list->no_spp->Visible) { // no_spp ?>
	<div id="r_no_spp" class="form-group">
		<label id="elh_vw_spp_tu_list_no_spp" for="x_no_spp" class="col-sm-2 control-label ewLabel"><?php echo $vw_spp_tu_list->no_spp->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $vw_spp_tu_list->no_spp->CellAttributes() ?>>
<span id="el_vw_spp_tu_list_no_spp">
<input type="text" data-table="vw_spp_tu_list" data-field="x_no_spp" name="x_no_spp" id="x_no_spp" size="30" maxlength="45" placeholder="<?php echo ew_HtmlEncode($vw_spp_tu_list->no_spp->getPlaceHolder()) ?>" value="<?php echo $vw_spp_tu_list->no_spp->EditValue ?>"<?php echo $vw_spp_tu_list->no_spp->EditAttributes() ?>>
</span>
<?php echo $vw_spp_tu_list->no_spp->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($vw_spp_tu_list->tgl_spp->Visible) { // tgl_spp ?>
	<div id="r_tgl_spp" class="form-group">
		<label id="elh_vw_spp_tu_list_tgl_spp" for="x_tgl_spp" class="col-sm-2 control-label ewLabel"><?php echo $vw_spp_tu_list->tgl_spp->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $vw_spp_tu_list->tgl_spp->CellAttributes() ?>>
<span id="el_vw_spp_tu_list_tgl_spp">
<input type="text" data-table="vw_spp_tu_list" data-field="x_tgl_spp" data-format="7" name="x_tgl_spp" id="x_tgl_spp" placeholder="<?php echo ew_HtmlEncode($vw_spp_tu_list->tgl_spp->getPlaceHolder()) ?>" value="<?php echo $vw_spp_tu_list->tgl_spp->EditValue ?>"<?php echo $vw_spp_tu_list->tgl_spp->EditAttributes() ?>>
<?php if (!$vw_spp_tu_list->tgl_spp->ReadOnly && !$vw_spp_tu_list->tgl_spp->Disabled && !isset($vw_spp_tu_list->tgl_spp->EditAttrs["readonly"]) && !isset($vw_spp_tu_list->tgl_spp->EditAttrs["disabled"])) { ?>
<script type="text/javascript">
ew_CreateCalendar("fvw_spp_tu_listedit", "x_tgl_spp", 7);
</script>
<?php } ?>
</span>
<?php echo $vw_spp_tu_list->tgl_spp->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($vw_spp_tu_list->kode_program->Visible) { // kode_program ?>
	<div id="r_kode_program" class="form-group">
		<label id="elh_vw_spp_tu_list_kode_program" for="x_kode_program" class="col-sm-2 control-label ewLabel"><?php echo $vw_spp_tu_list->kode_program->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $vw_spp_tu_list->kode_program->CellAttributes() ?>>
<span id="el_vw_spp_tu_list_kode_program">
<input type="text" data-table="vw_spp_tu_list" data-field="x_kode_program" name="x_kode_program" id="x_kode_program" size="30" maxlength="45" placeholder="<?php echo ew_HtmlEncode($vw_spp_tu_list->kode_program->getPlaceHolder()) ?>" value="<?php echo $vw_spp_tu_list->kode_program->EditValue ?>"<?php echo $vw_spp_tu_list->kode_program->EditAttributes() ?>>
</span>
<?php echo $vw_spp_tu_list->kode_program->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($vw_spp_tu_list->kode_kegiatan->Visible) { // kode_kegiatan ?>
	<div id="r_kode_kegiatan" class="form-group">
		<label id="elh_vw_spp_tu_list_kode_kegiatan" for="x_kode_kegiatan" class="col-sm-2 control-label ewLabel"><?php echo $vw_spp_tu_list->kode_kegiatan->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $vw_spp_tu_list->kode_kegiatan->CellAttributes() ?>>
<span id="el_vw_spp_tu_list_kode_kegiatan">
<input type="text" data-table="vw_spp_tu_list" data-field="x_kode_kegiatan" name="x_kode_kegiatan" id="x_kode_kegiatan" size="30" maxlength="45" placeholder="<?php echo ew_HtmlEncode($vw_spp_tu_list->kode_kegiatan->getPlaceHolder()) ?>" value="<?php echo $vw_spp_tu_list->kode_kegiatan->EditValue ?>"<?php echo $vw_spp_tu_list->kode_kegiatan->EditAttributes() ?>>
</span>
<?php echo $vw_spp_tu_list->kode_kegiatan->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($vw_spp_tu_list->keterangan->Visible) { // keterangan ?>
	<div id="r_keterangan" class="form-group">
		<label id="elh_vw_spp_tu_list_keterangan" for="x_keterangan" class="col-sm-2 control-label ewLabel"><?php echo $vw_spp_tu_list->keterangan->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $vw_spp_tu_list->keterangan->CellAttributes() ?>>
<span id="el_vw_spp_tu_list_keterangan">
<input type="text" data-table="vw_spp_tu_list" data-field="x_keterangan" name="x_keterangan" id="x_keterangan" size="30" maxlength="45" placeholder="<?php echo ew_HtmlEncode($vw_spp_tu_list->keterangan->getPlaceHolder()) ?>" value="<?php echo $vw_spp_tu_list->keterangan->EditValue ?>"<?php echo $vw_spp_tu_list->keterangan->EditAttributes() ?>>
</span>
<?php echo $vw_spp_tu_list->keterangan->CustomMsg ?></div></div>
	</div>
<?php } ?>
</div>
<?php if (!$vw_spp_tu_list_edit->IsModal) { ?>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $vw_spp_tu_list_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
fvw_spp_tu_listedit.Init();
</script>
<?php
$vw_spp_tu_list_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$vw_spp_tu_list_edit->Page_Terminate();
?>
