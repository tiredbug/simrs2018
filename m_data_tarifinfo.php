...
//
// Table class for m_data_tarif
//
class cm_data_tarif extends cTable {
	var $id;
	var $kode;
	var $nama_tindakan;
	...
	function __construct() {
		...
		$this->TableVar = 'm_data_tarif';
		$this->TableName = 'm_data_tarif';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`m_data_tarif`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('m_data_tarif', 'm_data_tarif', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// kode
		$this->kode = new cField('m_data_tarif', 'm_data_tarif', 'x_kode', 'kode', '`kode`', '`kode`', 3, -1, FALSE, '`kode`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->kode->Sortable = TRUE; // Allow sort
		$this->kode->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['kode'] = &$this->kode;

		// nama_tindakan
		$this->nama_tindakan = new cField('m_data_tarif', 'm_data_tarif', 'x_nama_tindakan', 'nama_tindakan', '`nama_tindakan`', '`nama_tindakan`', 200, -1, FALSE, '`nama_tindakan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->nama_tindakan->Sortable = TRUE; // Allow sort
		$this->fields['nama_tindakan'] = &$this->nama_tindakan;

		// kelompok_tindakan
		$this->kelompok_tindakan = new cField('m_data_tarif', 'm_data_tarif', 'x_kelompok_tindakan', 'kelompok_tindakan', '`kelompok_tindakan`', '`kelompok_tindakan`', 3, -1, FALSE, '`kelompok_tindakan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->kelompok_tindakan->Sortable = TRUE; // Allow sort
		$this->kelompok_tindakan->UsePleaseSelect = TRUE; // Use PleaseSelect by default
		$this->kelompok_tindakan->PleaseSelectText = $Language->Phrase("PleaseSelect"); // PleaseSelect text
		...
		// sub_kelompok1
		$this->sub_kelompok1 = new cField('m_data_tarif', 'm_data_tarif', 'x_sub_kelompok1', 'sub_kelompok1', '`sub_kelompok1`', '`sub_kelompok1`', 3, -1, FALSE, '`sub_kelompok1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->sub_kelompok1->Sortable = TRUE; // Allow sort
		$this->sub_kelompok1->UsePleaseSelect = TRUE; // Use PleaseSelect by default
		$this->sub_kelompok1->PleaseSelectText = $Language->Phrase("PleaseSelect"); // PleaseSelect text
		$this->sub_kelompok1->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['sub_kelompok1'] = &$this->sub_kelompok1;

		// sub_kelompok2
		$this->sub_kelompok2 = new cField('m_data_tarif', 'm_data_tarif', 'x_sub_kelompok2', 'sub_kelompok2', '`sub_kelompok2`', '`sub_kelompok2`', 3, -1, FALSE, '`sub_kelompok2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->sub_kelompok2->Sortable = TRUE; // Allow sort
		$this->sub_kelompok2->UsePleaseSelect = TRUE; // Use PleaseSelect by default
		$this->sub_kelompok2->PleaseSelectText = $Language->Phrase("PleaseSelect"); // PleaseSelect text
		$this->sub_kelompok2->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['sub_kelompok2'] = &$this->sub_kelompok2;

		// kelas
		$this->kelas = new cField('m_data_tarif', 'm_data_tarif', 'x_kelas', 'kelas', '`kelas`', '`kelas`', 3, -1, FALSE, '`kelas`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->kelas->OptionCount = 3;
		$this->kelas->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['kelas'] = &$this->kelas;

		// tarif
		$this->tarif = new cField('m_data_tarif', 'm_data_tarif', 'x_tarif', 'tarif', '`tarif`', '`tarif`', 5, -1, FALSE, '`tarif`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// bhp
		$this->bhp = new cField('m_data_tarif', 'm_data_tarif', 'x_bhp', 'bhp', '`bhp`', '`bhp`', 5, -1, FALSE, '`bhp`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`m_data_tarif`";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("m_data_tarifview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("m_data_tarifview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "m_data_tarifadd.php?" . $this->UrlParm($parm);
		else
			$url = "m_data_tarifadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("m_data_tarifedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("m_data_tarifadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("m_data_tarifdelete.php", $this->UrlParm());
	}
