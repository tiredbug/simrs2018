...
$vw_spp_gu_list_delete = NULL; // Initialize page object first

class cvw_spp_gu_list_delete extends cvw_spp_gu_list {
	...
	// Page object name
	var $PageObjName = 'vw_spp_gu_list_delete';
	...
	function Page_Main() {
		...
		if ($sFilter == "")
			$this->Page_Terminate("vw_spp_gu_listlist.php"); // Prevent SQL injection, return to list

		// Set up filter (SQL WHHERE clause) and get return SQL
		// SQL constructor in vw_spp_gu_list class, vw_spp_gu_listinfo.php
		...
		if ($this->CurrentAction == "I") { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->Page_Terminate("vw_spp_gu_listlist.php"); // Return to list
			}
		}
	}
...
// Create page object
if (!isset($vw_spp_gu_list_delete)) $vw_spp_gu_list_delete = new cvw_spp_gu_list_delete();

// Page init
$vw_spp_gu_list_delete->Page_Init();

// Page main
$vw_spp_gu_list_delete->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$vw_spp_gu_list_delete->Page_Render();
?>
...
var CurrentForm = fvw_spp_gu_listdelete = new ew_Form("fvw_spp_gu_listdelete", "delete");

// Form_CustomValidate event
fvw_spp_gu_listdelete.Form_CustomValidate = 
...
fvw_spp_gu_listdelete.ValidateRequired = true;
<?php } else { ?>
fvw_spp_gu_listdelete.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fvw_spp_gu_listdelete.Lists["x_id_jenis_spp"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_jenis_spp","","",""],"ParentFields":[],"ChildFields":["x_detail_jenis_spp"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"l_jenis_spp"};
fvw_spp_gu_listdelete.Lists["x_detail_jenis_spp"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_detail_jenis_spp","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"l_jenis_detail_spp"};
fvw_spp_gu_listdelete.Lists["x_status_spp"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fvw_spp_gu_listdelete.Lists["x_status_spp"].Options = <?php echo json_encode($vw_spp_gu_list->status_spp->Options()) ?>;
fvw_spp_gu_listdelete.Lists["x_nama_bendahara"] = {"LinkField":"x_nama","Ajax":true,"AutoFill":false,"DisplayFields":["x_nama","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"m_pejabat_keuangan"};
fvw_spp_gu_listdelete.Lists["x_nama_pptk"] = {"LinkField":"x_nama","Ajax":true,"AutoFill":false,"DisplayFields":["x_nama","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"m_pejabat_keuangan"};
fvw_spp_gu_listdelete.Lists["x_kode_program"] = {"LinkField":"x_kode_program","Ajax":true,"AutoFill":false,"DisplayFields":["x_nama_program","","",""],"ParentFields":[],"ChildFields":["x_kode_kegiatan","x_kode_sub_kegiatan"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"m_program"};
fvw_spp_gu_listdelete.Lists["x_kode_kegiatan"] = {"LinkField":"x_kode_kegiatan","Ajax":true,"AutoFill":false,"DisplayFields":["x_nama_kegiatan","","",""],"ParentFields":[],"ChildFields":["x_kode_sub_kegiatan"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"m_kegiatan"};
fvw_spp_gu_listdelete.Lists["x_kode_sub_kegiatan"] = {"LinkField":"x_kode_sub_kegiatan","Ajax":true,"AutoFill":false,"DisplayFields":["x_nama_sub_kegiatan","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"m_sub_kegiatan"};
fvw_spp_gu_listdelete.Lists["x_id_spj"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_no_spj","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t_spj"};
fvw_spp_gu_listdelete.Lists["x_id_spd"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_no_spd","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t_spd"};
...
<?php $vw_spp_gu_list_delete->ShowPageHeader(); ?>
<?php
$vw_spp_gu_list_delete->ShowMessage();
?>
<form name="fvw_spp_gu_listdelete" id="fvw_spp_gu_listdelete" class="form-inline ewForm ewDeleteForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($vw_spp_gu_list_delete->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $vw_spp_gu_list_delete->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="vw_spp_gu_list">
<input type="hidden" name="a_delete" id="a_delete" value="D">
<?php foreach ($vw_spp_gu_list_delete->RecKeys as $key) { ?>
...
<?php if ($vw_spp_gu_list->id->Visible) { // id ?>
		<th><span id="elh_vw_spp_gu_list_id" class="vw_spp_gu_list_id"><?php echo $vw_spp_gu_list->id->FldCaption() ?></span></th>
<?php } ?>
<?php if ($vw_spp_gu_list->id_jenis_spp->Visible) { // id_jenis_spp ?>
		<th><span id="elh_vw_spp_gu_list_id_jenis_spp" class="vw_spp_gu_list_id_jenis_spp"><?php echo $vw_spp_gu_list->id_jenis_spp->FldCaption() ?></span></th>
<?php } ?>
<?php if ($vw_spp_gu_list->detail_jenis_spp->Visible) { // detail_jenis_spp ?>
		<th><span id="elh_vw_spp_gu_list_detail_jenis_spp" class="vw_spp_gu_list_detail_jenis_spp"><?php echo $vw_spp_gu_list->detail_jenis_spp->FldCaption() ?></span></th>
<?php } ?>
<?php if ($vw_spp_gu_list->status_spp->Visible) { // status_spp ?>
		<th><span id="elh_vw_spp_gu_list_status_spp" class="vw_spp_gu_list_status_spp"><?php echo $vw_spp_gu_list->status_spp->FldCaption() ?></span></th>
<?php } ?>
<?php if ($vw_spp_gu_list->no_spp->Visible) { // no_spp ?>
		<th><span id="elh_vw_spp_gu_list_no_spp" class="vw_spp_gu_list_no_spp"><?php echo $vw_spp_gu_list->no_spp->FldCaption() ?></span></th>
<?php } ?>
<?php if ($vw_spp_gu_list->tgl_spp->Visible) { // tgl_spp ?>
		<th><span id="elh_vw_spp_gu_list_tgl_spp" class="vw_spp_gu_list_tgl_spp"><?php echo $vw_spp_gu_list->tgl_spp->FldCaption() ?></span></th>
<?php } ?>
<?php if ($vw_spp_gu_list->keterangan->Visible) { // keterangan ?>
		<th><span id="elh_vw_spp_gu_list_keterangan" class="vw_spp_gu_list_keterangan"><?php echo $vw_spp_gu_list->keterangan->FldCaption() ?></span></th>
<?php } ?>
<?php if ($vw_spp_gu_list->nama_bendahara->Visible) { // nama_bendahara ?>
		<th><span id="elh_vw_spp_gu_list_nama_bendahara" class="vw_spp_gu_list_nama_bendahara"><?php echo $vw_spp_gu_list->nama_bendahara->FldCaption() ?></span></th>
<?php } ?>
<?php if ($vw_spp_gu_list->nip_bendahara->Visible) { // nip_bendahara ?>
		<th><span id="elh_vw_spp_gu_list_nip_bendahara" class="vw_spp_gu_list_nip_bendahara"><?php echo $vw_spp_gu_list->nip_bendahara->FldCaption() ?></span></th>
<?php } ?>
<?php if ($vw_spp_gu_list->nama_pptk->Visible) { // nama_pptk ?>
		<th><span id="elh_vw_spp_gu_list_nama_pptk" class="vw_spp_gu_list_nama_pptk"><?php echo $vw_spp_gu_list->nama_pptk->FldCaption() ?></span></th>
<?php } ?>
<?php if ($vw_spp_gu_list->nip_pptk->Visible) { // nip_pptk ?>
		<th><span id="elh_vw_spp_gu_list_nip_pptk" class="vw_spp_gu_list_nip_pptk"><?php echo $vw_spp_gu_list->nip_pptk->FldCaption() ?></span></th>
<?php } ?>
<?php if ($vw_spp_gu_list->kode_program->Visible) { // kode_program ?>
		<th><span id="elh_vw_spp_gu_list_kode_program" class="vw_spp_gu_list_kode_program"><?php echo $vw_spp_gu_list->kode_program->FldCaption() ?></span></th>
<?php } ?>
<?php if ($vw_spp_gu_list->kode_kegiatan->Visible) { // kode_kegiatan ?>
		<th><span id="elh_vw_spp_gu_list_kode_kegiatan" class="vw_spp_gu_list_kode_kegiatan"><?php echo $vw_spp_gu_list->kode_kegiatan->FldCaption() ?></span></th>
<?php } ?>
<?php if ($vw_spp_gu_list->kode_sub_kegiatan->Visible) { // kode_sub_kegiatan ?>
		<th><span id="elh_vw_spp_gu_list_kode_sub_kegiatan" class="vw_spp_gu_list_kode_sub_kegiatan"><?php echo $vw_spp_gu_list->kode_sub_kegiatan->FldCaption() ?></span></th>
<?php } ?>
<?php if ($vw_spp_gu_list->tahun_anggaran->Visible) { // tahun_anggaran ?>
		<th><span id="elh_vw_spp_gu_list_tahun_anggaran" class="vw_spp_gu_list_tahun_anggaran"><?php echo $vw_spp_gu_list->tahun_anggaran->FldCaption() ?></span></th>
<?php } ?>
<?php if ($vw_spp_gu_list->id_spj->Visible) { // id_spj ?>
		<th><span id="elh_vw_spp_gu_list_id_spj" class="vw_spp_gu_list_id_spj"><?php echo $vw_spp_gu_list->id_spj->FldCaption() ?></span></th>
<?php } ?>
<?php if ($vw_spp_gu_list->id_spd->Visible) { // id_spd ?>
		<th><span id="elh_vw_spp_gu_list_id_spd" class="vw_spp_gu_list_id_spd"><?php echo $vw_spp_gu_list->id_spd->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
<?php
$vw_spp_gu_list_delete->RecCnt = 0;
$i = 0;
while (!$vw_spp_gu_list_delete->Recordset->EOF) {
	$vw_spp_gu_list_delete->RecCnt++;
	$vw_spp_gu_list_delete->RowCnt++;

	// Set row properties
	$vw_spp_gu_list->ResetAttrs();
	$vw_spp_gu_list->RowType = EW_ROWTYPE_VIEW; // View

	// Get the field contents
	$vw_spp_gu_list_delete->LoadRowValues($vw_spp_gu_list_delete->Recordset);

	// Render row
	$vw_spp_gu_list_delete->RenderRow();
?>
	<tr<?php echo $vw_spp_gu_list->RowAttributes() ?>>
<?php if ($vw_spp_gu_list->id->Visible) { // id ?>
		<td<?php echo $vw_spp_gu_list->id->CellAttributes() ?>>
<span id="el<?php echo $vw_spp_gu_list_delete->RowCnt ?>_vw_spp_gu_list_id" class="vw_spp_gu_list_id">
...
<?php } ?>
<?php if ($vw_spp_gu_list->id_jenis_spp->Visible) { // id_jenis_spp ?>
		<td<?php echo $vw_spp_gu_list->id_jenis_spp->CellAttributes() ?>>
<span id="el<?php echo $vw_spp_gu_list_delete->RowCnt ?>_vw_spp_gu_list_id_jenis_spp" class="vw_spp_gu_list_id_jenis_spp">
...
<?php } ?>
<?php if ($vw_spp_gu_list->detail_jenis_spp->Visible) { // detail_jenis_spp ?>
		<td<?php echo $vw_spp_gu_list->detail_jenis_spp->CellAttributes() ?>>
<span id="el<?php echo $vw_spp_gu_list_delete->RowCnt ?>_vw_spp_gu_list_detail_jenis_spp" class="vw_spp_gu_list_detail_jenis_spp">
...
<?php } ?>
<?php if ($vw_spp_gu_list->status_spp->Visible) { // status_spp ?>
		<td<?php echo $vw_spp_gu_list->status_spp->CellAttributes() ?>>
<span id="el<?php echo $vw_spp_gu_list_delete->RowCnt ?>_vw_spp_gu_list_status_spp" class="vw_spp_gu_list_status_spp">
...
<?php } ?>
<?php if ($vw_spp_gu_list->no_spp->Visible) { // no_spp ?>
		<td<?php echo $vw_spp_gu_list->no_spp->CellAttributes() ?>>
<span id="el<?php echo $vw_spp_gu_list_delete->RowCnt ?>_vw_spp_gu_list_no_spp" class="vw_spp_gu_list_no_spp">
...
<?php } ?>
<?php if ($vw_spp_gu_list->tgl_spp->Visible) { // tgl_spp ?>
		<td<?php echo $vw_spp_gu_list->tgl_spp->CellAttributes() ?>>
<span id="el<?php echo $vw_spp_gu_list_delete->RowCnt ?>_vw_spp_gu_list_tgl_spp" class="vw_spp_gu_list_tgl_spp">
...
<?php } ?>
<?php if ($vw_spp_gu_list->keterangan->Visible) { // keterangan ?>
		<td<?php echo $vw_spp_gu_list->keterangan->CellAttributes() ?>>
<span id="el<?php echo $vw_spp_gu_list_delete->RowCnt ?>_vw_spp_gu_list_keterangan" class="vw_spp_gu_list_keterangan">
...
<?php } ?>
<?php if ($vw_spp_gu_list->nama_bendahara->Visible) { // nama_bendahara ?>
		<td<?php echo $vw_spp_gu_list->nama_bendahara->CellAttributes() ?>>
<span id="el<?php echo $vw_spp_gu_list_delete->RowCnt ?>_vw_spp_gu_list_nama_bendahara" class="vw_spp_gu_list_nama_bendahara">
...
<?php } ?>
<?php if ($vw_spp_gu_list->nip_bendahara->Visible) { // nip_bendahara ?>
		<td<?php echo $vw_spp_gu_list->nip_bendahara->CellAttributes() ?>>
<span id="el<?php echo $vw_spp_gu_list_delete->RowCnt ?>_vw_spp_gu_list_nip_bendahara" class="vw_spp_gu_list_nip_bendahara">
...
<?php } ?>
<?php if ($vw_spp_gu_list->nama_pptk->Visible) { // nama_pptk ?>
		<td<?php echo $vw_spp_gu_list->nama_pptk->CellAttributes() ?>>
<span id="el<?php echo $vw_spp_gu_list_delete->RowCnt ?>_vw_spp_gu_list_nama_pptk" class="vw_spp_gu_list_nama_pptk">
...
<?php } ?>
<?php if ($vw_spp_gu_list->nip_pptk->Visible) { // nip_pptk ?>
		<td<?php echo $vw_spp_gu_list->nip_pptk->CellAttributes() ?>>
<span id="el<?php echo $vw_spp_gu_list_delete->RowCnt ?>_vw_spp_gu_list_nip_pptk" class="vw_spp_gu_list_nip_pptk">
...
<?php } ?>
<?php if ($vw_spp_gu_list->kode_program->Visible) { // kode_program ?>
		<td<?php echo $vw_spp_gu_list->kode_program->CellAttributes() ?>>
<span id="el<?php echo $vw_spp_gu_list_delete->RowCnt ?>_vw_spp_gu_list_kode_program" class="vw_spp_gu_list_kode_program">
...
<?php } ?>
<?php if ($vw_spp_gu_list->kode_kegiatan->Visible) { // kode_kegiatan ?>
		<td<?php echo $vw_spp_gu_list->kode_kegiatan->CellAttributes() ?>>
<span id="el<?php echo $vw_spp_gu_list_delete->RowCnt ?>_vw_spp_gu_list_kode_kegiatan" class="vw_spp_gu_list_kode_kegiatan">
...
<?php } ?>
<?php if ($vw_spp_gu_list->kode_sub_kegiatan->Visible) { // kode_sub_kegiatan ?>
		<td<?php echo $vw_spp_gu_list->kode_sub_kegiatan->CellAttributes() ?>>
<span id="el<?php echo $vw_spp_gu_list_delete->RowCnt ?>_vw_spp_gu_list_kode_sub_kegiatan" class="vw_spp_gu_list_kode_sub_kegiatan">
...
<?php } ?>
<?php if ($vw_spp_gu_list->tahun_anggaran->Visible) { // tahun_anggaran ?>
		<td<?php echo $vw_spp_gu_list->tahun_anggaran->CellAttributes() ?>>
<span id="el<?php echo $vw_spp_gu_list_delete->RowCnt ?>_vw_spp_gu_list_tahun_anggaran" class="vw_spp_gu_list_tahun_anggaran">
...
<?php } ?>
<?php if ($vw_spp_gu_list->id_spj->Visible) { // id_spj ?>
		<td<?php echo $vw_spp_gu_list->id_spj->CellAttributes() ?>>
<span id="el<?php echo $vw_spp_gu_list_delete->RowCnt ?>_vw_spp_gu_list_id_spj" class="vw_spp_gu_list_id_spj">
...
<?php } ?>
<?php if ($vw_spp_gu_list->id_spd->Visible) { // id_spd ?>
		<td<?php echo $vw_spp_gu_list->id_spd->CellAttributes() ?>>
<span id="el<?php echo $vw_spp_gu_list_delete->RowCnt ?>_vw_spp_gu_list_id_spd" class="vw_spp_gu_list_id_spd">
...
<?php
	$vw_spp_gu_list_delete->Recordset->MoveNext();
}
$vw_spp_gu_list_delete->Recordset->Close();
?>
</tbody>
</table>
</div>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $vw_spp_gu_list_delete->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
</div>
</form>
<script type="text/javascript">
fvw_spp_gu_listdelete.Init();
</script>
<?php
$vw_spp_gu_list_delete->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$vw_spp_gu_list_delete->Page_Terminate();
?>
