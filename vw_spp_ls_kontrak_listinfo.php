...
$vw_spp_ls_kontrak_list = NULL;

//
// Table class for vw_spp_ls_kontrak_list
//
class cvw_spp_ls_kontrak_list extends cTable {
	var $id;
	var $id_jenis_spp;
	...
	function __construct() {
		...
		$this->TableVar = 'vw_spp_ls_kontrak_list';
		$this->TableName = 'vw_spp_ls_kontrak_list';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`vw_spp_ls_kontrak_list`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('vw_spp_ls_kontrak_list', 'vw_spp_ls_kontrak_list', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// id_jenis_spp
		$this->id_jenis_spp = new cField('vw_spp_ls_kontrak_list', 'vw_spp_ls_kontrak_list', 'x_id_jenis_spp', 'id_jenis_spp', '`id_jenis_spp`', '`id_jenis_spp`', 3, -1, FALSE, '`id_jenis_spp`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// detail_jenis_spp
		$this->detail_jenis_spp = new cField('vw_spp_ls_kontrak_list', 'vw_spp_ls_kontrak_list', 'x_detail_jenis_spp', 'detail_jenis_spp', '`detail_jenis_spp`', '`detail_jenis_spp`', 3, -1, FALSE, '`detail_jenis_spp`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// status_spp
		$this->status_spp = new cField('vw_spp_ls_kontrak_list', 'vw_spp_ls_kontrak_list', 'x_status_spp', 'status_spp', '`status_spp`', '`status_spp`', 3, -1, FALSE, '`status_spp`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// no_spp
		$this->no_spp = new cField('vw_spp_ls_kontrak_list', 'vw_spp_ls_kontrak_list', 'x_no_spp', 'no_spp', '`no_spp`', '`no_spp`', 200, -1, FALSE, '`no_spp`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->no_spp->Sortable = TRUE; // Allow sort
		$this->fields['no_spp'] = &$this->no_spp;

		// tgl_spp
		$this->tgl_spp = new cField('vw_spp_ls_kontrak_list', 'vw_spp_ls_kontrak_list', 'x_tgl_spp', 'tgl_spp', '`tgl_spp`', ew_CastDateFieldForLike('`tgl_spp`', 7, "DB"), 135, 7, FALSE, '`tgl_spp`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// nama_pptk
		$this->nama_pptk = new cField('vw_spp_ls_kontrak_list', 'vw_spp_ls_kontrak_list', 'x_nama_pptk', 'nama_pptk', '`nama_pptk`', '`nama_pptk`', 200, -1, FALSE, '`nama_pptk`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// nip_pptk
		$this->nip_pptk = new cField('vw_spp_ls_kontrak_list', 'vw_spp_ls_kontrak_list', 'x_nip_pptk', 'nip_pptk', '`nip_pptk`', '`nip_pptk`', 200, -1, FALSE, '`nip_pptk`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->nip_pptk->Sortable = TRUE; // Allow sort
		$this->fields['nip_pptk'] = &$this->nip_pptk;

		// keterangan
		$this->keterangan = new cField('vw_spp_ls_kontrak_list', 'vw_spp_ls_kontrak_list', 'x_keterangan', 'keterangan', '`keterangan`', '`keterangan`', 201, -1, FALSE, '`keterangan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->keterangan->Sortable = TRUE; // Allow sort
		$this->fields['keterangan'] = &$this->keterangan;

		// nama_bendahara
		$this->nama_bendahara = new cField('vw_spp_ls_kontrak_list', 'vw_spp_ls_kontrak_list', 'x_nama_bendahara', 'nama_bendahara', '`nama_bendahara`', '`nama_bendahara`', 200, -1, FALSE, '`nama_bendahara`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// nip_bendahara
		$this->nip_bendahara = new cField('vw_spp_ls_kontrak_list', 'vw_spp_ls_kontrak_list', 'x_nip_bendahara', 'nip_bendahara', '`nip_bendahara`', '`nip_bendahara`', 200, -1, FALSE, '`nip_bendahara`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->nip_bendahara->Sortable = TRUE; // Allow sort
		$this->fields['nip_bendahara'] = &$this->nip_bendahara;

		// kode_program
		$this->kode_program = new cField('vw_spp_ls_kontrak_list', 'vw_spp_ls_kontrak_list', 'x_kode_program', 'kode_program', '`kode_program`', '`kode_program`', 200, -1, FALSE, '`kode_program`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->kode_program->Sortable = TRUE; // Allow sort
		$this->fields['kode_program'] = &$this->kode_program;

		// kode_kegiatan
		$this->kode_kegiatan = new cField('vw_spp_ls_kontrak_list', 'vw_spp_ls_kontrak_list', 'x_kode_kegiatan', 'kode_kegiatan', '`kode_kegiatan`', '`kode_kegiatan`', 200, -1, FALSE, '`kode_kegiatan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->kode_kegiatan->Sortable = TRUE; // Allow sort
		$this->fields['kode_kegiatan'] = &$this->kode_kegiatan;

		// kode_sub_kegiatan
		$this->kode_sub_kegiatan = new cField('vw_spp_ls_kontrak_list', 'vw_spp_ls_kontrak_list', 'x_kode_sub_kegiatan', 'kode_sub_kegiatan', '`kode_sub_kegiatan`', '`kode_sub_kegiatan`', 200, -1, FALSE, '`kode_sub_kegiatan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->kode_sub_kegiatan->Sortable = TRUE; // Allow sort
		$this->fields['kode_sub_kegiatan'] = &$this->kode_sub_kegiatan;

		// kontrak_id
		$this->kontrak_id = new cField('vw_spp_ls_kontrak_list', 'vw_spp_ls_kontrak_list', 'x_kontrak_id', 'kontrak_id', '`kontrak_id`', '`kontrak_id`', 3, -1, FALSE, '`kontrak_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		$this->kontrak_id->Sortable = TRUE; // Allow sort
		$this->kontrak_id->UsePleaseSelect = TRUE; // Use PleaseSelect by default
		$this->kontrak_id->PleaseSelectText = $Language->Phrase("PleaseSelect"); // PleaseSelect text
		$this->kontrak_id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['kontrak_id'] = &$this->kontrak_id;

		// tahun_anggaran
		$this->tahun_anggaran = new cField('vw_spp_ls_kontrak_list', 'vw_spp_ls_kontrak_list', 'x_tahun_anggaran', 'tahun_anggaran', '`tahun_anggaran`', '`tahun_anggaran`', 3, -1, FALSE, '`tahun_anggaran`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function GetDetailUrl() {
		...
		// Detail url
		$sDetailUrl = "";
		if ($this->getCurrentDetailTable() == "vw_spp_ls_barang_jasa_detail") {
			$sDetailUrl = $GLOBALS["vw_spp_ls_barang_jasa_detail"]->GetListUrl() . "?" . EW_TABLE_SHOW_MASTER . "=" . $this->TableVar;
		...
		if ($this->getCurrentDetailTable() == "vw_spp_detail_pajak") {
			$sDetailUrl = $GLOBALS["vw_spp_detail_pajak"]->GetListUrl() . "?" . EW_TABLE_SHOW_MASTER . "=" . $this->TableVar;
			$sDetailUrl .= "&fk_id=" . urlencode($this->id->CurrentValue);
			$sDetailUrl .= "&fk_id_jenis_spp=" . urlencode($this->id_jenis_spp->CurrentValue);
			$sDetailUrl .= "&fk_detail_jenis_spp=" . urlencode($this->detail_jenis_spp->CurrentValue);
			$sDetailUrl .= "&fk_no_spp=" . urlencode($this->no_spp->CurrentValue);
		...
		if ($sDetailUrl == "") {
			$sDetailUrl = "vw_spp_ls_kontrak_listlist.php";
		}
		return $sDetailUrl;
	}
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`vw_spp_ls_kontrak_list`";
	}
	...
	function getSqlWhere() { // Where
		...
		$this->TableFilter = "`detail_jenis_spp`=6";
	...
	function Delete(&$rs, $where = "", $curfilter = TRUE) {
		...
		// Cascade delete detail table 'vw_spp_ls_barang_jasa_detail'
		if (!isset($GLOBALS["vw_spp_ls_barang_jasa_detail"])) $GLOBALS["vw_spp_ls_barang_jasa_detail"] = new cvw_spp_ls_barang_jasa_detail();
		$rscascade = $GLOBALS["vw_spp_ls_barang_jasa_detail"]->LoadRs("`id_spp` = " . ew_QuotedValue($rs['id'], EW_DATATYPE_NUMBER, "DB") . " AND " . "`id_jenis_spp` = " . ew_QuotedValue($rs['id_jenis_spp'], EW_DATATYPE_NUMBER, "DB") . " AND " . "`detail_jenis_spp` = " . ew_QuotedValue($rs['detail_jenis_spp'], EW_DATATYPE_NUMBER, "DB") . " AND " . "`no_spp` = " . ew_QuotedValue($rs['no_spp'], EW_DATATYPE_STRING, "DB") . " AND " . "`program` = " . ew_QuotedValue($rs['kode_program'], EW_DATATYPE_STRING, "DB") . " AND " . "`kegiatan` = " . ew_QuotedValue($rs['kode_kegiatan'], EW_DATATYPE_STRING, "DB") . " AND " . "`sub_kegiatan` = " . ew_QuotedValue($rs['kode_sub_kegiatan'], EW_DATATYPE_STRING, "DB") . " AND " . "`tahun_anggaran` = " . ew_QuotedValue($rs['tahun_anggaran'], EW_DATATYPE_NUMBER, "DB")); 
		while ($rscascade && !$rscascade->EOF) {
			$GLOBALS["vw_spp_ls_barang_jasa_detail"]->Delete($rscascade->fields);
			$rscascade->MoveNext();
		}

		// Cascade delete detail table 'vw_spp_detail_pajak'
		if (!isset($GLOBALS["vw_spp_detail_pajak"])) $GLOBALS["vw_spp_detail_pajak"] = new cvw_spp_detail_pajak();
		$rscascade = $GLOBALS["vw_spp_detail_pajak"]->LoadRs("`id_spp` = " . ew_QuotedValue($rs['id'], EW_DATATYPE_NUMBER, "DB") . " AND " . "`id_jenis_spp` = " . ew_QuotedValue($rs['id_jenis_spp'], EW_DATATYPE_NUMBER, "DB") . " AND " . "`detail_jenis_spp` = " . ew_QuotedValue($rs['detail_jenis_spp'], EW_DATATYPE_NUMBER, "DB") . " AND " . "`no_spp` = " . ew_QuotedValue($rs['no_spp'], EW_DATATYPE_STRING, "DB") . " AND " . "`program` = " . ew_QuotedValue($rs['kode_program'], EW_DATATYPE_STRING, "DB") . " AND " . "`kegiatan` = " . ew_QuotedValue($rs['kode_kegiatan'], EW_DATATYPE_STRING, "DB") . " AND " . "`sub_kegiatan` = " . ew_QuotedValue($rs['kode_sub_kegiatan'], EW_DATATYPE_STRING, "DB") . " AND " . "`tahun_anggaran` = " . ew_QuotedValue($rs['tahun_anggaran'], EW_DATATYPE_NUMBER, "DB")); 
		while ($rscascade && !$rscascade->EOF) {
			$GLOBALS["vw_spp_detail_pajak"]->Delete($rscascade->fields);
			$rscascade->MoveNext();
		}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "vw_spp_ls_kontrak_listlist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("vw_spp_ls_kontrak_listview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("vw_spp_ls_kontrak_listview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "vw_spp_ls_kontrak_listadd.php?" . $this->UrlParm($parm);
		else
			$url = "vw_spp_ls_kontrak_listadd.php";
		return $this->AddMasterUrl($url);
	}
	...
	function GetEditUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("vw_spp_ls_kontrak_listedit.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("vw_spp_ls_kontrak_listedit.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("vw_spp_ls_kontrak_listadd.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("vw_spp_ls_kontrak_listadd.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("vw_spp_ls_kontrak_listdelete.php", $this->UrlParm());
	}
   ...
   // Common render codes
	...
	function GetAutoFill($id, $val) {
		...
		if (preg_match('/^x(\d)*_kontrak_id$/', $id)) {
			$conn = &$this->Connection();
			$sSqlWrk = "SELECT `program` AS FIELD0, `kegiatan` AS FIELD1, `sub_kegiatan` AS FIELD2 FROM `data_kontrak`";
			...
			if ($rs = ew_LoadRecordset($sSqlWrk, $conn)) {
				while ($rs && !$rs->EOF) {
					$ar = array();
					$this->kode_program->setDbValue($rs->fields[0]);
					$this->kode_kegiatan->setDbValue($rs->fields[1]);
					$this->kode_sub_kegiatan->setDbValue($rs->fields[2]);
					$this->RowType == EW_ROWTYPE_EDIT;
					$this->RenderEditRow();
					$ar[] = ($this->kode_program->AutoFillOriginalValue) ? $this->kode_program->CurrentValue : $this->kode_program->EditValue;
					$ar[] = ($this->kode_kegiatan->AutoFillOriginalValue) ? $this->kode_kegiatan->CurrentValue : $this->kode_kegiatan->EditValue;
					$ar[] = ($this->kode_sub_kegiatan->AutoFillOriginalValue) ? $this->kode_sub_kegiatan->CurrentValue : $this->kode_sub_kegiatan->EditValue;
					$rowcnt += 1;
					$rsarr[] = $ar;
					$rs->MoveNext();
				}
	...
	function Row_Inserting($rsold, &$rsnew) {
		...
		//$rsnew["kode_rekening"] = "fff";
		$rsnew["no_spp"] = GetNextNomerSPP_LS(); 
		return TRUE;
	}
	...
	function Row_Inserted($rsold, &$rsnew) {
		...
		//echo "Row Inserted"
		ew_Execute("call simrs2012.update_spp('".$rsnew["id"]."')");
	}
	...
	function Row_Rendered() {
		...
		$this->kode_program->ReadOnly = TRUE;
		$this->kode_kegiatan->ReadOnly = TRUE;
		$this->kode_sub_kegiatan->ReadOnly = TRUE;
		$this->nip_bendahara->ReadOnly = TRUE;
		$this->nip_pptk->ReadOnly = TRUE;
		$this->tahun_anggaran->ReadOnly = TRUE;
		if (CurrentPageID() == "add" && $this->CurrentAction != "F") {
			$this->no_spp->CurrentValue = GetNextNomerSPP_LS(); // trik
