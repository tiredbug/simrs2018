...
$m_sub_kegiatan_grid = NULL; // Initialize page object first

class cm_sub_kegiatan_grid extends cm_sub_kegiatan {
	...
	// Page object name
	var $PageObjName = 'm_sub_kegiatan_grid';

	// Grid form hidden field names
	var $FormName = 'fm_sub_kegiatangrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["m_sub_kegiatan"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function EmptyRow() {
		global $objForm;
		if ($objForm->HasValue("x_kode_program") && $objForm->HasValue("o_kode_program") && $this->kode_program->CurrentValue <> $this->kode_program->OldValue)
			return FALSE;
		if ($objForm->HasValue("x_kode_kegiatan") && $objForm->HasValue("o_kode_kegiatan") && $this->kode_kegiatan->CurrentValue <> $this->kode_kegiatan->OldValue)
			return FALSE;
		if ($objForm->HasValue("x_kode_sub_kegiatan") && $objForm->HasValue("o_kode_sub_kegiatan") && $this->kode_sub_kegiatan->CurrentValue <> $this->kode_sub_kegiatan->OldValue)
			return FALSE;
		if ($objForm->HasValue("x_nama_sub_kegiatan") && $objForm->HasValue("o_nama_sub_kegiatan") && $this->nama_sub_kegiatan->CurrentValue <> $this->nama_sub_kegiatan->OldValue)
			return FALSE;
		return TRUE;
	}
	...
	function AddRow($rsold = NULL) {
		...
		// Set up foreign key field value from Session
			if ($this->getCurrentMasterTable() == "m_kegiatan") {
				$this->kode_program->CurrentValue = $this->kode_program->getSessionValue();
				$this->kode_kegiatan->CurrentValue = $this->kode_kegiatan->getSessionValue();
			}
	...
	function SetUpMasterParms() {
		...
		if ($sMasterTblVar == "m_kegiatan") {
			...
			if ($GLOBALS["m_kegiatan"]->EventCancelled) $this->EventCancelled = TRUE;
			$this->kode_kegiatan->Visible = FALSE;
			if ($GLOBALS["m_kegiatan"]->EventCancelled) $this->EventCancelled = TRUE;
		}
