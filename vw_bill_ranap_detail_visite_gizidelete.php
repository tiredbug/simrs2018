...
$vw_bill_ranap_detail_visite_gizi_delete = NULL; // Initialize page object first

class cvw_bill_ranap_detail_visite_gizi_delete extends cvw_bill_ranap_detail_visite_gizi {
	...
	// Page object name
	var $PageObjName = 'vw_bill_ranap_detail_visite_gizi_delete';
	...
	function Page_Main() {
		...
		if ($sFilter == "")
			$this->Page_Terminate("vw_bill_ranap_detail_visite_gizilist.php"); // Prevent SQL injection, return to list

		// Set up filter (SQL WHHERE clause) and get return SQL
		// SQL constructor in vw_bill_ranap_detail_visite_gizi class, vw_bill_ranap_detail_visite_giziinfo.php
		...
		if ($this->CurrentAction == "I") { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->Page_Terminate("vw_bill_ranap_detail_visite_gizilist.php"); // Return to list
			}
		}
	}
...
// Create page object
if (!isset($vw_bill_ranap_detail_visite_gizi_delete)) $vw_bill_ranap_detail_visite_gizi_delete = new cvw_bill_ranap_detail_visite_gizi_delete();

// Page init
$vw_bill_ranap_detail_visite_gizi_delete->Page_Init();

// Page main
$vw_bill_ranap_detail_visite_gizi_delete->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$vw_bill_ranap_detail_visite_gizi_delete->Page_Render();
?>
...
var CurrentForm = fvw_bill_ranap_detail_visite_gizidelete = new ew_Form("fvw_bill_ranap_detail_visite_gizidelete", "delete");

// Form_CustomValidate event
fvw_bill_ranap_detail_visite_gizidelete.Form_CustomValidate = 
...
fvw_bill_ranap_detail_visite_gizidelete.ValidateRequired = true;
<?php } else { ?>
fvw_bill_ranap_detail_visite_gizidelete.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fvw_bill_ranap_detail_visite_gizidelete.Lists["x_kode_tindakan"] = {"LinkField":"x_kode","Ajax":true,"AutoFill":false,"DisplayFields":["x_nama_tindakan","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"vw_bill_ranap_data_tarif_tindakan"};
...
<?php $vw_bill_ranap_detail_visite_gizi_delete->ShowPageHeader(); ?>
<?php
$vw_bill_ranap_detail_visite_gizi_delete->ShowMessage();
?>
<form name="fvw_bill_ranap_detail_visite_gizidelete" id="fvw_bill_ranap_detail_visite_gizidelete" class="form-inline ewForm ewDeleteForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($vw_bill_ranap_detail_visite_gizi_delete->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $vw_bill_ranap_detail_visite_gizi_delete->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="vw_bill_ranap_detail_visite_gizi">
<input type="hidden" name="a_delete" id="a_delete" value="D">
<?php foreach ($vw_bill_ranap_detail_visite_gizi_delete->RecKeys as $key) { ?>
...
<?php if ($vw_bill_ranap_detail_visite_gizi->tanggal->Visible) { // tanggal ?>
		<th><span id="elh_vw_bill_ranap_detail_visite_gizi_tanggal" class="vw_bill_ranap_detail_visite_gizi_tanggal"><?php echo $vw_bill_ranap_detail_visite_gizi->tanggal->FldCaption() ?></span></th>
<?php } ?>
<?php if ($vw_bill_ranap_detail_visite_gizi->kode_tindakan->Visible) { // kode_tindakan ?>
		<th><span id="elh_vw_bill_ranap_detail_visite_gizi_kode_tindakan" class="vw_bill_ranap_detail_visite_gizi_kode_tindakan"><?php echo $vw_bill_ranap_detail_visite_gizi->kode_tindakan->FldCaption() ?></span></th>
<?php } ?>
<?php if ($vw_bill_ranap_detail_visite_gizi->tarif->Visible) { // tarif ?>
		<th><span id="elh_vw_bill_ranap_detail_visite_gizi_tarif" class="vw_bill_ranap_detail_visite_gizi_tarif"><?php echo $vw_bill_ranap_detail_visite_gizi->tarif->FldCaption() ?></span></th>
<?php } ?>
<?php if ($vw_bill_ranap_detail_visite_gizi->qty->Visible) { // qty ?>
		<th><span id="elh_vw_bill_ranap_detail_visite_gizi_qty" class="vw_bill_ranap_detail_visite_gizi_qty"><?php echo $vw_bill_ranap_detail_visite_gizi->qty->FldCaption() ?></span></th>
<?php } ?>
<?php if ($vw_bill_ranap_detail_visite_gizi->user->Visible) { // user ?>
		<th><span id="elh_vw_bill_ranap_detail_visite_gizi_user" class="vw_bill_ranap_detail_visite_gizi_user"><?php echo $vw_bill_ranap_detail_visite_gizi->user->FldCaption() ?></span></th>
<?php } ?>
<?php if ($vw_bill_ranap_detail_visite_gizi->no_ruang->Visible) { // no_ruang ?>
		<th><span id="elh_vw_bill_ranap_detail_visite_gizi_no_ruang" class="vw_bill_ranap_detail_visite_gizi_no_ruang"><?php echo $vw_bill_ranap_detail_visite_gizi->no_ruang->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
<?php
$vw_bill_ranap_detail_visite_gizi_delete->RecCnt = 0;
$i = 0;
while (!$vw_bill_ranap_detail_visite_gizi_delete->Recordset->EOF) {
	$vw_bill_ranap_detail_visite_gizi_delete->RecCnt++;
	$vw_bill_ranap_detail_visite_gizi_delete->RowCnt++;

	// Set row properties
	$vw_bill_ranap_detail_visite_gizi->ResetAttrs();
	$vw_bill_ranap_detail_visite_gizi->RowType = EW_ROWTYPE_VIEW; // View

	// Get the field contents
	$vw_bill_ranap_detail_visite_gizi_delete->LoadRowValues($vw_bill_ranap_detail_visite_gizi_delete->Recordset);

	// Render row
	$vw_bill_ranap_detail_visite_gizi_delete->RenderRow();
?>
	<tr<?php echo $vw_bill_ranap_detail_visite_gizi->RowAttributes() ?>>
<?php if ($vw_bill_ranap_detail_visite_gizi->tanggal->Visible) { // tanggal ?>
		<td<?php echo $vw_bill_ranap_detail_visite_gizi->tanggal->CellAttributes() ?>>
<span id="el<?php echo $vw_bill_ranap_detail_visite_gizi_delete->RowCnt ?>_vw_bill_ranap_detail_visite_gizi_tanggal" class="vw_bill_ranap_detail_visite_gizi_tanggal">
...
<?php } ?>
<?php if ($vw_bill_ranap_detail_visite_gizi->kode_tindakan->Visible) { // kode_tindakan ?>
		<td<?php echo $vw_bill_ranap_detail_visite_gizi->kode_tindakan->CellAttributes() ?>>
<span id="el<?php echo $vw_bill_ranap_detail_visite_gizi_delete->RowCnt ?>_vw_bill_ranap_detail_visite_gizi_kode_tindakan" class="vw_bill_ranap_detail_visite_gizi_kode_tindakan">
...
<?php } ?>
<?php if ($vw_bill_ranap_detail_visite_gizi->tarif->Visible) { // tarif ?>
		<td<?php echo $vw_bill_ranap_detail_visite_gizi->tarif->CellAttributes() ?>>
<span id="el<?php echo $vw_bill_ranap_detail_visite_gizi_delete->RowCnt ?>_vw_bill_ranap_detail_visite_gizi_tarif" class="vw_bill_ranap_detail_visite_gizi_tarif">
...
<?php } ?>
<?php if ($vw_bill_ranap_detail_visite_gizi->qty->Visible) { // qty ?>
		<td<?php echo $vw_bill_ranap_detail_visite_gizi->qty->CellAttributes() ?>>
<span id="el<?php echo $vw_bill_ranap_detail_visite_gizi_delete->RowCnt ?>_vw_bill_ranap_detail_visite_gizi_qty" class="vw_bill_ranap_detail_visite_gizi_qty">
...
<?php } ?>
<?php if ($vw_bill_ranap_detail_visite_gizi->user->Visible) { // user ?>
		<td<?php echo $vw_bill_ranap_detail_visite_gizi->user->CellAttributes() ?>>
<span id="el<?php echo $vw_bill_ranap_detail_visite_gizi_delete->RowCnt ?>_vw_bill_ranap_detail_visite_gizi_user" class="vw_bill_ranap_detail_visite_gizi_user">
...
<?php } ?>
<?php if ($vw_bill_ranap_detail_visite_gizi->no_ruang->Visible) { // no_ruang ?>
		<td<?php echo $vw_bill_ranap_detail_visite_gizi->no_ruang->CellAttributes() ?>>
<span id="el<?php echo $vw_bill_ranap_detail_visite_gizi_delete->RowCnt ?>_vw_bill_ranap_detail_visite_gizi_no_ruang" class="vw_bill_ranap_detail_visite_gizi_no_ruang">
...
<?php
	$vw_bill_ranap_detail_visite_gizi_delete->Recordset->MoveNext();
}
$vw_bill_ranap_detail_visite_gizi_delete->Recordset->Close();
?>
</tbody>
</table>
</div>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $vw_bill_ranap_detail_visite_gizi_delete->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
</div>
</form>
<script type="text/javascript">
fvw_bill_ranap_detail_visite_gizidelete.Init();
</script>
<?php
$vw_bill_ranap_detail_visite_gizi_delete->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$vw_bill_ranap_detail_visite_gizi_delete->Page_Terminate();
?>
