...
$t_advis_spm_detail_edit = NULL; // Initialize page object first

class ct_advis_spm_detail_edit extends ct_advis_spm_detail {
	...
	// Page object name
	var $PageObjName = 't_advis_spm_detail_edit';
	...
	function Page_Main() {
		...
		if ($this->id->CurrentValue == "") {
			$this->Page_Terminate("t_advis_spm_detaillist.php"); // Invalid key, return to list
		}
...
// Create page object
if (!isset($t_advis_spm_detail_edit)) $t_advis_spm_detail_edit = new ct_advis_spm_detail_edit();

// Page init
$t_advis_spm_detail_edit->Page_Init();

// Page main
$t_advis_spm_detail_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t_advis_spm_detail_edit->Page_Render();
?>
...
var CurrentForm = ft_advis_spm_detailedit = new ew_Form("ft_advis_spm_detailedit", "edit");

// Validate form
ft_advis_spm_detailedit.Validate = function() {
...
ft_advis_spm_detailedit.Form_CustomValidate = 
...
ft_advis_spm_detailedit.ValidateRequired = true;
<?php } else { ?>
ft_advis_spm_detailedit.ValidateRequired = false; 
<?php } ?>
...
<?php if (!$t_advis_spm_detail_edit->IsModal) { ?>
<?php } ?>
<?php $t_advis_spm_detail_edit->ShowPageHeader(); ?>
<?php
$t_advis_spm_detail_edit->ShowMessage();
?>
<form name="ft_advis_spm_detailedit" id="ft_advis_spm_detailedit" class="<?php echo $t_advis_spm_detail_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t_advis_spm_detail_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t_advis_spm_detail_edit->Token ?>">
<?php } ?>
...
<?php } ?>
<div>
<?php if ($t_advis_spm_detail->id->Visible) { // id ?>
	<div id="r_id" class="form-group">
		<label id="elh_t_advis_spm_detail_id" class="col-sm-2 control-label ewLabel"><?php echo $t_advis_spm_detail->id->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $t_advis_spm_detail->id->CellAttributes() ?>>
<span id="el_t_advis_spm_detail_id">
<span<?php echo $t_advis_spm_detail->id->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $t_advis_spm_detail->id->EditValue ?></p></span>
</span>
<input type="hidden" data-table="t_advis_spm_detail" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($t_advis_spm_detail->id->CurrentValue) ?>">
<?php echo $t_advis_spm_detail->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
</div>
<?php if (!$t_advis_spm_detail_edit->IsModal) { ?>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t_advis_spm_detail_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
ft_advis_spm_detailedit.Init();
</script>
<?php
$t_advis_spm_detail_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$t_advis_spm_detail_edit->Page_Terminate();
?>
