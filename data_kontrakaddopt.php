...
$data_kontrak_addopt = NULL; // Initialize page object first

class cdata_kontrak_addopt extends cdata_kontrak {
	...
	// Page object name
	var $PageObjName = 'data_kontrak_addopt';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow()) { // Add successful
					...
					$row["x_program"] = $this->program->DbValue;
					$row["x_kegiatan"] = $this->kegiatan->DbValue;
					$row["x_sub_kegiatan"] = $this->sub_kegiatan->DbValue;
					$row["x_no_kontrak"] = $this->no_kontrak->DbValue;
					$row["x_tgl_kontrak"] = $this->tgl_kontrak->DbValue;
					$row["x_nama_perusahaan"] = $this->nama_perusahaan->DbValue;
					$row["x_bentuk_perusahaan"] = $this->bentuk_perusahaan->DbValue;
					$row["x_alamat_perusahaan"] = $this->alamat_perusahaan->DbValue;
					$row["x_kepala_perusahaan"] = $this->kepala_perusahaan->DbValue;
					$row["x_npwp"] = $this->npwp->DbValue;
					$row["x_nama_bank"] = $this->nama_bank->DbValue;
					$row["x_nama_rekening"] = $this->nama_rekening->DbValue;
					$row["x_nomer_rekening"] = $this->nomer_rekening->DbValue;
					$row["x_lanjutkan"] = $this->lanjutkan->DbValue;
					$row["x_waktu_kontrak"] = $this->waktu_kontrak->DbValue;
					$row["x_tgl_mulai"] = $this->tgl_mulai->DbValue;
					$row["x_tgl_selesai"] = $this->tgl_selesai->DbValue;
					$row["x_paket_pekerjaan"] = $this->paket_pekerjaan->DbValue;
					$row["x_nama_ppkom"] = $this->nama_ppkom->DbValue;
					$row["x_nip_ppkom"] = $this->nip_ppkom->DbValue;
					if (!EW_DEBUG_ENABLED && ob_get_length())
						ob_end_clean();
	...
	function LoadDefaultValues() {
		...
		$this->no_kontrak->CurrentValue = NULL;
		$this->no_kontrak->OldValue = $this->no_kontrak->CurrentValue;
		$this->tgl_kontrak->CurrentValue = NULL;
		$this->tgl_kontrak->OldValue = $this->tgl_kontrak->CurrentValue;
		$this->nama_perusahaan->CurrentValue = NULL;
		$this->nama_perusahaan->OldValue = $this->nama_perusahaan->CurrentValue;
		$this->bentuk_perusahaan->CurrentValue = NULL;
		$this->bentuk_perusahaan->OldValue = $this->bentuk_perusahaan->CurrentValue;
		$this->alamat_perusahaan->CurrentValue = NULL;
		$this->alamat_perusahaan->OldValue = $this->alamat_perusahaan->CurrentValue;
		$this->kepala_perusahaan->CurrentValue = NULL;
		$this->kepala_perusahaan->OldValue = $this->kepala_perusahaan->CurrentValue;
		...
		$this->lanjutkan->CurrentValue = NULL;
		$this->lanjutkan->OldValue = $this->lanjutkan->CurrentValue;
		$this->waktu_kontrak->CurrentValue = NULL;
		$this->waktu_kontrak->OldValue = $this->waktu_kontrak->CurrentValue;
		$this->tgl_mulai->CurrentValue = date("d/m/Y");
		$this->tgl_selesai->CurrentValue = date("d/m/Y");
		$this->paket_pekerjaan->CurrentValue = NULL;
		$this->paket_pekerjaan->OldValue = $this->paket_pekerjaan->CurrentValue;
		$this->nama_ppkom->CurrentValue = NULL;
		$this->nama_ppkom->OldValue = $this->nama_ppkom->CurrentValue;
		$this->nip_ppkom->CurrentValue = NULL;
		$this->nip_ppkom->OldValue = $this->nip_ppkom->CurrentValue;
	}
	...
	function LoadFormValues() {
		...
		if (!$this->program->FldIsDetailKey) {
			$this->program->setFormValue(ew_ConvertFromUtf8($objForm->GetValue("x_program")));
		}
		if (!$this->kegiatan->FldIsDetailKey) {
			$this->kegiatan->setFormValue(ew_ConvertFromUtf8($objForm->GetValue("x_kegiatan")));
		}
		if (!$this->sub_kegiatan->FldIsDetailKey) {
			$this->sub_kegiatan->setFormValue(ew_ConvertFromUtf8($objForm->GetValue("x_sub_kegiatan")));
		}
		if (!$this->no_kontrak->FldIsDetailKey) {
			$this->no_kontrak->setFormValue(ew_ConvertFromUtf8($objForm->GetValue("x_no_kontrak")));
		}
		if (!$this->tgl_kontrak->FldIsDetailKey) {
			$this->tgl_kontrak->setFormValue(ew_ConvertFromUtf8($objForm->GetValue("x_tgl_kontrak")));
			$this->tgl_kontrak->CurrentValue = ew_UnFormatDateTime($this->tgl_kontrak->CurrentValue, 0);
		}
		if (!$this->nama_perusahaan->FldIsDetailKey) {
			$this->nama_perusahaan->setFormValue(ew_ConvertFromUtf8($objForm->GetValue("x_nama_perusahaan")));
		}
		if (!$this->bentuk_perusahaan->FldIsDetailKey) {
			$this->bentuk_perusahaan->setFormValue(ew_ConvertFromUtf8($objForm->GetValue("x_bentuk_perusahaan")));
		}
		if (!$this->alamat_perusahaan->FldIsDetailKey) {
			$this->alamat_perusahaan->setFormValue(ew_ConvertFromUtf8($objForm->GetValue("x_alamat_perusahaan")));
		}
		if (!$this->kepala_perusahaan->FldIsDetailKey) {
			$this->kepala_perusahaan->setFormValue(ew_ConvertFromUtf8($objForm->GetValue("x_kepala_perusahaan")));
		}
		...
		if (!$this->nama_bank->FldIsDetailKey) {
			$this->nama_bank->setFormValue(ew_ConvertFromUtf8($objForm->GetValue("x_nama_bank")));
		}
		...
		if (!$this->lanjutkan->FldIsDetailKey) {
			$this->lanjutkan->setFormValue(ew_ConvertFromUtf8($objForm->GetValue("x_lanjutkan")));
		}
		if (!$this->waktu_kontrak->FldIsDetailKey) {
			$this->waktu_kontrak->setFormValue(ew_ConvertFromUtf8($objForm->GetValue("x_waktu_kontrak")));
		}
		if (!$this->tgl_mulai->FldIsDetailKey) {
			$this->tgl_mulai->setFormValue(ew_ConvertFromUtf8($objForm->GetValue("x_tgl_mulai")));
			$this->tgl_mulai->CurrentValue = ew_UnFormatDateTime($this->tgl_mulai->CurrentValue, 7);
		}
		if (!$this->tgl_selesai->FldIsDetailKey) {
			$this->tgl_selesai->setFormValue(ew_ConvertFromUtf8($objForm->GetValue("x_tgl_selesai")));
			$this->tgl_selesai->CurrentValue = ew_UnFormatDateTime($this->tgl_selesai->CurrentValue, 7);
		}
		if (!$this->paket_pekerjaan->FldIsDetailKey) {
			$this->paket_pekerjaan->setFormValue(ew_ConvertFromUtf8($objForm->GetValue("x_paket_pekerjaan")));
		}
		if (!$this->nama_ppkom->FldIsDetailKey) {
			$this->nama_ppkom->setFormValue(ew_ConvertFromUtf8($objForm->GetValue("x_nama_ppkom")));
		}
		if (!$this->nip_ppkom->FldIsDetailKey) {
			$this->nip_ppkom->setFormValue(ew_ConvertFromUtf8($objForm->GetValue("x_nip_ppkom")));
		}
	}
	...
	function RestoreFormValues() {
		global $objForm;
		$this->program->CurrentValue = ew_ConvertToUtf8($this->program->FormValue);
		$this->kegiatan->CurrentValue = ew_ConvertToUtf8($this->kegiatan->FormValue);
		$this->sub_kegiatan->CurrentValue = ew_ConvertToUtf8($this->sub_kegiatan->FormValue);
		$this->no_kontrak->CurrentValue = ew_ConvertToUtf8($this->no_kontrak->FormValue);
		$this->tgl_kontrak->CurrentValue = ew_ConvertToUtf8($this->tgl_kontrak->FormValue);
		$this->tgl_kontrak->CurrentValue = ew_UnFormatDateTime($this->tgl_kontrak->CurrentValue, 0);
		$this->nama_perusahaan->CurrentValue = ew_ConvertToUtf8($this->nama_perusahaan->FormValue);
		$this->bentuk_perusahaan->CurrentValue = ew_ConvertToUtf8($this->bentuk_perusahaan->FormValue);
		$this->alamat_perusahaan->CurrentValue = ew_ConvertToUtf8($this->alamat_perusahaan->FormValue);
		$this->kepala_perusahaan->CurrentValue = ew_ConvertToUtf8($this->kepala_perusahaan->FormValue);
		$this->npwp->CurrentValue = ew_ConvertToUtf8($this->npwp->FormValue);
		$this->nama_bank->CurrentValue = ew_ConvertToUtf8($this->nama_bank->FormValue);
		...
		$this->lanjutkan->CurrentValue = ew_ConvertToUtf8($this->lanjutkan->FormValue);
		$this->waktu_kontrak->CurrentValue = ew_ConvertToUtf8($this->waktu_kontrak->FormValue);
		$this->tgl_mulai->CurrentValue = ew_ConvertToUtf8($this->tgl_mulai->FormValue);
		$this->tgl_mulai->CurrentValue = ew_UnFormatDateTime($this->tgl_mulai->CurrentValue, 7);
		$this->tgl_selesai->CurrentValue = ew_ConvertToUtf8($this->tgl_selesai->FormValue);
		$this->tgl_selesai->CurrentValue = ew_UnFormatDateTime($this->tgl_selesai->CurrentValue, 7);
		$this->paket_pekerjaan->CurrentValue = ew_ConvertToUtf8($this->paket_pekerjaan->FormValue);
		$this->nama_ppkom->CurrentValue = ew_ConvertToUtf8($this->nama_ppkom->FormValue);
		$this->nip_ppkom->CurrentValue = ew_ConvertToUtf8($this->nip_ppkom->FormValue);
	}
	...
	function AddRow($rsold = NULL) {
		...
		// no_kontrak
		$this->no_kontrak->SetDbValueDef($rsnew, $this->no_kontrak->CurrentValue, NULL, FALSE);

		// tgl_kontrak
		$this->tgl_kontrak->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->tgl_kontrak->CurrentValue, 0), NULL, FALSE);

		// nama_perusahaan
		$this->nama_perusahaan->SetDbValueDef($rsnew, $this->nama_perusahaan->CurrentValue, NULL, FALSE);

		// bentuk_perusahaan
		$this->bentuk_perusahaan->SetDbValueDef($rsnew, $this->bentuk_perusahaan->CurrentValue, NULL, FALSE);

		// alamat_perusahaan
		$this->alamat_perusahaan->SetDbValueDef($rsnew, $this->alamat_perusahaan->CurrentValue, NULL, FALSE);

		// kepala_perusahaan
		$this->kepala_perusahaan->SetDbValueDef($rsnew, $this->kepala_perusahaan->CurrentValue, NULL, FALSE);
		...
		// lanjutkan
		$this->lanjutkan->SetDbValueDef($rsnew, $this->lanjutkan->CurrentValue, NULL, FALSE);

		// waktu_kontrak
		$this->waktu_kontrak->SetDbValueDef($rsnew, $this->waktu_kontrak->CurrentValue, NULL, FALSE);

		// tgl_mulai
		$this->tgl_mulai->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->tgl_mulai->CurrentValue, 7), NULL, FALSE);

		// tgl_selesai
		$this->tgl_selesai->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->tgl_selesai->CurrentValue, 7), NULL, FALSE);

		// paket_pekerjaan
		$this->paket_pekerjaan->SetDbValueDef($rsnew, $this->paket_pekerjaan->CurrentValue, NULL, FALSE);

		// nama_ppkom
		$this->nama_ppkom->SetDbValueDef($rsnew, $this->nama_ppkom->CurrentValue, NULL, FALSE);

		// nip_ppkom
		$this->nip_ppkom->SetDbValueDef($rsnew, $this->nip_ppkom->CurrentValue, NULL, FALSE);
...
// Create page object
if (!isset($data_kontrak_addopt)) $data_kontrak_addopt = new cdata_kontrak_addopt();

// Page init
$data_kontrak_addopt->Page_Init();

// Page main
$data_kontrak_addopt->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$data_kontrak_addopt->Page_Render();
?>
<script type="text/javascript">

// Form object
var CurrentPageID = EW_PAGE_ID = "addopt";
var CurrentForm = fdata_kontrakaddopt = new ew_Form("fdata_kontrakaddopt", "addopt");

// Validate form
fdata_kontrakaddopt.Validate = function() {
...
fdata_kontrakaddopt.Form_CustomValidate = 
...
fdata_kontrakaddopt.ValidateRequired = true;
<?php } else { ?>
fdata_kontrakaddopt.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fdata_kontrakaddopt.Lists["x_program"] = {"LinkField":"x_kode_program","Ajax":true,"AutoFill":false,"DisplayFields":["x_nama_program","","",""],"ParentFields":[],"ChildFields":["x_kegiatan"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"m_program"};
fdata_kontrakaddopt.Lists["x_kegiatan"] = {"LinkField":"x_kode_kegiatan","Ajax":true,"AutoFill":false,"DisplayFields":["x_nama_kegiatan","","",""],"ParentFields":["x_program"],"ChildFields":["x_sub_kegiatan"],"FilterFields":["x_kode_program"],"Options":[],"Template":"","LinkTable":"m_kegiatan"};
fdata_kontrakaddopt.Lists["x_sub_kegiatan"] = {"LinkField":"x_kode_sub_kegiatan","Ajax":true,"AutoFill":true,"DisplayFields":["x_nama_sub_kegiatan","","",""],"ParentFields":["x_kegiatan"],"ChildFields":[],"FilterFields":["x_kode_kegiatan"],"Options":[],"Template":"","LinkTable":"m_sub_kegiatan"};
fdata_kontrakaddopt.Lists["x_bentuk_perusahaan"] = {"LinkField":"x_bentuk_perusahaan","Ajax":true,"AutoFill":false,"DisplayFields":["x_bentuk_perusahaan","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"bentuk_perusahaan"};
fdata_kontrakaddopt.Lists["x_lanjutkan"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fdata_kontrakaddopt.Lists["x_lanjutkan"].Options = <?php echo json_encode($data_kontrak->lanjutkan->Options()) ?>;
fdata_kontrakaddopt.Lists["x_nama_ppkom"] = {"LinkField":"x_nama","Ajax":true,"AutoFill":true,"DisplayFields":["x_nama","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"m_pejabat_keuangan"};
...
<?php
$data_kontrak_addopt->ShowMessage();
?>
<form name="fdata_kontrakaddopt" id="fdata_kontrakaddopt" class="ewForm form-horizontal" action="data_kontrakaddopt.php" method="post">
<?php if ($data_kontrak_addopt->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $data_kontrak_addopt->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="data_kontrak">
<input type="hidden" name="a_addopt" id="a_addopt" value="A">
<?php if ($data_kontrak->program->Visible) { // program ?>
	<div class="form-group">
		<label class="col-sm-3 control-label ewLabel" for="x_program"><?php echo $data_kontrak->program->FldCaption() ?></label>
		<div class="col-sm-9">
...
<?php if ($data_kontrak->kegiatan->Visible) { // kegiatan ?>
	<div class="form-group">
		<label class="col-sm-3 control-label ewLabel" for="x_kegiatan"><?php echo $data_kontrak->kegiatan->FldCaption() ?></label>
		<div class="col-sm-9">
...
<?php if ($data_kontrak->sub_kegiatan->Visible) { // sub_kegiatan ?>
	<div class="form-group">
		<label class="col-sm-3 control-label ewLabel" for="x_sub_kegiatan"><?php echo $data_kontrak->sub_kegiatan->FldCaption() ?></label>
		<div class="col-sm-9">
<?php $data_kontrak->sub_kegiatan->EditAttrs["onchange"] = "ew_AutoFill(this); " . @$data_kontrak->sub_kegiatan->EditAttrs["onchange"]; ?>
...
<input type="hidden" name="ln_x_sub_kegiatan" id="ln_x_sub_kegiatan" value="x_no_kontrak">
</div>
	</div>
<?php } ?>	
<?php if ($data_kontrak->no_kontrak->Visible) { // no_kontrak ?>
	<div class="form-group">
		<label class="col-sm-3 control-label ewLabel" for="x_no_kontrak"><?php echo $data_kontrak->no_kontrak->FldCaption() ?></label>
		<div class="col-sm-9">
...
<?php if ($data_kontrak->tgl_kontrak->Visible) { // tgl_kontrak ?>
	<div class="form-group">
		<label class="col-sm-3 control-label ewLabel" for="x_tgl_kontrak"><?php echo $data_kontrak->tgl_kontrak->FldCaption() ?></label>
		<div class="col-sm-9">
...
<script type="text/javascript">
ew_CreateCalendar("fdata_kontrakaddopt", "x_tgl_kontrak", 0);
</script>
<?php } ?>
</div>
	</div>
...
<?php if ($data_kontrak->nama_perusahaan->Visible) { // nama_perusahaan ?>
	<div class="form-group">
		<label class="col-sm-3 control-label ewLabel" for="x_nama_perusahaan"><?php echo $data_kontrak->nama_perusahaan->FldCaption() ?></label>
		<div class="col-sm-9">
...
<?php if ($data_kontrak->bentuk_perusahaan->Visible) { // bentuk_perusahaan ?>
	<div class="form-group">
		<label class="col-sm-3 control-label ewLabel" for="x_bentuk_perusahaan"><?php echo $data_kontrak->bentuk_perusahaan->FldCaption() ?></label>
		<div class="col-sm-9">
...
<?php if ($data_kontrak->alamat_perusahaan->Visible) { // alamat_perusahaan ?>
	<div class="form-group">
		<label class="col-sm-3 control-label ewLabel" for="x_alamat_perusahaan"><?php echo $data_kontrak->alamat_perusahaan->FldCaption() ?></label>
		<div class="col-sm-9">
...
<?php if ($data_kontrak->kepala_perusahaan->Visible) { // kepala_perusahaan ?>
	<div class="form-group">
		<label class="col-sm-3 control-label ewLabel" for="x_kepala_perusahaan"><?php echo $data_kontrak->kepala_perusahaan->FldCaption() ?></label>
		<div class="col-sm-9">
...
<?php if ($data_kontrak->npwp->Visible) { // npwp ?>
	<div class="form-group">
		<label class="col-sm-3 control-label ewLabel" for="x_npwp"><?php echo $data_kontrak->npwp->FldCaption() ?></label>
		<div class="col-sm-9">
...
<?php if ($data_kontrak->nama_bank->Visible) { // nama_bank ?>
	<div class="form-group">
		<label class="col-sm-3 control-label ewLabel" for="x_nama_bank"><?php echo $data_kontrak->nama_bank->FldCaption() ?></label>
		<div class="col-sm-9">
...
<?php if ($data_kontrak->nama_rekening->Visible) { // nama_rekening ?>
	<div class="form-group">
		<label class="col-sm-3 control-label ewLabel" for="x_nama_rekening"><?php echo $data_kontrak->nama_rekening->FldCaption() ?></label>
		<div class="col-sm-9">
...
<?php if ($data_kontrak->nomer_rekening->Visible) { // nomer_rekening ?>
	<div class="form-group">
		<label class="col-sm-3 control-label ewLabel" for="x_nomer_rekening"><?php echo $data_kontrak->nomer_rekening->FldCaption() ?></label>
		<div class="col-sm-9">
...
<?php if ($data_kontrak->lanjutkan->Visible) { // lanjutkan ?>
	<div class="form-group">
		<label class="col-sm-3 control-label ewLabel" for="x_lanjutkan"><?php echo $data_kontrak->lanjutkan->FldCaption() ?></label>
		<div class="col-sm-9">
...
<?php if ($data_kontrak->waktu_kontrak->Visible) { // waktu_kontrak ?>
	<div class="form-group">
		<label class="col-sm-3 control-label ewLabel" for="x_waktu_kontrak"><?php echo $data_kontrak->waktu_kontrak->FldCaption() ?></label>
		<div class="col-sm-9">
...
<?php if ($data_kontrak->tgl_mulai->Visible) { // tgl_mulai ?>
	<div class="form-group">
		<label class="col-sm-3 control-label ewLabel" for="x_tgl_mulai"><?php echo $data_kontrak->tgl_mulai->FldCaption() ?></label>
		<div class="col-sm-9">
...
<script type="text/javascript">
ew_CreateCalendar("fdata_kontrakaddopt", "x_tgl_mulai", 7);
</script>
<?php } ?>
</div>
	</div>
...
<?php if ($data_kontrak->tgl_selesai->Visible) { // tgl_selesai ?>
	<div class="form-group">
		<label class="col-sm-3 control-label ewLabel" for="x_tgl_selesai"><?php echo $data_kontrak->tgl_selesai->FldCaption() ?></label>
		<div class="col-sm-9">
...
<script type="text/javascript">
ew_CreateCalendar("fdata_kontrakaddopt", "x_tgl_selesai", 7);
</script>
<?php } ?>
</div>
	</div>
...
<?php if ($data_kontrak->paket_pekerjaan->Visible) { // paket_pekerjaan ?>
	<div class="form-group">
		<label class="col-sm-3 control-label ewLabel" for="x_paket_pekerjaan"><?php echo $data_kontrak->paket_pekerjaan->FldCaption() ?></label>
		<div class="col-sm-9">
...
<?php if ($data_kontrak->nama_ppkom->Visible) { // nama_ppkom ?>
	<div class="form-group">
		<label class="col-sm-3 control-label ewLabel" for="x_nama_ppkom"><?php echo $data_kontrak->nama_ppkom->FldCaption() ?></label>
		<div class="col-sm-9">
...
<?php if ($data_kontrak->nip_ppkom->Visible) { // nip_ppkom ?>
	<div class="form-group">
		<label class="col-sm-3 control-label ewLabel" for="x_nip_ppkom"><?php echo $data_kontrak->nip_ppkom->FldCaption() ?></label>
		<div class="col-sm-9">
...
<?php
$data_kontrak_addopt->Page_Terminate();
?>
