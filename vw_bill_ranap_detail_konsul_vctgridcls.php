...
$vw_bill_ranap_detail_konsul_vct_grid = NULL; // Initialize page object first

class cvw_bill_ranap_detail_konsul_vct_grid extends cvw_bill_ranap_detail_konsul_vct {
	...
	// Page object name
	var $PageObjName = 'vw_bill_ranap_detail_konsul_vct_grid';

	// Grid form hidden field names
	var $FormName = 'fvw_bill_ranap_detail_konsul_vctgrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["vw_bill_ranap_detail_konsul_vct"];
