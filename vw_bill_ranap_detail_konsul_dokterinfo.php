...
$vw_bill_ranap_detail_konsul_dokter = NULL;

//
// Table class for vw_bill_ranap_detail_konsul_dokter
//
class cvw_bill_ranap_detail_konsul_dokter extends cTable {
	...
	function __construct() {
		...
		$this->TableVar = 'vw_bill_ranap_detail_konsul_dokter';
		$this->TableName = 'vw_bill_ranap_detail_konsul_dokter';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`vw_bill_ranap_detail_konsul_dokter`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('vw_bill_ranap_detail_konsul_dokter', 'vw_bill_ranap_detail_konsul_dokter', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// id_admission
		$this->id_admission = new cField('vw_bill_ranap_detail_konsul_dokter', 'vw_bill_ranap_detail_konsul_dokter', 'x_id_admission', 'id_admission', '`id_admission`', '`id_admission`', 3, -1, FALSE, '`id_admission`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// nomr
		$this->nomr = new cField('vw_bill_ranap_detail_konsul_dokter', 'vw_bill_ranap_detail_konsul_dokter', 'x_nomr', 'nomr', '`nomr`', '`nomr`', 200, -1, FALSE, '`nomr`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->nomr->Sortable = TRUE; // Allow sort
		$this->fields['nomr'] = &$this->nomr;

		// statusbayar
		$this->statusbayar = new cField('vw_bill_ranap_detail_konsul_dokter', 'vw_bill_ranap_detail_konsul_dokter', 'x_statusbayar', 'statusbayar', '`statusbayar`', '`statusbayar`', 3, -1, FALSE, '`statusbayar`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// kelas
		$this->kelas = new cField('vw_bill_ranap_detail_konsul_dokter', 'vw_bill_ranap_detail_konsul_dokter', 'x_kelas', 'kelas', '`kelas`', '`kelas`', 3, -1, FALSE, '`kelas`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// tanggal
		$this->tanggal = new cField('vw_bill_ranap_detail_konsul_dokter', 'vw_bill_ranap_detail_konsul_dokter', 'x_tanggal', 'tanggal', '`tanggal`', ew_CastDateFieldForLike('`tanggal`', 7, "DB"), 135, 7, FALSE, '`tanggal`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->tanggal->Sortable = TRUE; // Allow sort
		$this->tanggal->FldDefaultErrMsg = str_replace("%s", $GLOBALS["EW_DATE_SEPARATOR"], $Language->Phrase("IncorrectDateDMY"));
		$this->fields['tanggal'] = &$this->tanggal;

		// kode_tindakan
		$this->kode_tindakan = new cField('vw_bill_ranap_detail_konsul_dokter', 'vw_bill_ranap_detail_konsul_dokter', 'x_kode_tindakan', 'kode_tindakan', '`kode_tindakan`', '`kode_tindakan`', 3, -1, FALSE, '`kode_tindakan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// kode_dokter
		$this->kode_dokter = new cField('vw_bill_ranap_detail_konsul_dokter', 'vw_bill_ranap_detail_konsul_dokter', 'x_kode_dokter', 'kode_dokter', '`kode_dokter`', '`kode_dokter`', 3, -1, FALSE, '`kode_dokter`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// qty
		$this->qty = new cField('vw_bill_ranap_detail_konsul_dokter', 'vw_bill_ranap_detail_konsul_dokter', 'x_qty', 'qty', '`qty`', '`qty`', 3, -1, FALSE, '`qty`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->qty->Sortable = TRUE; // Allow sort
		$this->qty->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['qty'] = &$this->qty;

		// tarif
		$this->tarif = new cField('vw_bill_ranap_detail_konsul_dokter', 'vw_bill_ranap_detail_konsul_dokter', 'x_tarif', 'tarif', '`tarif`', '`tarif`', 5, -1, FALSE, '`tarif`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// bhp
		$this->bhp = new cField('vw_bill_ranap_detail_konsul_dokter', 'vw_bill_ranap_detail_konsul_dokter', 'x_bhp', 'bhp', '`bhp`', '`bhp`', 5, -1, FALSE, '`bhp`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->bhp->Sortable = TRUE; // Allow sort
		$this->bhp->FldDefaultErrMsg = $Language->Phrase("IncorrectFloat");
		$this->fields['bhp'] = &$this->bhp;

		// kelompok_tindakan
		$this->kelompok_tindakan = new cField('vw_bill_ranap_detail_konsul_dokter', 'vw_bill_ranap_detail_konsul_dokter', 'x_kelompok_tindakan', 'kelompok_tindakan', '`kelompok_tindakan`', '`kelompok_tindakan`', 3, -1, FALSE, '`kelompok_tindakan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// kelompok1
		$this->kelompok1 = new cField('vw_bill_ranap_detail_konsul_dokter', 'vw_bill_ranap_detail_konsul_dokter', 'x_kelompok1', 'kelompok1', '`kelompok1`', '`kelompok1`', 3, -1, FALSE, '`kelompok1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// kelompok2
		$this->kelompok2 = new cField('vw_bill_ranap_detail_konsul_dokter', 'vw_bill_ranap_detail_konsul_dokter', 'x_kelompok2', 'kelompok2', '`kelompok2`', '`kelompok2`', 3, -1, FALSE, '`kelompok2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// nama_tindakan
		$this->nama_tindakan = new cField('vw_bill_ranap_detail_konsul_dokter', 'vw_bill_ranap_detail_konsul_dokter', 'x_nama_tindakan', 'nama_tindakan', '`nama_tindakan`', '`nama_tindakan`', 200, -1, FALSE, '`nama_tindakan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->nama_tindakan->Sortable = TRUE; // Allow sort
		$this->fields['nama_tindakan'] = &$this->nama_tindakan;

		// user
		$this->user = new cField('vw_bill_ranap_detail_konsul_dokter', 'vw_bill_ranap_detail_konsul_dokter', 'x_user', 'user', '`user`', '`user`', 200, -1, FALSE, '`user`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->user->Sortable = TRUE; // Allow sort
		$this->fields['user'] = &$this->user;

		// no_ruang
		$this->no_ruang = new cField('vw_bill_ranap_detail_konsul_dokter', 'vw_bill_ranap_detail_konsul_dokter', 'x_no_ruang', 'no_ruang', '`no_ruang`', '`no_ruang`', 3, -1, FALSE, '`no_ruang`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`vw_bill_ranap_detail_konsul_dokter`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "vw_bill_ranap_detail_konsul_dokterlist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("vw_bill_ranap_detail_konsul_dokterview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("vw_bill_ranap_detail_konsul_dokterview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "vw_bill_ranap_detail_konsul_dokteradd.php?" . $this->UrlParm($parm);
		else
			$url = "vw_bill_ranap_detail_konsul_dokteradd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("vw_bill_ranap_detail_konsul_dokteredit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("vw_bill_ranap_detail_konsul_dokteradd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("vw_bill_ranap_detail_konsul_dokterdelete.php", $this->UrlParm());
	}
   ...
   // Common render codes
	...
	function WriteAuditTrailDummy($typ) {
		$table = 'vw_bill_ranap_detail_konsul_dokter';
		$usr = CurrentUserID();
