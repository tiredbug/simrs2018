...
$m_sub_kegiatan_add = NULL; // Initialize page object first

class cm_sub_kegiatan_add extends cm_sub_kegiatan {
	...
	// Page object name
	var $PageObjName = 'm_sub_kegiatan_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "m_sub_kegiatanview.php")
	...
	function LoadDefaultValues() {
		...
		$this->nama_sub_kegiatan->CurrentValue = NULL;
		$this->nama_sub_kegiatan->OldValue = $this->nama_sub_kegiatan->CurrentValue;
	}
	...
	function AddRow($rsold = NULL) {
		...
		if (strval($this->kode_kegiatan->CurrentValue) <> "") {
			$sMasterFilter = str_replace("@kode_kegiatan@", ew_AdjustSql($this->kode_kegiatan->CurrentValue, "DB"), $sMasterFilter);
		} else {
			$bValidMasterRecord = FALSE;
		}
		...
		// nama_sub_kegiatan
		$this->nama_sub_kegiatan->SetDbValueDef($rsnew, $this->nama_sub_kegiatan->CurrentValue, NULL, FALSE);
...
// Create page object
if (!isset($m_sub_kegiatan_add)) $m_sub_kegiatan_add = new cm_sub_kegiatan_add();

// Page init
$m_sub_kegiatan_add->Page_Init();

// Page main
$m_sub_kegiatan_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$m_sub_kegiatan_add->Page_Render();
?>
...
var CurrentForm = fm_sub_kegiatanadd = new ew_Form("fm_sub_kegiatanadd", "add");

// Validate form
fm_sub_kegiatanadd.Validate = function() {
...
fm_sub_kegiatanadd.Form_CustomValidate = 
...
fm_sub_kegiatanadd.ValidateRequired = true;
<?php } else { ?>
fm_sub_kegiatanadd.ValidateRequired = false; 
<?php } ?>
...
<?php if (!$m_sub_kegiatan_add->IsModal) { ?>
<?php } ?>
<?php $m_sub_kegiatan_add->ShowPageHeader(); ?>
<?php
$m_sub_kegiatan_add->ShowMessage();
?>
<form name="fm_sub_kegiatanadd" id="fm_sub_kegiatanadd" class="<?php echo $m_sub_kegiatan_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($m_sub_kegiatan_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $m_sub_kegiatan_add->Token ?>">
<?php } ?>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $m_sub_kegiatan_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
fm_sub_kegiatanadd.Init();
</script>
<?php
$m_sub_kegiatan_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$m_sub_kegiatan_add->Page_Terminate();
?>
