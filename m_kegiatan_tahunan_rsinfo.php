...
$m_kegiatan_tahunan_rs = NULL;

//
// Table class for m_kegiatan_tahunan_rs
//
class cm_kegiatan_tahunan_rs extends cTable {
	var $id;
	var $tahun;
	var $program;
	var $kode_kegiatan;
	...
	function __construct() {
		...
		$this->TableVar = 'm_kegiatan_tahunan_rs';
		$this->TableName = 'm_kegiatan_tahunan_rs';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`m_kegiatan_tahunan_rs`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('m_kegiatan_tahunan_rs', 'm_kegiatan_tahunan_rs', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// tahun
		$this->tahun = new cField('m_kegiatan_tahunan_rs', 'm_kegiatan_tahunan_rs', 'x_tahun', 'tahun', '`tahun`', '`tahun`', 3, -1, FALSE, '`tahun`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// program
		$this->program = new cField('m_kegiatan_tahunan_rs', 'm_kegiatan_tahunan_rs', 'x_program', 'program', '`program`', '`program`', 200, -1, FALSE, '`program`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// kode_kegiatan
		$this->kode_kegiatan = new cField('m_kegiatan_tahunan_rs', 'm_kegiatan_tahunan_rs', 'x_kode_kegiatan', 'kode_kegiatan', '`kode_kegiatan`', '`kode_kegiatan`', 200, -1, FALSE, '`kode_kegiatan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// sub_kegiatan
		$this->sub_kegiatan = new cField('m_kegiatan_tahunan_rs', 'm_kegiatan_tahunan_rs', 'x_sub_kegiatan', 'sub_kegiatan', '`sub_kegiatan`', '`sub_kegiatan`', 200, -1, FALSE, '`sub_kegiatan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`m_kegiatan_tahunan_rs`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "m_kegiatan_tahunan_rslist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("m_kegiatan_tahunan_rsview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("m_kegiatan_tahunan_rsview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "m_kegiatan_tahunan_rsadd.php?" . $this->UrlParm($parm);
		else
			$url = "m_kegiatan_tahunan_rsadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("m_kegiatan_tahunan_rsedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("m_kegiatan_tahunan_rsadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("m_kegiatan_tahunan_rsdelete.php", $this->UrlParm());
	}
