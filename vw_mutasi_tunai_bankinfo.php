...
$vw_mutasi_tunai_bank = NULL;

//
// Table class for vw_mutasi_tunai_bank
//
class cvw_mutasi_tunai_bank extends cTable {
	var $id;
	var $jenis_mutasi;
	var $no_bukti;
	var $tgl_bukti;
	...
	function __construct() {
		...
		$this->TableVar = 'vw_mutasi_tunai_bank';
		$this->TableName = 'vw_mutasi_tunai_bank';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`vw_mutasi_tunai_bank`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('vw_mutasi_tunai_bank', 'vw_mutasi_tunai_bank', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// jenis_mutasi
		$this->jenis_mutasi = new cField('vw_mutasi_tunai_bank', 'vw_mutasi_tunai_bank', 'x_jenis_mutasi', 'jenis_mutasi', '`jenis_mutasi`', '`jenis_mutasi`', 3, -1, FALSE, '`jenis_mutasi`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// no_bukti
		$this->no_bukti = new cField('vw_mutasi_tunai_bank', 'vw_mutasi_tunai_bank', 'x_no_bukti', 'no_bukti', '`no_bukti`', '`no_bukti`', 200, -1, FALSE, '`no_bukti`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->no_bukti->Sortable = TRUE; // Allow sort
		$this->fields['no_bukti'] = &$this->no_bukti;

		// tgl_bukti
		$this->tgl_bukti = new cField('vw_mutasi_tunai_bank', 'vw_mutasi_tunai_bank', 'x_tgl_bukti', 'tgl_bukti', '`tgl_bukti`', ew_CastDateFieldForLike('`tgl_bukti`', 7, "DB"), 135, 7, FALSE, '`tgl_bukti`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// uraian
		$this->uraian = new cField('vw_mutasi_tunai_bank', 'vw_mutasi_tunai_bank', 'x_uraian', 'uraian', '`uraian`', '`uraian`', 200, -1, FALSE, '`uraian`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->uraian->Sortable = TRUE; // Allow sort
		$this->fields['uraian'] = &$this->uraian;

		// jumlah
		$this->jumlah = new cField('vw_mutasi_tunai_bank', 'vw_mutasi_tunai_bank', 'x_jumlah', 'jumlah', '`jumlah`', '`jumlah`', 5, -1, FALSE, '`jumlah`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`vw_mutasi_tunai_bank`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "vw_mutasi_tunai_banklist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("vw_mutasi_tunai_bankview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("vw_mutasi_tunai_bankview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "vw_mutasi_tunai_bankadd.php?" . $this->UrlParm($parm);
		else
			$url = "vw_mutasi_tunai_bankadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("vw_mutasi_tunai_bankedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("vw_mutasi_tunai_bankadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("vw_mutasi_tunai_bankdelete.php", $this->UrlParm());
	}
