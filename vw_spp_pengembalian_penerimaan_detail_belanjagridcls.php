...
$vw_spp_pengembalian_penerimaan_detail_belanja_grid = NULL; // Initialize page object first

class cvw_spp_pengembalian_penerimaan_detail_belanja_grid extends cvw_spp_pengembalian_penerimaan_detail_belanja {
	...
	// Page object name
	var $PageObjName = 'vw_spp_pengembalian_penerimaan_detail_belanja_grid';

	// Grid form hidden field names
	var $FormName = 'fvw_spp_pengembalian_penerimaan_detail_belanjagrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["vw_spp_pengembalian_penerimaan_detail_belanja"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function SetUpMasterParms() {
		...
		if ($sMasterTblVar == "vw_spp_pengembalian_penerimaan") {
			...
			if ($GLOBALS["vw_spp_pengembalian_penerimaan"]->EventCancelled) $this->EventCancelled = TRUE;
