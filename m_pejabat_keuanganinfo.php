...
$m_pejabat_keuangan = NULL;

//
// Table class for m_pejabat_keuangan
//
class cm_pejabat_keuangan extends cTable {
	var $id;
	var $jabatan;
	var $nama;
	var $nip;
	...
	function __construct() {
		...
		$this->TableVar = 'm_pejabat_keuangan';
		$this->TableName = 'm_pejabat_keuangan';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`m_pejabat_keuangan`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('m_pejabat_keuangan', 'm_pejabat_keuangan', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// jabatan
		$this->jabatan = new cField('m_pejabat_keuangan', 'm_pejabat_keuangan', 'x_jabatan', 'jabatan', '`jabatan`', '`jabatan`', 200, -1, FALSE, '`jabatan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->jabatan->OptionCount = 4;
		$this->fields['jabatan'] = &$this->jabatan;

		// nama
		$this->nama = new cField('m_pejabat_keuangan', 'm_pejabat_keuangan', 'x_nama', 'nama', '`nama`', '`nama`', 200, -1, FALSE, '`nama`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->nama->Sortable = TRUE; // Allow sort
		$this->fields['nama'] = &$this->nama;

		// nip
		$this->nip = new cField('m_pejabat_keuangan', 'm_pejabat_keuangan', 'x_nip', 'nip', '`nip`', '`nip`', 200, -1, FALSE, '`nip`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->nip->Sortable = TRUE; // Allow sort
		$this->fields['nip'] = &$this->nip;

		// npwp
		$this->npwp = new cField('m_pejabat_keuangan', 'm_pejabat_keuangan', 'x_npwp', 'npwp', '`npwp`', '`npwp`', 200, -1, FALSE, '`npwp`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->npwp->Sortable = TRUE; // Allow sort
		$this->fields['npwp'] = &$this->npwp;

		// nama_rekening
		$this->nama_rekening = new cField('m_pejabat_keuangan', 'm_pejabat_keuangan', 'x_nama_rekening', 'nama_rekening', '`nama_rekening`', '`nama_rekening`', 200, -1, FALSE, '`nama_rekening`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->nama_rekening->Sortable = TRUE; // Allow sort
		$this->fields['nama_rekening'] = &$this->nama_rekening;

		// nomer_rekening
		$this->nomer_rekening = new cField('m_pejabat_keuangan', 'm_pejabat_keuangan', 'x_nomer_rekening', 'nomer_rekening', '`nomer_rekening`', '`nomer_rekening`', 200, -1, FALSE, '`nomer_rekening`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`m_pejabat_keuangan`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "m_pejabat_keuanganlist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("m_pejabat_keuanganview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("m_pejabat_keuanganview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "m_pejabat_keuanganadd.php?" . $this->UrlParm($parm);
		else
			$url = "m_pejabat_keuanganadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("m_pejabat_keuanganedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("m_pejabat_keuanganadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("m_pejabat_keuangandelete.php", $this->UrlParm());
	}
