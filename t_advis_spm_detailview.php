...
$t_advis_spm_detail_view = NULL; // Initialize page object first

class ct_advis_spm_detail_view extends ct_advis_spm_detail {
	...
	// Page object name
	var $PageObjName = 't_advis_spm_detail_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["id"] <> "") {
				...
				$sReturnUrl = "t_advis_spm_detaillist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "t_advis_spm_detaillist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "t_advis_spm_detaillist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($t_advis_spm_detail_view)) $t_advis_spm_detail_view = new ct_advis_spm_detail_view();

// Page init
$t_advis_spm_detail_view->Page_Init();

// Page main
$t_advis_spm_detail_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t_advis_spm_detail_view->Page_Render();
?>
...
var CurrentForm = ft_advis_spm_detailview = new ew_Form("ft_advis_spm_detailview", "view");

// Form_CustomValidate event
ft_advis_spm_detailview.Form_CustomValidate = 
...
ft_advis_spm_detailview.ValidateRequired = true;
<?php } else { ?>
ft_advis_spm_detailview.ValidateRequired = false; 
<?php } ?>
...
<?php if (!$t_advis_spm_detail_view->IsModal) { ?>
<?php } ?>
<?php $t_advis_spm_detail_view->ExportOptions->Render("body") ?>
<?php
	foreach ($t_advis_spm_detail_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$t_advis_spm_detail_view->IsModal) { ?>
...
<?php $t_advis_spm_detail_view->ShowPageHeader(); ?>
<?php
$t_advis_spm_detail_view->ShowMessage();
?>
<form name="ft_advis_spm_detailview" id="ft_advis_spm_detailview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t_advis_spm_detail_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t_advis_spm_detail_view->Token ?>">
<?php } ?>
...
<script type="text/javascript">
ft_advis_spm_detailview.Init();
</script>
<?php
$t_advis_spm_detail_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$t_advis_spm_detail_view->Page_Terminate();
?>
