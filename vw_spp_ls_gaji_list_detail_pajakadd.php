...
$vw_spp_ls_gaji_list_detail_pajak_add = NULL; // Initialize page object first

class cvw_spp_ls_gaji_list_detail_pajak_add extends cvw_spp_ls_gaji_list_detail_pajak {
	...
	// Page object name
	var $PageObjName = 'vw_spp_ls_gaji_list_detail_pajak_add';
		...
		switch ($this->CurrentAction) {
			...
			case "C": // Copy an existing record
				if (!$this->LoadRow()) { // Load record based on key
					...
					$this->Page_Terminate("vw_spp_ls_gaji_list_detail_pajaklist.php"); // No matching record, return to list
				}
				break;
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					if (ew_GetPageName($sReturnUrl) == "vw_spp_ls_gaji_list_detail_pajaklist.php")
						$sReturnUrl = $this->AddMasterUrl($sReturnUrl); // List page, return to list page with correct master key if necessary
					elseif (ew_GetPageName($sReturnUrl) == "vw_spp_ls_gaji_list_detail_pajakview.php")
	...
	function RenderRow() {
		...
		$this->jumlah_belanja->ViewCustomAttributes = "";
			...
			$sSqlWrk = "SELECT `kd_akun`, `nama_akun` AS `DispFld`, '' AS `Disp2Fld`, '' AS `Disp3Fld`, '' AS `Disp4Fld`, '' AS `SelectFilterFld`, '' AS `SelectFilterFld2`, '' AS `SelectFilterFld3`, '' AS `SelectFilterFld4` FROM `keu_akun5`";
			$sWhereWrk = "";
			$this->kd_rekening_belanja->LookupFilters = array();
			$lookuptblfilter = "`akun1` = 7 and `akun2` = 1";
			ew_AddFilter($sWhereWrk, $lookuptblfilter);
	...
	function SetupLookupFilters($fld, $pageId = null) {
		...
		case "x_kd_rekening_belanja":
			$sSqlWrk = "";
			$sSqlWrk = "SELECT `kd_akun` AS `LinkFld`, `nama_akun` AS `DispFld`, '' AS `Disp2Fld`, '' AS `Disp3Fld`, '' AS `Disp4Fld` FROM `keu_akun5`";
			$sWhereWrk = "";
			$this->kd_rekening_belanja->LookupFilters = array();
			$lookuptblfilter = "`akun1` = 7 and `akun2` = 1";
			ew_AddFilter($sWhereWrk, $lookuptblfilter);
...
// Create page object
if (!isset($vw_spp_ls_gaji_list_detail_pajak_add)) $vw_spp_ls_gaji_list_detail_pajak_add = new cvw_spp_ls_gaji_list_detail_pajak_add();

// Page init
$vw_spp_ls_gaji_list_detail_pajak_add->Page_Init();

// Page main
$vw_spp_ls_gaji_list_detail_pajak_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$vw_spp_ls_gaji_list_detail_pajak_add->Page_Render();
?>
...
var CurrentForm = fvw_spp_ls_gaji_list_detail_pajakadd = new ew_Form("fvw_spp_ls_gaji_list_detail_pajakadd", "add");

// Validate form
fvw_spp_ls_gaji_list_detail_pajakadd.Validate = function() {
...
fvw_spp_ls_gaji_list_detail_pajakadd.Form_CustomValidate = 
...
fvw_spp_ls_gaji_list_detail_pajakadd.ValidateRequired = true;
<?php } else { ?>
fvw_spp_ls_gaji_list_detail_pajakadd.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fvw_spp_ls_gaji_list_detail_pajakadd.Lists["x_kd_rekening_belanja"] = {"LinkField":"x_kd_akun","Ajax":true,"AutoFill":false,"DisplayFields":["x_nama_akun","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"keu_akun5"};
...
<?php if (!$vw_spp_ls_gaji_list_detail_pajak_add->IsModal) { ?>
<?php } ?>
<?php $vw_spp_ls_gaji_list_detail_pajak_add->ShowPageHeader(); ?>
<?php
$vw_spp_ls_gaji_list_detail_pajak_add->ShowMessage();
?>
<form name="fvw_spp_ls_gaji_list_detail_pajakadd" id="fvw_spp_ls_gaji_list_detail_pajakadd" class="<?php echo $vw_spp_ls_gaji_list_detail_pajak_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($vw_spp_ls_gaji_list_detail_pajak_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $vw_spp_ls_gaji_list_detail_pajak_add->Token ?>">
<?php } ?>
...
<?php } ?>
<?php if ($vw_spp_ls_gaji_list_detail_pajak->getCurrentMasterTable() == "vw_spp_ls_gaji_list") { ?>
...
<?php if ($vw_spp_ls_gaji_list_detail_pajak->kd_rekening_belanja->Visible) { // kd_rekening_belanja ?>
	<div id="r_kd_rekening_belanja" class="form-group">
		<label id="elh_vw_spp_ls_gaji_list_detail_pajak_kd_rekening_belanja" for="x_kd_rekening_belanja" class="col-sm-2 control-label ewLabel"><?php echo $vw_spp_ls_gaji_list_detail_pajak->kd_rekening_belanja->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="col-sm-10"><div<?php echo $vw_spp_ls_gaji_list_detail_pajak->kd_rekening_belanja->CellAttributes() ?>>
<span id="el_vw_spp_ls_gaji_list_detail_pajak_kd_rekening_belanja">
<select data-table="vw_spp_ls_gaji_list_detail_pajak" data-field="x_kd_rekening_belanja" data-value-separator="<?php echo $vw_spp_ls_gaji_list_detail_pajak->kd_rekening_belanja->DisplayValueSeparatorAttribute() ?>" id="x_kd_rekening_belanja" name="x_kd_rekening_belanja"<?php echo $vw_spp_ls_gaji_list_detail_pajak->kd_rekening_belanja->EditAttributes() ?>>
<?php echo $vw_spp_ls_gaji_list_detail_pajak->kd_rekening_belanja->SelectOptionListHtml("x_kd_rekening_belanja") ?>
</select>
<input type="hidden" name="s_x_kd_rekening_belanja" id="s_x_kd_rekening_belanja" value="<?php echo $vw_spp_ls_gaji_list_detail_pajak->kd_rekening_belanja->LookupFilterQuery() ?>">
</span>
<?php echo $vw_spp_ls_gaji_list_detail_pajak->kd_rekening_belanja->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($vw_spp_ls_gaji_list_detail_pajak->jumlah_belanja->Visible) { // jumlah_belanja ?>
	<div id="r_jumlah_belanja" class="form-group">
		<label id="elh_vw_spp_ls_gaji_list_detail_pajak_jumlah_belanja" for="x_jumlah_belanja" class="col-sm-2 control-label ewLabel"><?php echo $vw_spp_ls_gaji_list_detail_pajak->jumlah_belanja->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="col-sm-10"><div<?php echo $vw_spp_ls_gaji_list_detail_pajak->jumlah_belanja->CellAttributes() ?>>
<span id="el_vw_spp_ls_gaji_list_detail_pajak_jumlah_belanja">
<input type="text" data-table="vw_spp_ls_gaji_list_detail_pajak" data-field="x_jumlah_belanja" name="x_jumlah_belanja" id="x_jumlah_belanja" size="30" placeholder="<?php echo ew_HtmlEncode($vw_spp_ls_gaji_list_detail_pajak->jumlah_belanja->getPlaceHolder()) ?>" value="<?php echo $vw_spp_ls_gaji_list_detail_pajak->jumlah_belanja->EditValue ?>"<?php echo $vw_spp_ls_gaji_list_detail_pajak->jumlah_belanja->EditAttributes() ?>>
</span>
<?php echo $vw_spp_ls_gaji_list_detail_pajak->jumlah_belanja->CustomMsg ?></div></div>
	</div>
<?php } ?>
</div>
<?php if (strval($vw_spp_ls_gaji_list_detail_pajak->id_spp->getSessionValue()) <> "") { ?>
<input type="hidden" name="x_id_spp" id="x_id_spp" value="<?php echo ew_HtmlEncode(strval($vw_spp_ls_gaji_list_detail_pajak->id_spp->getSessionValue())) ?>">
<?php } ?>
<?php if (strval($vw_spp_ls_gaji_list_detail_pajak->id_jenis_spp->getSessionValue()) <> "") { ?>
<input type="hidden" name="x_id_jenis_spp" id="x_id_jenis_spp" value="<?php echo ew_HtmlEncode(strval($vw_spp_ls_gaji_list_detail_pajak->id_jenis_spp->getSessionValue())) ?>">
<?php } ?>
<?php if (strval($vw_spp_ls_gaji_list_detail_pajak->detail_jenis_spp->getSessionValue()) <> "") { ?>
<input type="hidden" name="x_detail_jenis_spp" id="x_detail_jenis_spp" value="<?php echo ew_HtmlEncode(strval($vw_spp_ls_gaji_list_detail_pajak->detail_jenis_spp->getSessionValue())) ?>">
<?php } ?>
<?php if (strval($vw_spp_ls_gaji_list_detail_pajak->no_spp->getSessionValue()) <> "") { ?>
<input type="hidden" name="x_no_spp" id="x_no_spp" value="<?php echo ew_HtmlEncode(strval($vw_spp_ls_gaji_list_detail_pajak->no_spp->getSessionValue())) ?>">
<?php } ?>
<?php if (strval($vw_spp_ls_gaji_list_detail_pajak->program->getSessionValue()) <> "") { ?>
<input type="hidden" name="x_program" id="x_program" value="<?php echo ew_HtmlEncode(strval($vw_spp_ls_gaji_list_detail_pajak->program->getSessionValue())) ?>">
<?php } ?>
<?php if (strval($vw_spp_ls_gaji_list_detail_pajak->kegiatan->getSessionValue()) <> "") { ?>
<input type="hidden" name="x_kegiatan" id="x_kegiatan" value="<?php echo ew_HtmlEncode(strval($vw_spp_ls_gaji_list_detail_pajak->kegiatan->getSessionValue())) ?>">
<?php } ?>
<?php if (strval($vw_spp_ls_gaji_list_detail_pajak->sub_kegiatan->getSessionValue()) <> "") { ?>
<input type="hidden" name="x_sub_kegiatan" id="x_sub_kegiatan" value="<?php echo ew_HtmlEncode(strval($vw_spp_ls_gaji_list_detail_pajak->sub_kegiatan->getSessionValue())) ?>">
<?php } ?>
<?php if (strval($vw_spp_ls_gaji_list_detail_pajak->tahun_anggaran->getSessionValue()) <> "") { ?>
<input type="hidden" name="x_tahun_anggaran" id="x_tahun_anggaran" value="<?php echo ew_HtmlEncode(strval($vw_spp_ls_gaji_list_detail_pajak->tahun_anggaran->getSessionValue())) ?>">
<?php } ?>
<?php if (!$vw_spp_ls_gaji_list_detail_pajak_add->IsModal) { ?>
<div class="form-group">
	<div class="col-sm-offset-2 col-sm-10">
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $vw_spp_ls_gaji_list_detail_pajak_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
fvw_spp_ls_gaji_list_detail_pajakadd.Init();
</script>
<?php
$vw_spp_ls_gaji_list_detail_pajak_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$vw_spp_ls_gaji_list_detail_pajak_add->Page_Terminate();
?>
