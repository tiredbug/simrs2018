...
$m_pejabat_keuangan_add = NULL; // Initialize page object first

class cm_pejabat_keuangan_add extends cm_pejabat_keuangan {
	...
	// Page object name
	var $PageObjName = 'm_pejabat_keuangan_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "m_pejabat_keuanganview.php")
...
// Create page object
if (!isset($m_pejabat_keuangan_add)) $m_pejabat_keuangan_add = new cm_pejabat_keuangan_add();

// Page init
$m_pejabat_keuangan_add->Page_Init();

// Page main
$m_pejabat_keuangan_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$m_pejabat_keuangan_add->Page_Render();
?>
...
var CurrentForm = fm_pejabat_keuanganadd = new ew_Form("fm_pejabat_keuanganadd", "add");

// Validate form
fm_pejabat_keuanganadd.Validate = function() {
...
fm_pejabat_keuanganadd.Form_CustomValidate = 
...
fm_pejabat_keuanganadd.ValidateRequired = true;
<?php } else { ?>
fm_pejabat_keuanganadd.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fm_pejabat_keuanganadd.Lists["x_jabatan"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fm_pejabat_keuanganadd.Lists["x_jabatan"].Options = <?php echo json_encode($m_pejabat_keuangan->jabatan->Options()) ?>;
...
<?php if (!$m_pejabat_keuangan_add->IsModal) { ?>
<?php } ?>
<?php $m_pejabat_keuangan_add->ShowPageHeader(); ?>
<?php
$m_pejabat_keuangan_add->ShowMessage();
?>
<form name="fm_pejabat_keuanganadd" id="fm_pejabat_keuanganadd" class="<?php echo $m_pejabat_keuangan_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($m_pejabat_keuangan_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $m_pejabat_keuangan_add->Token ?>">
<?php } ?>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $m_pejabat_keuangan_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
fm_pejabat_keuanganadd.Init();
</script>
<?php
$m_pejabat_keuangan_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$m_pejabat_keuangan_add->Page_Terminate();
?>
