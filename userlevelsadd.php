...
<?php } ?>
	...
	<div id="rp_permission" class="form-group">
		...
		<div class="col-sm-10">
<div class="checkbox"><label><input class="checkbox" type="checkbox" name="x__AllowAdd" id="Add" value="<?php echo EW_ALLOW_ADD ?>"><span><?php echo $Language->Phrase("PermissionAddCopy") ?></span></label></div>
<div class="checkbox"><label><input class="checkbox" type="checkbox" name="x__AllowDelete" id="Delete" value="<?php echo EW_ALLOW_DELETE ?>"><span><?php echo $Language->Phrase("PermissionDelete") ?></span></label></div>
<div class="checkbox"><label><input class="checkbox" type="checkbox" name="x__AllowEdit" id="Edit" value="<?php echo EW_ALLOW_EDIT ?>"><span><?php echo $Language->Phrase("PermissionEdit") ?></span></label></div>
<?php if (defined("EW_USER_LEVEL_COMPAT")) { ?>
<div class="checkbox"><label><input class="checkbox" type="checkbox" name="x__AllowList" id="List" value="<?php echo EW_ALLOW_LIST ?>"><span><?php echo $Language->Phrase("PermissionListSearchView") ?></span></label></div>
<?php } else { ?>
<div class="checkbox"><label><input class="checkbox" type="checkbox" name="x__AllowList" id="List" value="<?php echo EW_ALLOW_LIST ?>"><span><?php echo $Language->Phrase("PermissionList") ?></span></label></div>
<div class="checkbox"><label><input class="checkbox" type="checkbox" name="x__AllowView" id="View" value="<?php echo EW_ALLOW_VIEW ?>"><span><?php echo $Language->Phrase("PermissionView") ?></span></label></div>
<div class="checkbox"><label><input class="checkbox" type="checkbox" name="x__AllowSearch" id="Search" value="<?php echo EW_ALLOW_SEARCH ?>"><span><?php echo $Language->Phrase("PermissionSearch") ?></span></label></div>
<?php } ?>
		</div>
	</div>
</div>
