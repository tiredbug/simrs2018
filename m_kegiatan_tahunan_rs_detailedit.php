...
$m_kegiatan_tahunan_rs_detail_edit = NULL; // Initialize page object first

class cm_kegiatan_tahunan_rs_detail_edit extends cm_kegiatan_tahunan_rs_detail {
	...
	// Page object name
	var $PageObjName = 'm_kegiatan_tahunan_rs_detail_edit';
	...
	function Page_Main() {
		...
		if ($this->id->CurrentValue == "") {
			$this->Page_Terminate("m_kegiatan_tahunan_rs_detaillist.php"); // Invalid key, return to list
		}
...
// Create page object
if (!isset($m_kegiatan_tahunan_rs_detail_edit)) $m_kegiatan_tahunan_rs_detail_edit = new cm_kegiatan_tahunan_rs_detail_edit();

// Page init
$m_kegiatan_tahunan_rs_detail_edit->Page_Init();

// Page main
$m_kegiatan_tahunan_rs_detail_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$m_kegiatan_tahunan_rs_detail_edit->Page_Render();
?>
...
var CurrentForm = fm_kegiatan_tahunan_rs_detailedit = new ew_Form("fm_kegiatan_tahunan_rs_detailedit", "edit");

// Validate form
fm_kegiatan_tahunan_rs_detailedit.Validate = function() {
...
fm_kegiatan_tahunan_rs_detailedit.Form_CustomValidate = 
...
fm_kegiatan_tahunan_rs_detailedit.ValidateRequired = true;
<?php } else { ?>
fm_kegiatan_tahunan_rs_detailedit.ValidateRequired = false; 
<?php } ?>
...
<?php if (!$m_kegiatan_tahunan_rs_detail_edit->IsModal) { ?>
<?php } ?>
<?php $m_kegiatan_tahunan_rs_detail_edit->ShowPageHeader(); ?>
<?php
$m_kegiatan_tahunan_rs_detail_edit->ShowMessage();
?>
<form name="fm_kegiatan_tahunan_rs_detailedit" id="fm_kegiatan_tahunan_rs_detailedit" class="<?php echo $m_kegiatan_tahunan_rs_detail_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($m_kegiatan_tahunan_rs_detail_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $m_kegiatan_tahunan_rs_detail_edit->Token ?>">
<?php } ?>
...
<p class="form-control-static"><?php echo $m_kegiatan_tahunan_rs_detail->id->EditValue ?></p></span>
</span>
<input type="hidden" data-table="m_kegiatan_tahunan_rs_detail" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($m_kegiatan_tahunan_rs_detail->id->CurrentValue) ?>">
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $m_kegiatan_tahunan_rs_detail_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
fm_kegiatan_tahunan_rs_detailedit.Init();
</script>
<?php
$m_kegiatan_tahunan_rs_detail_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$m_kegiatan_tahunan_rs_detail_edit->Page_Terminate();
?>
