...
$vw_pajak_sbp_detail_grid = NULL; // Initialize page object first

class cvw_pajak_sbp_detail_grid extends cvw_pajak_sbp_detail {
	...
	// Page object name
	var $PageObjName = 'vw_pajak_sbp_detail_grid';

	// Grid form hidden field names
	var $FormName = 'fvw_pajak_sbp_detailgrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["vw_pajak_sbp_detail"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function SetUpMasterParms() {
		...
		if ($sMasterTblVar == "t_sbp") {
			$this->id_sbp->Visible = FALSE;
			if ($GLOBALS["t_sbp"]->EventCancelled) $this->EventCancelled = TRUE;
			$this->tipe_sbp->Visible = FALSE;
			if ($GLOBALS["t_sbp"]->EventCancelled) $this->EventCancelled = TRUE;
			$this->no_sbp->Visible = FALSE;
			if ($GLOBALS["t_sbp"]->EventCancelled) $this->EventCancelled = TRUE;
