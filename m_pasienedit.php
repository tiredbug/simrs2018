...
$m_pasien_edit = NULL; // Initialize page object first

class cm_pasien_edit extends cm_pasien {
	...
	function Page_Main() {
		...
		if ($this->id->CurrentValue == "") {
			$this->Page_Terminate("m_pasienlist.php"); // Invalid key, return to list
		}
	...
	function EditRow() {
		...
		$conn = &$this->Connection();
		if ($this->NOMR->CurrentValue <> "") { // Check field with unique index
			$sFilterChk = "(`NOMR` = '" . ew_AdjustSql($this->NOMR->CurrentValue, $this->DBID) . "')";
			...
			if ($rsChk === FALSE) {
				...
				$sIdxErrMsg = str_replace("%f", $this->NOMR->FldCaption(), $Language->Phrase("DupIndex"));
				$sIdxErrMsg = str_replace("%v", $this->NOMR->CurrentValue, $sIdxErrMsg);
		...
		if ($rs->EOF) {
			...
			// TGLLAHIR
			$this->TGLLAHIR->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->TGLLAHIR->CurrentValue, 7), ew_CurrentDate(), $this->TGLLAHIR->ReadOnly);

			// JENISKELAMIN
			$this->JENISKELAMIN->SetDbValueDef($rsnew, $this->JENISKELAMIN->CurrentValue, "", $this->JENISKELAMIN->ReadOnly);

			// ALAMAT
			$this->ALAMAT->SetDbValueDef($rsnew, $this->ALAMAT->CurrentValue, "", $this->ALAMAT->ReadOnly);

			// KDPROVINSI
			$this->KDPROVINSI->SetDbValueDef($rsnew, $this->KDPROVINSI->CurrentValue, 0, $this->KDPROVINSI->ReadOnly);

			// KOTA
			$this->KOTA->SetDbValueDef($rsnew, $this->KOTA->CurrentValue, "", $this->KOTA->ReadOnly);

			// KDKECAMATAN
			$this->KDKECAMATAN->SetDbValueDef($rsnew, $this->KDKECAMATAN->CurrentValue, 0, $this->KDKECAMATAN->ReadOnly);

			// KELURAHAN
			$this->KELURAHAN->SetDbValueDef($rsnew, $this->KELURAHAN->CurrentValue, "", $this->KELURAHAN->ReadOnly);

			// NOTELP
			$this->NOTELP->SetDbValueDef($rsnew, $this->NOTELP->CurrentValue, "", $this->NOTELP->ReadOnly);

			// NOKTP
			$this->NOKTP->SetDbValueDef($rsnew, $this->NOKTP->CurrentValue, "", $this->NOKTP->ReadOnly);
			...
			// PENDIDIKAN
			$this->PENDIDIKAN->SetDbValueDef($rsnew, $this->PENDIDIKAN->CurrentValue, 0, $this->PENDIDIKAN->ReadOnly);

			// KDCARABAYAR
			$this->KDCARABAYAR->SetDbValueDef($rsnew, $this->KDCARABAYAR->CurrentValue, NULL, $this->KDCARABAYAR->ReadOnly);

			// NIP
			$this->NIP->SetDbValueDef($rsnew, $this->NIP->CurrentValue, "", $this->NIP->ReadOnly);

			// TGLDAFTAR
			$this->TGLDAFTAR->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->TGLDAFTAR->CurrentValue, 7), ew_CurrentDate(), $this->TGLDAFTAR->ReadOnly);

			// ALAMAT_KTP
			$this->ALAMAT_KTP->SetDbValueDef($rsnew, $this->ALAMAT_KTP->CurrentValue, "", $this->ALAMAT_KTP->ReadOnly);

			// PENANGGUNGJAWAB_NAMA
			$this->PENANGGUNGJAWAB_NAMA->SetDbValueDef($rsnew, $this->PENANGGUNGJAWAB_NAMA->CurrentValue, NULL, $this->PENANGGUNGJAWAB_NAMA->ReadOnly);

			// PENANGGUNGJAWAB_HUBUNGAN
			$this->PENANGGUNGJAWAB_HUBUNGAN->SetDbValueDef($rsnew, $this->PENANGGUNGJAWAB_HUBUNGAN->CurrentValue, NULL, $this->PENANGGUNGJAWAB_HUBUNGAN->ReadOnly);

			// PENANGGUNGJAWAB_ALAMAT
			$this->PENANGGUNGJAWAB_ALAMAT->SetDbValueDef($rsnew, $this->PENANGGUNGJAWAB_ALAMAT->CurrentValue, NULL, $this->PENANGGUNGJAWAB_ALAMAT->ReadOnly);

			// PENANGGUNGJAWAB_PHONE
			$this->PENANGGUNGJAWAB_PHONE->SetDbValueDef($rsnew, $this->PENANGGUNGJAWAB_PHONE->CurrentValue, NULL, $this->PENANGGUNGJAWAB_PHONE->ReadOnly);

			// NO_KARTU
			$this->NO_KARTU->SetDbValueDef($rsnew, $this->NO_KARTU->CurrentValue, NULL, $this->NO_KARTU->ReadOnly);

			// JNS_PASIEN
			$this->JNS_PASIEN->SetDbValueDef($rsnew, $this->JNS_PASIEN->CurrentValue, NULL, $this->JNS_PASIEN->ReadOnly);

			// nama_ayah
			$this->nama_ayah->SetDbValueDef($rsnew, $this->nama_ayah->CurrentValue, "", $this->nama_ayah->ReadOnly);

			// nama_ibu
			$this->nama_ibu->SetDbValueDef($rsnew, $this->nama_ibu->CurrentValue, "", $this->nama_ibu->ReadOnly);

			// nama_suami
			$this->nama_suami->SetDbValueDef($rsnew, $this->nama_suami->CurrentValue, "", $this->nama_suami->ReadOnly);

			// nama_istri
			$this->nama_istri->SetDbValueDef($rsnew, $this->nama_istri->CurrentValue, "", $this->nama_istri->ReadOnly);

			// KD_ETNIS
			$this->KD_ETNIS->SetDbValueDef($rsnew, $this->KD_ETNIS->CurrentValue, NULL, $this->KD_ETNIS->ReadOnly);

			// KD_BHS_HARIAN
			$this->KD_BHS_HARIAN->SetDbValueDef($rsnew, $this->KD_BHS_HARIAN->CurrentValue, NULL, $this->KD_BHS_HARIAN->ReadOnly);
...
// Create page object
if (!isset($m_pasien_edit)) $m_pasien_edit = new cm_pasien_edit();

// Page init
$m_pasien_edit->Page_Init();

// Page main
$m_pasien_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$m_pasien_edit->Page_Render();
?>
...
var CurrentForm = fm_pasienedit = new ew_Form("fm_pasienedit", "edit");
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		$fobj.data("rowindex", infix);
			...
			if (elm && !ew_IsHidden(elm) && !ew_HasValue(elm))
				return this.OnError(elm, "<?php echo ew_JsEncode2(str_replace("%s", $m_pasien->NOMR->FldCaption(), $m_pasien->NOMR->ReqErrMsg)) ?>");
...
fm_pasienedit.Form_CustomValidate = 
...
fm_pasienedit.ValidateRequired = true;
<?php } else { ?>
fm_pasienedit.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fm_pasienedit.Lists["x_TITLE"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_title","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"l_titel"};
fm_pasienedit.Lists["x_JENISKELAMIN"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_jeniskelamin","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"l_jeniskelamin"};
fm_pasienedit.Lists["x_KDPROVINSI"] = {"LinkField":"x_idprovinsi","Ajax":true,"AutoFill":false,"DisplayFields":["x_namaprovinsi","","",""],"ParentFields":[],"ChildFields":["x_KOTA"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"m_provinsi"};
fm_pasienedit.Lists["x_KOTA"] = {"LinkField":"x_idkota","Ajax":true,"AutoFill":false,"DisplayFields":["x_namakota","","",""],"ParentFields":["x_KDPROVINSI"],"ChildFields":["x_KDKECAMATAN"],"FilterFields":["x_idprovinsi"],"Options":[],"Template":"","LinkTable":"m_kota"};
fm_pasienedit.Lists["x_KDKECAMATAN"] = {"LinkField":"x_idkecamatan","Ajax":true,"AutoFill":false,"DisplayFields":["x_namakecamatan","","",""],"ParentFields":["x_KOTA"],"ChildFields":["x_KELURAHAN"],"FilterFields":["x_idkota"],"Options":[],"Template":"","LinkTable":"m_kecamatan"};
fm_pasienedit.Lists["x_KELURAHAN"] = {"LinkField":"x_idkelurahan","Ajax":true,"AutoFill":false,"DisplayFields":["x_namakelurahan","","",""],"ParentFields":["x_KDKECAMATAN"],"ChildFields":[],"FilterFields":["x_idkecamatan"],"Options":[],"Template":"","LinkTable":"m_kelurahan"};
fm_pasienedit.Lists["x_STATUS"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_statusperkawinan","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"l_statusperkawin"};
fm_pasienedit.Lists["x_AGAMA"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_agama","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"l_agama"};
fm_pasienedit.Lists["x_PENDIDIKAN"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_pendidikan","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"l_pendidikanterakhir"};
fm_pasienedit.Lists["x_KDCARABAYAR"] = {"LinkField":"x_KODE","Ajax":true,"AutoFill":false,"DisplayFields":["x_NAMA","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"m_carabayar"};
fm_pasienedit.Lists["x_JNS_PASIEN"] = {"LinkField":"x_jenis_pasien","Ajax":true,"AutoFill":false,"DisplayFields":["x_nama_jenis","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"l_jenis_pasien"};
fm_pasienedit.Lists["x_KD_ETNIS"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_nama_etnis","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"m_etnis"};
fm_pasienedit.Lists["x_KD_BHS_HARIAN"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_bahasa_harian","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"m_bahasa_harian"};
...
<?php if (!$m_pasien_edit->IsModal) { ?>
<?php } ?>
<?php $m_pasien_edit->ShowPageHeader(); ?>
<?php
$m_pasien_edit->ShowMessage();
?>
<form name="fm_pasienedit" id="fm_pasienedit" class="<?php echo $m_pasien_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($m_pasien_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $m_pasien_edit->Token ?>">
<?php } ?>
...
<?php } ?>
<div>
<?php if ($m_pasien->id->Visible) { // id ?>
	<div id="r_id" class="form-group">
		<label id="elh_m_pasien_id" class="col-sm-2 control-label ewLabel"><?php echo $m_pasien->id->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $m_pasien->id->CellAttributes() ?>>
<span id="el_m_pasien_id">
<span<?php echo $m_pasien->id->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $m_pasien->id->EditValue ?></p></span>
</span>
<input type="hidden" data-table="m_pasien" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($m_pasien->id->CurrentValue) ?>">
<?php echo $m_pasien->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($m_pasien->NOMR->Visible) { // NOMR ?>
	<div id="r_NOMR" class="form-group">
		<label id="elh_m_pasien_NOMR" for="x_NOMR" class="col-sm-2 control-label ewLabel"><?php echo $m_pasien->NOMR->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="col-sm-10"><div<?php echo $m_pasien->NOMR->CellAttributes() ?>>
...
<?php echo $m_pasien->NOMR->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($m_pasien->TITLE->Visible) { // TITLE ?>
	<div id="r_TITLE" class="form-group">
		<label id="elh_m_pasien_TITLE" for="x_TITLE" class="col-sm-2 control-label ewLabel"><?php echo $m_pasien->TITLE->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
...
<?php if ($m_pasien->NAMA->Visible) { // NAMA ?>
	<div id="r_NAMA" class="form-group">
		<label id="elh_m_pasien_NAMA" for="x_NAMA" class="col-sm-2 control-label ewLabel"><?php echo $m_pasien->NAMA->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
...
<?php if ($m_pasien->TEMPAT->Visible) { // TEMPAT ?>
	<div id="r_TEMPAT" class="form-group">
		<label id="elh_m_pasien_TEMPAT" for="x_TEMPAT" class="col-sm-2 control-label ewLabel"><?php echo $m_pasien->TEMPAT->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
...
<?php if ($m_pasien->TGLLAHIR->Visible) { // TGLLAHIR ?>
	<div id="r_TGLLAHIR" class="form-group">
		<label id="elh_m_pasien_TGLLAHIR" for="x_TGLLAHIR" class="col-sm-2 control-label ewLabel"><?php echo $m_pasien->TGLLAHIR->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
...
<script type="text/javascript">
ew_CreateCalendar("fm_pasienedit", "x_TGLLAHIR", 7);
</script>
<?php } ?>
</span>
...
<?php if ($m_pasien->JENISKELAMIN->Visible) { // JENISKELAMIN ?>
	<div id="r_JENISKELAMIN" class="form-group">
		<label id="elh_m_pasien_JENISKELAMIN" class="col-sm-2 control-label ewLabel"><?php echo $m_pasien->JENISKELAMIN->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
...
<?php if ($m_pasien->ALAMAT->Visible) { // ALAMAT ?>
	<div id="r_ALAMAT" class="form-group">
		<label id="elh_m_pasien_ALAMAT" for="x_ALAMAT" class="col-sm-2 control-label ewLabel"><?php echo $m_pasien->ALAMAT->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
...
<?php if ($m_pasien->KDPROVINSI->Visible) { // KDPROVINSI ?>
	<div id="r_KDPROVINSI" class="form-group">
		<label id="elh_m_pasien_KDPROVINSI" for="x_KDPROVINSI" class="col-sm-2 control-label ewLabel"><?php echo $m_pasien->KDPROVINSI->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
...
<?php if ($m_pasien->KOTA->Visible) { // KOTA ?>
	<div id="r_KOTA" class="form-group">
		<label id="elh_m_pasien_KOTA" for="x_KOTA" class="col-sm-2 control-label ewLabel"><?php echo $m_pasien->KOTA->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
...
<?php if ($m_pasien->KDKECAMATAN->Visible) { // KDKECAMATAN ?>
	<div id="r_KDKECAMATAN" class="form-group">
		<label id="elh_m_pasien_KDKECAMATAN" for="x_KDKECAMATAN" class="col-sm-2 control-label ewLabel"><?php echo $m_pasien->KDKECAMATAN->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
...
<?php if ($m_pasien->KELURAHAN->Visible) { // KELURAHAN ?>
	<div id="r_KELURAHAN" class="form-group">
		<label id="elh_m_pasien_KELURAHAN" for="x_KELURAHAN" class="col-sm-2 control-label ewLabel"><?php echo $m_pasien->KELURAHAN->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
...
<?php if ($m_pasien->NOTELP->Visible) { // NOTELP ?>
	<div id="r_NOTELP" class="form-group">
		<label id="elh_m_pasien_NOTELP" for="x_NOTELP" class="col-sm-2 control-label ewLabel"><?php echo $m_pasien->NOTELP->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
...
<?php if ($m_pasien->NOKTP->Visible) { // NOKTP ?>
	<div id="r_NOKTP" class="form-group">
		<label id="elh_m_pasien_NOKTP" for="x_NOKTP" class="col-sm-2 control-label ewLabel"><?php echo $m_pasien->NOKTP->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
...
<?php if ($m_pasien->PEKERJAAN->Visible) { // PEKERJAAN ?>
	<div id="r_PEKERJAAN" class="form-group">
		<label id="elh_m_pasien_PEKERJAAN" for="x_PEKERJAAN" class="col-sm-2 control-label ewLabel"><?php echo $m_pasien->PEKERJAAN->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
...
<?php if ($m_pasien->STATUS->Visible) { // STATUS ?>
	<div id="r_STATUS" class="form-group">
		<label id="elh_m_pasien_STATUS" for="x_STATUS" class="col-sm-2 control-label ewLabel"><?php echo $m_pasien->STATUS->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
...
<?php if ($m_pasien->AGAMA->Visible) { // AGAMA ?>
	<div id="r_AGAMA" class="form-group">
		<label id="elh_m_pasien_AGAMA" for="x_AGAMA" class="col-sm-2 control-label ewLabel"><?php echo $m_pasien->AGAMA->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
...
<?php if ($m_pasien->PENDIDIKAN->Visible) { // PENDIDIKAN ?>
	<div id="r_PENDIDIKAN" class="form-group">
		<label id="elh_m_pasien_PENDIDIKAN" for="x_PENDIDIKAN" class="col-sm-2 control-label ewLabel"><?php echo $m_pasien->PENDIDIKAN->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
...
<?php if ($m_pasien->KDCARABAYAR->Visible) { // KDCARABAYAR ?>
	<div id="r_KDCARABAYAR" class="form-group">
		<label id="elh_m_pasien_KDCARABAYAR" for="x_KDCARABAYAR" class="col-sm-2 control-label ewLabel"><?php echo $m_pasien->KDCARABAYAR->FldCaption() ?></label>
...
<?php if ($m_pasien->NIP->Visible) { // NIP ?>
	<div id="r_NIP" class="form-group">
		<label id="elh_m_pasien_NIP" for="x_NIP" class="col-sm-2 control-label ewLabel"><?php echo $m_pasien->NIP->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
...
<?php if ($m_pasien->TGLDAFTAR->Visible) { // TGLDAFTAR ?>
	<div id="r_TGLDAFTAR" class="form-group">
		<label id="elh_m_pasien_TGLDAFTAR" for="x_TGLDAFTAR" class="col-sm-2 control-label ewLabel"><?php echo $m_pasien->TGLDAFTAR->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
...
<?php if ($m_pasien->ALAMAT_KTP->Visible) { // ALAMAT_KTP ?>
	<div id="r_ALAMAT_KTP" class="form-group">
		<label id="elh_m_pasien_ALAMAT_KTP" for="x_ALAMAT_KTP" class="col-sm-2 control-label ewLabel"><?php echo $m_pasien->ALAMAT_KTP->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
...
<?php if ($m_pasien->PENANGGUNGJAWAB_NAMA->Visible) { // PENANGGUNGJAWAB_NAMA ?>
	<div id="r_PENANGGUNGJAWAB_NAMA" class="form-group">
		<label id="elh_m_pasien_PENANGGUNGJAWAB_NAMA" for="x_PENANGGUNGJAWAB_NAMA" class="col-sm-2 control-label ewLabel"><?php echo $m_pasien->PENANGGUNGJAWAB_NAMA->FldCaption() ?></label>
...
<?php if ($m_pasien->PENANGGUNGJAWAB_HUBUNGAN->Visible) { // PENANGGUNGJAWAB_HUBUNGAN ?>
	<div id="r_PENANGGUNGJAWAB_HUBUNGAN" class="form-group">
		<label id="elh_m_pasien_PENANGGUNGJAWAB_HUBUNGAN" for="x_PENANGGUNGJAWAB_HUBUNGAN" class="col-sm-2 control-label ewLabel"><?php echo $m_pasien->PENANGGUNGJAWAB_HUBUNGAN->FldCaption() ?></label>
...
<?php if ($m_pasien->PENANGGUNGJAWAB_ALAMAT->Visible) { // PENANGGUNGJAWAB_ALAMAT ?>
	<div id="r_PENANGGUNGJAWAB_ALAMAT" class="form-group">
		<label id="elh_m_pasien_PENANGGUNGJAWAB_ALAMAT" for="x_PENANGGUNGJAWAB_ALAMAT" class="col-sm-2 control-label ewLabel"><?php echo $m_pasien->PENANGGUNGJAWAB_ALAMAT->FldCaption() ?></label>
...
<?php if ($m_pasien->PENANGGUNGJAWAB_PHONE->Visible) { // PENANGGUNGJAWAB_PHONE ?>
	<div id="r_PENANGGUNGJAWAB_PHONE" class="form-group">
		<label id="elh_m_pasien_PENANGGUNGJAWAB_PHONE" for="x_PENANGGUNGJAWAB_PHONE" class="col-sm-2 control-label ewLabel"><?php echo $m_pasien->PENANGGUNGJAWAB_PHONE->FldCaption() ?></label>
...
<?php if ($m_pasien->NO_KARTU->Visible) { // NO_KARTU ?>
	<div id="r_NO_KARTU" class="form-group">
		<label id="elh_m_pasien_NO_KARTU" for="x_NO_KARTU" class="col-sm-2 control-label ewLabel"><?php echo $m_pasien->NO_KARTU->FldCaption() ?></label>
...
<?php if ($m_pasien->JNS_PASIEN->Visible) { // JNS_PASIEN ?>
	<div id="r_JNS_PASIEN" class="form-group">
		<label id="elh_m_pasien_JNS_PASIEN" for="x_JNS_PASIEN" class="col-sm-2 control-label ewLabel"><?php echo $m_pasien->JNS_PASIEN->FldCaption() ?></label>
...
<?php if ($m_pasien->nama_ayah->Visible) { // nama_ayah ?>
	<div id="r_nama_ayah" class="form-group">
		<label id="elh_m_pasien_nama_ayah" for="x_nama_ayah" class="col-sm-2 control-label ewLabel"><?php echo $m_pasien->nama_ayah->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
...
<?php if ($m_pasien->nama_ibu->Visible) { // nama_ibu ?>
	<div id="r_nama_ibu" class="form-group">
		<label id="elh_m_pasien_nama_ibu" for="x_nama_ibu" class="col-sm-2 control-label ewLabel"><?php echo $m_pasien->nama_ibu->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
...
<?php if ($m_pasien->nama_suami->Visible) { // nama_suami ?>
	<div id="r_nama_suami" class="form-group">
		<label id="elh_m_pasien_nama_suami" for="x_nama_suami" class="col-sm-2 control-label ewLabel"><?php echo $m_pasien->nama_suami->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
...
<?php if ($m_pasien->nama_istri->Visible) { // nama_istri ?>
	<div id="r_nama_istri" class="form-group">
		<label id="elh_m_pasien_nama_istri" for="x_nama_istri" class="col-sm-2 control-label ewLabel"><?php echo $m_pasien->nama_istri->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
...
<?php if ($m_pasien->KD_ETNIS->Visible) { // KD_ETNIS ?>
	<div id="r_KD_ETNIS" class="form-group">
		<label id="elh_m_pasien_KD_ETNIS" for="x_KD_ETNIS" class="col-sm-2 control-label ewLabel"><?php echo $m_pasien->KD_ETNIS->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
...
<?php if ($m_pasien->KD_BHS_HARIAN->Visible) { // KD_BHS_HARIAN ?>
	<div id="r_KD_BHS_HARIAN" class="form-group">
		<label id="elh_m_pasien_KD_BHS_HARIAN" for="x_KD_BHS_HARIAN" class="col-sm-2 control-label ewLabel"><?php echo $m_pasien->KD_BHS_HARIAN->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $m_pasien_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
