...
$vw_spp_pengembalian_penerimaan_edit = NULL; // Initialize page object first

class cvw_spp_pengembalian_penerimaan_edit extends cvw_spp_pengembalian_penerimaan {
	...
	// Page object name
	var $PageObjName = 'vw_spp_pengembalian_penerimaan_edit';
	...
	function Page_Main() {
		...
		if ($this->id->CurrentValue == "") {
			$this->Page_Terminate("vw_spp_pengembalian_penerimaanlist.php"); // Invalid key, return to list
		}
	...
	function ValidateForm() {
		...
		if (in_array("vw_spp_pengembalian_penerimaan_detail_belanja", $DetailTblVar) && $GLOBALS["vw_spp_pengembalian_penerimaan_detail_belanja"]->DetailEdit) {
			...
			if ($bUpdateRow) {
				...
				if ($EditRow) {
					if (in_array("vw_spp_pengembalian_penerimaan_detail_belanja", $DetailTblVar) && $GLOBALS["vw_spp_pengembalian_penerimaan_detail_belanja"]->DetailEdit) {
						...
						$EditRow = $GLOBALS["vw_spp_pengembalian_penerimaan_detail_belanja_grid"]->GridUpdate();
	...
	function SetUpDetailParms() {
		...
		if ($sDetailTblVar <> "") {
			...
			if (in_array("vw_spp_pengembalian_penerimaan_detail_belanja", $DetailTblVar)) {
				...
				if ($GLOBALS["vw_spp_pengembalian_penerimaan_detail_belanja_grid"]->DetailEdit) {
					$GLOBALS["vw_spp_pengembalian_penerimaan_detail_belanja_grid"]->CurrentMode = "edit";
					$GLOBALS["vw_spp_pengembalian_penerimaan_detail_belanja_grid"]->CurrentAction = "gridedit";
...
// Create page object
if (!isset($vw_spp_pengembalian_penerimaan_edit)) $vw_spp_pengembalian_penerimaan_edit = new cvw_spp_pengembalian_penerimaan_edit();

// Page init
$vw_spp_pengembalian_penerimaan_edit->Page_Init();

// Page main
$vw_spp_pengembalian_penerimaan_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$vw_spp_pengembalian_penerimaan_edit->Page_Render();
?>
...
var CurrentForm = fvw_spp_pengembalian_penerimaanedit = new ew_Form("fvw_spp_pengembalian_penerimaanedit", "edit");

// Validate form
fvw_spp_pengembalian_penerimaanedit.Validate = function() {
...
fvw_spp_pengembalian_penerimaanedit.Form_CustomValidate = 
...
fvw_spp_pengembalian_penerimaanedit.ValidateRequired = true;
<?php } else { ?>
fvw_spp_pengembalian_penerimaanedit.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fvw_spp_pengembalian_penerimaanedit.Lists["x_id_jenis_spp"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_jenis_spp","","",""],"ParentFields":[],"ChildFields":["x_detail_jenis_spp"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"l_jenis_spp"};
fvw_spp_pengembalian_penerimaanedit.Lists["x_detail_jenis_spp"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_detail_jenis_spp","","",""],"ParentFields":["x_id_jenis_spp"],"ChildFields":[],"FilterFields":["x_id_jenis"],"Options":[],"Template":"","LinkTable":"l_jenis_detail_spp"};
fvw_spp_pengembalian_penerimaanedit.Lists["x_status_spp"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fvw_spp_pengembalian_penerimaanedit.Lists["x_status_spp"].Options = <?php echo json_encode($vw_spp_pengembalian_penerimaan->status_spp->Options()) ?>;
fvw_spp_pengembalian_penerimaanedit.Lists["x_kode_program"] = {"LinkField":"x_kode_program","Ajax":true,"AutoFill":false,"DisplayFields":["x_nama_program","","",""],"ParentFields":[],"ChildFields":["x_kode_kegiatan"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"m_program"};
fvw_spp_pengembalian_penerimaanedit.Lists["x_kode_kegiatan"] = {"LinkField":"x_kode_kegiatan","Ajax":true,"AutoFill":false,"DisplayFields":["x_nama_kegiatan","","",""],"ParentFields":["x_kode_program"],"ChildFields":["x_kode_sub_kegiatan"],"FilterFields":["x_kode_program"],"Options":[],"Template":"","LinkTable":"m_kegiatan"};
fvw_spp_pengembalian_penerimaanedit.Lists["x_kode_sub_kegiatan"] = {"LinkField":"x_kode_sub_kegiatan","Ajax":true,"AutoFill":false,"DisplayFields":["x_nama_sub_kegiatan","","",""],"ParentFields":["x_kode_kegiatan"],"ChildFields":[],"FilterFields":["x_kode_kegiatan"],"Options":[],"Template":"","LinkTable":"m_sub_kegiatan"};
fvw_spp_pengembalian_penerimaanedit.Lists["x_nama_bendahara"] = {"LinkField":"x_nama","Ajax":true,"AutoFill":true,"DisplayFields":["x_nama","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"m_pejabat_keuangan"};
...
<?php if (!$vw_spp_pengembalian_penerimaan_edit->IsModal) { ?>
<?php } ?>
<?php $vw_spp_pengembalian_penerimaan_edit->ShowPageHeader(); ?>
<?php
$vw_spp_pengembalian_penerimaan_edit->ShowMessage();
?>
<form name="fvw_spp_pengembalian_penerimaanedit" id="fvw_spp_pengembalian_penerimaanedit" class="<?php echo $vw_spp_pengembalian_penerimaan_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($vw_spp_pengembalian_penerimaan_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $vw_spp_pengembalian_penerimaan_edit->Token ?>">
<?php } ?>
...
<?php if ($vw_spp_pengembalian_penerimaan->id->Visible) { // id ?>
	<div id="r_id" class="form-group">
		<label id="elh_vw_spp_pengembalian_penerimaan_id" class="col-sm-2 control-label ewLabel"><?php echo $vw_spp_pengembalian_penerimaan->id->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $vw_spp_pengembalian_penerimaan->id->CellAttributes() ?>>
...
<p class="form-control-static"><?php echo $vw_spp_pengembalian_penerimaan->id->EditValue ?></p></span>
</span>
</div>
<?php
...
?>
<input type="hidden" data-table="vw_spp_pengembalian_penerimaan" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($vw_spp_pengembalian_penerimaan->id->CurrentValue) ?>">
<?php echo $vw_spp_pengembalian_penerimaan->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($vw_spp_pengembalian_penerimaan->id_jenis_spp->Visible) { // id_jenis_spp ?>
	<div id="r_id_jenis_spp" class="form-group">
		<label id="elh_vw_spp_pengembalian_penerimaan_id_jenis_spp" for="x_id_jenis_spp" class="col-sm-2 control-label ewLabel"><?php echo $vw_spp_pengembalian_penerimaan->id_jenis_spp->FldCaption() ?></label>
...
<?php if ($vw_spp_pengembalian_penerimaan->detail_jenis_spp->Visible) { // detail_jenis_spp ?>
	<div id="r_detail_jenis_spp" class="form-group">
		<label id="elh_vw_spp_pengembalian_penerimaan_detail_jenis_spp" for="x_detail_jenis_spp" class="col-sm-2 control-label ewLabel"><?php echo $vw_spp_pengembalian_penerimaan->detail_jenis_spp->FldCaption() ?></label>
...
<?php if ($vw_spp_pengembalian_penerimaan->status_spp->Visible) { // status_spp ?>
	<div id="r_status_spp" class="form-group">
		<label id="elh_vw_spp_pengembalian_penerimaan_status_spp" for="x_status_spp" class="col-sm-2 control-label ewLabel"><?php echo $vw_spp_pengembalian_penerimaan->status_spp->FldCaption() ?></label>
...
<?php if ($vw_spp_pengembalian_penerimaan->kode_program->Visible) { // kode_program ?>
	<div id="r_kode_program" class="form-group">
		<label id="elh_vw_spp_pengembalian_penerimaan_kode_program" for="x_kode_program" class="col-sm-2 control-label ewLabel"><?php echo $vw_spp_pengembalian_penerimaan->kode_program->FldCaption() ?></label>
...
<?php if ($vw_spp_pengembalian_penerimaan->kode_kegiatan->Visible) { // kode_kegiatan ?>
	<div id="r_kode_kegiatan" class="form-group">
		<label id="elh_vw_spp_pengembalian_penerimaan_kode_kegiatan" for="x_kode_kegiatan" class="col-sm-2 control-label ewLabel"><?php echo $vw_spp_pengembalian_penerimaan->kode_kegiatan->FldCaption() ?></label>
...
<?php if ($vw_spp_pengembalian_penerimaan->kode_sub_kegiatan->Visible) { // kode_sub_kegiatan ?>
	<div id="r_kode_sub_kegiatan" class="form-group">
		<label id="elh_vw_spp_pengembalian_penerimaan_kode_sub_kegiatan" for="x_kode_sub_kegiatan" class="col-sm-2 control-label ewLabel"><?php echo $vw_spp_pengembalian_penerimaan->kode_sub_kegiatan->FldCaption() ?></label>
...
<?php if ($vw_spp_pengembalian_penerimaan->no_spp->Visible) { // no_spp ?>
	<div id="r_no_spp" class="form-group">
		<label id="elh_vw_spp_pengembalian_penerimaan_no_spp" for="x_no_spp" class="col-sm-2 control-label ewLabel"><?php echo $vw_spp_pengembalian_penerimaan->no_spp->FldCaption() ?></label>
...
<?php if ($vw_spp_pengembalian_penerimaan->nama_bendahara->Visible) { // nama_bendahara ?>
	<div id="r_nama_bendahara" class="form-group">
		<label id="elh_vw_spp_pengembalian_penerimaan_nama_bendahara" for="x_nama_bendahara" class="col-sm-2 control-label ewLabel"><?php echo $vw_spp_pengembalian_penerimaan->nama_bendahara->FldCaption() ?></label>
...
<?php if ($vw_spp_pengembalian_penerimaan->nip_bendahara->Visible) { // nip_bendahara ?>
	<div id="r_nip_bendahara" class="form-group">
		<label id="elh_vw_spp_pengembalian_penerimaan_nip_bendahara" for="x_nip_bendahara" class="col-sm-2 control-label ewLabel"><?php echo $vw_spp_pengembalian_penerimaan->nip_bendahara->FldCaption() ?></label>
...
<?php if ($vw_spp_pengembalian_penerimaan->tgl_spp->Visible) { // tgl_spp ?>
	<div id="r_tgl_spp" class="form-group">
		<label id="elh_vw_spp_pengembalian_penerimaan_tgl_spp" for="x_tgl_spp" class="col-sm-2 control-label ewLabel"><?php echo $vw_spp_pengembalian_penerimaan->tgl_spp->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
...
<script type="text/javascript">
ew_CreateCalendar("fvw_spp_pengembalian_penerimaanedit", "x_tgl_spp", 7);
</script>
<?php } ?>
</span>
...
<?php } ?>
<?php if ($vw_spp_pengembalian_penerimaan->kode_rekening->Visible) { // kode_rekening ?>
	<div id="r_kode_rekening" class="form-group">
		<label id="elh_vw_spp_pengembalian_penerimaan_kode_rekening" for="x_kode_rekening" class="col-sm-2 control-label ewLabel"><?php echo $vw_spp_pengembalian_penerimaan->kode_rekening->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $vw_spp_pengembalian_penerimaan->kode_rekening->CellAttributes() ?>>
<span id="el_vw_spp_pengembalian_penerimaan_kode_rekening">
<input type="text" data-table="vw_spp_pengembalian_penerimaan" data-field="x_kode_rekening" name="x_kode_rekening" id="x_kode_rekening" size="30" maxlength="45" placeholder="<?php echo ew_HtmlEncode($vw_spp_pengembalian_penerimaan->kode_rekening->getPlaceHolder()) ?>" value="<?php echo $vw_spp_pengembalian_penerimaan->kode_rekening->EditValue ?>"<?php echo $vw_spp_pengembalian_penerimaan->kode_rekening->EditAttributes() ?>>
</span>
<?php echo $vw_spp_pengembalian_penerimaan->kode_rekening->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($vw_spp_pengembalian_penerimaan->keterangan->Visible) { // keterangan ?>
	<div id="r_keterangan" class="form-group">
		<label id="elh_vw_spp_pengembalian_penerimaan_keterangan" for="x_keterangan" class="col-sm-2 control-label ewLabel"><?php echo $vw_spp_pengembalian_penerimaan->keterangan->FldCaption() ?></label>
...
<?php if ($vw_spp_pengembalian_penerimaan->tahun_anggaran->Visible) { // tahun_anggaran ?>
	<div id="r_tahun_anggaran" class="form-group">
		<label id="elh_vw_spp_pengembalian_penerimaan_tahun_anggaran" for="x_tahun_anggaran" class="col-sm-2 control-label ewLabel"><?php echo $vw_spp_pengembalian_penerimaan->tahun_anggaran->FldCaption() ?></label>
...
<?php if ($vw_spp_pengembalian_penerimaan->id_spd->Visible) { // id_spd ?>
	<div id="r_id_spd" class="form-group">
		<label id="elh_vw_spp_pengembalian_penerimaan_id_spd" for="x_id_spd" class="col-sm-2 control-label ewLabel"><?php echo $vw_spp_pengembalian_penerimaan->id_spd->FldCaption() ?></label>
...
<?php if ($vw_spp_pengembalian_penerimaan->tanggal_spd->Visible) { // tanggal_spd ?>
	<div id="r_tanggal_spd" class="form-group">
		<label id="elh_vw_spp_pengembalian_penerimaan_tanggal_spd" for="x_tanggal_spd" class="col-sm-2 control-label ewLabel"><?php echo $vw_spp_pengembalian_penerimaan->tanggal_spd->FldCaption() ?></label>
...
<?php if ($vw_spp_pengembalian_penerimaan->nomer_dasar_spd->Visible) { // nomer_dasar_spd ?>
	<div id="r_nomer_dasar_spd" class="form-group">
		<label id="elh_vw_spp_pengembalian_penerimaan_nomer_dasar_spd" for="x_nomer_dasar_spd" class="col-sm-2 control-label ewLabel"><?php echo $vw_spp_pengembalian_penerimaan->nomer_dasar_spd->FldCaption() ?></label>
...
<?php if ($vw_spp_pengembalian_penerimaan->jumlah_spd->Visible) { // jumlah_spd ?>
	<div id="r_jumlah_spd" class="form-group">
		<label id="elh_vw_spp_pengembalian_penerimaan_jumlah_spd" for="x_jumlah_spd" class="col-sm-2 control-label ewLabel"><?php echo $vw_spp_pengembalian_penerimaan->jumlah_spd->FldCaption() ?></label>
...
<?php
	if (in_array("vw_spp_pengembalian_penerimaan_detail_belanja", explode(",", $vw_spp_pengembalian_penerimaan->getCurrentDetailTable())) && $vw_spp_pengembalian_penerimaan_detail_belanja->DetailEdit) {
?>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $vw_spp_pengembalian_penerimaan_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
fvw_spp_pengembalian_penerimaanedit.Init();
</script>
<?php
$vw_spp_pengembalian_penerimaan_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$vw_spp_pengembalian_penerimaan_edit->Page_Terminate();
?>
