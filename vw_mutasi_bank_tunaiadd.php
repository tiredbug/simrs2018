...
$vw_mutasi_bank_tunai_add = NULL; // Initialize page object first

class cvw_mutasi_bank_tunai_add extends cvw_mutasi_bank_tunai {
	...
	// Page object name
	var $PageObjName = 'vw_mutasi_bank_tunai_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "vw_mutasi_bank_tunaiview.php")
	...
	function LoadDefaultValues() {
		$this->jenis_mutasi->CurrentValue = 1;
...
// Create page object
if (!isset($vw_mutasi_bank_tunai_add)) $vw_mutasi_bank_tunai_add = new cvw_mutasi_bank_tunai_add();

// Page init
$vw_mutasi_bank_tunai_add->Page_Init();

// Page main
$vw_mutasi_bank_tunai_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$vw_mutasi_bank_tunai_add->Page_Render();
?>
...
var CurrentForm = fvw_mutasi_bank_tunaiadd = new ew_Form("fvw_mutasi_bank_tunaiadd", "add");

// Validate form
fvw_mutasi_bank_tunaiadd.Validate = function() {
...
fvw_mutasi_bank_tunaiadd.Form_CustomValidate = 
...
fvw_mutasi_bank_tunaiadd.ValidateRequired = true;
<?php } else { ?>
fvw_mutasi_bank_tunaiadd.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fvw_mutasi_bank_tunaiadd.Lists["x_jenis_mutasi"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_jenis_mutasi","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"l_jenis_mutasi"};
...
<?php if (!$vw_mutasi_bank_tunai_add->IsModal) { ?>
<?php } ?>
<?php $vw_mutasi_bank_tunai_add->ShowPageHeader(); ?>
<?php
$vw_mutasi_bank_tunai_add->ShowMessage();
?>
<form name="fvw_mutasi_bank_tunaiadd" id="fvw_mutasi_bank_tunaiadd" class="<?php echo $vw_mutasi_bank_tunai_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($vw_mutasi_bank_tunai_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $vw_mutasi_bank_tunai_add->Token ?>">
<?php } ?>
...
<script type="text/javascript">
ew_CreateCalendar("fvw_mutasi_bank_tunaiadd", "x_tgl_bukti", 7);
</script>
<?php } ?>
</span>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $vw_mutasi_bank_tunai_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
fvw_mutasi_bank_tunaiadd.Init();
</script>
<?php
$vw_mutasi_bank_tunai_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$vw_mutasi_bank_tunai_add->Page_Terminate();
?>
