...
$vw_spp_pengembalian_penerimaan_detail_pajak_delete = NULL; // Initialize page object first

class cvw_spp_pengembalian_penerimaan_detail_pajak_delete extends cvw_spp_pengembalian_penerimaan_detail_pajak {
	...
	// Page object name
	var $PageObjName = 'vw_spp_pengembalian_penerimaan_detail_pajak_delete';
	...
	function Page_Main() {
		...
		if ($sFilter == "")
			$this->Page_Terminate("vw_spp_pengembalian_penerimaan_detail_pajaklist.php"); // Prevent SQL injection, return to list

		// Set up filter (SQL WHHERE clause) and get return SQL
		// SQL constructor in vw_spp_pengembalian_penerimaan_detail_pajak class, vw_spp_pengembalian_penerimaan_detail_pajakinfo.php
		...
		if ($this->CurrentAction == "I") { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->Page_Terminate("vw_spp_pengembalian_penerimaan_detail_pajaklist.php"); // Return to list
			}
		}
	}
...
// Create page object
if (!isset($vw_spp_pengembalian_penerimaan_detail_pajak_delete)) $vw_spp_pengembalian_penerimaan_detail_pajak_delete = new cvw_spp_pengembalian_penerimaan_detail_pajak_delete();

// Page init
$vw_spp_pengembalian_penerimaan_detail_pajak_delete->Page_Init();

// Page main
$vw_spp_pengembalian_penerimaan_detail_pajak_delete->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$vw_spp_pengembalian_penerimaan_detail_pajak_delete->Page_Render();
?>
...
var CurrentForm = fvw_spp_pengembalian_penerimaan_detail_pajakdelete = new ew_Form("fvw_spp_pengembalian_penerimaan_detail_pajakdelete", "delete");

// Form_CustomValidate event
fvw_spp_pengembalian_penerimaan_detail_pajakdelete.Form_CustomValidate = 
...
fvw_spp_pengembalian_penerimaan_detail_pajakdelete.ValidateRequired = true;
<?php } else { ?>
fvw_spp_pengembalian_penerimaan_detail_pajakdelete.ValidateRequired = false; 
<?php } ?>
...
<?php $vw_spp_pengembalian_penerimaan_detail_pajak_delete->ShowPageHeader(); ?>
<?php
$vw_spp_pengembalian_penerimaan_detail_pajak_delete->ShowMessage();
?>
<form name="fvw_spp_pengembalian_penerimaan_detail_pajakdelete" id="fvw_spp_pengembalian_penerimaan_detail_pajakdelete" class="form-inline ewForm ewDeleteForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($vw_spp_pengembalian_penerimaan_detail_pajak_delete->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $vw_spp_pengembalian_penerimaan_detail_pajak_delete->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="vw_spp_pengembalian_penerimaan_detail_pajak">
<input type="hidden" name="a_delete" id="a_delete" value="D">
<?php foreach ($vw_spp_pengembalian_penerimaan_detail_pajak_delete->RecKeys as $key) { ?>
...
<?php if ($vw_spp_pengembalian_penerimaan_detail_pajak->kd_rekening_belanja->Visible) { // kd_rekening_belanja ?>
		<th><span id="elh_vw_spp_pengembalian_penerimaan_detail_pajak_kd_rekening_belanja" class="vw_spp_pengembalian_penerimaan_detail_pajak_kd_rekening_belanja"><?php echo $vw_spp_pengembalian_penerimaan_detail_pajak->kd_rekening_belanja->FldCaption() ?></span></th>
<?php } ?>
<?php if ($vw_spp_pengembalian_penerimaan_detail_pajak->jumlah_belanja->Visible) { // jumlah_belanja ?>
		<th><span id="elh_vw_spp_pengembalian_penerimaan_detail_pajak_jumlah_belanja" class="vw_spp_pengembalian_penerimaan_detail_pajak_jumlah_belanja"><?php echo $vw_spp_pengembalian_penerimaan_detail_pajak->jumlah_belanja->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
<?php
$vw_spp_pengembalian_penerimaan_detail_pajak_delete->RecCnt = 0;
$i = 0;
while (!$vw_spp_pengembalian_penerimaan_detail_pajak_delete->Recordset->EOF) {
	$vw_spp_pengembalian_penerimaan_detail_pajak_delete->RecCnt++;
	$vw_spp_pengembalian_penerimaan_detail_pajak_delete->RowCnt++;

	// Set row properties
	$vw_spp_pengembalian_penerimaan_detail_pajak->ResetAttrs();
	$vw_spp_pengembalian_penerimaan_detail_pajak->RowType = EW_ROWTYPE_VIEW; // View

	// Get the field contents
	$vw_spp_pengembalian_penerimaan_detail_pajak_delete->LoadRowValues($vw_spp_pengembalian_penerimaan_detail_pajak_delete->Recordset);

	// Render row
	$vw_spp_pengembalian_penerimaan_detail_pajak_delete->RenderRow();
?>
	<tr<?php echo $vw_spp_pengembalian_penerimaan_detail_pajak->RowAttributes() ?>>
<?php if ($vw_spp_pengembalian_penerimaan_detail_pajak->kd_rekening_belanja->Visible) { // kd_rekening_belanja ?>
		<td<?php echo $vw_spp_pengembalian_penerimaan_detail_pajak->kd_rekening_belanja->CellAttributes() ?>>
<span id="el<?php echo $vw_spp_pengembalian_penerimaan_detail_pajak_delete->RowCnt ?>_vw_spp_pengembalian_penerimaan_detail_pajak_kd_rekening_belanja" class="vw_spp_pengembalian_penerimaan_detail_pajak_kd_rekening_belanja">
...
<?php } ?>
<?php if ($vw_spp_pengembalian_penerimaan_detail_pajak->jumlah_belanja->Visible) { // jumlah_belanja ?>
		<td<?php echo $vw_spp_pengembalian_penerimaan_detail_pajak->jumlah_belanja->CellAttributes() ?>>
<span id="el<?php echo $vw_spp_pengembalian_penerimaan_detail_pajak_delete->RowCnt ?>_vw_spp_pengembalian_penerimaan_detail_pajak_jumlah_belanja" class="vw_spp_pengembalian_penerimaan_detail_pajak_jumlah_belanja">
...
<?php
	$vw_spp_pengembalian_penerimaan_detail_pajak_delete->Recordset->MoveNext();
}
$vw_spp_pengembalian_penerimaan_detail_pajak_delete->Recordset->Close();
?>
</tbody>
</table>
</div>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $vw_spp_pengembalian_penerimaan_detail_pajak_delete->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
</div>
</form>
<script type="text/javascript">
fvw_spp_pengembalian_penerimaan_detail_pajakdelete.Init();
</script>
<?php
$vw_spp_pengembalian_penerimaan_detail_pajak_delete->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$vw_spp_pengembalian_penerimaan_detail_pajak_delete->Page_Terminate();
?>
