...
$vw_spp_ls_gaji_list_detail_pajak_grid = NULL; // Initialize page object first

class cvw_spp_ls_gaji_list_detail_pajak_grid extends cvw_spp_ls_gaji_list_detail_pajak {
	...
	// Page object name
	var $PageObjName = 'vw_spp_ls_gaji_list_detail_pajak_grid';

	// Grid form hidden field names
	var $FormName = 'fvw_spp_ls_gaji_list_detail_pajakgrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["vw_spp_ls_gaji_list_detail_pajak"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function SetUpMasterParms() {
		...
		if ($sMasterTblVar == "vw_spp_ls_gaji_list") {
			...
			if ($GLOBALS["vw_spp_ls_gaji_list"]->EventCancelled) $this->EventCancelled = TRUE;
