...
$vw_bill_ranap_detail_tindakan_penunjang_grid = NULL; // Initialize page object first

class cvw_bill_ranap_detail_tindakan_penunjang_grid extends cvw_bill_ranap_detail_tindakan_penunjang {
	...
	// Page object name
	var $PageObjName = 'vw_bill_ranap_detail_tindakan_penunjang_grid';

	// Grid form hidden field names
	var $FormName = 'fvw_bill_ranap_detail_tindakan_penunjanggrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["vw_bill_ranap_detail_tindakan_penunjang"];
