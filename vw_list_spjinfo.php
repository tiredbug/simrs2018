...
//
// Table class for vw_list_spj
//
class cvw_list_spj extends cTable {
	var $id;
	var $no_sbp;
	var $id_sbp;
	...
	function __construct() {
		...
		$this->TableVar = 'vw_list_spj';
		$this->TableName = 'vw_list_spj';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`vw_list_spj`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('vw_list_spj', 'vw_list_spj', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// no_sbp
		$this->no_sbp = new cField('vw_list_spj', 'vw_list_spj', 'x_no_sbp', 'no_sbp', '`no_sbp`', '`no_sbp`', 200, -1, FALSE, '`no_sbp`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->no_sbp->Sortable = TRUE; // Allow sort
		$this->fields['no_sbp'] = &$this->no_sbp;

		// id_sbp
		$this->id_sbp = new cField('vw_list_spj', 'vw_list_spj', 'x_id_sbp', 'id_sbp', '`id_sbp`', '`id_sbp`', 3, -1, FALSE, '`id_sbp`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`vw_list_spj`";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("vw_list_spjview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("vw_list_spjview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "vw_list_spjadd.php?" . $this->UrlParm($parm);
		else
			$url = "vw_list_spjadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("vw_list_spjedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("vw_list_spjadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("vw_list_spjdelete.php", $this->UrlParm());
	}
