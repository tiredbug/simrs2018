...
$keu_akun5_view = NULL; // Initialize page object first

class ckeu_akun5_view extends ckeu_akun5 {
	...
	// Page object name
	var $PageObjName = 'keu_akun5_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["id"] <> "") {
				...
				$sReturnUrl = "keu_akun5list.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "keu_akun5list.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "keu_akun5list.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($keu_akun5_view)) $keu_akun5_view = new ckeu_akun5_view();

// Page init
$keu_akun5_view->Page_Init();

// Page main
$keu_akun5_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$keu_akun5_view->Page_Render();
?>
...
var CurrentForm = fkeu_akun5view = new ew_Form("fkeu_akun5view", "view");

// Form_CustomValidate event
fkeu_akun5view.Form_CustomValidate = 
...
fkeu_akun5view.ValidateRequired = true;
<?php } else { ?>
fkeu_akun5view.ValidateRequired = false; 
<?php } ?>
...
<?php if (!$keu_akun5_view->IsModal) { ?>
<?php } ?>
<?php $keu_akun5_view->ExportOptions->Render("body") ?>
<?php
	foreach ($keu_akun5_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$keu_akun5_view->IsModal) { ?>
...
<?php $keu_akun5_view->ShowPageHeader(); ?>
<?php
$keu_akun5_view->ShowMessage();
?>
<form name="fkeu_akun5view" id="fkeu_akun5view" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($keu_akun5_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $keu_akun5_view->Token ?>">
<?php } ?>
...
<?php if ($keu_akun5->id->Visible) { // id ?>
	<tr id="r_id">
		<td><span id="elh_keu_akun5_id"><?php echo $keu_akun5->id->FldCaption() ?></span></td>
		<td data-name="id"<?php echo $keu_akun5->id->CellAttributes() ?>>
<span id="el_keu_akun5_id">
<span<?php echo $keu_akun5->id->ViewAttributes() ?>>
<?php echo $keu_akun5->id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($keu_akun5->kd_akun->Visible) { // kd_akun ?>
	<tr id="r_kd_akun">
		<td><span id="elh_keu_akun5_kd_akun"><?php echo $keu_akun5->kd_akun->FldCaption() ?></span></td>
...
<?php echo $keu_akun5->kd_akun->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($keu_akun5->akun1->Visible) { // akun1 ?>
	<tr id="r_akun1">
		<td><span id="elh_keu_akun5_akun1"><?php echo $keu_akun5->akun1->FldCaption() ?></span></td>
		<td data-name="akun1"<?php echo $keu_akun5->akun1->CellAttributes() ?>>
<span id="el_keu_akun5_akun1">
<span<?php echo $keu_akun5->akun1->ViewAttributes() ?>>
<?php echo $keu_akun5->akun1->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($keu_akun5->akun2->Visible) { // akun2 ?>
	<tr id="r_akun2">
		<td><span id="elh_keu_akun5_akun2"><?php echo $keu_akun5->akun2->FldCaption() ?></span></td>
		<td data-name="akun2"<?php echo $keu_akun5->akun2->CellAttributes() ?>>
<span id="el_keu_akun5_akun2">
<span<?php echo $keu_akun5->akun2->ViewAttributes() ?>>
<?php echo $keu_akun5->akun2->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($keu_akun5->akun3->Visible) { // akun3 ?>
	<tr id="r_akun3">
		<td><span id="elh_keu_akun5_akun3"><?php echo $keu_akun5->akun3->FldCaption() ?></span></td>
		<td data-name="akun3"<?php echo $keu_akun5->akun3->CellAttributes() ?>>
<span id="el_keu_akun5_akun3">
<span<?php echo $keu_akun5->akun3->ViewAttributes() ?>>
<?php echo $keu_akun5->akun3->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($keu_akun5->akun4->Visible) { // akun4 ?>
	<tr id="r_akun4">
		<td><span id="elh_keu_akun5_akun4"><?php echo $keu_akun5->akun4->FldCaption() ?></span></td>
		<td data-name="akun4"<?php echo $keu_akun5->akun4->CellAttributes() ?>>
<span id="el_keu_akun5_akun4">
<span<?php echo $keu_akun5->akun4->ViewAttributes() ?>>
<?php echo $keu_akun5->akun4->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($keu_akun5->akun5->Visible) { // akun5 ?>
	<tr id="r_akun5">
		<td><span id="elh_keu_akun5_akun5"><?php echo $keu_akun5->akun5->FldCaption() ?></span></td>
...
<?php echo $keu_akun5->akun5->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($keu_akun5->nama_akun->Visible) { // nama_akun ?>
	<tr id="r_nama_akun">
		<td><span id="elh_keu_akun5_nama_akun"><?php echo $keu_akun5->nama_akun->FldCaption() ?></span></td>
...
<?php echo $keu_akun5->nama_akun->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($keu_akun5->kd_akun4->Visible) { // kd_akun4 ?>
	<tr id="r_kd_akun4">
		<td><span id="elh_keu_akun5_kd_akun4"><?php echo $keu_akun5->kd_akun4->FldCaption() ?></span></td>
		<td data-name="kd_akun4"<?php echo $keu_akun5->kd_akun4->CellAttributes() ?>>
<span id="el_keu_akun5_kd_akun4">
<span<?php echo $keu_akun5->kd_akun4->ViewAttributes() ?>>
<?php echo $keu_akun5->kd_akun4->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
