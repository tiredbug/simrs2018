...
//
// Table class for t_sbp_detail
//
class ct_sbp_detail extends cTable {
	var $id;
	var $id_sbp;
	var $tipe_sbp;
	...
	function __construct() {
		...
		$this->TableVar = 't_sbp_detail';
		$this->TableName = 't_sbp_detail';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`t_sbp_detail`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('t_sbp_detail', 't_sbp_detail', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// id_sbp
		$this->id_sbp = new cField('t_sbp_detail', 't_sbp_detail', 'x_id_sbp', 'id_sbp', '`id_sbp`', '`id_sbp`', 3, -1, FALSE, '`id_sbp`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// tipe_sbp
		$this->tipe_sbp = new cField('t_sbp_detail', 't_sbp_detail', 'x_tipe_sbp', 'tipe_sbp', '`tipe_sbp`', '`tipe_sbp`', 3, -1, FALSE, '`tipe_sbp`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// detail_jenis_spp
		$this->detail_jenis_spp = new cField('t_sbp_detail', 't_sbp_detail', 'x_detail_jenis_spp', 'detail_jenis_spp', '`detail_jenis_spp`', '`detail_jenis_spp`', 3, -1, FALSE, '`detail_jenis_spp`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// no_sbp
		$this->no_sbp = new cField('t_sbp_detail', 't_sbp_detail', 'x_no_sbp', 'no_sbp', '`no_sbp`', '`no_sbp`', 200, -1, FALSE, '`no_sbp`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->no_sbp->Sortable = TRUE; // Allow sort
		$this->fields['no_sbp'] = &$this->no_sbp;

		// program
		$this->program = new cField('t_sbp_detail', 't_sbp_detail', 'x_program', 'program', '`program`', '`program`', 200, -1, FALSE, '`program`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->program->Sortable = TRUE; // Allow sort
		$this->fields['program'] = &$this->program;

		// kegiatan
		$this->kegiatan = new cField('t_sbp_detail', 't_sbp_detail', 'x_kegiatan', 'kegiatan', '`kegiatan`', '`kegiatan`', 200, -1, FALSE, '`kegiatan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->kegiatan->Sortable = TRUE; // Allow sort
		$this->fields['kegiatan'] = &$this->kegiatan;

		// sub_kegiatan
		$this->sub_kegiatan = new cField('t_sbp_detail', 't_sbp_detail', 'x_sub_kegiatan', 'sub_kegiatan', '`sub_kegiatan`', '`sub_kegiatan`', 200, -1, FALSE, '`sub_kegiatan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->sub_kegiatan->Sortable = TRUE; // Allow sort
		$this->fields['sub_kegiatan'] = &$this->sub_kegiatan;

		// tahun_anggaran
		$this->tahun_anggaran = new cField('t_sbp_detail', 't_sbp_detail', 'x_tahun_anggaran', 'tahun_anggaran', '`tahun_anggaran`', '`tahun_anggaran`', 3, -1, FALSE, '`tahun_anggaran`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// kd_rekening_belanja
		$this->kd_rekening_belanja = new cField('t_sbp_detail', 't_sbp_detail', 'x_kd_rekening_belanja', 'kd_rekening_belanja', '`kd_rekening_belanja`', '`kd_rekening_belanja`', 200, -1, FALSE, '`kd_rekening_belanja`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->kd_rekening_belanja->Sortable = TRUE; // Allow sort
		$this->fields['kd_rekening_belanja'] = &$this->kd_rekening_belanja;

		// akun1
		$this->akun1 = new cField('t_sbp_detail', 't_sbp_detail', 'x_akun1', 'akun1', '`akun1`', '`akun1`', 200, -1, FALSE, '`akun1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// akun2
		$this->akun2 = new cField('t_sbp_detail', 't_sbp_detail', 'x_akun2', 'akun2', '`akun2`', '`akun2`', 200, -1, FALSE, '`akun2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// akun3
		$this->akun3 = new cField('t_sbp_detail', 't_sbp_detail', 'x_akun3', 'akun3', '`akun3`', '`akun3`', 200, -1, FALSE, '`akun3`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// akun4
		$this->akun4 = new cField('t_sbp_detail', 't_sbp_detail', 'x_akun4', 'akun4', '`akun4`', '`akun4`', 200, -1, FALSE, '`akun4`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// akun5
		$this->akun5 = new cField('t_sbp_detail', 't_sbp_detail', 'x_akun5', 'akun5', '`akun5`', '`akun5`', 200, -1, FALSE, '`akun5`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// jumlah_belanja
		$this->jumlah_belanja = new cField('t_sbp_detail', 't_sbp_detail', 'x_jumlah_belanja', 'jumlah_belanja', '`jumlah_belanja`', '`jumlah_belanja`', 5, -1, FALSE, '`jumlah_belanja`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// uraian_tambahan
		$this->uraian_tambahan = new cField('t_sbp_detail', 't_sbp_detail', 'x_uraian_tambahan', 'uraian_tambahan', '`uraian_tambahan`', '`uraian_tambahan`', 201, -1, FALSE, '`uraian_tambahan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
		$this->uraian_tambahan->Sortable = TRUE; // Allow sort
		$this->fields['uraian_tambahan'] = &$this->uraian_tambahan;
	}
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`t_sbp_detail`";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("t_sbp_detailview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("t_sbp_detailview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "t_sbp_detailadd.php?" . $this->UrlParm($parm);
		else
			$url = "t_sbp_detailadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("t_sbp_detailedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("t_sbp_detailadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("t_sbp_detaildelete.php", $this->UrlParm());
	}
   ...
   // Common render codes
	...
	function RenderEditRow() {
		...
		$this->uraian_tambahan->EditValue = $this->uraian_tambahan->CurrentValue;
		...
		if (!$Doc->ExportCustom) {
			...
			if ($Doc->Horizontal) { // Horizontal format, write header
				...
				if ($ExportPageType == "view") {
					...
					if ($this->tipe_sbp->Exportable) $Doc->ExportCaption($this->tipe_sbp);
					...
					if ($this->uraian_tambahan->Exportable) $Doc->ExportCaption($this->uraian_tambahan);
				} else {
					if ($this->id->Exportable) $Doc->ExportCaption($this->id);
					if ($this->id_sbp->Exportable) $Doc->ExportCaption($this->id_sbp);
					if ($this->tipe_sbp->Exportable) $Doc->ExportCaption($this->tipe_sbp);
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if (!$Doc->ExportCustom) {
					...
					if ($ExportPageType == "view") {
						...
						if ($this->tipe_sbp->Exportable) $Doc->ExportField($this->tipe_sbp);
						...
						if ($this->uraian_tambahan->Exportable) $Doc->ExportField($this->uraian_tambahan);
					} else {
						if ($this->id->Exportable) $Doc->ExportField($this->id);
						if ($this->id_sbp->Exportable) $Doc->ExportField($this->id_sbp);
						if ($this->tipe_sbp->Exportable) $Doc->ExportField($this->tipe_sbp);
	...
	function Row_Rendered() {
		...
		$this->uraian_tambahan->EditValue = ew_ExecuteScalar("select uraian from t_sbp where id =".$this->id_sbp->CurrentValue."");
	}
