...
$m_sub_kegiatan_view = NULL; // Initialize page object first

class cm_sub_kegiatan_view extends cm_sub_kegiatan {
	...
	// Page object name
	var $PageObjName = 'm_sub_kegiatan_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["id"] <> "") {
				...
				$sReturnUrl = "m_sub_kegiatanlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "m_sub_kegiatanlist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "m_sub_kegiatanlist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($m_sub_kegiatan_view)) $m_sub_kegiatan_view = new cm_sub_kegiatan_view();

// Page init
$m_sub_kegiatan_view->Page_Init();

// Page main
$m_sub_kegiatan_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$m_sub_kegiatan_view->Page_Render();
?>
...
var CurrentForm = fm_sub_kegiatanview = new ew_Form("fm_sub_kegiatanview", "view");

// Form_CustomValidate event
fm_sub_kegiatanview.Form_CustomValidate = 
...
fm_sub_kegiatanview.ValidateRequired = true;
<?php } else { ?>
fm_sub_kegiatanview.ValidateRequired = false; 
<?php } ?>
...
<?php if (!$m_sub_kegiatan_view->IsModal) { ?>
<?php } ?>
<?php $m_sub_kegiatan_view->ExportOptions->Render("body") ?>
<?php
	foreach ($m_sub_kegiatan_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$m_sub_kegiatan_view->IsModal) { ?>
...
<?php $m_sub_kegiatan_view->ShowPageHeader(); ?>
<?php
$m_sub_kegiatan_view->ShowMessage();
?>
<form name="fm_sub_kegiatanview" id="fm_sub_kegiatanview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($m_sub_kegiatan_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $m_sub_kegiatan_view->Token ?>">
<?php } ?>
...
<?php if ($m_sub_kegiatan->id->Visible) { // id ?>
	<tr id="r_id">
		<td><span id="elh_m_sub_kegiatan_id"><?php echo $m_sub_kegiatan->id->FldCaption() ?></span></td>
...
<?php echo $m_sub_kegiatan->id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($m_sub_kegiatan->kode_program->Visible) { // kode_program ?>
	<tr id="r_kode_program">
		<td><span id="elh_m_sub_kegiatan_kode_program"><?php echo $m_sub_kegiatan->kode_program->FldCaption() ?></span></td>
...
<?php echo $m_sub_kegiatan->kode_program->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($m_sub_kegiatan->kode_kegiatan->Visible) { // kode_kegiatan ?>
	<tr id="r_kode_kegiatan">
		<td><span id="elh_m_sub_kegiatan_kode_kegiatan"><?php echo $m_sub_kegiatan->kode_kegiatan->FldCaption() ?></span></td>
...
<?php echo $m_sub_kegiatan->kode_kegiatan->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($m_sub_kegiatan->kode_sub_kegiatan->Visible) { // kode_sub_kegiatan ?>
	<tr id="r_kode_sub_kegiatan">
		<td><span id="elh_m_sub_kegiatan_kode_sub_kegiatan"><?php echo $m_sub_kegiatan->kode_sub_kegiatan->FldCaption() ?></span></td>
...
<?php echo $m_sub_kegiatan->kode_sub_kegiatan->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($m_sub_kegiatan->nama_sub_kegiatan->Visible) { // nama_sub_kegiatan ?>
	<tr id="r_nama_sub_kegiatan">
		<td><span id="elh_m_sub_kegiatan_nama_sub_kegiatan"><?php echo $m_sub_kegiatan->nama_sub_kegiatan->FldCaption() ?></span></td>
...
<?php echo $m_sub_kegiatan->nama_sub_kegiatan->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
fm_sub_kegiatanview.Init();
</script>
<?php
$m_sub_kegiatan_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$m_sub_kegiatan_view->Page_Terminate();
?>
