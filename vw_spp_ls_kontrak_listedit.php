...
$vw_spp_ls_kontrak_list_edit = NULL; // Initialize page object first

class cvw_spp_ls_kontrak_list_edit extends cvw_spp_ls_kontrak_list {
	...
	// Page object name
	var $PageObjName = 'vw_spp_ls_kontrak_list_edit';
	...
	function Page_Main() {
		...
		if ($this->id->CurrentValue == "") {
			$this->Page_Terminate("vw_spp_ls_kontrak_listlist.php"); // Invalid key, return to list
		}
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// kontrak_id
			$this->kontrak_id->SetDbValueDef($rsnew, $this->kontrak_id->CurrentValue, NULL, $this->kontrak_id->ReadOnly);
...
// Create page object
if (!isset($vw_spp_ls_kontrak_list_edit)) $vw_spp_ls_kontrak_list_edit = new cvw_spp_ls_kontrak_list_edit();

// Page init
$vw_spp_ls_kontrak_list_edit->Page_Init();

// Page main
$vw_spp_ls_kontrak_list_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$vw_spp_ls_kontrak_list_edit->Page_Render();
?>
...
var CurrentForm = fvw_spp_ls_kontrak_listedit = new ew_Form("fvw_spp_ls_kontrak_listedit", "edit");

// Validate form
fvw_spp_ls_kontrak_listedit.Validate = function() {
...
fvw_spp_ls_kontrak_listedit.Form_CustomValidate = 
...
fvw_spp_ls_kontrak_listedit.ValidateRequired = true;
<?php } else { ?>
fvw_spp_ls_kontrak_listedit.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fvw_spp_ls_kontrak_listedit.Lists["x_id_jenis_spp"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_jenis_spp","","",""],"ParentFields":[],"ChildFields":["x_detail_jenis_spp"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"l_jenis_spp"};
fvw_spp_ls_kontrak_listedit.Lists["x_detail_jenis_spp"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_detail_jenis_spp","","",""],"ParentFields":["x_id_jenis_spp"],"ChildFields":[],"FilterFields":["x_id_jenis"],"Options":[],"Template":"","LinkTable":"l_jenis_detail_spp"};
fvw_spp_ls_kontrak_listedit.Lists["x_status_spp"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fvw_spp_ls_kontrak_listedit.Lists["x_status_spp"].Options = <?php echo json_encode($vw_spp_ls_kontrak_list->status_spp->Options()) ?>;
fvw_spp_ls_kontrak_listedit.Lists["x_nama_pptk"] = {"LinkField":"x_nama","Ajax":true,"AutoFill":true,"DisplayFields":["x_nama","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"m_pejabat_keuangan"};
fvw_spp_ls_kontrak_listedit.Lists["x_nama_bendahara"] = {"LinkField":"x_nama","Ajax":true,"AutoFill":true,"DisplayFields":["x_nama","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"m_pejabat_keuangan"};
fvw_spp_ls_kontrak_listedit.Lists["x_kontrak_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":true,"DisplayFields":["x_nama_perusahaan","x_tgl_kontrak","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"data_kontrak"};
...
<?php if (!$vw_spp_ls_kontrak_list_edit->IsModal) { ?>
<?php } ?>
<?php $vw_spp_ls_kontrak_list_edit->ShowPageHeader(); ?>
<?php
$vw_spp_ls_kontrak_list_edit->ShowMessage();
?>
<form name="fvw_spp_ls_kontrak_listedit" id="fvw_spp_ls_kontrak_listedit" class="<?php echo $vw_spp_ls_kontrak_list_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($vw_spp_ls_kontrak_list_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $vw_spp_ls_kontrak_list_edit->Token ?>">
<?php } ?>
...
<?php } ?>
<div id="tpd_vw_spp_ls_kontrak_listedit" class="ewCustomTemplate"></div>
<script id="tpm_vw_spp_ls_kontrak_listedit" type="text/html">
<div id="ct_vw_spp_ls_kontrak_list_edit"><div id="ct_sample_add">
<div class="ewRow">
...
<?php if ($vw_spp_ls_kontrak_list->id->Visible) { // id ?>
	<div id="r_id" class="form-group">
		<label id="elh_vw_spp_ls_kontrak_list_id" class="col-sm-2 control-label ewLabel"><script id="tpc_vw_spp_ls_kontrak_list_id" class="vw_spp_ls_kontrak_listedit" type="text/html"><span><?php echo $vw_spp_ls_kontrak_list->id->FldCaption() ?></span></script></label>
		<div class="col-sm-10"><div<?php echo $vw_spp_ls_kontrak_list->id->CellAttributes() ?>>
...
<p class="form-control-static"><?php echo $vw_spp_ls_kontrak_list->id->EditValue ?></p></span>
</span>
</div>
<script id="tpx_vw_spp_ls_kontrak_list_id" class="vw_spp_ls_kontrak_listedit" type="text/html">
<span id="cvt_vw_spp_ls_kontrak_list_id"><?php
...
<input type="hidden" data-table="vw_spp_ls_kontrak_list" data-field="x_id" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($vw_spp_ls_kontrak_list->id->CurrentValue) ?>">
<?php echo $vw_spp_ls_kontrak_list->id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($vw_spp_ls_kontrak_list->id_jenis_spp->Visible) { // id_jenis_spp ?>
	<div id="r_id_jenis_spp" class="form-group">
		<label id="elh_vw_spp_ls_kontrak_list_id_jenis_spp" for="x_id_jenis_spp" class="col-sm-2 control-label ewLabel"><script id="tpc_vw_spp_ls_kontrak_list_id_jenis_spp" class="vw_spp_ls_kontrak_listedit" type="text/html"><span><?php echo $vw_spp_ls_kontrak_list->id_jenis_spp->FldCaption() ?></span></script></label>
		<div class="col-sm-10"><div<?php echo $vw_spp_ls_kontrak_list->id_jenis_spp->CellAttributes() ?>>
<script id="tpx_vw_spp_ls_kontrak_list_id_jenis_spp" class="vw_spp_ls_kontrak_listedit" type="text/html">
...
<?php if ($vw_spp_ls_kontrak_list->detail_jenis_spp->Visible) { // detail_jenis_spp ?>
	<div id="r_detail_jenis_spp" class="form-group">
		<label id="elh_vw_spp_ls_kontrak_list_detail_jenis_spp" for="x_detail_jenis_spp" class="col-sm-2 control-label ewLabel"><script id="tpc_vw_spp_ls_kontrak_list_detail_jenis_spp" class="vw_spp_ls_kontrak_listedit" type="text/html"><span><?php echo $vw_spp_ls_kontrak_list->detail_jenis_spp->FldCaption() ?></span></script></label>
		<div class="col-sm-10"><div<?php echo $vw_spp_ls_kontrak_list->detail_jenis_spp->CellAttributes() ?>>
<script id="tpx_vw_spp_ls_kontrak_list_detail_jenis_spp" class="vw_spp_ls_kontrak_listedit" type="text/html">
...
<?php if ($vw_spp_ls_kontrak_list->status_spp->Visible) { // status_spp ?>
	<div id="r_status_spp" class="form-group">
		<label id="elh_vw_spp_ls_kontrak_list_status_spp" for="x_status_spp" class="col-sm-2 control-label ewLabel"><script id="tpc_vw_spp_ls_kontrak_list_status_spp" class="vw_spp_ls_kontrak_listedit" type="text/html"><span><?php echo $vw_spp_ls_kontrak_list->status_spp->FldCaption() ?></span></script></label>
		<div class="col-sm-10"><div<?php echo $vw_spp_ls_kontrak_list->status_spp->CellAttributes() ?>>
<script id="tpx_vw_spp_ls_kontrak_list_status_spp" class="vw_spp_ls_kontrak_listedit" type="text/html">
...
<?php if ($vw_spp_ls_kontrak_list->no_spp->Visible) { // no_spp ?>
	<div id="r_no_spp" class="form-group">
		<label id="elh_vw_spp_ls_kontrak_list_no_spp" for="x_no_spp" class="col-sm-2 control-label ewLabel"><script id="tpc_vw_spp_ls_kontrak_list_no_spp" class="vw_spp_ls_kontrak_listedit" type="text/html"><span><?php echo $vw_spp_ls_kontrak_list->no_spp->FldCaption() ?></span></script></label>
		<div class="col-sm-10"><div<?php echo $vw_spp_ls_kontrak_list->no_spp->CellAttributes() ?>>
<script id="tpx_vw_spp_ls_kontrak_list_no_spp" class="vw_spp_ls_kontrak_listedit" type="text/html">
...
<?php if ($vw_spp_ls_kontrak_list->tgl_spp->Visible) { // tgl_spp ?>
	<div id="r_tgl_spp" class="form-group">
		<label id="elh_vw_spp_ls_kontrak_list_tgl_spp" for="x_tgl_spp" class="col-sm-2 control-label ewLabel"><script id="tpc_vw_spp_ls_kontrak_list_tgl_spp" class="vw_spp_ls_kontrak_listedit" type="text/html"><span><?php echo $vw_spp_ls_kontrak_list->tgl_spp->FldCaption() ?></span></script></label>
		<div class="col-sm-10"><div<?php echo $vw_spp_ls_kontrak_list->tgl_spp->CellAttributes() ?>>
<script id="tpx_vw_spp_ls_kontrak_list_tgl_spp" class="vw_spp_ls_kontrak_listedit" type="text/html">
...
<script type="text/html" class="vw_spp_ls_kontrak_listedit_js">
ew_CreateCalendar("fvw_spp_ls_kontrak_listedit", "x_tgl_spp", 7);
</script>
...
<?php if ($vw_spp_ls_kontrak_list->nama_pptk->Visible) { // nama_pptk ?>
	<div id="r_nama_pptk" class="form-group">
		<label id="elh_vw_spp_ls_kontrak_list_nama_pptk" for="x_nama_pptk" class="col-sm-2 control-label ewLabel"><script id="tpc_vw_spp_ls_kontrak_list_nama_pptk" class="vw_spp_ls_kontrak_listedit" type="text/html"><span><?php echo $vw_spp_ls_kontrak_list->nama_pptk->FldCaption() ?></span></script></label>
		<div class="col-sm-10"><div<?php echo $vw_spp_ls_kontrak_list->nama_pptk->CellAttributes() ?>>
<script id="tpx_vw_spp_ls_kontrak_list_nama_pptk" class="vw_spp_ls_kontrak_listedit" type="text/html">
...
<?php if ($vw_spp_ls_kontrak_list->nip_pptk->Visible) { // nip_pptk ?>
	<div id="r_nip_pptk" class="form-group">
		<label id="elh_vw_spp_ls_kontrak_list_nip_pptk" for="x_nip_pptk" class="col-sm-2 control-label ewLabel"><script id="tpc_vw_spp_ls_kontrak_list_nip_pptk" class="vw_spp_ls_kontrak_listedit" type="text/html"><span><?php echo $vw_spp_ls_kontrak_list->nip_pptk->FldCaption() ?></span></script></label>
		<div class="col-sm-10"><div<?php echo $vw_spp_ls_kontrak_list->nip_pptk->CellAttributes() ?>>
<script id="tpx_vw_spp_ls_kontrak_list_nip_pptk" class="vw_spp_ls_kontrak_listedit" type="text/html">
...
<?php if ($vw_spp_ls_kontrak_list->keterangan->Visible) { // keterangan ?>
	<div id="r_keterangan" class="form-group">
		<label id="elh_vw_spp_ls_kontrak_list_keterangan" for="x_keterangan" class="col-sm-2 control-label ewLabel"><script id="tpc_vw_spp_ls_kontrak_list_keterangan" class="vw_spp_ls_kontrak_listedit" type="text/html"><span><?php echo $vw_spp_ls_kontrak_list->keterangan->FldCaption() ?></span></script></label>
		<div class="col-sm-10"><div<?php echo $vw_spp_ls_kontrak_list->keterangan->CellAttributes() ?>>
<script id="tpx_vw_spp_ls_kontrak_list_keterangan" class="vw_spp_ls_kontrak_listedit" type="text/html">
...
<?php if ($vw_spp_ls_kontrak_list->nama_bendahara->Visible) { // nama_bendahara ?>
	<div id="r_nama_bendahara" class="form-group">
		<label id="elh_vw_spp_ls_kontrak_list_nama_bendahara" for="x_nama_bendahara" class="col-sm-2 control-label ewLabel"><script id="tpc_vw_spp_ls_kontrak_list_nama_bendahara" class="vw_spp_ls_kontrak_listedit" type="text/html"><span><?php echo $vw_spp_ls_kontrak_list->nama_bendahara->FldCaption() ?></span></script></label>
		<div class="col-sm-10"><div<?php echo $vw_spp_ls_kontrak_list->nama_bendahara->CellAttributes() ?>>
<script id="tpx_vw_spp_ls_kontrak_list_nama_bendahara" class="vw_spp_ls_kontrak_listedit" type="text/html">
...
<?php if ($vw_spp_ls_kontrak_list->nip_bendahara->Visible) { // nip_bendahara ?>
	<div id="r_nip_bendahara" class="form-group">
		<label id="elh_vw_spp_ls_kontrak_list_nip_bendahara" for="x_nip_bendahara" class="col-sm-2 control-label ewLabel"><script id="tpc_vw_spp_ls_kontrak_list_nip_bendahara" class="vw_spp_ls_kontrak_listedit" type="text/html"><span><?php echo $vw_spp_ls_kontrak_list->nip_bendahara->FldCaption() ?></span></script></label>
		<div class="col-sm-10"><div<?php echo $vw_spp_ls_kontrak_list->nip_bendahara->CellAttributes() ?>>
<script id="tpx_vw_spp_ls_kontrak_list_nip_bendahara" class="vw_spp_ls_kontrak_listedit" type="text/html">
...
<?php if ($vw_spp_ls_kontrak_list->kode_program->Visible) { // kode_program ?>
	<div id="r_kode_program" class="form-group">
		<label id="elh_vw_spp_ls_kontrak_list_kode_program" for="x_kode_program" class="col-sm-2 control-label ewLabel"><script id="tpc_vw_spp_ls_kontrak_list_kode_program" class="vw_spp_ls_kontrak_listedit" type="text/html"><span><?php echo $vw_spp_ls_kontrak_list->kode_program->FldCaption() ?></span></script></label>
		<div class="col-sm-10"><div<?php echo $vw_spp_ls_kontrak_list->kode_program->CellAttributes() ?>>
<script id="tpx_vw_spp_ls_kontrak_list_kode_program" class="vw_spp_ls_kontrak_listedit" type="text/html">
...
<?php if ($vw_spp_ls_kontrak_list->kode_kegiatan->Visible) { // kode_kegiatan ?>
	<div id="r_kode_kegiatan" class="form-group">
		<label id="elh_vw_spp_ls_kontrak_list_kode_kegiatan" for="x_kode_kegiatan" class="col-sm-2 control-label ewLabel"><script id="tpc_vw_spp_ls_kontrak_list_kode_kegiatan" class="vw_spp_ls_kontrak_listedit" type="text/html"><span><?php echo $vw_spp_ls_kontrak_list->kode_kegiatan->FldCaption() ?></span></script></label>
		<div class="col-sm-10"><div<?php echo $vw_spp_ls_kontrak_list->kode_kegiatan->CellAttributes() ?>>
<script id="tpx_vw_spp_ls_kontrak_list_kode_kegiatan" class="vw_spp_ls_kontrak_listedit" type="text/html">
...
<?php if ($vw_spp_ls_kontrak_list->kode_sub_kegiatan->Visible) { // kode_sub_kegiatan ?>
	<div id="r_kode_sub_kegiatan" class="form-group">
		<label id="elh_vw_spp_ls_kontrak_list_kode_sub_kegiatan" for="x_kode_sub_kegiatan" class="col-sm-2 control-label ewLabel"><script id="tpc_vw_spp_ls_kontrak_list_kode_sub_kegiatan" class="vw_spp_ls_kontrak_listedit" type="text/html"><span><?php echo $vw_spp_ls_kontrak_list->kode_sub_kegiatan->FldCaption() ?></span></script></label>
		<div class="col-sm-10"><div<?php echo $vw_spp_ls_kontrak_list->kode_sub_kegiatan->CellAttributes() ?>>
<script id="tpx_vw_spp_ls_kontrak_list_kode_sub_kegiatan" class="vw_spp_ls_kontrak_listedit" type="text/html">
...
<?php if ($vw_spp_ls_kontrak_list->kontrak_id->Visible) { // kontrak_id ?>
	<div id="r_kontrak_id" class="form-group">
		<label id="elh_vw_spp_ls_kontrak_list_kontrak_id" for="x_kontrak_id" class="col-sm-2 control-label ewLabel"><script id="tpc_vw_spp_ls_kontrak_list_kontrak_id" class="vw_spp_ls_kontrak_listedit" type="text/html"><span><?php echo $vw_spp_ls_kontrak_list->kontrak_id->FldCaption() ?></span></script></label>
		<div class="col-sm-10"><div<?php echo $vw_spp_ls_kontrak_list->kontrak_id->CellAttributes() ?>>
<script id="tpx_vw_spp_ls_kontrak_list_kontrak_id" class="vw_spp_ls_kontrak_listedit" type="text/html">
...
<?php if ($vw_spp_ls_kontrak_list->tahun_anggaran->Visible) { // tahun_anggaran ?>
	<div id="r_tahun_anggaran" class="form-group">
		<label id="elh_vw_spp_ls_kontrak_list_tahun_anggaran" for="x_tahun_anggaran" class="col-sm-2 control-label ewLabel"><script id="tpc_vw_spp_ls_kontrak_list_tahun_anggaran" class="vw_spp_ls_kontrak_listedit" type="text/html"><span><?php echo $vw_spp_ls_kontrak_list->tahun_anggaran->FldCaption() ?></span></script></label>
		<div class="col-sm-10"><div<?php echo $vw_spp_ls_kontrak_list->tahun_anggaran->CellAttributes() ?>>
<script id="tpx_vw_spp_ls_kontrak_list_tahun_anggaran" class="vw_spp_ls_kontrak_listedit" type="text/html">
...
<?php
	if (in_array("vw_spp_ls_barang_jasa_detail", explode(",", $vw_spp_ls_kontrak_list->getCurrentDetailTable())) && $vw_spp_ls_barang_jasa_detail->DetailEdit) {
?>
...
<?php } ?>
<?php
	if (in_array("vw_spp_detail_pajak", explode(",", $vw_spp_ls_kontrak_list->getCurrentDetailTable())) && $vw_spp_detail_pajak->DetailEdit) {
?>
<?php if ($vw_spp_ls_kontrak_list->getCurrentDetailTable() <> "") { ?>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $vw_spp_ls_kontrak_list_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
ew_ApplyTemplate("tpd_vw_spp_ls_kontrak_listedit", "tpm_vw_spp_ls_kontrak_listedit", "vw_spp_ls_kontrak_listedit", "<?php echo $vw_spp_ls_kontrak_list->CustomExport ?>");
jQuery("script.vw_spp_ls_kontrak_listedit_js").each(function(){ew_AddScript(this.text);});
</script>
<script type="text/javascript">
fvw_spp_ls_kontrak_listedit.Init();
</script>
<?php
$vw_spp_ls_kontrak_list_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$vw_spp_ls_kontrak_list_edit->Page_Terminate();
?>
