...
$t_spp_detail_grid = NULL; // Initialize page object first

class ct_spp_detail_grid extends ct_spp_detail {
	...
	// Page object name
	var $PageObjName = 't_spp_detail_grid';

	// Grid form hidden field names
	var $FormName = 'ft_spp_detailgrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["t_spp_detail"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function SetUpMasterParms() {
		...
		if ($sMasterTblVar == "vw_spp_up_list") {
			...
			if ($GLOBALS["vw_spp_up_list"]->EventCancelled) $this->EventCancelled = TRUE;
