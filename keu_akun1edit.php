...
$keu_akun1_edit = NULL; // Initialize page object first

class ckeu_akun1_edit extends ckeu_akun1 {
	...
	// Page object name
	var $PageObjName = 'keu_akun1_edit';
	...
	function Page_Main() {
		...
		if ($this->kel1->CurrentValue == "") {
			$this->Page_Terminate("keu_akun1list.php"); // Invalid key, return to list
		}
	...
	function ValidateForm() {
		...
		if (in_array("keu_akun2", $DetailTblVar) && $GLOBALS["keu_akun2"]->DetailEdit) {
			...
			if ($bUpdateRow) {
				...
				if ($EditRow) {
					if (in_array("keu_akun2", $DetailTblVar) && $GLOBALS["keu_akun2"]->DetailEdit) {
						...
						$EditRow = $GLOBALS["keu_akun2_grid"]->GridUpdate();
	...
	function SetUpDetailParms() {
		...
		if ($sDetailTblVar <> "") {
			...
			if (in_array("keu_akun2", $DetailTblVar)) {
				...
				if ($GLOBALS["keu_akun2_grid"]->DetailEdit) {
					$GLOBALS["keu_akun2_grid"]->CurrentMode = "edit";
					$GLOBALS["keu_akun2_grid"]->CurrentAction = "gridedit";
...
// Create page object
if (!isset($keu_akun1_edit)) $keu_akun1_edit = new ckeu_akun1_edit();

// Page init
$keu_akun1_edit->Page_Init();

// Page main
$keu_akun1_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$keu_akun1_edit->Page_Render();
?>
...
var CurrentForm = fkeu_akun1edit = new ew_Form("fkeu_akun1edit", "edit");

// Validate form
fkeu_akun1edit.Validate = function() {
...
fkeu_akun1edit.Form_CustomValidate = 
...
fkeu_akun1edit.ValidateRequired = true;
<?php } else { ?>
fkeu_akun1edit.ValidateRequired = false; 
<?php } ?>
...
<?php if (!$keu_akun1_edit->IsModal) { ?>
<?php } ?>
<?php $keu_akun1_edit->ShowPageHeader(); ?>
<?php
$keu_akun1_edit->ShowMessage();
?>
<form name="fkeu_akun1edit" id="fkeu_akun1edit" class="<?php echo $keu_akun1_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($keu_akun1_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $keu_akun1_edit->Token ?>">
<?php } ?>
...
<p class="form-control-static"><?php echo $keu_akun1->kel1->EditValue ?></p></span>
</span>
<input type="hidden" data-table="keu_akun1" data-field="x_kel1" name="x_kel1" id="x_kel1" value="<?php echo ew_HtmlEncode($keu_akun1->kel1->CurrentValue) ?>">
...
<?php
	if (in_array("keu_akun2", explode(",", $keu_akun1->getCurrentDetailTable())) && $keu_akun2->DetailEdit) {
?>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $keu_akun1_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
