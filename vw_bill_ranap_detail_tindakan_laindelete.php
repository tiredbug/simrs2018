...
$vw_bill_ranap_detail_tindakan_lain_delete = NULL; // Initialize page object first

class cvw_bill_ranap_detail_tindakan_lain_delete extends cvw_bill_ranap_detail_tindakan_lain {
	...
	// Page object name
	var $PageObjName = 'vw_bill_ranap_detail_tindakan_lain_delete';
	...
	function Page_Main() {
		...
		if ($sFilter == "")
			$this->Page_Terminate("vw_bill_ranap_detail_tindakan_lainlist.php"); // Prevent SQL injection, return to list

		// Set up filter (SQL WHHERE clause) and get return SQL
		// SQL constructor in vw_bill_ranap_detail_tindakan_lain class, vw_bill_ranap_detail_tindakan_laininfo.php
		...
		if ($this->CurrentAction == "I") { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->Page_Terminate("vw_bill_ranap_detail_tindakan_lainlist.php"); // Return to list
			}
		}
	}
...
// Create page object
if (!isset($vw_bill_ranap_detail_tindakan_lain_delete)) $vw_bill_ranap_detail_tindakan_lain_delete = new cvw_bill_ranap_detail_tindakan_lain_delete();

// Page init
$vw_bill_ranap_detail_tindakan_lain_delete->Page_Init();

// Page main
$vw_bill_ranap_detail_tindakan_lain_delete->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$vw_bill_ranap_detail_tindakan_lain_delete->Page_Render();
?>
...
var CurrentForm = fvw_bill_ranap_detail_tindakan_laindelete = new ew_Form("fvw_bill_ranap_detail_tindakan_laindelete", "delete");

// Form_CustomValidate event
fvw_bill_ranap_detail_tindakan_laindelete.Form_CustomValidate = 
...
fvw_bill_ranap_detail_tindakan_laindelete.ValidateRequired = true;
<?php } else { ?>
fvw_bill_ranap_detail_tindakan_laindelete.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fvw_bill_ranap_detail_tindakan_laindelete.Lists["x_kode_tindakan"] = {"LinkField":"x_kode","Ajax":true,"AutoFill":false,"DisplayFields":["x_nama_tindakan","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"vw_bill_ranap_data_tarif_tindakan"};
...
<?php $vw_bill_ranap_detail_tindakan_lain_delete->ShowPageHeader(); ?>
<?php
$vw_bill_ranap_detail_tindakan_lain_delete->ShowMessage();
?>
<form name="fvw_bill_ranap_detail_tindakan_laindelete" id="fvw_bill_ranap_detail_tindakan_laindelete" class="form-inline ewForm ewDeleteForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($vw_bill_ranap_detail_tindakan_lain_delete->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $vw_bill_ranap_detail_tindakan_lain_delete->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="vw_bill_ranap_detail_tindakan_lain">
<input type="hidden" name="a_delete" id="a_delete" value="D">
<?php foreach ($vw_bill_ranap_detail_tindakan_lain_delete->RecKeys as $key) { ?>
...
<?php if ($vw_bill_ranap_detail_tindakan_lain->tanggal->Visible) { // tanggal ?>
		<th><span id="elh_vw_bill_ranap_detail_tindakan_lain_tanggal" class="vw_bill_ranap_detail_tindakan_lain_tanggal"><?php echo $vw_bill_ranap_detail_tindakan_lain->tanggal->FldCaption() ?></span></th>
<?php } ?>
<?php if ($vw_bill_ranap_detail_tindakan_lain->kode_tindakan->Visible) { // kode_tindakan ?>
		<th><span id="elh_vw_bill_ranap_detail_tindakan_lain_kode_tindakan" class="vw_bill_ranap_detail_tindakan_lain_kode_tindakan"><?php echo $vw_bill_ranap_detail_tindakan_lain->kode_tindakan->FldCaption() ?></span></th>
<?php } ?>
<?php if ($vw_bill_ranap_detail_tindakan_lain->qty->Visible) { // qty ?>
		<th><span id="elh_vw_bill_ranap_detail_tindakan_lain_qty" class="vw_bill_ranap_detail_tindakan_lain_qty"><?php echo $vw_bill_ranap_detail_tindakan_lain->qty->FldCaption() ?></span></th>
<?php } ?>
<?php if ($vw_bill_ranap_detail_tindakan_lain->tarif->Visible) { // tarif ?>
		<th><span id="elh_vw_bill_ranap_detail_tindakan_lain_tarif" class="vw_bill_ranap_detail_tindakan_lain_tarif"><?php echo $vw_bill_ranap_detail_tindakan_lain->tarif->FldCaption() ?></span></th>
<?php } ?>
<?php if ($vw_bill_ranap_detail_tindakan_lain->bhp->Visible) { // bhp ?>
		<th><span id="elh_vw_bill_ranap_detail_tindakan_lain_bhp" class="vw_bill_ranap_detail_tindakan_lain_bhp"><?php echo $vw_bill_ranap_detail_tindakan_lain->bhp->FldCaption() ?></span></th>
<?php } ?>
<?php if ($vw_bill_ranap_detail_tindakan_lain->user->Visible) { // user ?>
		<th><span id="elh_vw_bill_ranap_detail_tindakan_lain_user" class="vw_bill_ranap_detail_tindakan_lain_user"><?php echo $vw_bill_ranap_detail_tindakan_lain->user->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
<?php
$vw_bill_ranap_detail_tindakan_lain_delete->RecCnt = 0;
$i = 0;
while (!$vw_bill_ranap_detail_tindakan_lain_delete->Recordset->EOF) {
	$vw_bill_ranap_detail_tindakan_lain_delete->RecCnt++;
	$vw_bill_ranap_detail_tindakan_lain_delete->RowCnt++;

	// Set row properties
	$vw_bill_ranap_detail_tindakan_lain->ResetAttrs();
	$vw_bill_ranap_detail_tindakan_lain->RowType = EW_ROWTYPE_VIEW; // View

	// Get the field contents
	$vw_bill_ranap_detail_tindakan_lain_delete->LoadRowValues($vw_bill_ranap_detail_tindakan_lain_delete->Recordset);

	// Render row
	$vw_bill_ranap_detail_tindakan_lain_delete->RenderRow();
?>
	<tr<?php echo $vw_bill_ranap_detail_tindakan_lain->RowAttributes() ?>>
<?php if ($vw_bill_ranap_detail_tindakan_lain->tanggal->Visible) { // tanggal ?>
		<td<?php echo $vw_bill_ranap_detail_tindakan_lain->tanggal->CellAttributes() ?>>
<span id="el<?php echo $vw_bill_ranap_detail_tindakan_lain_delete->RowCnt ?>_vw_bill_ranap_detail_tindakan_lain_tanggal" class="vw_bill_ranap_detail_tindakan_lain_tanggal">
...
<?php } ?>
<?php if ($vw_bill_ranap_detail_tindakan_lain->kode_tindakan->Visible) { // kode_tindakan ?>
		<td<?php echo $vw_bill_ranap_detail_tindakan_lain->kode_tindakan->CellAttributes() ?>>
<span id="el<?php echo $vw_bill_ranap_detail_tindakan_lain_delete->RowCnt ?>_vw_bill_ranap_detail_tindakan_lain_kode_tindakan" class="vw_bill_ranap_detail_tindakan_lain_kode_tindakan">
...
<?php } ?>
<?php if ($vw_bill_ranap_detail_tindakan_lain->qty->Visible) { // qty ?>
		<td<?php echo $vw_bill_ranap_detail_tindakan_lain->qty->CellAttributes() ?>>
<span id="el<?php echo $vw_bill_ranap_detail_tindakan_lain_delete->RowCnt ?>_vw_bill_ranap_detail_tindakan_lain_qty" class="vw_bill_ranap_detail_tindakan_lain_qty">
...
<?php } ?>
<?php if ($vw_bill_ranap_detail_tindakan_lain->tarif->Visible) { // tarif ?>
		<td<?php echo $vw_bill_ranap_detail_tindakan_lain->tarif->CellAttributes() ?>>
<span id="el<?php echo $vw_bill_ranap_detail_tindakan_lain_delete->RowCnt ?>_vw_bill_ranap_detail_tindakan_lain_tarif" class="vw_bill_ranap_detail_tindakan_lain_tarif">
...
<?php } ?>
<?php if ($vw_bill_ranap_detail_tindakan_lain->bhp->Visible) { // bhp ?>
		<td<?php echo $vw_bill_ranap_detail_tindakan_lain->bhp->CellAttributes() ?>>
<span id="el<?php echo $vw_bill_ranap_detail_tindakan_lain_delete->RowCnt ?>_vw_bill_ranap_detail_tindakan_lain_bhp" class="vw_bill_ranap_detail_tindakan_lain_bhp">
...
<?php } ?>
<?php if ($vw_bill_ranap_detail_tindakan_lain->user->Visible) { // user ?>
		<td<?php echo $vw_bill_ranap_detail_tindakan_lain->user->CellAttributes() ?>>
<span id="el<?php echo $vw_bill_ranap_detail_tindakan_lain_delete->RowCnt ?>_vw_bill_ranap_detail_tindakan_lain_user" class="vw_bill_ranap_detail_tindakan_lain_user">
...
<?php
	$vw_bill_ranap_detail_tindakan_lain_delete->Recordset->MoveNext();
}
$vw_bill_ranap_detail_tindakan_lain_delete->Recordset->Close();
?>
</tbody>
</table>
</div>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $vw_bill_ranap_detail_tindakan_lain_delete->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
</div>
</form>
<script type="text/javascript">
fvw_bill_ranap_detail_tindakan_laindelete.Init();
</script>
<?php
$vw_bill_ranap_detail_tindakan_lain_delete->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$vw_bill_ranap_detail_tindakan_lain_delete->Page_Terminate();
?>
