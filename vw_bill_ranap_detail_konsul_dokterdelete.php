...
$vw_bill_ranap_detail_konsul_dokter_delete = NULL; // Initialize page object first

class cvw_bill_ranap_detail_konsul_dokter_delete extends cvw_bill_ranap_detail_konsul_dokter {
	...
	// Page object name
	var $PageObjName = 'vw_bill_ranap_detail_konsul_dokter_delete';
	...
	function Page_Main() {
		...
		if ($sFilter == "")
			$this->Page_Terminate("vw_bill_ranap_detail_konsul_dokterlist.php"); // Prevent SQL injection, return to list

		// Set up filter (SQL WHHERE clause) and get return SQL
		// SQL constructor in vw_bill_ranap_detail_konsul_dokter class, vw_bill_ranap_detail_konsul_dokterinfo.php
		...
		if ($this->CurrentAction == "I") { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->Page_Terminate("vw_bill_ranap_detail_konsul_dokterlist.php"); // Return to list
			}
		}
	}
...
// Create page object
if (!isset($vw_bill_ranap_detail_konsul_dokter_delete)) $vw_bill_ranap_detail_konsul_dokter_delete = new cvw_bill_ranap_detail_konsul_dokter_delete();

// Page init
$vw_bill_ranap_detail_konsul_dokter_delete->Page_Init();

// Page main
$vw_bill_ranap_detail_konsul_dokter_delete->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$vw_bill_ranap_detail_konsul_dokter_delete->Page_Render();
?>
...
var CurrentForm = fvw_bill_ranap_detail_konsul_dokterdelete = new ew_Form("fvw_bill_ranap_detail_konsul_dokterdelete", "delete");

// Form_CustomValidate event
fvw_bill_ranap_detail_konsul_dokterdelete.Form_CustomValidate = 
...
fvw_bill_ranap_detail_konsul_dokterdelete.ValidateRequired = true;
<?php } else { ?>
fvw_bill_ranap_detail_konsul_dokterdelete.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fvw_bill_ranap_detail_konsul_dokterdelete.Lists["x_kode_tindakan"] = {"LinkField":"x_kode","Ajax":true,"AutoFill":false,"DisplayFields":["x_nama_tindakan","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"vw_bill_ranap_data_tarif_tindakan"};
fvw_bill_ranap_detail_konsul_dokterdelete.Lists["x_kode_dokter"] = {"LinkField":"x_kd_dokter","Ajax":true,"AutoFill":false,"DisplayFields":["x_NAMADOKTER","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"vw_dokter_jaga_ranap"};
...
<?php $vw_bill_ranap_detail_konsul_dokter_delete->ShowPageHeader(); ?>
<?php
$vw_bill_ranap_detail_konsul_dokter_delete->ShowMessage();
?>
<form name="fvw_bill_ranap_detail_konsul_dokterdelete" id="fvw_bill_ranap_detail_konsul_dokterdelete" class="form-inline ewForm ewDeleteForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($vw_bill_ranap_detail_konsul_dokter_delete->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $vw_bill_ranap_detail_konsul_dokter_delete->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="vw_bill_ranap_detail_konsul_dokter">
<input type="hidden" name="a_delete" id="a_delete" value="D">
<?php foreach ($vw_bill_ranap_detail_konsul_dokter_delete->RecKeys as $key) { ?>
...
<?php if ($vw_bill_ranap_detail_konsul_dokter->tanggal->Visible) { // tanggal ?>
		<th><span id="elh_vw_bill_ranap_detail_konsul_dokter_tanggal" class="vw_bill_ranap_detail_konsul_dokter_tanggal"><?php echo $vw_bill_ranap_detail_konsul_dokter->tanggal->FldCaption() ?></span></th>
<?php } ?>
<?php if ($vw_bill_ranap_detail_konsul_dokter->kode_tindakan->Visible) { // kode_tindakan ?>
		<th><span id="elh_vw_bill_ranap_detail_konsul_dokter_kode_tindakan" class="vw_bill_ranap_detail_konsul_dokter_kode_tindakan"><?php echo $vw_bill_ranap_detail_konsul_dokter->kode_tindakan->FldCaption() ?></span></th>
<?php } ?>
<?php if ($vw_bill_ranap_detail_konsul_dokter->kode_dokter->Visible) { // kode_dokter ?>
		<th><span id="elh_vw_bill_ranap_detail_konsul_dokter_kode_dokter" class="vw_bill_ranap_detail_konsul_dokter_kode_dokter"><?php echo $vw_bill_ranap_detail_konsul_dokter->kode_dokter->FldCaption() ?></span></th>
<?php } ?>
<?php if ($vw_bill_ranap_detail_konsul_dokter->qty->Visible) { // qty ?>
		<th><span id="elh_vw_bill_ranap_detail_konsul_dokter_qty" class="vw_bill_ranap_detail_konsul_dokter_qty"><?php echo $vw_bill_ranap_detail_konsul_dokter->qty->FldCaption() ?></span></th>
<?php } ?>
<?php if ($vw_bill_ranap_detail_konsul_dokter->tarif->Visible) { // tarif ?>
		<th><span id="elh_vw_bill_ranap_detail_konsul_dokter_tarif" class="vw_bill_ranap_detail_konsul_dokter_tarif"><?php echo $vw_bill_ranap_detail_konsul_dokter->tarif->FldCaption() ?></span></th>
<?php } ?>
<?php if ($vw_bill_ranap_detail_konsul_dokter->user->Visible) { // user ?>
		<th><span id="elh_vw_bill_ranap_detail_konsul_dokter_user" class="vw_bill_ranap_detail_konsul_dokter_user"><?php echo $vw_bill_ranap_detail_konsul_dokter->user->FldCaption() ?></span></th>
<?php } ?>
<?php if ($vw_bill_ranap_detail_konsul_dokter->no_ruang->Visible) { // no_ruang ?>
		<th><span id="elh_vw_bill_ranap_detail_konsul_dokter_no_ruang" class="vw_bill_ranap_detail_konsul_dokter_no_ruang"><?php echo $vw_bill_ranap_detail_konsul_dokter->no_ruang->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
<?php
$vw_bill_ranap_detail_konsul_dokter_delete->RecCnt = 0;
$i = 0;
while (!$vw_bill_ranap_detail_konsul_dokter_delete->Recordset->EOF) {
	$vw_bill_ranap_detail_konsul_dokter_delete->RecCnt++;
	$vw_bill_ranap_detail_konsul_dokter_delete->RowCnt++;

	// Set row properties
	$vw_bill_ranap_detail_konsul_dokter->ResetAttrs();
	$vw_bill_ranap_detail_konsul_dokter->RowType = EW_ROWTYPE_VIEW; // View

	// Get the field contents
	$vw_bill_ranap_detail_konsul_dokter_delete->LoadRowValues($vw_bill_ranap_detail_konsul_dokter_delete->Recordset);

	// Render row
	$vw_bill_ranap_detail_konsul_dokter_delete->RenderRow();
?>
	<tr<?php echo $vw_bill_ranap_detail_konsul_dokter->RowAttributes() ?>>
<?php if ($vw_bill_ranap_detail_konsul_dokter->tanggal->Visible) { // tanggal ?>
		<td<?php echo $vw_bill_ranap_detail_konsul_dokter->tanggal->CellAttributes() ?>>
<span id="el<?php echo $vw_bill_ranap_detail_konsul_dokter_delete->RowCnt ?>_vw_bill_ranap_detail_konsul_dokter_tanggal" class="vw_bill_ranap_detail_konsul_dokter_tanggal">
...
<?php } ?>
<?php if ($vw_bill_ranap_detail_konsul_dokter->kode_tindakan->Visible) { // kode_tindakan ?>
		<td<?php echo $vw_bill_ranap_detail_konsul_dokter->kode_tindakan->CellAttributes() ?>>
<span id="el<?php echo $vw_bill_ranap_detail_konsul_dokter_delete->RowCnt ?>_vw_bill_ranap_detail_konsul_dokter_kode_tindakan" class="vw_bill_ranap_detail_konsul_dokter_kode_tindakan">
...
<?php } ?>
<?php if ($vw_bill_ranap_detail_konsul_dokter->kode_dokter->Visible) { // kode_dokter ?>
		<td<?php echo $vw_bill_ranap_detail_konsul_dokter->kode_dokter->CellAttributes() ?>>
<span id="el<?php echo $vw_bill_ranap_detail_konsul_dokter_delete->RowCnt ?>_vw_bill_ranap_detail_konsul_dokter_kode_dokter" class="vw_bill_ranap_detail_konsul_dokter_kode_dokter">
...
<?php } ?>
<?php if ($vw_bill_ranap_detail_konsul_dokter->qty->Visible) { // qty ?>
		<td<?php echo $vw_bill_ranap_detail_konsul_dokter->qty->CellAttributes() ?>>
<span id="el<?php echo $vw_bill_ranap_detail_konsul_dokter_delete->RowCnt ?>_vw_bill_ranap_detail_konsul_dokter_qty" class="vw_bill_ranap_detail_konsul_dokter_qty">
...
<?php } ?>
<?php if ($vw_bill_ranap_detail_konsul_dokter->tarif->Visible) { // tarif ?>
		<td<?php echo $vw_bill_ranap_detail_konsul_dokter->tarif->CellAttributes() ?>>
<span id="el<?php echo $vw_bill_ranap_detail_konsul_dokter_delete->RowCnt ?>_vw_bill_ranap_detail_konsul_dokter_tarif" class="vw_bill_ranap_detail_konsul_dokter_tarif">
...
<?php } ?>
<?php if ($vw_bill_ranap_detail_konsul_dokter->user->Visible) { // user ?>
		<td<?php echo $vw_bill_ranap_detail_konsul_dokter->user->CellAttributes() ?>>
<span id="el<?php echo $vw_bill_ranap_detail_konsul_dokter_delete->RowCnt ?>_vw_bill_ranap_detail_konsul_dokter_user" class="vw_bill_ranap_detail_konsul_dokter_user">
...
<?php } ?>
<?php if ($vw_bill_ranap_detail_konsul_dokter->no_ruang->Visible) { // no_ruang ?>
		<td<?php echo $vw_bill_ranap_detail_konsul_dokter->no_ruang->CellAttributes() ?>>
<span id="el<?php echo $vw_bill_ranap_detail_konsul_dokter_delete->RowCnt ?>_vw_bill_ranap_detail_konsul_dokter_no_ruang" class="vw_bill_ranap_detail_konsul_dokter_no_ruang">
...
<?php
	$vw_bill_ranap_detail_konsul_dokter_delete->Recordset->MoveNext();
}
$vw_bill_ranap_detail_konsul_dokter_delete->Recordset->Close();
?>
</tbody>
</table>
</div>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $vw_bill_ranap_detail_konsul_dokter_delete->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
</div>
</form>
<script type="text/javascript">
fvw_bill_ranap_detail_konsul_dokterdelete.Init();
</script>
<?php
$vw_bill_ranap_detail_konsul_dokter_delete->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$vw_bill_ranap_detail_konsul_dokter_delete->Page_Terminate();
?>
