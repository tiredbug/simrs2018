...
//
// Table class for keu_akun5
//
class ckeu_akun5 extends cTable {
	var $id;
	var $kd_akun;
	var $akun1;
	var $akun2;
	...
	function __construct() {
		...
		$this->TableVar = 'keu_akun5';
		$this->TableName = 'keu_akun5';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`keu_akun5`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('keu_akun5', 'keu_akun5', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// kd_akun
		$this->kd_akun = new cField('keu_akun5', 'keu_akun5', 'x_kd_akun', 'kd_akun', '`kd_akun`', '`kd_akun`', 200, -1, FALSE, '`kd_akun`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->kd_akun->Sortable = TRUE; // Allow sort
		$this->fields['kd_akun'] = &$this->kd_akun;

		// akun1
		$this->akun1 = new cField('keu_akun5', 'keu_akun5', 'x_akun1', 'akun1', '`akun1`', '`akun1`', 200, -1, FALSE, '`akun1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->akun1->Sortable = TRUE; // Allow sort
		$this->fields['akun1'] = &$this->akun1;

		// akun2
		$this->akun2 = new cField('keu_akun5', 'keu_akun5', 'x_akun2', 'akun2', '`akun2`', '`akun2`', 200, -1, FALSE, '`akun2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->akun2->Sortable = TRUE; // Allow sort
		$this->fields['akun2'] = &$this->akun2;

		// akun3
		$this->akun3 = new cField('keu_akun5', 'keu_akun5', 'x_akun3', 'akun3', '`akun3`', '`akun3`', 200, -1, FALSE, '`akun3`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->akun3->Sortable = TRUE; // Allow sort
		$this->fields['akun3'] = &$this->akun3;

		// akun4
		$this->akun4 = new cField('keu_akun5', 'keu_akun5', 'x_akun4', 'akun4', '`akun4`', '`akun4`', 200, -1, FALSE, '`akun4`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->akun4->Sortable = TRUE; // Allow sort
		$this->fields['akun4'] = &$this->akun4;

		// akun5
		$this->akun5 = new cField('keu_akun5', 'keu_akun5', 'x_akun5', 'akun5', '`akun5`', '`akun5`', 200, -1, FALSE, '`akun5`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->akun5->Sortable = TRUE; // Allow sort
		$this->fields['akun5'] = &$this->akun5;

		// nama_akun
		$this->nama_akun = new cField('keu_akun5', 'keu_akun5', 'x_nama_akun', 'nama_akun', '`nama_akun`', '`nama_akun`', 200, -1, FALSE, '`nama_akun`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->nama_akun->Sortable = TRUE; // Allow sort
		$this->fields['nama_akun'] = &$this->nama_akun;

		// kd_akun4
		$this->kd_akun4 = new cField('keu_akun5', 'keu_akun5', 'x_kd_akun4', 'kd_akun4', '`kd_akun4`', '`kd_akun4`', 3, -1, FALSE, '`kd_akun4`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->kd_akun4->Sortable = TRUE; // Allow sort
		$this->kd_akun4->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['kd_akun4'] = &$this->kd_akun4;
	}
	...
	function GetMasterFilter() {
		...
		// Master filter
		$sMasterFilter = "";
		if ($this->getCurrentMasterTable() == "keu_akun4") {
			if ($this->akun1->getSessionValue() <> "")
				$sMasterFilter .= "`kel1`=" . ew_QuotedValue($this->akun1->getSessionValue(), EW_DATATYPE_STRING, "DB");
			else
				return "";
			if ($this->akun2->getSessionValue() <> "")
				$sMasterFilter .= " AND `kel2`=" . ew_QuotedValue($this->akun2->getSessionValue(), EW_DATATYPE_STRING, "DB");
			else
				return "";
			if ($this->akun3->getSessionValue() <> "")
				$sMasterFilter .= " AND `kel3`=" . ew_QuotedValue($this->akun3->getSessionValue(), EW_DATATYPE_STRING, "DB");
			else
				return "";
			if ($this->akun4->getSessionValue() <> "")
				$sMasterFilter .= " AND `kel4`=" . ew_QuotedValue($this->akun4->getSessionValue(), EW_DATATYPE_STRING, "DB");
			else
				return "";
		}
	...
	function GetDetailFilter() {
		...
		if ($this->getCurrentMasterTable() == "keu_akun4") {
			if ($this->akun1->getSessionValue() <> "")
				$sDetailFilter .= "`akun1`=" . ew_QuotedValue($this->akun1->getSessionValue(), EW_DATATYPE_STRING, "DB");
			else
				return "";
			if ($this->akun2->getSessionValue() <> "")
				$sDetailFilter .= " AND `akun2`=" . ew_QuotedValue($this->akun2->getSessionValue(), EW_DATATYPE_STRING, "DB");
			else
				return "";
			if ($this->akun3->getSessionValue() <> "")
				$sDetailFilter .= " AND `akun3`=" . ew_QuotedValue($this->akun3->getSessionValue(), EW_DATATYPE_STRING, "DB");
			else
				return "";
			if ($this->akun4->getSessionValue() <> "")
				$sDetailFilter .= " AND `akun4`=" . ew_QuotedValue($this->akun4->getSessionValue(), EW_DATATYPE_STRING, "DB");
			else
				return "";
		}
	...
	// Master filter
	function SqlMasterFilter_keu_akun4() {
		return "`kel1`='@kel1@' AND `kel2`='@kel2@' AND `kel3`='@kel3@' AND `kel4`='@kel4@'";
	}

	// Detail filter
	function SqlDetailFilter_keu_akun4() {
		return "`akun1`='@akun1@' AND `akun2`='@akun2@' AND `akun3`='@akun3@' AND `akun4`='@akun4@'";
	}
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`keu_akun5`";
	}
	...
	function getSqlWhere() { // Where
		...
		$this->TableFilter = "`akun5` IS NOT NULL";
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("keu_akun5view.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("keu_akun5view.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "keu_akun5add.php?" . $this->UrlParm($parm);
		else
			$url = "keu_akun5add.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("keu_akun5edit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("keu_akun5add.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("keu_akun5delete.php", $this->UrlParm());
	}

	// Add master url
	function AddMasterUrl($url) {
		if ($this->getCurrentMasterTable() == "keu_akun4" && strpos($url, EW_TABLE_SHOW_MASTER . "=") === FALSE) {
			$url .= (strpos($url, "?") !== FALSE ? "&" : "?") . EW_TABLE_SHOW_MASTER . "=" . $this->getCurrentMasterTable();
			$url .= "&fk_kel1=" . urlencode($this->akun1->CurrentValue);
			$url .= "&fk_kel2=" . urlencode($this->akun2->CurrentValue);
			$url .= "&fk_kel3=" . urlencode($this->akun3->CurrentValue);
			$url .= "&fk_kel4=" . urlencode($this->akun4->CurrentValue);
		}
		return $url;
	}
   ...
   // Common render codes
	...
	function RenderEditRow() {
		...
		$this->kd_akun4->EditValue = $this->kd_akun4->CurrentValue;
		...
		if (!$Doc->ExportCustom) {
			...
			if ($Doc->Horizontal) { // Horizontal format, write header
				...
				if ($ExportPageType == "view") {
					...
					if ($this->kd_akun4->Exportable) $Doc->ExportCaption($this->kd_akun4);
				} else {
					if ($this->id->Exportable) $Doc->ExportCaption($this->id);
					if ($this->kd_akun->Exportable) $Doc->ExportCaption($this->kd_akun);
					if ($this->akun1->Exportable) $Doc->ExportCaption($this->akun1);
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if (!$Doc->ExportCustom) {
					...
					if ($ExportPageType == "view") {
						...
						if ($this->kd_akun4->Exportable) $Doc->ExportField($this->kd_akun4);
					} else {
						if ($this->id->Exportable) $Doc->ExportField($this->id);
						if ($this->kd_akun->Exportable) $Doc->ExportField($this->kd_akun);
						if ($this->akun1->Exportable) $Doc->ExportField($this->akun1);
