...
$m_ruang_search = NULL; // Initialize page object first

class cm_ruang_search extends cm_ruang {
	...
	// Page object name
	var $PageObjName = 'm_ruang_search';
			...
			switch ($this->CurrentAction) {
				case "S": // Get search criteria
					...
					if ($sSrchStr <> "") {
						...
						$sSrchStr = "m_ruanglist.php" . "?" . $sSrchStr;
	...
	function BuildAdvancedSearch() {
		$sSrchUrl = "";
		$this->BuildSearchUrl($sSrchUrl, $this->ruang); // ruang
	...
	function LoadSearchValues() {
		...
		$this->ruang->AdvancedSearch->SearchValue = ew_StripSlashes($objForm->GetValue("x_ruang"));
		$this->ruang->AdvancedSearch->SearchOperator = $objForm->GetValue("z_ruang");
	}
	...
	function RenderRow() {
		...
		$this->group_id->ViewCustomAttributes = "";
			...
			$this->ruang->EditValue = ew_HtmlEncode($this->ruang->AdvancedSearch->SearchValue);
...
// Create page object
if (!isset($m_ruang_search)) $m_ruang_search = new cm_ruang_search();

// Page init
$m_ruang_search->Page_Init();

// Page main
$m_ruang_search->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$m_ruang_search->Page_Render();
?>
...
<?php if ($m_ruang_search->IsModal) { ?>
var CurrentAdvancedSearchForm = fm_ruangsearch = new ew_Form("fm_ruangsearch", "search");
<?php } else { ?>
var CurrentForm = fm_ruangsearch = new ew_Form("fm_ruangsearch", "search");
<?php } ?>

// Form_CustomValidate event
fm_ruangsearch.Form_CustomValidate = 
...
fm_ruangsearch.ValidateRequired = true;
<?php } else { ?>
fm_ruangsearch.ValidateRequired = false; 
<?php } ?>
...
fm_ruangsearch.Validate = function(fobj) {
...
<?php if (!$m_ruang_search->IsModal) { ?>
<?php } ?>
<?php $m_ruang_search->ShowPageHeader(); ?>
<?php
$m_ruang_search->ShowMessage();
?>
<form name="fm_ruangsearch" id="fm_ruangsearch" class="<?php echo $m_ruang_search->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($m_ruang_search->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $m_ruang_search->Token ?>">
<?php } ?>
...
<?php if ($m_ruang->ruang->Visible) { // ruang ?>
	<div id="r_ruang" class="form-group">
		<label for="x_ruang" class="<?php echo $m_ruang_search->SearchLabelClass ?>"><span id="elh_m_ruang_ruang"><?php echo $m_ruang->ruang->FldCaption() ?></span>	
		<p class="form-control-static ewSearchOperator"><?php echo $Language->Phrase("LIKE") ?><input type="hidden" name="z_ruang" id="z_ruang" value="LIKE"></p>
		</label>
		<div class="<?php echo $m_ruang_search->SearchRightColumnClass ?>"><div<?php echo $m_ruang->ruang->CellAttributes() ?>>
