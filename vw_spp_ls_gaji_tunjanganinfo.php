...
$vw_spp_ls_gaji_tunjangan = NULL;

//
// Table class for vw_spp_ls_gaji_tunjangan
//
class cvw_spp_ls_gaji_tunjangan extends cTable {
	var $id;
	...
	function __construct() {
		...
		$this->TableVar = 'vw_spp_ls_gaji_tunjangan';
		$this->TableName = 'vw_spp_ls_gaji_tunjangan';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`vw_spp_ls_gaji_tunjangan`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('vw_spp_ls_gaji_tunjangan', 'vw_spp_ls_gaji_tunjangan', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// detail_jenis_spp
		$this->detail_jenis_spp = new cField('vw_spp_ls_gaji_tunjangan', 'vw_spp_ls_gaji_tunjangan', 'x_detail_jenis_spp', 'detail_jenis_spp', '`detail_jenis_spp`', '`detail_jenis_spp`', 3, -1, FALSE, '`detail_jenis_spp`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// id_jenis_spp
		$this->id_jenis_spp = new cField('vw_spp_ls_gaji_tunjangan', 'vw_spp_ls_gaji_tunjangan', 'x_id_jenis_spp', 'id_jenis_spp', '`id_jenis_spp`', '`id_jenis_spp`', 3, -1, FALSE, '`id_jenis_spp`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// status_spp
		$this->status_spp = new cField('vw_spp_ls_gaji_tunjangan', 'vw_spp_ls_gaji_tunjangan', 'x_status_spp', 'status_spp', '`status_spp`', '`status_spp`', 3, -1, FALSE, '`status_spp`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// no_spp
		$this->no_spp = new cField('vw_spp_ls_gaji_tunjangan', 'vw_spp_ls_gaji_tunjangan', 'x_no_spp', 'no_spp', '`no_spp`', '`no_spp`', 200, -1, FALSE, '`no_spp`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->no_spp->Sortable = TRUE; // Allow sort
		$this->fields['no_spp'] = &$this->no_spp;

		// tgl_spp
		$this->tgl_spp = new cField('vw_spp_ls_gaji_tunjangan', 'vw_spp_ls_gaji_tunjangan', 'x_tgl_spp', 'tgl_spp', '`tgl_spp`', ew_CastDateFieldForLike('`tgl_spp`', 0, "DB"), 135, 0, FALSE, '`tgl_spp`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// keterangan
		$this->keterangan = new cField('vw_spp_ls_gaji_tunjangan', 'vw_spp_ls_gaji_tunjangan', 'x_keterangan', 'keterangan', '`keterangan`', '`keterangan`', 200, -1, FALSE, '`keterangan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function GetMasterFilter() {
		...
		// Master filter
		$sMasterFilter = "";
		if ($this->getCurrentMasterTable() == "l_jenis_detail_spp") {
			if ($this->detail_jenis_spp->getSessionValue() <> "")
				$sMasterFilter .= "`id`=" . ew_QuotedValue($this->detail_jenis_spp->getSessionValue(), EW_DATATYPE_NUMBER, "DB");
			else
				return "";
			if ($this->id_jenis_spp->getSessionValue() <> "")
				$sMasterFilter .= " AND `id_jenis`=" . ew_QuotedValue($this->id_jenis_spp->getSessionValue(), EW_DATATYPE_NUMBER, "DB");
			else
				return "";
		}
	...
	function GetDetailFilter() {
		...
		if ($this->getCurrentMasterTable() == "l_jenis_detail_spp") {
			if ($this->detail_jenis_spp->getSessionValue() <> "")
				$sDetailFilter .= "`detail_jenis_spp`=" . ew_QuotedValue($this->detail_jenis_spp->getSessionValue(), EW_DATATYPE_NUMBER, "DB");
			else
				return "";
			if ($this->id_jenis_spp->getSessionValue() <> "")
	...
	// Master filter
	function SqlMasterFilter_l_jenis_detail_spp() {
		return "`id`=@id@ AND `id_jenis`=@id_jenis@";
	}

	// Detail filter
	function SqlDetailFilter_l_jenis_detail_spp() {
		return "`detail_jenis_spp`=@detail_jenis_spp@ AND `id_jenis_spp`=@id_jenis_spp@";
	}
	...
	function GetDetailUrl() {
		...
		if ($sDetailUrl == "") {
			$sDetailUrl = "vw_spp_ls_gaji_tunjanganlist.php";
		}
		return $sDetailUrl;
	}
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`vw_spp_ls_gaji_tunjangan`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "vw_spp_ls_gaji_tunjanganlist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("vw_spp_ls_gaji_tunjanganview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("vw_spp_ls_gaji_tunjanganview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "vw_spp_ls_gaji_tunjanganadd.php?" . $this->UrlParm($parm);
		else
			$url = "vw_spp_ls_gaji_tunjanganadd.php";
		return $this->AddMasterUrl($url);
	}
	...
	function GetEditUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("vw_spp_ls_gaji_tunjanganedit.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("vw_spp_ls_gaji_tunjanganedit.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("vw_spp_ls_gaji_tunjanganadd.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("vw_spp_ls_gaji_tunjanganadd.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("vw_spp_ls_gaji_tunjangandelete.php", $this->UrlParm());
	}

	// Add master url
	function AddMasterUrl($url) {
		if ($this->getCurrentMasterTable() == "l_jenis_detail_spp" && strpos($url, EW_TABLE_SHOW_MASTER . "=") === FALSE) {
			$url .= (strpos($url, "?") !== FALSE ? "&" : "?") . EW_TABLE_SHOW_MASTER . "=" . $this->getCurrentMasterTable();
			$url .= "&fk_id=" . urlencode($this->detail_jenis_spp->CurrentValue);
			$url .= "&fk_id_jenis=" . urlencode($this->id_jenis_spp->CurrentValue);
		}
		return $url;
	}
   ...
   // Common render codes
	...
	function RenderEditRow() {
		...
		$this->status_spp->EditValue = $this->status_spp->CurrentValue;
		...
		$this->tgl_spp->EditValue = ew_FormatDateTime($this->tgl_spp->CurrentValue, 8);
