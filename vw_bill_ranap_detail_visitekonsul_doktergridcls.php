...
$vw_bill_ranap_detail_visitekonsul_dokter_grid = NULL; // Initialize page object first

class cvw_bill_ranap_detail_visitekonsul_dokter_grid extends cvw_bill_ranap_detail_visitekonsul_dokter {
	...
	// Page object name
	var $PageObjName = 'vw_bill_ranap_detail_visitekonsul_dokter_grid';

	// Grid form hidden field names
	var $FormName = 'fvw_bill_ranap_detail_visitekonsul_doktergrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["vw_bill_ranap_detail_visitekonsul_dokter"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function EmptyRow() {
		...
		if ($objForm->HasValue("x_kode_tindakan") && $objForm->HasValue("o_kode_tindakan") && $this->kode_tindakan->CurrentValue <> $this->kode_tindakan->OldValue)
			return FALSE;
		if ($objForm->HasValue("x_kode_dokter") && $objForm->HasValue("o_kode_dokter") && $this->kode_dokter->CurrentValue <> $this->kode_dokter->OldValue)
			return FALSE;
	...
	function LoadFormValues() {
		...
		$this->kode_dokter->setOldValue($objForm->GetValue("o_kode_dokter"));
