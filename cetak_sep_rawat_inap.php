...
$sql2 = "select counter_cetak_sep as 'counter_cetak_kartu' from t_admission where id_admission = ".htmlspecialchars($idx)." limit 1";
//print $sql2;
...
<?php 	
		$update_sql= "UPDATE t_admission SET counter_cetak_sep = counter_cetak_sep + 1 WHERE id_admission = ". htmlspecialchars($idx);
