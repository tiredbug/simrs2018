...
$t_sbp_view = NULL; // Initialize page object first

class ct_sbp_view extends ct_sbp {
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["id"] <> "") {
				...
				$sReturnUrl = "t_sbplist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "t_sbplist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "t_sbplist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($t_sbp_view)) $t_sbp_view = new ct_sbp_view();

// Page init
$t_sbp_view->Page_Init();

// Page main
$t_sbp_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t_sbp_view->Page_Render();
?>
...
var CurrentForm = ft_sbpview = new ew_Form("ft_sbpview", "view");

// Form_CustomValidate event
ft_sbpview.Form_CustomValidate = 
...
ft_sbpview.ValidateRequired = true;
<?php } else { ?>
ft_sbpview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ft_sbpview.Lists["x_tipe"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
ft_sbpview.Lists["x_tipe"].Options = <?php echo json_encode($t_sbp->tipe->Options()) ?>;
ft_sbpview.Lists["x_tipe_sbp"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
ft_sbpview.Lists["x_tipe_sbp"].Options = <?php echo json_encode($t_sbp->tipe_sbp->Options()) ?>;
ft_sbpview.Lists["x_program"] = {"LinkField":"x_kode_program","Ajax":true,"AutoFill":false,"DisplayFields":["x_nama_program","","",""],"ParentFields":[],"ChildFields":["x_kegiatan"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"m_program"};
ft_sbpview.Lists["x_kegiatan"] = {"LinkField":"x_kode_kegiatan","Ajax":true,"AutoFill":false,"DisplayFields":["x_nama_kegiatan","","",""],"ParentFields":[],"ChildFields":["x_sub_kegiatan"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"m_kegiatan"};
ft_sbpview.Lists["x_sub_kegiatan"] = {"LinkField":"x_kode_sub_kegiatan","Ajax":true,"AutoFill":false,"DisplayFields":["x_nama_sub_kegiatan","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"m_sub_kegiatan"};
ft_sbpview.Lists["x_nama_pptk"] = {"LinkField":"x_nama","Ajax":true,"AutoFill":false,"DisplayFields":["x_nama","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"m_pejabat_keuangan"};
ft_sbpview.Lists["x_nama_pengguna"] = {"LinkField":"x_direktur","Ajax":true,"AutoFill":false,"DisplayFields":["x_direktur","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"m_blud_rs"};
ft_sbpview.Lists["x_akun1"] = {"LinkField":"x_kel1","Ajax":true,"AutoFill":false,"DisplayFields":["x_nmkel1","","",""],"ParentFields":[],"ChildFields":["x_akun2","x_akun3","x_akun4","x_akun5"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"keu_akun1"};
ft_sbpview.Lists["x_akun2"] = {"LinkField":"x_kel2","Ajax":true,"AutoFill":false,"DisplayFields":["x_nmkel2","","",""],"ParentFields":[],"ChildFields":["x_akun3","x_akun4","x_akun5"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"keu_akun2"};
ft_sbpview.Lists["x_akun3"] = {"LinkField":"x_kel3","Ajax":true,"AutoFill":false,"DisplayFields":["x_nmkel3","","",""],"ParentFields":[],"ChildFields":["x_akun4","x_akun5"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"keu_akun3"};
ft_sbpview.Lists["x_akun4"] = {"LinkField":"x_kel4","Ajax":true,"AutoFill":false,"DisplayFields":["x_nmkel4","","",""],"ParentFields":[],"ChildFields":["x_akun5"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"keu_akun4"};
ft_sbpview.Lists["x_akun5"] = {"LinkField":"x_akun5","Ajax":true,"AutoFill":false,"DisplayFields":["x_nama_akun","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"keu_akun5"};
...
<?php if (!$t_sbp_view->IsModal) { ?>
<?php } ?>
<?php $t_sbp_view->ExportOptions->Render("body") ?>
<?php
	foreach ($t_sbp_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$t_sbp_view->IsModal) { ?>
...
<?php $t_sbp_view->ShowPageHeader(); ?>
<?php
$t_sbp_view->ShowMessage();
?>
<form name="ft_sbpview" id="ft_sbpview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t_sbp_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t_sbp_view->Token ?>">
<?php } ?>
...
<?php if ($t_sbp->tipe->Visible) { // tipe ?>
	<tr id="r_tipe">
		<td><span id="elh_t_sbp_tipe"><?php echo $t_sbp->tipe->FldCaption() ?></span></td>
		<td data-name="tipe"<?php echo $t_sbp->tipe->CellAttributes() ?>>
<span id="el_t_sbp_tipe">
<span<?php echo $t_sbp->tipe->ViewAttributes() ?>>
<?php echo $t_sbp->tipe->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_sbp->tipe_sbp->Visible) { // tipe_sbp ?>
	<tr id="r_tipe_sbp">
		<td><span id="elh_t_sbp_tipe_sbp"><?php echo $t_sbp->tipe_sbp->FldCaption() ?></span></td>
...
<?php echo $t_sbp->tipe_sbp->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($t_sbp->tgl_sbp->Visible) { // tgl_sbp ?>
	<tr id="r_tgl_sbp">
		<td><span id="elh_t_sbp_tgl_sbp"><?php echo $t_sbp->tgl_sbp->FldCaption() ?></span></td>
		<td data-name="tgl_sbp"<?php echo $t_sbp->tgl_sbp->CellAttributes() ?>>
<span id="el_t_sbp_tgl_sbp">
<span<?php echo $t_sbp->tgl_sbp->ViewAttributes() ?>>
<?php echo $t_sbp->tgl_sbp->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_sbp->program->Visible) { // program ?>
	<tr id="r_program">
		<td><span id="elh_t_sbp_program"><?php echo $t_sbp->program->FldCaption() ?></span></td>
		<td data-name="program"<?php echo $t_sbp->program->CellAttributes() ?>>
<span id="el_t_sbp_program">
<span<?php echo $t_sbp->program->ViewAttributes() ?>>
<?php echo $t_sbp->program->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_sbp->kegiatan->Visible) { // kegiatan ?>
	<tr id="r_kegiatan">
		<td><span id="elh_t_sbp_kegiatan"><?php echo $t_sbp->kegiatan->FldCaption() ?></span></td>
		<td data-name="kegiatan"<?php echo $t_sbp->kegiatan->CellAttributes() ?>>
<span id="el_t_sbp_kegiatan">
<span<?php echo $t_sbp->kegiatan->ViewAttributes() ?>>
<?php echo $t_sbp->kegiatan->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_sbp->sub_kegiatan->Visible) { // sub_kegiatan ?>
	<tr id="r_sub_kegiatan">
		<td><span id="elh_t_sbp_sub_kegiatan"><?php echo $t_sbp->sub_kegiatan->FldCaption() ?></span></td>
		<td data-name="sub_kegiatan"<?php echo $t_sbp->sub_kegiatan->CellAttributes() ?>>
<span id="el_t_sbp_sub_kegiatan">
<span<?php echo $t_sbp->sub_kegiatan->ViewAttributes() ?>>
<?php echo $t_sbp->sub_kegiatan->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_sbp->uraian->Visible) { // uraian ?>
	<tr id="r_uraian">
		<td><span id="elh_t_sbp_uraian"><?php echo $t_sbp->uraian->FldCaption() ?></span></td>
		<td data-name="uraian"<?php echo $t_sbp->uraian->CellAttributes() ?>>
<span id="el_t_sbp_uraian">
<span<?php echo $t_sbp->uraian->ViewAttributes() ?>>
<?php echo $t_sbp->uraian->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_sbp->nama_penerima->Visible) { // nama_penerima ?>
	<tr id="r_nama_penerima">
		<td><span id="elh_t_sbp_nama_penerima"><?php echo $t_sbp->nama_penerima->FldCaption() ?></span></td>
		<td data-name="nama_penerima"<?php echo $t_sbp->nama_penerima->CellAttributes() ?>>
<span id="el_t_sbp_nama_penerima">
<span<?php echo $t_sbp->nama_penerima->ViewAttributes() ?>>
<?php echo $t_sbp->nama_penerima->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_sbp->alamat_penerima->Visible) { // alamat_penerima ?>
	<tr id="r_alamat_penerima">
		<td><span id="elh_t_sbp_alamat_penerima"><?php echo $t_sbp->alamat_penerima->FldCaption() ?></span></td>
		<td data-name="alamat_penerima"<?php echo $t_sbp->alamat_penerima->CellAttributes() ?>>
<span id="el_t_sbp_alamat_penerima">
<span<?php echo $t_sbp->alamat_penerima->ViewAttributes() ?>>
<?php echo $t_sbp->alamat_penerima->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_sbp->nama_pptk->Visible) { // nama_pptk ?>
	<tr id="r_nama_pptk">
		<td><span id="elh_t_sbp_nama_pptk"><?php echo $t_sbp->nama_pptk->FldCaption() ?></span></td>
		<td data-name="nama_pptk"<?php echo $t_sbp->nama_pptk->CellAttributes() ?>>
<span id="el_t_sbp_nama_pptk">
<span<?php echo $t_sbp->nama_pptk->ViewAttributes() ?>>
<?php echo $t_sbp->nama_pptk->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_sbp->nip_pptk->Visible) { // nip_pptk ?>
	<tr id="r_nip_pptk">
		<td><span id="elh_t_sbp_nip_pptk"><?php echo $t_sbp->nip_pptk->FldCaption() ?></span></td>
		<td data-name="nip_pptk"<?php echo $t_sbp->nip_pptk->CellAttributes() ?>>
<span id="el_t_sbp_nip_pptk">
<span<?php echo $t_sbp->nip_pptk->ViewAttributes() ?>>
<?php echo $t_sbp->nip_pptk->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_sbp->nama_pengguna->Visible) { // nama_pengguna ?>
	<tr id="r_nama_pengguna">
		<td><span id="elh_t_sbp_nama_pengguna"><?php echo $t_sbp->nama_pengguna->FldCaption() ?></span></td>
		<td data-name="nama_pengguna"<?php echo $t_sbp->nama_pengguna->CellAttributes() ?>>
<span id="el_t_sbp_nama_pengguna">
<span<?php echo $t_sbp->nama_pengguna->ViewAttributes() ?>>
<?php echo $t_sbp->nama_pengguna->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_sbp->nip_pengguna_anggaran->Visible) { // nip_pengguna_anggaran ?>
	<tr id="r_nip_pengguna_anggaran">
		<td><span id="elh_t_sbp_nip_pengguna_anggaran"><?php echo $t_sbp->nip_pengguna_anggaran->FldCaption() ?></span></td>
		<td data-name="nip_pengguna_anggaran"<?php echo $t_sbp->nip_pengguna_anggaran->CellAttributes() ?>>
<span id="el_t_sbp_nip_pengguna_anggaran">
<span<?php echo $t_sbp->nip_pengguna_anggaran->ViewAttributes() ?>>
<?php echo $t_sbp->nip_pengguna_anggaran->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_sbp->akun1->Visible) { // akun1 ?>
	<tr id="r_akun1">
		<td><span id="elh_t_sbp_akun1"><?php echo $t_sbp->akun1->FldCaption() ?></span></td>
		<td data-name="akun1"<?php echo $t_sbp->akun1->CellAttributes() ?>>
<span id="el_t_sbp_akun1">
<span<?php echo $t_sbp->akun1->ViewAttributes() ?>>
<?php echo $t_sbp->akun1->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_sbp->akun2->Visible) { // akun2 ?>
	<tr id="r_akun2">
		<td><span id="elh_t_sbp_akun2"><?php echo $t_sbp->akun2->FldCaption() ?></span></td>
		<td data-name="akun2"<?php echo $t_sbp->akun2->CellAttributes() ?>>
<span id="el_t_sbp_akun2">
<span<?php echo $t_sbp->akun2->ViewAttributes() ?>>
<?php echo $t_sbp->akun2->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_sbp->akun3->Visible) { // akun3 ?>
	<tr id="r_akun3">
		<td><span id="elh_t_sbp_akun3"><?php echo $t_sbp->akun3->FldCaption() ?></span></td>
		<td data-name="akun3"<?php echo $t_sbp->akun3->CellAttributes() ?>>
<span id="el_t_sbp_akun3">
<span<?php echo $t_sbp->akun3->ViewAttributes() ?>>
<?php echo $t_sbp->akun3->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_sbp->akun4->Visible) { // akun4 ?>
	<tr id="r_akun4">
		<td><span id="elh_t_sbp_akun4"><?php echo $t_sbp->akun4->FldCaption() ?></span></td>
		<td data-name="akun4"<?php echo $t_sbp->akun4->CellAttributes() ?>>
<span id="el_t_sbp_akun4">
<span<?php echo $t_sbp->akun4->ViewAttributes() ?>>
<?php echo $t_sbp->akun4->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_sbp->akun5->Visible) { // akun5 ?>
	<tr id="r_akun5">
		<td><span id="elh_t_sbp_akun5"><?php echo $t_sbp->akun5->FldCaption() ?></span></td>
		<td data-name="akun5"<?php echo $t_sbp->akun5->CellAttributes() ?>>
<span id="el_t_sbp_akun5">
<span<?php echo $t_sbp->akun5->ViewAttributes() ?>>
<?php echo $t_sbp->akun5->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_sbp->kode_rekening->Visible) { // kode_rekening ?>
	<tr id="r_kode_rekening">
		<td><span id="elh_t_sbp_kode_rekening"><?php echo $t_sbp->kode_rekening->FldCaption() ?></span></td>
		<td data-name="kode_rekening"<?php echo $t_sbp->kode_rekening->CellAttributes() ?>>
<span id="el_t_sbp_kode_rekening">
<span<?php echo $t_sbp->kode_rekening->ViewAttributes() ?>>
<?php echo $t_sbp->kode_rekening->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_sbp->pph21->Visible) { // pph21 ?>
	<tr id="r_pph21">
		<td><span id="elh_t_sbp_pph21"><?php echo $t_sbp->pph21->FldCaption() ?></span></td>
		<td data-name="pph21"<?php echo $t_sbp->pph21->CellAttributes() ?>>
<span id="el_t_sbp_pph21">
<span<?php echo $t_sbp->pph21->ViewAttributes() ?>>
<?php echo $t_sbp->pph21->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_sbp->pph22->Visible) { // pph22 ?>
	<tr id="r_pph22">
		<td><span id="elh_t_sbp_pph22"><?php echo $t_sbp->pph22->FldCaption() ?></span></td>
		<td data-name="pph22"<?php echo $t_sbp->pph22->CellAttributes() ?>>
<span id="el_t_sbp_pph22">
<span<?php echo $t_sbp->pph22->ViewAttributes() ?>>
<?php echo $t_sbp->pph22->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_sbp->pph23->Visible) { // pph23 ?>
	<tr id="r_pph23">
		<td><span id="elh_t_sbp_pph23"><?php echo $t_sbp->pph23->FldCaption() ?></span></td>
		<td data-name="pph23"<?php echo $t_sbp->pph23->CellAttributes() ?>>
<span id="el_t_sbp_pph23">
<span<?php echo $t_sbp->pph23->ViewAttributes() ?>>
<?php echo $t_sbp->pph23->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_sbp->pph4->Visible) { // pph4 ?>
	<tr id="r_pph4">
		<td><span id="elh_t_sbp_pph4"><?php echo $t_sbp->pph4->FldCaption() ?></span></td>
		<td data-name="pph4"<?php echo $t_sbp->pph4->CellAttributes() ?>>
<span id="el_t_sbp_pph4">
<span<?php echo $t_sbp->pph4->ViewAttributes() ?>>
<?php echo $t_sbp->pph4->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t_sbp->jumlah_belanja->Visible) { // jumlah_belanja ?>
	<tr id="r_jumlah_belanja">
		<td><span id="elh_t_sbp_jumlah_belanja"><?php echo $t_sbp->jumlah_belanja->FldCaption() ?></span></td>
		<td data-name="jumlah_belanja"<?php echo $t_sbp->jumlah_belanja->CellAttributes() ?>>
<span id="el_t_sbp_jumlah_belanja">
<span<?php echo $t_sbp->jumlah_belanja->ViewAttributes() ?>>
<?php echo $t_sbp->jumlah_belanja->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
