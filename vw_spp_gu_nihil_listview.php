...
$vw_spp_gu_nihil_list_view = NULL; // Initialize page object first

class cvw_spp_gu_nihil_list_view extends cvw_spp_gu_nihil_list {
	...
	// Page object name
	var $PageObjName = 'vw_spp_gu_nihil_list_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["id"] <> "") {
				...
				$sReturnUrl = "vw_spp_gu_nihil_listlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "vw_spp_gu_nihil_listlist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "vw_spp_gu_nihil_listlist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
	...
	function SetupOtherOptions() {
		...
		$item = &$option->Add("detail_vw_spp_detail_pajak");
		$body = $Language->Phrase("ViewPageDetailLink") . $Language->TablePhrase("vw_spp_detail_pajak", "TblCaption");
		$body = "<a class=\"btn btn-default btn-sm ewRowLink ewDetail\" data-action=\"list\" href=\"" . ew_HtmlEncode("vw_spp_detail_pajaklist.php?" . EW_TABLE_SHOW_MASTER . "=vw_spp_gu_nihil_list&fk_id=" . urlencode(strval($this->id->CurrentValue)) . "&fk_id_jenis_spp=" . urlencode(strval($this->id_jenis_spp->CurrentValue)) . "&fk_detail_jenis_spp=" . urlencode(strval($this->detail_jenis_spp->CurrentValue)) . "&fk_no_spp=" . urlencode(strval($this->no_spp->CurrentValue)) . "") . "\">" . $body . "</a>";
		$links = "";
		if ($GLOBALS["vw_spp_detail_pajak_grid"] && $GLOBALS["vw_spp_detail_pajak_grid"]->DetailView && $Security->CanView() && $Security->AllowView(CurrentProjectID() . 'vw_spp_detail_pajak')) {
			$links .= "<li><a class=\"ewRowLink ewDetailView\" data-action=\"view\" data-caption=\"" . ew_HtmlTitle($Language->Phrase("MasterDetailViewLink")) . "\" href=\"" . ew_HtmlEncode($this->GetViewUrl(EW_TABLE_SHOW_DETAIL . "=vw_spp_detail_pajak")) . "\">" . ew_HtmlImageAndText($Language->Phrase("MasterDetailViewLink")) . "</a></li>";
			if ($DetailViewTblVar <> "") $DetailViewTblVar .= ",";
			$DetailViewTblVar .= "vw_spp_detail_pajak";
		}
		if ($GLOBALS["vw_spp_detail_pajak_grid"] && $GLOBALS["vw_spp_detail_pajak_grid"]->DetailEdit && $Security->CanEdit() && $Security->AllowEdit(CurrentProjectID() . 'vw_spp_detail_pajak')) {
			$links .= "<li><a class=\"ewRowLink ewDetailEdit\" data-action=\"edit\" data-caption=\"" . ew_HtmlTitle($Language->Phrase("MasterDetailEditLink")) . "\" href=\"" . ew_HtmlEncode($this->GetEditUrl(EW_TABLE_SHOW_DETAIL . "=vw_spp_detail_pajak")) . "\">" . ew_HtmlImageAndText($Language->Phrase("MasterDetailEditLink")) . "</a></li>";
		...
		$item->Body = $body;
		$item->Visible = $Security->AllowList(CurrentProjectID() . 'vw_spp_detail_pajak');
		if ($item->Visible) {
		...
		$item = &$option->Add("detail_vw_spp_ls_barang_jasa_detail");
		$body = $Language->Phrase("ViewPageDetailLink") . $Language->TablePhrase("vw_spp_ls_barang_jasa_detail", "TblCaption");
		$body = "<a class=\"btn btn-default btn-sm ewRowLink ewDetail\" data-action=\"list\" href=\"" . ew_HtmlEncode("vw_spp_ls_barang_jasa_detaillist.php?" . EW_TABLE_SHOW_MASTER . "=vw_spp_gu_nihil_list&fk_id=" . urlencode(strval($this->id->CurrentValue)) . "&fk_id_jenis_spp=" . urlencode(strval($this->id_jenis_spp->CurrentValue)) . "&fk_detail_jenis_spp=" . urlencode(strval($this->detail_jenis_spp->CurrentValue)) . "&fk_no_spp=" . urlencode(strval($this->no_spp->CurrentValue)) . "") . "\">" . $body . "</a>";
		$links = "";
		if ($GLOBALS["vw_spp_ls_barang_jasa_detail_grid"] && $GLOBALS["vw_spp_ls_barang_jasa_detail_grid"]->DetailView && $Security->CanView() && $Security->AllowView(CurrentProjectID() . 'vw_spp_ls_barang_jasa_detail')) {
			$links .= "<li><a class=\"ewRowLink ewDetailView\" data-action=\"view\" data-caption=\"" . ew_HtmlTitle($Language->Phrase("MasterDetailViewLink")) . "\" href=\"" . ew_HtmlEncode($this->GetViewUrl(EW_TABLE_SHOW_DETAIL . "=vw_spp_ls_barang_jasa_detail")) . "\">" . ew_HtmlImageAndText($Language->Phrase("MasterDetailViewLink")) . "</a></li>";
			if ($DetailViewTblVar <> "") $DetailViewTblVar .= ",";
			$DetailViewTblVar .= "vw_spp_ls_barang_jasa_detail";
		}
		if ($GLOBALS["vw_spp_ls_barang_jasa_detail_grid"] && $GLOBALS["vw_spp_ls_barang_jasa_detail_grid"]->DetailEdit && $Security->CanEdit() && $Security->AllowEdit(CurrentProjectID() . 'vw_spp_ls_barang_jasa_detail')) {
			$links .= "<li><a class=\"ewRowLink ewDetailEdit\" data-action=\"edit\" data-caption=\"" . ew_HtmlTitle($Language->Phrase("MasterDetailEditLink")) . "\" href=\"" . ew_HtmlEncode($this->GetEditUrl(EW_TABLE_SHOW_DETAIL . "=vw_spp_ls_barang_jasa_detail")) . "\">" . ew_HtmlImageAndText($Language->Phrase("MasterDetailEditLink")) . "</a></li>";
			if ($DetailEditTblVar <> "") $DetailEditTblVar .= ",";
		...
		$body = "<div class=\"btn-group\">" . $body . "</div>";
		$item->Body = $body;
		$item->Visible = $Security->AllowList(CurrentProjectID() . 'vw_spp_ls_barang_jasa_detail');
		if ($item->Visible) {
			if ($DetailTableLink <> "") $DetailTableLink .= ",";
	...
	function SetUpDetailParms() {
		...
		if ($sDetailTblVar <> "") {
			...
			if (in_array("vw_spp_detail_pajak", $DetailTblVar)) {
				...
				if ($GLOBALS["vw_spp_detail_pajak_grid"]->DetailView) {
					$GLOBALS["vw_spp_detail_pajak_grid"]->CurrentMode = "view";
			...
			if (in_array("vw_spp_ls_barang_jasa_detail", $DetailTblVar)) {
				...
				if ($GLOBALS["vw_spp_ls_barang_jasa_detail_grid"]->DetailView) {
					$GLOBALS["vw_spp_ls_barang_jasa_detail_grid"]->CurrentMode = "view";
...
// Create page object
if (!isset($vw_spp_gu_nihil_list_view)) $vw_spp_gu_nihil_list_view = new cvw_spp_gu_nihil_list_view();

// Page init
$vw_spp_gu_nihil_list_view->Page_Init();

// Page main
$vw_spp_gu_nihil_list_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$vw_spp_gu_nihil_list_view->Page_Render();
?>
...
var CurrentForm = fvw_spp_gu_nihil_listview = new ew_Form("fvw_spp_gu_nihil_listview", "view");

// Form_CustomValidate event
fvw_spp_gu_nihil_listview.Form_CustomValidate = 
...
fvw_spp_gu_nihil_listview.ValidateRequired = true;
<?php } else { ?>
fvw_spp_gu_nihil_listview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fvw_spp_gu_nihil_listview.Lists["x_id_jenis_spp"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_jenis_spp","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"l_jenis_spp"};
fvw_spp_gu_nihil_listview.Lists["x_detail_jenis_spp"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_detail_jenis_spp","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"l_jenis_detail_spp"};
fvw_spp_gu_nihil_listview.Lists["x_status_spp"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fvw_spp_gu_nihil_listview.Lists["x_status_spp"].Options = <?php echo json_encode($vw_spp_gu_nihil_list->status_spp->Options()) ?>;
fvw_spp_gu_nihil_listview.Lists["x_nama_bendahara"] = {"LinkField":"x_nama","Ajax":true,"AutoFill":false,"DisplayFields":["x_nama","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"m_pejabat_keuangan"};
fvw_spp_gu_nihil_listview.Lists["x_nama_pptk"] = {"LinkField":"x_nama","Ajax":true,"AutoFill":false,"DisplayFields":["x_nama","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"m_pejabat_keuangan"};
fvw_spp_gu_nihil_listview.Lists["x_kode_program"] = {"LinkField":"x_kode_program","Ajax":true,"AutoFill":false,"DisplayFields":["x_nama_program","","",""],"ParentFields":[],"ChildFields":["x_kode_kegiatan","x_kode_sub_kegiatan"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"m_program"};
fvw_spp_gu_nihil_listview.Lists["x_kode_kegiatan"] = {"LinkField":"x_kode_kegiatan","Ajax":true,"AutoFill":false,"DisplayFields":["x_nama_kegiatan","","",""],"ParentFields":[],"ChildFields":["x_kode_sub_kegiatan"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"m_kegiatan"};
fvw_spp_gu_nihil_listview.Lists["x_kode_sub_kegiatan"] = {"LinkField":"x_kode_sub_kegiatan","Ajax":true,"AutoFill":false,"DisplayFields":["x_nama_sub_kegiatan","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"m_sub_kegiatan"};
...
<?php if (!$vw_spp_gu_nihil_list_view->IsModal) { ?>
<?php } ?>
<?php $vw_spp_gu_nihil_list_view->ExportOptions->Render("body") ?>
<?php
	foreach ($vw_spp_gu_nihil_list_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$vw_spp_gu_nihil_list_view->IsModal) { ?>
...
<?php $vw_spp_gu_nihil_list_view->ShowPageHeader(); ?>
<?php
$vw_spp_gu_nihil_list_view->ShowMessage();
?>
<form name="fvw_spp_gu_nihil_listview" id="fvw_spp_gu_nihil_listview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($vw_spp_gu_nihil_list_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $vw_spp_gu_nihil_list_view->Token ?>">
<?php } ?>
...
<?php if ($vw_spp_gu_nihil_list->id->Visible) { // id ?>
	<tr id="r_id">
		<td><span id="elh_vw_spp_gu_nihil_list_id"><?php echo $vw_spp_gu_nihil_list->id->FldCaption() ?></span></td>
...
<?php echo $vw_spp_gu_nihil_list->id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($vw_spp_gu_nihil_list->id_jenis_spp->Visible) { // id_jenis_spp ?>
	<tr id="r_id_jenis_spp">
		<td><span id="elh_vw_spp_gu_nihil_list_id_jenis_spp"><?php echo $vw_spp_gu_nihil_list->id_jenis_spp->FldCaption() ?></span></td>
		<td data-name="id_jenis_spp"<?php echo $vw_spp_gu_nihil_list->id_jenis_spp->CellAttributes() ?>>
<span id="el_vw_spp_gu_nihil_list_id_jenis_spp">
<span<?php echo $vw_spp_gu_nihil_list->id_jenis_spp->ViewAttributes() ?>>
<?php echo $vw_spp_gu_nihil_list->id_jenis_spp->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($vw_spp_gu_nihil_list->detail_jenis_spp->Visible) { // detail_jenis_spp ?>
	<tr id="r_detail_jenis_spp">
		<td><span id="elh_vw_spp_gu_nihil_list_detail_jenis_spp"><?php echo $vw_spp_gu_nihil_list->detail_jenis_spp->FldCaption() ?></span></td>
		<td data-name="detail_jenis_spp"<?php echo $vw_spp_gu_nihil_list->detail_jenis_spp->CellAttributes() ?>>
<span id="el_vw_spp_gu_nihil_list_detail_jenis_spp">
<span<?php echo $vw_spp_gu_nihil_list->detail_jenis_spp->ViewAttributes() ?>>
<?php echo $vw_spp_gu_nihil_list->detail_jenis_spp->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($vw_spp_gu_nihil_list->status_spp->Visible) { // status_spp ?>
	<tr id="r_status_spp">
		<td><span id="elh_vw_spp_gu_nihil_list_status_spp"><?php echo $vw_spp_gu_nihil_list->status_spp->FldCaption() ?></span></td>
...
<?php echo $vw_spp_gu_nihil_list->status_spp->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($vw_spp_gu_nihil_list->no_spp->Visible) { // no_spp ?>
	<tr id="r_no_spp">
		<td><span id="elh_vw_spp_gu_nihil_list_no_spp"><?php echo $vw_spp_gu_nihil_list->no_spp->FldCaption() ?></span></td>
...
<?php echo $vw_spp_gu_nihil_list->no_spp->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($vw_spp_gu_nihil_list->tgl_spp->Visible) { // tgl_spp ?>
	<tr id="r_tgl_spp">
		<td><span id="elh_vw_spp_gu_nihil_list_tgl_spp"><?php echo $vw_spp_gu_nihil_list->tgl_spp->FldCaption() ?></span></td>
...
<?php echo $vw_spp_gu_nihil_list->tgl_spp->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($vw_spp_gu_nihil_list->keterangan->Visible) { // keterangan ?>
	<tr id="r_keterangan">
		<td><span id="elh_vw_spp_gu_nihil_list_keterangan"><?php echo $vw_spp_gu_nihil_list->keterangan->FldCaption() ?></span></td>
...
<?php echo $vw_spp_gu_nihil_list->keterangan->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($vw_spp_gu_nihil_list->nama_bendahara->Visible) { // nama_bendahara ?>
	<tr id="r_nama_bendahara">
		<td><span id="elh_vw_spp_gu_nihil_list_nama_bendahara"><?php echo $vw_spp_gu_nihil_list->nama_bendahara->FldCaption() ?></span></td>
		<td data-name="nama_bendahara"<?php echo $vw_spp_gu_nihil_list->nama_bendahara->CellAttributes() ?>>
<span id="el_vw_spp_gu_nihil_list_nama_bendahara">
<span<?php echo $vw_spp_gu_nihil_list->nama_bendahara->ViewAttributes() ?>>
<?php echo $vw_spp_gu_nihil_list->nama_bendahara->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($vw_spp_gu_nihil_list->nip_bendahara->Visible) { // nip_bendahara ?>
	<tr id="r_nip_bendahara">
		<td><span id="elh_vw_spp_gu_nihil_list_nip_bendahara"><?php echo $vw_spp_gu_nihil_list->nip_bendahara->FldCaption() ?></span></td>
		<td data-name="nip_bendahara"<?php echo $vw_spp_gu_nihil_list->nip_bendahara->CellAttributes() ?>>
<span id="el_vw_spp_gu_nihil_list_nip_bendahara">
<span<?php echo $vw_spp_gu_nihil_list->nip_bendahara->ViewAttributes() ?>>
<?php echo $vw_spp_gu_nihil_list->nip_bendahara->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($vw_spp_gu_nihil_list->nama_pptk->Visible) { // nama_pptk ?>
	<tr id="r_nama_pptk">
		<td><span id="elh_vw_spp_gu_nihil_list_nama_pptk"><?php echo $vw_spp_gu_nihil_list->nama_pptk->FldCaption() ?></span></td>
		<td data-name="nama_pptk"<?php echo $vw_spp_gu_nihil_list->nama_pptk->CellAttributes() ?>>
<span id="el_vw_spp_gu_nihil_list_nama_pptk">
<span<?php echo $vw_spp_gu_nihil_list->nama_pptk->ViewAttributes() ?>>
<?php echo $vw_spp_gu_nihil_list->nama_pptk->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($vw_spp_gu_nihil_list->nip_pptk->Visible) { // nip_pptk ?>
	<tr id="r_nip_pptk">
		<td><span id="elh_vw_spp_gu_nihil_list_nip_pptk"><?php echo $vw_spp_gu_nihil_list->nip_pptk->FldCaption() ?></span></td>
		<td data-name="nip_pptk"<?php echo $vw_spp_gu_nihil_list->nip_pptk->CellAttributes() ?>>
<span id="el_vw_spp_gu_nihil_list_nip_pptk">
<span<?php echo $vw_spp_gu_nihil_list->nip_pptk->ViewAttributes() ?>>
<?php echo $vw_spp_gu_nihil_list->nip_pptk->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($vw_spp_gu_nihil_list->kode_program->Visible) { // kode_program ?>
	<tr id="r_kode_program">
		<td><span id="elh_vw_spp_gu_nihil_list_kode_program"><?php echo $vw_spp_gu_nihil_list->kode_program->FldCaption() ?></span></td>
		<td data-name="kode_program"<?php echo $vw_spp_gu_nihil_list->kode_program->CellAttributes() ?>>
<span id="el_vw_spp_gu_nihil_list_kode_program">
<span<?php echo $vw_spp_gu_nihil_list->kode_program->ViewAttributes() ?>>
<?php echo $vw_spp_gu_nihil_list->kode_program->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($vw_spp_gu_nihil_list->kode_kegiatan->Visible) { // kode_kegiatan ?>
	<tr id="r_kode_kegiatan">
		<td><span id="elh_vw_spp_gu_nihil_list_kode_kegiatan"><?php echo $vw_spp_gu_nihil_list->kode_kegiatan->FldCaption() ?></span></td>
		<td data-name="kode_kegiatan"<?php echo $vw_spp_gu_nihil_list->kode_kegiatan->CellAttributes() ?>>
<span id="el_vw_spp_gu_nihil_list_kode_kegiatan">
<span<?php echo $vw_spp_gu_nihil_list->kode_kegiatan->ViewAttributes() ?>>
<?php echo $vw_spp_gu_nihil_list->kode_kegiatan->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($vw_spp_gu_nihil_list->kode_sub_kegiatan->Visible) { // kode_sub_kegiatan ?>
	<tr id="r_kode_sub_kegiatan">
		<td><span id="elh_vw_spp_gu_nihil_list_kode_sub_kegiatan"><?php echo $vw_spp_gu_nihil_list->kode_sub_kegiatan->FldCaption() ?></span></td>
		<td data-name="kode_sub_kegiatan"<?php echo $vw_spp_gu_nihil_list->kode_sub_kegiatan->CellAttributes() ?>>
<span id="el_vw_spp_gu_nihil_list_kode_sub_kegiatan">
<span<?php echo $vw_spp_gu_nihil_list->kode_sub_kegiatan->ViewAttributes() ?>>
<?php echo $vw_spp_gu_nihil_list->kode_sub_kegiatan->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php
	if (in_array("vw_spp_detail_pajak", explode(",", $vw_spp_gu_nihil_list->getCurrentDetailTable())) && $vw_spp_detail_pajak->DetailView) {
?>
...
<?php } ?>
<?php
	if (in_array("vw_spp_ls_barang_jasa_detail", explode(",", $vw_spp_gu_nihil_list->getCurrentDetailTable())) && $vw_spp_ls_barang_jasa_detail->DetailView) {
?>
<?php if ($vw_spp_gu_nihil_list->getCurrentDetailTable() <> "") { ?>
...
<script type="text/javascript">
fvw_spp_gu_nihil_listview.Init();
</script>
<?php
$vw_spp_gu_nihil_list_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$vw_spp_gu_nihil_list_view->Page_Terminate();
?>
