...
//
// Table class for m_blud_rs
//
class cm_blud_rs extends cTable {
	var $id;
	var $direktur;
	var $nip;
	var $jabatan_keuangan;
	var $rekening;
	var $nomer_rekening;
	var $npwp;
	var $bendahara_keuangan;
	var $nip_bendahara_keuangan;
	...
	function __construct() {
		...
		$this->TableVar = 'm_blud_rs';
		$this->TableName = 'm_blud_rs';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`m_blud_rs`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('m_blud_rs', 'm_blud_rs', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// direktur
		$this->direktur = new cField('m_blud_rs', 'm_blud_rs', 'x_direktur', 'direktur', '`direktur`', '`direktur`', 200, -1, FALSE, '`direktur`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->direktur->Sortable = TRUE; // Allow sort
		$this->fields['direktur'] = &$this->direktur;

		// nip
		$this->nip = new cField('m_blud_rs', 'm_blud_rs', 'x_nip', 'nip', '`nip`', '`nip`', 200, -1, FALSE, '`nip`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->nip->Sortable = TRUE; // Allow sort
		$this->fields['nip'] = &$this->nip;

		// jabatan_keuangan
		$this->jabatan_keuangan = new cField('m_blud_rs', 'm_blud_rs', 'x_jabatan_keuangan', 'jabatan_keuangan', '`jabatan_keuangan`', '`jabatan_keuangan`', 200, -1, FALSE, '`jabatan_keuangan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->jabatan_keuangan->Sortable = TRUE; // Allow sort
		$this->fields['jabatan_keuangan'] = &$this->jabatan_keuangan;

		// rekening
		$this->rekening = new cField('m_blud_rs', 'm_blud_rs', 'x_rekening', 'rekening', '`rekening`', '`rekening`', 200, -1, FALSE, '`rekening`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->rekening->Sortable = TRUE; // Allow sort
		$this->fields['rekening'] = &$this->rekening;

		// nomer_rekening
		$this->nomer_rekening = new cField('m_blud_rs', 'm_blud_rs', 'x_nomer_rekening', 'nomer_rekening', '`nomer_rekening`', '`nomer_rekening`', 200, -1, FALSE, '`nomer_rekening`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->nomer_rekening->Sortable = TRUE; // Allow sort
		$this->fields['nomer_rekening'] = &$this->nomer_rekening;

		// npwp
		$this->npwp = new cField('m_blud_rs', 'm_blud_rs', 'x_npwp', 'npwp', '`npwp`', '`npwp`', 200, -1, FALSE, '`npwp`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->npwp->Sortable = TRUE; // Allow sort
		$this->fields['npwp'] = &$this->npwp;

		// bendahara_keuangan
		$this->bendahara_keuangan = new cField('m_blud_rs', 'm_blud_rs', 'x_bendahara_keuangan', 'bendahara_keuangan', '`bendahara_keuangan`', '`bendahara_keuangan`', 200, -1, FALSE, '`bendahara_keuangan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->bendahara_keuangan->Sortable = TRUE; // Allow sort
		$this->fields['bendahara_keuangan'] = &$this->bendahara_keuangan;

		// nip_bendahara_keuangan
		$this->nip_bendahara_keuangan = new cField('m_blud_rs', 'm_blud_rs', 'x_nip_bendahara_keuangan', 'nip_bendahara_keuangan', '`nip_bendahara_keuangan`', '`nip_bendahara_keuangan`', 200, -1, FALSE, '`nip_bendahara_keuangan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->nip_bendahara_keuangan->Sortable = TRUE; // Allow sort
		$this->fields['nip_bendahara_keuangan'] = &$this->nip_bendahara_keuangan;
	}
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`m_blud_rs`";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("m_blud_rsview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("m_blud_rsview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "m_blud_rsadd.php?" . $this->UrlParm($parm);
		else
			$url = "m_blud_rsadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("m_blud_rsedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("m_blud_rsadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("m_blud_rsdelete.php", $this->UrlParm());
	}
   ...
   // Common render codes
	...
	function RenderEditRow() {
		...
		$this->direktur->EditValue = $this->direktur->CurrentValue;
		...
		$this->jabatan_keuangan->EditValue = $this->jabatan_keuangan->CurrentValue;
		...
		$this->bendahara_keuangan->EditValue = $this->bendahara_keuangan->CurrentValue;
		...
		$this->nip_bendahara_keuangan->EditValue = $this->nip_bendahara_keuangan->CurrentValue;
		...
		if (!$Doc->ExportCustom) {
			...
			if ($Doc->Horizontal) { // Horizontal format, write header
				...
				if ($ExportPageType == "view") {
					...
					if ($this->direktur->Exportable) $Doc->ExportCaption($this->direktur);
					if ($this->nip->Exportable) $Doc->ExportCaption($this->nip);
					if ($this->jabatan_keuangan->Exportable) $Doc->ExportCaption($this->jabatan_keuangan);
					...
					if ($this->bendahara_keuangan->Exportable) $Doc->ExportCaption($this->bendahara_keuangan);
					if ($this->nip_bendahara_keuangan->Exportable) $Doc->ExportCaption($this->nip_bendahara_keuangan);
				} else {
					if ($this->id->Exportable) $Doc->ExportCaption($this->id);
					if ($this->direktur->Exportable) $Doc->ExportCaption($this->direktur);
					if ($this->nip->Exportable) $Doc->ExportCaption($this->nip);
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if (!$Doc->ExportCustom) {
					...
					if ($ExportPageType == "view") {
						...
						if ($this->direktur->Exportable) $Doc->ExportField($this->direktur);
						if ($this->nip->Exportable) $Doc->ExportField($this->nip);
						if ($this->jabatan_keuangan->Exportable) $Doc->ExportField($this->jabatan_keuangan);
						...
						if ($this->bendahara_keuangan->Exportable) $Doc->ExportField($this->bendahara_keuangan);
						if ($this->nip_bendahara_keuangan->Exportable) $Doc->ExportField($this->nip_bendahara_keuangan);
					} else {
						if ($this->id->Exportable) $Doc->ExportField($this->id);
						if ($this->direktur->Exportable) $Doc->ExportField($this->direktur);
						if ($this->nip->Exportable) $Doc->ExportField($this->nip);
