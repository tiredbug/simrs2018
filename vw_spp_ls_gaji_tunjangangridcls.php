...
$vw_spp_ls_gaji_tunjangan_grid = NULL; // Initialize page object first

class cvw_spp_ls_gaji_tunjangan_grid extends cvw_spp_ls_gaji_tunjangan {
	...
	// Page object name
	var $PageObjName = 'vw_spp_ls_gaji_tunjangan_grid';

	// Grid form hidden field names
	var $FormName = 'fvw_spp_ls_gaji_tunjangangrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["vw_spp_ls_gaji_tunjangan"];

		}
		$this->AddUrl = "vw_spp_ls_gaji_tunjanganadd.php";
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function EmptyRow() {
		global $objForm;
		if ($objForm->HasValue("x_status_spp") && $objForm->HasValue("o_status_spp") && $this->status_spp->CurrentValue <> $this->status_spp->OldValue)
			return FALSE;
		if ($objForm->HasValue("x_no_spp") && $objForm->HasValue("o_no_spp") && $this->no_spp->CurrentValue <> $this->no_spp->OldValue)
			return FALSE;
		if ($objForm->HasValue("x_tgl_spp") && $objForm->HasValue("o_tgl_spp") && $this->tgl_spp->CurrentValue <> $this->tgl_spp->OldValue)
			return FALSE;
	...
	function LoadFormValues() {
		...
		$this->status_spp->setOldValue($objForm->GetValue("o_status_spp"));
		if (!$this->no_spp->FldIsDetailKey) {
			$this->no_spp->setFormValue($objForm->GetValue("x_no_spp"));
		}
		$this->no_spp->setOldValue($objForm->GetValue("o_no_spp"));
		...
		$this->tgl_spp->setOldValue($objForm->GetValue("o_tgl_spp"));
	...
	function SetUpMasterParms() {
		...
		if ($sMasterTblVar == "l_jenis_detail_spp") {
			...
			if ($GLOBALS["l_jenis_detail_spp"]->EventCancelled) $this->EventCancelled = TRUE;
