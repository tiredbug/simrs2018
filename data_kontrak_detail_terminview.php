...
$data_kontrak_detail_termin_view = NULL; // Initialize page object first

class cdata_kontrak_detail_termin_view extends cdata_kontrak_detail_termin {
	...
	// Page object name
	var $PageObjName = 'data_kontrak_detail_termin_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["id"] <> "") {
				...
				$sReturnUrl = "data_kontrak_detail_terminlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "data_kontrak_detail_terminlist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "data_kontrak_detail_terminlist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($data_kontrak_detail_termin_view)) $data_kontrak_detail_termin_view = new cdata_kontrak_detail_termin_view();

// Page init
$data_kontrak_detail_termin_view->Page_Init();

// Page main
$data_kontrak_detail_termin_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$data_kontrak_detail_termin_view->Page_Render();
?>
...
var CurrentForm = fdata_kontrak_detail_terminview = new ew_Form("fdata_kontrak_detail_terminview", "view");

// Form_CustomValidate event
fdata_kontrak_detail_terminview.Form_CustomValidate = 
...
fdata_kontrak_detail_terminview.ValidateRequired = true;
<?php } else { ?>
fdata_kontrak_detail_terminview.ValidateRequired = false; 
<?php } ?>
...
<?php if (!$data_kontrak_detail_termin_view->IsModal) { ?>
<?php } ?>
<?php $data_kontrak_detail_termin_view->ExportOptions->Render("body") ?>
<?php
	foreach ($data_kontrak_detail_termin_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$data_kontrak_detail_termin_view->IsModal) { ?>
...
<?php $data_kontrak_detail_termin_view->ShowPageHeader(); ?>
<?php
$data_kontrak_detail_termin_view->ShowMessage();
?>
<form name="fdata_kontrak_detail_terminview" id="fdata_kontrak_detail_terminview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($data_kontrak_detail_termin_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $data_kontrak_detail_termin_view->Token ?>">
<?php } ?>
...
<?php if ($data_kontrak_detail_termin->id->Visible) { // id ?>
	<tr id="r_id">
		<td><span id="elh_data_kontrak_detail_termin_id"><?php echo $data_kontrak_detail_termin->id->FldCaption() ?></span></td>
...
<?php echo $data_kontrak_detail_termin->id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($data_kontrak_detail_termin->terminke->Visible) { // terminke ?>
	<tr id="r_terminke">
		<td><span id="elh_data_kontrak_detail_termin_terminke"><?php echo $data_kontrak_detail_termin->terminke->FldCaption() ?></span></td>
...
<?php echo $data_kontrak_detail_termin->terminke->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($data_kontrak_detail_termin->target_fisik->Visible) { // target_fisik ?>
	<tr id="r_target_fisik">
		<td><span id="elh_data_kontrak_detail_termin_target_fisik"><?php echo $data_kontrak_detail_termin->target_fisik->FldCaption() ?></span></td>
...
<?php echo $data_kontrak_detail_termin->target_fisik->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($data_kontrak_detail_termin->nilai->Visible) { // nilai ?>
	<tr id="r_nilai">
		<td><span id="elh_data_kontrak_detail_termin_nilai"><?php echo $data_kontrak_detail_termin->nilai->FldCaption() ?></span></td>
...
<?php echo $data_kontrak_detail_termin->nilai->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($data_kontrak_detail_termin->id_detail->Visible) { // id_detail ?>
	<tr id="r_id_detail">
		<td><span id="elh_data_kontrak_detail_termin_id_detail"><?php echo $data_kontrak_detail_termin->id_detail->FldCaption() ?></span></td>
...
<?php echo $data_kontrak_detail_termin->id_detail->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
fdata_kontrak_detail_terminview.Init();
</script>
<?php
$data_kontrak_detail_termin_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$data_kontrak_detail_termin_view->Page_Terminate();
?>
