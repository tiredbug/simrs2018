...
$vw_bridging_sep_by_no_rujukan_delete = NULL; // Initialize page object first

class cvw_bridging_sep_by_no_rujukan_delete extends cvw_bridging_sep_by_no_rujukan {
	...
	// Page object name
	var $PageObjName = 'vw_bridging_sep_by_no_rujukan_delete';
	...
	function Page_Main() {
		...
		if ($sFilter == "")
			$this->Page_Terminate("vw_bridging_sep_by_no_rujukanlist.php"); // Prevent SQL injection, return to list

		// Set up filter (SQL WHHERE clause) and get return SQL
		// SQL constructor in vw_bridging_sep_by_no_rujukan class, vw_bridging_sep_by_no_rujukaninfo.php
		...
		if ($this->CurrentAction == "I") { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->Page_Terminate("vw_bridging_sep_by_no_rujukanlist.php"); // Return to list
			}
		}
	}
...
// Create page object
if (!isset($vw_bridging_sep_by_no_rujukan_delete)) $vw_bridging_sep_by_no_rujukan_delete = new cvw_bridging_sep_by_no_rujukan_delete();

// Page init
$vw_bridging_sep_by_no_rujukan_delete->Page_Init();

// Page main
$vw_bridging_sep_by_no_rujukan_delete->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$vw_bridging_sep_by_no_rujukan_delete->Page_Render();
?>
...
var CurrentForm = fvw_bridging_sep_by_no_rujukandelete = new ew_Form("fvw_bridging_sep_by_no_rujukandelete", "delete");

// Form_CustomValidate event
fvw_bridging_sep_by_no_rujukandelete.Form_CustomValidate = 
...
fvw_bridging_sep_by_no_rujukandelete.ValidateRequired = true;
<?php } else { ?>
fvw_bridging_sep_by_no_rujukandelete.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fvw_bridging_sep_by_no_rujukandelete.Lists["x_NOMR"] = {"LinkField":"x_NOMR","Ajax":true,"AutoFill":false,"DisplayFields":["x_NOMR","x_NAMA","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"m_pasien"};
fvw_bridging_sep_by_no_rujukandelete.Lists["x_KDCARABAYAR"] = {"LinkField":"x_KODE","Ajax":true,"AutoFill":false,"DisplayFields":["x_NAMA","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"m_carabayar"};
...
<?php $vw_bridging_sep_by_no_rujukan_delete->ShowPageHeader(); ?>
<?php
$vw_bridging_sep_by_no_rujukan_delete->ShowMessage();
?>
<form name="fvw_bridging_sep_by_no_rujukandelete" id="fvw_bridging_sep_by_no_rujukandelete" class="form-inline ewForm ewDeleteForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($vw_bridging_sep_by_no_rujukan_delete->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $vw_bridging_sep_by_no_rujukan_delete->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="vw_bridging_sep_by_no_rujukan">
<input type="hidden" name="a_delete" id="a_delete" value="D">
<?php foreach ($vw_bridging_sep_by_no_rujukan_delete->RecKeys as $key) { ?>
...
<?php if ($vw_bridging_sep_by_no_rujukan->IDXDAFTAR->Visible) { // IDXDAFTAR ?>
		<th><span id="elh_vw_bridging_sep_by_no_rujukan_IDXDAFTAR" class="vw_bridging_sep_by_no_rujukan_IDXDAFTAR"><?php echo $vw_bridging_sep_by_no_rujukan->IDXDAFTAR->FldCaption() ?></span></th>
<?php } ?>
<?php if ($vw_bridging_sep_by_no_rujukan->NOMR->Visible) { // NOMR ?>
		<th><span id="elh_vw_bridging_sep_by_no_rujukan_NOMR" class="vw_bridging_sep_by_no_rujukan_NOMR"><?php echo $vw_bridging_sep_by_no_rujukan->NOMR->FldCaption() ?></span></th>
<?php } ?>
<?php if ($vw_bridging_sep_by_no_rujukan->KDCARABAYAR->Visible) { // KDCARABAYAR ?>
		<th><span id="elh_vw_bridging_sep_by_no_rujukan_KDCARABAYAR" class="vw_bridging_sep_by_no_rujukan_KDCARABAYAR"><?php echo $vw_bridging_sep_by_no_rujukan->KDCARABAYAR->FldCaption() ?></span></th>
<?php } ?>
<?php if ($vw_bridging_sep_by_no_rujukan->NIP->Visible) { // NIP ?>
		<th><span id="elh_vw_bridging_sep_by_no_rujukan_NIP" class="vw_bridging_sep_by_no_rujukan_NIP"><?php echo $vw_bridging_sep_by_no_rujukan->NIP->FldCaption() ?></span></th>
<?php } ?>
<?php if ($vw_bridging_sep_by_no_rujukan->JAMREG->Visible) { // JAMREG ?>
		<th><span id="elh_vw_bridging_sep_by_no_rujukan_JAMREG" class="vw_bridging_sep_by_no_rujukan_JAMREG"><?php echo $vw_bridging_sep_by_no_rujukan->JAMREG->FldCaption() ?></span></th>
<?php } ?>
<?php if ($vw_bridging_sep_by_no_rujukan->NO_SJP->Visible) { // NO_SJP ?>
		<th><span id="elh_vw_bridging_sep_by_no_rujukan_NO_SJP" class="vw_bridging_sep_by_no_rujukan_NO_SJP"><?php echo $vw_bridging_sep_by_no_rujukan->NO_SJP->FldCaption() ?></span></th>
<?php } ?>
<?php if ($vw_bridging_sep_by_no_rujukan->NORUJUKAN_SEP->Visible) { // NORUJUKAN_SEP ?>
		<th><span id="elh_vw_bridging_sep_by_no_rujukan_NORUJUKAN_SEP" class="vw_bridging_sep_by_no_rujukan_NORUJUKAN_SEP"><?php echo $vw_bridging_sep_by_no_rujukan->NORUJUKAN_SEP->FldCaption() ?></span></th>
<?php } ?>
<?php if ($vw_bridging_sep_by_no_rujukan->USER->Visible) { // USER ?>
		<th><span id="elh_vw_bridging_sep_by_no_rujukan_USER" class="vw_bridging_sep_by_no_rujukan_USER"><?php echo $vw_bridging_sep_by_no_rujukan->USER->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
<?php
$vw_bridging_sep_by_no_rujukan_delete->RecCnt = 0;
$i = 0;
while (!$vw_bridging_sep_by_no_rujukan_delete->Recordset->EOF) {
	$vw_bridging_sep_by_no_rujukan_delete->RecCnt++;
	$vw_bridging_sep_by_no_rujukan_delete->RowCnt++;

	// Set row properties
	$vw_bridging_sep_by_no_rujukan->ResetAttrs();
	$vw_bridging_sep_by_no_rujukan->RowType = EW_ROWTYPE_VIEW; // View

	// Get the field contents
	$vw_bridging_sep_by_no_rujukan_delete->LoadRowValues($vw_bridging_sep_by_no_rujukan_delete->Recordset);

	// Render row
	$vw_bridging_sep_by_no_rujukan_delete->RenderRow();
?>
	<tr<?php echo $vw_bridging_sep_by_no_rujukan->RowAttributes() ?>>
<?php if ($vw_bridging_sep_by_no_rujukan->IDXDAFTAR->Visible) { // IDXDAFTAR ?>
		<td<?php echo $vw_bridging_sep_by_no_rujukan->IDXDAFTAR->CellAttributes() ?>>
<div id="orig<?php echo $vw_bridging_sep_by_no_rujukan_delete->RowCnt ?>_vw_bridging_sep_by_no_rujukan_IDXDAFTAR" class="hide">
<span id="el<?php echo $vw_bridging_sep_by_no_rujukan_delete->RowCnt ?>_vw_bridging_sep_by_no_rujukan_IDXDAFTAR" class="vw_bridging_sep_by_no_rujukan_IDXDAFTAR">
...
<?php } ?>
<?php if ($vw_bridging_sep_by_no_rujukan->NOMR->Visible) { // NOMR ?>
		<td<?php echo $vw_bridging_sep_by_no_rujukan->NOMR->CellAttributes() ?>>
<span id="el<?php echo $vw_bridging_sep_by_no_rujukan_delete->RowCnt ?>_vw_bridging_sep_by_no_rujukan_NOMR" class="vw_bridging_sep_by_no_rujukan_NOMR">
...
<?php } ?>
<?php if ($vw_bridging_sep_by_no_rujukan->KDCARABAYAR->Visible) { // KDCARABAYAR ?>
		<td<?php echo $vw_bridging_sep_by_no_rujukan->KDCARABAYAR->CellAttributes() ?>>
<span id="el<?php echo $vw_bridging_sep_by_no_rujukan_delete->RowCnt ?>_vw_bridging_sep_by_no_rujukan_KDCARABAYAR" class="vw_bridging_sep_by_no_rujukan_KDCARABAYAR">
...
<?php } ?>
<?php if ($vw_bridging_sep_by_no_rujukan->NIP->Visible) { // NIP ?>
		<td<?php echo $vw_bridging_sep_by_no_rujukan->NIP->CellAttributes() ?>>
<span id="el<?php echo $vw_bridging_sep_by_no_rujukan_delete->RowCnt ?>_vw_bridging_sep_by_no_rujukan_NIP" class="vw_bridging_sep_by_no_rujukan_NIP">
...
<?php } ?>
<?php if ($vw_bridging_sep_by_no_rujukan->JAMREG->Visible) { // JAMREG ?>
		<td<?php echo $vw_bridging_sep_by_no_rujukan->JAMREG->CellAttributes() ?>>
<span id="el<?php echo $vw_bridging_sep_by_no_rujukan_delete->RowCnt ?>_vw_bridging_sep_by_no_rujukan_JAMREG" class="vw_bridging_sep_by_no_rujukan_JAMREG">
...
<?php } ?>
<?php if ($vw_bridging_sep_by_no_rujukan->NO_SJP->Visible) { // NO_SJP ?>
		<td<?php echo $vw_bridging_sep_by_no_rujukan->NO_SJP->CellAttributes() ?>>
<span id="el<?php echo $vw_bridging_sep_by_no_rujukan_delete->RowCnt ?>_vw_bridging_sep_by_no_rujukan_NO_SJP" class="vw_bridging_sep_by_no_rujukan_NO_SJP">
...
<?php } ?>
<?php if ($vw_bridging_sep_by_no_rujukan->NORUJUKAN_SEP->Visible) { // NORUJUKAN_SEP ?>
		<td<?php echo $vw_bridging_sep_by_no_rujukan->NORUJUKAN_SEP->CellAttributes() ?>>
<span id="el<?php echo $vw_bridging_sep_by_no_rujukan_delete->RowCnt ?>_vw_bridging_sep_by_no_rujukan_NORUJUKAN_SEP" class="vw_bridging_sep_by_no_rujukan_NORUJUKAN_SEP">
...
<?php } ?>
<?php if ($vw_bridging_sep_by_no_rujukan->USER->Visible) { // USER ?>
		<td<?php echo $vw_bridging_sep_by_no_rujukan->USER->CellAttributes() ?>>
<span id="el<?php echo $vw_bridging_sep_by_no_rujukan_delete->RowCnt ?>_vw_bridging_sep_by_no_rujukan_USER" class="vw_bridging_sep_by_no_rujukan_USER">
...
<?php
	$vw_bridging_sep_by_no_rujukan_delete->Recordset->MoveNext();
}
$vw_bridging_sep_by_no_rujukan_delete->Recordset->Close();
?>
</tbody>
</table>
</div>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $vw_bridging_sep_by_no_rujukan_delete->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
</div>
</form>
<script type="text/javascript">
fvw_bridging_sep_by_no_rujukandelete.Init();
</script>
<?php
$vw_bridging_sep_by_no_rujukan_delete->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$vw_bridging_sep_by_no_rujukan_delete->Page_Terminate();
?>
