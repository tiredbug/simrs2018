...
//
// Table class for keu_akun3
//
class ckeu_akun3 extends cTable {
	var $id;
	var $kd_akun;
	var $kel1;
	var $kel2;
	...
	function __construct() {
		...
		$this->TableVar = 'keu_akun3';
		$this->TableName = 'keu_akun3';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`keu_akun3`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('keu_akun3', 'keu_akun3', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// kd_akun
		$this->kd_akun = new cField('keu_akun3', 'keu_akun3', 'x_kd_akun', 'kd_akun', '`kd_akun`', '`kd_akun`', 200, -1, FALSE, '`kd_akun`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->kd_akun->Sortable = TRUE; // Allow sort
		$this->fields['kd_akun'] = &$this->kd_akun;

		// kel1
		$this->kel1 = new cField('keu_akun3', 'keu_akun3', 'x_kel1', 'kel1', '`kel1`', '`kel1`', 200, -1, FALSE, '`kel1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->kel1->Sortable = TRUE; // Allow sort
		$this->fields['kel1'] = &$this->kel1;

		// kel2
		$this->kel2 = new cField('keu_akun3', 'keu_akun3', 'x_kel2', 'kel2', '`kel2`', '`kel2`', 200, -1, FALSE, '`kel2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->kel2->Sortable = TRUE; // Allow sort
		$this->fields['kel2'] = &$this->kel2;

		// kel3
		$this->kel3 = new cField('keu_akun3', 'keu_akun3', 'x_kel3', 'kel3', '`kel3`', '`kel3`', 200, -1, FALSE, '`kel3`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->kel3->Sortable = TRUE; // Allow sort
		$this->fields['kel3'] = &$this->kel3;

		// nmkel3
		$this->nmkel3 = new cField('keu_akun3', 'keu_akun3', 'x_nmkel3', 'nmkel3', '`nmkel3`', '`nmkel3`', 200, -1, FALSE, '`nmkel3`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->nmkel3->Sortable = TRUE; // Allow sort
		$this->fields['nmkel3'] = &$this->nmkel3;

		// kode_akun2
		$this->kode_akun2 = new cField('keu_akun3', 'keu_akun3', 'x_kode_akun2', 'kode_akun2', '`kode_akun2`', '`kode_akun2`', 3, -1, FALSE, '`kode_akun2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->kode_akun2->Sortable = TRUE; // Allow sort
		$this->kode_akun2->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['kode_akun2'] = &$this->kode_akun2;
	}
	...
	function GetMasterFilter() {
		...
		// Master filter
		$sMasterFilter = "";
		if ($this->getCurrentMasterTable() == "keu_akun2") {
	...
	// Master filter
	function SqlMasterFilter_keu_akun2() {
		return "`kel1`='@kel1@' AND `kel2`='@kel2@'";
	}

	// Detail filter
	function SqlDetailFilter_keu_akun2() {
		return "`kel1`='@kel1@' AND `kel2`='@kel2@'";
	}
	...
	function GetDetailUrl() {
		...
		// Detail url
		$sDetailUrl = "";
		if ($this->getCurrentDetailTable() == "keu_akun4") {
			$sDetailUrl = $GLOBALS["keu_akun4"]->GetListUrl() . "?" . EW_TABLE_SHOW_MASTER . "=" . $this->TableVar;
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`keu_akun3`";
	}
	...
	function getSqlWhere() { // Where
		...
		$this->TableFilter = "`kel3` IS NOT NULL";
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("keu_akun3view.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("keu_akun3view.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "keu_akun3add.php?" . $this->UrlParm($parm);
		else
			$url = "keu_akun3add.php";
		return $this->AddMasterUrl($url);
	}
	...
	function GetEditUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("keu_akun3edit.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("keu_akun3edit.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("keu_akun3add.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("keu_akun3add.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("keu_akun3delete.php", $this->UrlParm());
	}

	// Add master url
	function AddMasterUrl($url) {
		if ($this->getCurrentMasterTable() == "keu_akun2" && strpos($url, EW_TABLE_SHOW_MASTER . "=") === FALSE) {
   ...
   // Common render codes
	...
	function RenderEditRow() {
		...
		$this->nmkel3->EditValue = $this->nmkel3->CurrentValue;
		...
		$this->kode_akun2->EditValue = $this->kode_akun2->CurrentValue;
		...
		if (!$Doc->ExportCustom) {
			...
			if ($Doc->Horizontal) { // Horizontal format, write header
				...
				if ($ExportPageType == "view") {
					...
					if ($this->nmkel3->Exportable) $Doc->ExportCaption($this->nmkel3);
					if ($this->kode_akun2->Exportable) $Doc->ExportCaption($this->kode_akun2);
				} else {
					if ($this->id->Exportable) $Doc->ExportCaption($this->id);
					if ($this->kd_akun->Exportable) $Doc->ExportCaption($this->kd_akun);
					if ($this->kel1->Exportable) $Doc->ExportCaption($this->kel1);
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if (!$Doc->ExportCustom) {
					...
					if ($ExportPageType == "view") {
						...
						if ($this->nmkel3->Exportable) $Doc->ExportField($this->nmkel3);
						if ($this->kode_akun2->Exportable) $Doc->ExportField($this->kode_akun2);
					} else {
						if ($this->id->Exportable) $Doc->ExportField($this->id);
						if ($this->kd_akun->Exportable) $Doc->ExportField($this->kd_akun);
						if ($this->kel1->Exportable) $Doc->ExportField($this->kel1);
