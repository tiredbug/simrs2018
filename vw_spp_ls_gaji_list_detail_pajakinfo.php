...
$vw_spp_ls_gaji_list_detail_pajak = NULL;

//
// Table class for vw_spp_ls_gaji_list_detail_pajak
//
class cvw_spp_ls_gaji_list_detail_pajak extends cTable {
	var $id;
	var $id_spp;
	var $id_jenis_spp;
	...
	function __construct() {
		...
		$this->TableVar = 'vw_spp_ls_gaji_list_detail_pajak';
		$this->TableName = 'vw_spp_ls_gaji_list_detail_pajak';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`vw_spp_ls_gaji_list_detail_pajak`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('vw_spp_ls_gaji_list_detail_pajak', 'vw_spp_ls_gaji_list_detail_pajak', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// id_spp
		$this->id_spp = new cField('vw_spp_ls_gaji_list_detail_pajak', 'vw_spp_ls_gaji_list_detail_pajak', 'x_id_spp', 'id_spp', '`id_spp`', '`id_spp`', 3, -1, FALSE, '`id_spp`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// id_jenis_spp
		$this->id_jenis_spp = new cField('vw_spp_ls_gaji_list_detail_pajak', 'vw_spp_ls_gaji_list_detail_pajak', 'x_id_jenis_spp', 'id_jenis_spp', '`id_jenis_spp`', '`id_jenis_spp`', 3, -1, FALSE, '`id_jenis_spp`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// detail_jenis_spp
		$this->detail_jenis_spp = new cField('vw_spp_ls_gaji_list_detail_pajak', 'vw_spp_ls_gaji_list_detail_pajak', 'x_detail_jenis_spp', 'detail_jenis_spp', '`detail_jenis_spp`', '`detail_jenis_spp`', 3, -1, FALSE, '`detail_jenis_spp`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// no_spp
		$this->no_spp = new cField('vw_spp_ls_gaji_list_detail_pajak', 'vw_spp_ls_gaji_list_detail_pajak', 'x_no_spp', 'no_spp', '`no_spp`', '`no_spp`', 200, -1, FALSE, '`no_spp`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->no_spp->Sortable = TRUE; // Allow sort
		$this->fields['no_spp'] = &$this->no_spp;

		// program
		$this->program = new cField('vw_spp_ls_gaji_list_detail_pajak', 'vw_spp_ls_gaji_list_detail_pajak', 'x_program', 'program', '`program`', '`program`', 200, -1, FALSE, '`program`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->program->Sortable = TRUE; // Allow sort
		$this->fields['program'] = &$this->program;

		// kegiatan
		$this->kegiatan = new cField('vw_spp_ls_gaji_list_detail_pajak', 'vw_spp_ls_gaji_list_detail_pajak', 'x_kegiatan', 'kegiatan', '`kegiatan`', '`kegiatan`', 200, -1, FALSE, '`kegiatan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->kegiatan->Sortable = TRUE; // Allow sort
		$this->fields['kegiatan'] = &$this->kegiatan;

		// sub_kegiatan
		$this->sub_kegiatan = new cField('vw_spp_ls_gaji_list_detail_pajak', 'vw_spp_ls_gaji_list_detail_pajak', 'x_sub_kegiatan', 'sub_kegiatan', '`sub_kegiatan`', '`sub_kegiatan`', 200, -1, FALSE, '`sub_kegiatan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->sub_kegiatan->Sortable = TRUE; // Allow sort
		$this->fields['sub_kegiatan'] = &$this->sub_kegiatan;

		// tahun_anggaran
		$this->tahun_anggaran = new cField('vw_spp_ls_gaji_list_detail_pajak', 'vw_spp_ls_gaji_list_detail_pajak', 'x_tahun_anggaran', 'tahun_anggaran', '`tahun_anggaran`', '`tahun_anggaran`', 3, -1, FALSE, '`tahun_anggaran`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// akun1
		$this->akun1 = new cField('vw_spp_ls_gaji_list_detail_pajak', 'vw_spp_ls_gaji_list_detail_pajak', 'x_akun1', 'akun1', '`akun1`', '`akun1`', 200, -1, FALSE, '`akun1`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// akun2
		$this->akun2 = new cField('vw_spp_ls_gaji_list_detail_pajak', 'vw_spp_ls_gaji_list_detail_pajak', 'x_akun2', 'akun2', '`akun2`', '`akun2`', 200, -1, FALSE, '`akun2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// akun3
		$this->akun3 = new cField('vw_spp_ls_gaji_list_detail_pajak', 'vw_spp_ls_gaji_list_detail_pajak', 'x_akun3', 'akun3', '`akun3`', '`akun3`', 200, -1, FALSE, '`akun3`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// akun4
		$this->akun4 = new cField('vw_spp_ls_gaji_list_detail_pajak', 'vw_spp_ls_gaji_list_detail_pajak', 'x_akun4', 'akun4', '`akun4`', '`akun4`', 200, -1, FALSE, '`akun4`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// akun5
		$this->akun5 = new cField('vw_spp_ls_gaji_list_detail_pajak', 'vw_spp_ls_gaji_list_detail_pajak', 'x_akun5', 'akun5', '`akun5`', '`akun5`', 200, -1, FALSE, '`akun5`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// kd_rekening_belanja
		$this->kd_rekening_belanja = new cField('vw_spp_ls_gaji_list_detail_pajak', 'vw_spp_ls_gaji_list_detail_pajak', 'x_kd_rekening_belanja', 'kd_rekening_belanja', '`kd_rekening_belanja`', '`kd_rekening_belanja`', 200, -1, FALSE, '`kd_rekening_belanja`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// jumlah_belanja
		$this->jumlah_belanja = new cField('vw_spp_ls_gaji_list_detail_pajak', 'vw_spp_ls_gaji_list_detail_pajak', 'x_jumlah_belanja', 'jumlah_belanja', '`jumlah_belanja`', '`jumlah_belanja`', 5, -1, FALSE, '`jumlah_belanja`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`vw_spp_ls_gaji_list_detail_pajak`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "vw_spp_ls_gaji_list_detail_pajaklist.php";
		}
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("vw_spp_ls_gaji_list_detail_pajakview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("vw_spp_ls_gaji_list_detail_pajakview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "vw_spp_ls_gaji_list_detail_pajakadd.php?" . $this->UrlParm($parm);
		else
			$url = "vw_spp_ls_gaji_list_detail_pajakadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("vw_spp_ls_gaji_list_detail_pajakedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("vw_spp_ls_gaji_list_detail_pajakadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("vw_spp_ls_gaji_list_detail_pajakdelete.php", $this->UrlParm());
	}
