...
$vw_spp_gu_list_add = NULL; // Initialize page object first

class cvw_spp_gu_list_add extends cvw_spp_gu_list {
	...
	// Page object name
	var $PageObjName = 'vw_spp_gu_list_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "vw_spp_gu_listview.php")
	...
	function LoadDefaultValues() {
		...
		$this->detail_jenis_spp->CurrentValue = 1;
...
// Create page object
if (!isset($vw_spp_gu_list_add)) $vw_spp_gu_list_add = new cvw_spp_gu_list_add();

// Page init
$vw_spp_gu_list_add->Page_Init();

// Page main
$vw_spp_gu_list_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$vw_spp_gu_list_add->Page_Render();
?>
...
var CurrentForm = fvw_spp_gu_listadd = new ew_Form("fvw_spp_gu_listadd", "add");

// Validate form
fvw_spp_gu_listadd.Validate = function() {
...
fvw_spp_gu_listadd.Form_CustomValidate = 
...
fvw_spp_gu_listadd.ValidateRequired = true;
<?php } else { ?>
fvw_spp_gu_listadd.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fvw_spp_gu_listadd.Lists["x_id_jenis_spp"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_jenis_spp","","",""],"ParentFields":[],"ChildFields":["x_detail_jenis_spp"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"l_jenis_spp"};
fvw_spp_gu_listadd.Lists["x_detail_jenis_spp"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_detail_jenis_spp","","",""],"ParentFields":["x_id_jenis_spp"],"ChildFields":[],"FilterFields":["x_id_jenis"],"Options":[],"Template":"","LinkTable":"l_jenis_detail_spp"};
fvw_spp_gu_listadd.Lists["x_status_spp"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fvw_spp_gu_listadd.Lists["x_status_spp"].Options = <?php echo json_encode($vw_spp_gu_list->status_spp->Options()) ?>;
fvw_spp_gu_listadd.Lists["x_nama_bendahara"] = {"LinkField":"x_nama","Ajax":true,"AutoFill":true,"DisplayFields":["x_nama","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"m_pejabat_keuangan"};
fvw_spp_gu_listadd.Lists["x_nama_pptk"] = {"LinkField":"x_nama","Ajax":true,"AutoFill":true,"DisplayFields":["x_nama","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"m_pejabat_keuangan"};
fvw_spp_gu_listadd.Lists["x_kode_program"] = {"LinkField":"x_kode_program","Ajax":true,"AutoFill":false,"DisplayFields":["x_nama_program","","",""],"ParentFields":[],"ChildFields":["x_kode_kegiatan","x_kode_sub_kegiatan"],"FilterFields":[],"Options":[],"Template":"","LinkTable":"m_program"};
fvw_spp_gu_listadd.Lists["x_kode_kegiatan"] = {"LinkField":"x_kode_kegiatan","Ajax":true,"AutoFill":false,"DisplayFields":["x_nama_kegiatan","","",""],"ParentFields":["x_kode_program"],"ChildFields":["x_kode_sub_kegiatan"],"FilterFields":["x_kode_program"],"Options":[],"Template":"","LinkTable":"m_kegiatan"};
fvw_spp_gu_listadd.Lists["x_kode_sub_kegiatan"] = {"LinkField":"x_kode_sub_kegiatan","Ajax":true,"AutoFill":false,"DisplayFields":["x_nama_sub_kegiatan","","",""],"ParentFields":["x_kode_kegiatan","x_kode_program"],"ChildFields":[],"FilterFields":["x_kode_kegiatan","x_kode_program"],"Options":[],"Template":"","LinkTable":"m_sub_kegiatan"};
fvw_spp_gu_listadd.Lists["x_id_spj"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_no_spj","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t_spj"};
fvw_spp_gu_listadd.Lists["x_id_spd"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_no_spd","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t_spd"};
...
<?php if (!$vw_spp_gu_list_add->IsModal) { ?>
<?php } ?>
<?php $vw_spp_gu_list_add->ShowPageHeader(); ?>
<?php
$vw_spp_gu_list_add->ShowMessage();
?>
<form name="fvw_spp_gu_listadd" id="fvw_spp_gu_listadd" class="<?php echo $vw_spp_gu_list_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($vw_spp_gu_list_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $vw_spp_gu_list_add->Token ?>">
<?php } ?>
...
<script type="text/javascript">
ew_CreateCalendar("fvw_spp_gu_listadd", "x_tgl_spp", 7);
</script>
<?php } ?>
</span>
...
<script type="text/javascript">
fvw_spp_gu_listadd.CreateAutoSuggest({"id":"x_id_spj","forceSelect":false});
</script>
...
<script type="text/javascript">
fvw_spp_gu_listadd.CreateAutoSuggest({"id":"x_id_spd","forceSelect":true});
</script>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $vw_spp_gu_list_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
fvw_spp_gu_listadd.Init();
</script>
<?php
$vw_spp_gu_list_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$vw_spp_gu_list_add->Page_Terminate();
?>
